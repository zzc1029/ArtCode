...
static void Rool_Alarm_Handle(void)
{
	...
	TIP_0XA3  = (JINZHAN_TINGCHE || TestBits(CanData[ID(0x18FF8DAC)][BYTE2],0,4,5));
	TIP_0XA4  = (TestBits(CanData[ID(0x18FF8DAC)][BYTE1],4,4,1) && TestBits(CanData[ID(0x18FF8DAC)][BYTE3],0,2,1));
	TIP_0XA5  = (TestBits(CanData[ID(0x18FF8DAC)][BYTE2],0,4,5) && TestBits(CanData[ID(0x18FF8DAC)][BYTE3],0,2,1));
    ...
    if(PASSAGE_GET_OUT_SW && (passgetoff == 0))
    {
        //if(falgggg == 0)
        //{
          //if(blinker == 1)
	...
	TIP_0XAC  = TestBits(CanData[ID(0x18FFA898)][0],6,2,2);
	...
	TIP_0XC2 = TestBitTrue(taiya.alarm_status[0].byte,0);
	TIP_0XC3 = TestBitTrue(taiya.alarm_status[1].byte,0);
	TIP_0XC4 = TestBitTrue(taiya.alarm_status[2].byte,0);
	TIP_0XC5 = TestBitTrue(taiya.alarm_status[3].byte,0);
	TIP_0XC6 = TestBitTrue(taiya.alarm_status[4].byte,0);
	TIP_0XC7 = TestBitTrue(taiya.alarm_status[5].byte,0);
	TIP_0XC8 = TestBits(taiya.alarm_status[0].byte,3,2,1);
	TIP_0XC9 = TestBits(taiya.alarm_status[1].byte,3,2,1);
	TIP_0XCA = TestBits(taiya.alarm_status[2].byte,3,2,1);
	TIP_0XCB = TestBits(taiya.alarm_status[3].byte,3,2,1);
	TIP_0XCC = TestBits(taiya.alarm_status[4].byte,3,2,1);
	TIP_0XCD = TestBits(taiya.alarm_status[5].byte,3,2,1);
	TIP_0XCE = TestBits(taiya.alarm_status[0].byte,5,3,0);
	TIP_0XCF = TestBits(taiya.alarm_status[1].byte,5,3,0);
	TIP_0XD0 = TestBits(taiya.alarm_status[2].byte,5,3,0);
	TIP_0XD1 = TestBits(taiya.alarm_status[3].byte,5,3,0);
	TIP_0XD2 = TestBits(taiya.alarm_status[4].byte,5,3,0);
	TIP_0XD3 = TestBits(taiya.alarm_status[5].byte,5,3,0);
	TIP_0XD4 = TestBits(taiya.alarm_status[0].byte,5,3,4);
	TIP_0XD5 = TestBits(taiya.alarm_status[1].byte,5,3,4);
	TIP_0XD6 = TestBits(taiya.alarm_status[2].byte,5,3,4);
	TIP_0XD7 = TestBits(taiya.alarm_status[3].byte,5,3,4);
	TIP_0XD8 = TestBits(taiya.alarm_status[4].byte,5,3,4);
	TIP_0XD9 = TestBits(taiya.alarm_status[5].byte,5,3,4);
	TIP_0XDA = (Meihuo[0].alarm_level > 0);
	TIP_0XDB = (Meihuo[1].alarm_level > 0);
	TIP_0XDC = (Meihuo[2].alarm_level > 0);
	TIP_0XDD = (Meihuo[3].alarm_level > 0);
	TIP_0XDE = (Meihuo[4].alarm_level > 0);
	TIP_0XDF = (Meihuo[5].alarm_level > 0);
	TIP_0XE0 = (Meihuo[6].alarm_level > 0);
	TIP_0XE1 = (Meihuo[7].alarm_level > 0);
	TIP_0XE2 = (Meihuo[8].alarm_level > 0);
	TIP_0XE3 = (Meihuo[9].alarm_level > 0);
	TIP_0XE4 = (Meihuo[10].alarm_level > 0);
	TIP_0XE5 = (Meihuo[11].alarm_level > 0);
	TIP_0XE6 = (Meihuo[12].alarm_level > 0);
	TIP_0XE7 = (Meihuo[13].alarm_level > 0);
	TIP_0XE8 = (Meihuo[14].alarm_level > 0);
	TIP_0XE9 = TestBits(CanData[ID(0x18FF8DAC)][BYTE3],2,2,1);
...
//--------------------------------------------------------------------------------
   ...
   BUZZ_Normal  = TIP_0X46||TIP_0X47||TIP_0X4A||TIP_0X4B||TIP_0X4C||TIP_0X4F||TIP_0X50||TIP_0X51||TIP_0X52||(time2 > 0)\
		...
		||(passgetoff > 0)||TIP_0X47||TIP_0X8B||TIP_0X8A||TIP_0X98||TAIYA_ALARM_FLAG||TIP_0XE9||\
   ...
   BUZZ_Critical = TIP_0X45||TIP_0X49 || TIP_0X48 ||(buzz_hurry_time > 0);
...
void j1939_tx_100ms(void)
{
	...
	if(clear_mile_time > 2)
	{
		...
		temp_u8.byte = 0;
		temp_u8.bit.b0 = !R_SW_P34;
		temp_u8.bit.b2 = (BREAK_SW || TestBits(CanData[ID(0x18F0010B)][BYTE1],6,2,1));
		...
		metre_state2[1].bit.b0  = (BREAK_SW || ELEC_BREAK || TestBits(CanData[ID(0x18F0010B)][BYTE1],6,2,1)); 
		...
		metre_state2[3].bit.b2  = RIGHT_LED_SW;
		metre_state2[3].bit.b3  = 0;
		metre_state2[3].bit.b4  = LEFT_LED_SW;
...
void BCMConfig(void)
{
    ...
    F_OUT_P3   =  SYSTEM_POW && (HBEAM_SW && LBEAM_SW && BACKLIGHT_SW);
    F_OUT_P11  =  F_OUT_P3;
    ...
    R_OUT_P1    =  SYSTEM_POW && (veh_speed_display < 50);
    R_OUT_P9    =  KEY_ON && (BREAK_SW || ELEC_BREAK);
	#if 0
	...
	if(powertime > 0)
	   powertime--;
    R_OUT_P11   =  KEY_ON && TestBits(CanData[ID(0x18FFEA97)][BYTE1],3,3,2) && (!BACKLIGHT_SW);
	#if 0
	...
	if(FrontCloseCount > 0)
		FrontCloseCount--;
	#else
	R_OUT_P8    =  SYSTEM_POW && BACKLIGHT_SW;
	#endif
    R_OUT_P17   =  UNUSE;
    ...
    T_OUT_P1    =  SYSTEM_POW && RIGUANGDENG_ZUO_SW;
    T_OUT_P9    =  R_OUT_P6;
    T_OUT_P2    =  SYSTEM_POW && FAN_SW;
    T_OUT_P10   =  SYSTEM_POW && DRIVER_LIGHT_SW;
    T_OUT_P3    =  KEY_ON && (BREAK_SW || ELEC_BREAK || TestBits(CanData[ID(0x18F0010B)][BYTE1],6,2,1));
    T_OUT_P11   =  SYSTEM_POW;
	...
	if(LED_MIDDLE_DOOR_SW)
		T_OUT_P5 =0;
    T_OUT_P13   =  SYSTEM_POW && TV_SW;
    T_OUT_P6    =  R_OUT_P7;
    T_OUT_P14   =  SYSTEM_POW && RIGUANGDENG_YOU_SW;
...
void LED_Handle(void)
{
    ...
    LED4_B6 = KEY_ON && (bcm_senor2_r <= 271);
	{
   ...
   // LED5_B3 = TestBitTrue(CanData[ID(0x18FFF897)][7],2);
	...
	LED9_B7 = (GetU16LEData(CanData[ID(0x18FF65AC)][BYTE4],CanData[ID(0x18FF65AC)][BYTE5]) > 0);
	/*if(PODAO_QIBU_ON)
		LED9_B5 = 1;
		...
		LED9_B5 = 0;*/
	if(TestBits(CanData[ID(0x18FF8DAC)][BYTE2],0,4,6))
		LED9_B6 = 1;
	else if(TestBits(CanData[ID(0x18FF8DAC)][BYTE2],0,4,5))
		LED9_B6 = (hz > 4);
	else
		LED9_B6 = 0;
	LED9_B4 = LED_ABS_SW;      
	LED9_B3 = 0;//JINZHAN_TINGCHE;   
	LED9_B2 = 0;//EBS_YELLOW;

	if((((tip_code4.byte[0] >> 2) & 0x3F) > 0)||((tip_code4.byte[1] & 0xFF) > 0)||((tip_code4.byte[2] & 0xFF) > 0)||((tip_code4.byte[3] & 0x03) > 0))
		TAIYA_ALARM_FLAG = 1;
	else
		TAIYA_ALARM_FLAG = 0;
	LED9_B1 = TAIYA_ALARM_FLAG;
