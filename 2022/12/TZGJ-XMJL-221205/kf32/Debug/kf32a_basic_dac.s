...
.Lscope1:
	...
	.type	.text$DAC_Reset$scode_local_2, @function
	.text$DAC_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$DAC_Configuration$scode_local_3, @function
	.text$DAC_Configuration$scode_loacal_3:
	.align	1
...
DAC_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext3
.Ltext3:
...
.LM24:
	...
	LD.w	r4,[sp+#1]
	ST.w	[r4],r5
	.stabn	68,0,118,.LM25-.LFBB3
.LM25:
	LD.w	r5,[sp+#2]
	LD.w	r4,[r5+#6]
	.stabn	68,0,119,.LM26-.LFBB3
.LM26:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#5]
	ORL	r4,r4,r5
	.stabn	68,0,120,.LM27-.LFBB3
.LM27:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#7]
	ORL	r4,r4,r5
	.stabn	68,0,121,.LM28-.LFBB3
.LM28:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#8]
	LSL	r5,#6
	ORL	r4,r4,r5
	.stabn	68,0,122,.LM29-.LFBB3
.LM29:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#9]
...
.LM31:
	...
	LD.w	r5,[sp+#1]
	ST.w	[r5+#3],r4
	.stabn	68,0,127,.LM32-.LFBB3
.LM32:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#10]
	ST.w	[sp],r5
	.stabn	68,0,128,.LM33-.LFBB3
.LM33:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#1]
	MOV	r0,r5
...
.Lscope3:
	...
	.type	.text$DAC_Struct_Init$scode_local_4, @function
	.text$DAC_Struct_Init$scode_loacal_4:
	.align	1
	.stabs	"DAC_Struct_Init:F(0,15)",36,0,137,DAC_Struct_Init
	.stabs	"dacInitStruct:p(0,17)",160,0,137,0
...
.Ltext4:
	.stabn	68,0,138,.LM35-.LFBB4
.LM35:
.LFBB4:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,140,.LM36-.LFBB4
.LM36:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,142,.LM37-.LFBB4
.LM37:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,144,.LM38-.LFBB4
.LM38:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,146,.LM39-.LFBB4
.LM39:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,148,.LM40-.LFBB4
.LM40:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
...
.LM41:
	...
	MOV	r4,#0
	ST.w	[r5+#5],r4
	.stabn	68,0,152,.LM42-.LFBB4
.LM42:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#6],r4
	.stabn	68,0,154,.LM43-.LFBB4
.LM43:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#7],r4
	.stabn	68,0,156,.LM44-.LFBB4
.LM44:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#8],r4
	.stabn	68,0,158,.LM45-.LFBB4
.LM45:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#9],r4
	.stabn	68,0,160,.LM46-.LFBB4
.LM46:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#10],r4
	.stabn	68,0,161,.LM47-.LFBB4
.LM47:
	ADD	sp,#4
	JMP	lr
...
.Lscope4:
	...
	.type	.text$DAC_Cmd$scode_local_5, @function
	.text$DAC_Cmd$scode_loacal_5:
	.align	1
	.stabs	"DAC_Cmd:F(0,15)",36,0,171,DAC_Cmd
	.stabs	"DACx:p(0,16)",160,0,171,0
	.stabs	"NewState:p(2,2)",160,0,171,4
	.export	DAC_Cmd
	.type	DAC_Cmd, @function
DAC_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,172,.LM48-.LFBB5
.LM48:
.LFBB5:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,177,.LM49-.LFBB5
.LM49:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L9
	.stabn	68,0,180,.LM50-.LFBB5
.LM50:
	LD.w	r5,[sp]
// inline asm begin
...
.Lscope5:
	...
	.type	.text$DAC_Software_Trigger_Cmd$scode_local_6, @function
	.text$DAC_Software_Trigger_Cmd$scode_loacal_6:
	.align	1
	.stabs	"DAC_Software_Trigger_Cmd:F(0,15)",36,0,197,DAC_Software_Trigger_Cmd
	.stabs	"DACx:p(0,16)",160,0,197,0
	.stabs	"NewState:p(2,2)",160,0,197,4
...
.Ltext6:
	.stabn	68,0,198,.LM53-.LFBB6
.LM53:
.LFBB6:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,203,.LM54-.LFBB6
.LM54:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L12
	.stabn	68,0,206,.LM55-.LFBB6
.LM55:
	LD.w	r5,[sp]
// inline asm begin
...
.Lscope6:
	...
	.type	.text$DAC_DMA_Cmd$scode_local_7, @function
	.text$DAC_DMA_Cmd$scode_loacal_7:
	.align	1
	.stabs	"DAC_DMA_Cmd:F(0,15)",36,0,223,DAC_DMA_Cmd
	.stabs	"DACx:p(0,16)",160,0,223,0
	.stabs	"NewState:p(2,2)",160,0,223,4
	.export	DAC_DMA_Cmd
	.type	DAC_DMA_Cmd, @function
DAC_DMA_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,224,.LM58-.LFBB7
.LM58:
.LFBB7:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,229,.LM59-.LFBB7
.LM59:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JZ	.L15
	.stabn	68,0,232,.LM60-.LFBB7
.LM60:
	LD.w	r5,[sp]
// inline asm begin
...
.Lscope7:
	...
	.type	.text$DAC_Output_Buffer_Config$scode_local_8, @function
	.text$DAC_Output_Buffer_Config$scode_loacal_8:
	.align	1
	.stabs	"DAC_Output_Buffer_Config:F(0,15)",36,0,249,DAC_Output_Buffer_Config
	.stabs	"DACx:p(0,16)",160,0,249,0
	.stabs	"NewState:p(2,2)",160,0,249,4
...
.Lscope8:
	...
	.type	.text$DAC_Output_Port_Config$scode_local_9, @function
	.text$DAC_Output_Port_Config$scode_loacal_9:
	.align	1
	.stabs	"DAC_Output_Port_Config:F(0,15)",36,0,275,DAC_Output_Port_Config
	.stabs	"DACx:p(0,16)",160,0,275,0
	.stabs	"NewState:p(2,2)",160,0,275,4
...
.Lscope9:
	...
	.type	.text$DAC_Write_Output_Data$scode_local_10, @function
	.text$DAC_Write_Output_Data$scode_loacal_10:
	.align	1
	.stabs	"DAC_Write_Output_Data:F(0,15)",36,0,310,DAC_Write_Output_Data
	.stabs	"DACx:p(0,16)",160,0,310,0
	.stabs	"Value:p(3,6)",160,0,310,4
...
.Ltext10:
	.stabn	68,0,311,.LM73-.LFBB10
.LM73:
.LFBB10:
	SUB	sp,#8
	ST.w	[sp],r0
	ST.w	[sp+#1],r1
	.stabn	68,0,316,.LM74-.LFBB10
.LM74:
	LD.w	r5,[sp]
	LD.w	r4,[sp+#1]
	ST.w	[r5+#1],r4
	.stabn	68,0,317,.LM75-.LFBB10
.LM75:
	ADD	sp,#8
	JMP	lr
...
.Lscope10:
	...
	.type	.text$DAC_Read_Output_Data$scode_local_11, @function
	.text$DAC_Read_Output_Data$scode_loacal_11:
	.align	1
	.stabs	"DAC_Read_Output_Data:F(3,6)",36,0,325,DAC_Read_Output_Data
	.stabs	"DACx:p(0,16)",160,0,325,0
...
.Lscope11:
	...
	.type	.text$DAC_Calibration_Config$scode_local_12, @function
	.text$DAC_Calibration_Config$scode_loacal_12:
	.align	1
	.stabs	"DAC_Calibration_Config:F(0,15)",36,0,349,DAC_Calibration_Config
	.stabs	"DACx:p(0,16)",160,0,349,4
	.stabs	"dacCalStruct:p(0,18)=*(1,3)",160,0,349,8
...
.LFBB12:
	...
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,351,.LM80-.LFBB12
.LM80:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,366,.LM81-.LFBB12
.LM81:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5]
	MOV	r3,#28
	LSL	r4,r5,r3
	.stabn	68,0,367,.LM82-.LFBB12
.LM82:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#1]
	LSL	r5,#24
	.stabn	68,0,366,.LM83-.LFBB12
.LM83:
	ORL	r4,r4,r5
	.stabn	68,0,368,.LM84-.LFBB12
.LM84:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#2]
	LSL	r5,#20
	.stabn	68,0,367,.LM85-.LFBB12
.LM85:
	ORL	r4,r4,r5
	.stabn	68,0,369,.LM86-.LFBB12
.LM86:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#3]
	LSL	r5,#16
	.stabn	68,0,368,.LM87-.LFBB12
.LM87:
	ORL	r4,r4,r5
	.stabn	68,0,370,.LM88-.LFBB12
.LM88:
	LD.w	r5,[sp+#2]
	LD.w	r5,[r5+#4]
	LSL	r5,#15
	.stabn	68,0,366,.LM89-.LFBB12
.LM89:
	ORL	r5,r4,r5
	ST.w	[sp],r5
	.stabn	68,0,371,.LM90-.LFBB12
.LM90:
	LD.w	r5,[sp+#1]
	LD.w	r5,[r5+#5]
	MOV	r0,r5
	...
	LD.w	r5,[sp+#1]
	ST.w	[r5+#5],r4
	.stabn	68,0,372,.LM91-.LFBB12
.LM91:
	ADD	sp,#12
	POP	lr
	JMP	lr
	.size	DAC_Calibration_Config, .-DAC_Calibration_Config
	.stabs	"tmpreg:(3,6)",128,0,351,0
...
.Lscope12:
	...
	.type	.text$DAC_Calibration_Struct_Init$scode_local_13, @function
	.text$DAC_Calibration_Struct_Init$scode_loacal_13:
	.align	1
	.stabs	"DAC_Calibration_Struct_Init:F(0,15)",36,0,380,DAC_Calibration_Struct_Init
	.stabs	"dacCalStruct:p(0,18)",160,0,380,0
...
.Ltext13:
	.stabn	68,0,381,.LM92-.LFBB13
.LM92:
.LFBB13:
	SUB	sp,#4
	ST.w	[sp],r0
	.stabn	68,0,383,.LM93-.LFBB13
.LM93:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,385,.LM94-.LFBB13
.LM94:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#1],r4
	.stabn	68,0,387,.LM95-.LFBB13
.LM95:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,389,.LM96-.LFBB13
.LM96:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#3],r4
	.stabn	68,0,391,.LM97-.LFBB13
.LM97:
	LD.w	r5,[sp]
	MOV	r4,#0
	ST.w	[r5+#4],r4
	.stabn	68,0,392,.LM98-.LFBB13
.LM98:
	ADD	sp,#4
	JMP	lr
