...
# 1 "G:/workspace32/YB-CZGJ-AK-221201/driver/keyfifo.h" 1
# 12 "G:/workspace32/YB-CZGJ-AK-221201/driver/keyfifo.h"
...
static u8 ChangeSubi(u8 key,u8 initpw)
{
 ...
 if(sendflag == 1)
 {
  ...
  if(kehu_mi)
  {
   ...
   if((Set_odometer_const > (1.2*1800))||(Set_odometer_const < (0.8*1800)))
   {
...
static u8 ChangePulse(u8 key,u8 initpw)
{
 ...
 static u16 set_Pulse_last;
  ...
  if(kehu_mi)
  {
   ...
   if((Set_Pulse > (1.2*1450))||(Set_Pulse < (0.8*1450)))
   {
...
static u8 ChangeCoef(u8 key,u8 initpw)
{
 ...
 if(sendflag == 1)
 {
  ...
  if(kehu_mi)
  {
   ...
   if((Set_Coef > (1.2*100))||(Set_Coef < (0.8*100)))
   {
...
static u32 MenuDIS_POWER_MENU(u8 key,u8 initpw)
{
 ...
 if((!(port_a.bit.b2 || port_a.bit.b3))||port_c.bit.b4||((Ankai_Add_190703.bit.b5 == 1) && Art.bit.b34))
  return DIS_NOP_MENU;
 else
  return DIS_POWER_MENU;
}
# 2708 "../source/displayhelper.c"
static u32 NopMesg(u8 key,u8 initpw)
{
   ...
   case 3:
    ...
    else if((port_a.bit.b2 || port_a.bit.b3 || port_a.bit.b0) && (Ankai_Add_190703.bit.b5 == 1))
    {
       flag = 0;
    Art.bit.b35 = 1;
...
void roll_alarm_Task(void)
{
    if((port_c.bit.b4&&(Art.bit.b28)) || port_a.bit.b2|| port_a.bit.b3)
    {
        roll_alarm();
    }
}
...
# 3564 "../source/displayhelper.c"
 if(port_c.bit.b4||(Ankai_Add_190703.bit.b5 == 0))
  return DIS_NOP_MENU;
 else
  return DIS_PARK_MENU;
