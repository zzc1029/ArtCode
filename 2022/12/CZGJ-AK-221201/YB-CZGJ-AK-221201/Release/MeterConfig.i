...
void power_task(void)
{
 ...
 {
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0200), SET);
  if((port_a.bit.b1||port_a.bit.b2||port_a.bit.b3||port_c.bit.b4||port_a.bit.b0))
  {
...
# 573 "../source/MeterConfig.c"
    T_Set_PWM.bit.b3 = 1;
# 582 "../source/MeterConfig.c"
    T_Set_PWM.bit.b6 = 1;
# 591 "../source/MeterConfig.c"
    T_Set_PWM.bit.b9 = 1;
...
void RainConfig(void)
{
 ...
 else
 {
  ...
  start_wait = 0;
    ...
    ctrl_cmd[6].bit.b0 = (port_c.bit.b4||port_a.bit.b0) && (port_b.bit.b1);
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_c.bit.b4||port_a.bit.b0) && (port_b.bit.b7);
    if((start_wait >= 30) && (key_on_flag == 1))
 {
  start_wait = 30;
  ctrl_cmd[6].bit.b2 = (port_c.bit.b4||port_a.bit.b0) && (port_b.bit.b0);
 }
 else if(port_c.bit.b4)
  start_wait++;
    ctrl_cmd[6].bit.b3 = (port_c.bit.b4||port_a.bit.b0) && (port_b.bit.b6);
