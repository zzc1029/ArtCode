...
void HC165PortInit(void)
{
  ...
  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0100));
  ...
  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0400));

  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0200));


  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000));


  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x2000));


  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0080));

  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100));
}
...
void switch_task(void)
{
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)),((uint16_t)0x0008), SET);
 dump=0;
 for(j = 0; j < 5; j++)
 {
  for(i=0;i<8;i++)
  {
   ...
   dump = (dump<<1);
   dump |= GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0100));
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0080), SET);
   for(k = 0; k < 9; k++)
   {
    asm("nop");
   }
 ...
 port_a.bit.b0 = sw_input[0].bit.b3;
 port_a.bit.b1 = sw_input[0].bit.b2;
 port_a.bit.b2 = sw_input[0].bit.b1;
 port_a.bit.b3 = sw_input[0].bit.b0;
 port_a.bit.b4 = sw_input[0].bit.b7;
 port_a.bit.b5 = sw_input[0].bit.b6;
 port_a.bit.b6 = sw_input[0].bit.b5;


 port_a.bit.b7 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100)) == RESET);

 port_a.bit.b8 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000)) == RESET);

 port_a.bit.b9 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0080)) == RESET);

 port_a.bit.b10 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x2000)) == RESET);


 port_c.bit.b0 = sw_input[1].bit.b7;
 port_c.bit.b1 = sw_input[1].bit.b6;
 port_c.bit.b2 = sw_input[1].bit.b5;
 port_c.bit.b3 = sw_input[1].bit.b4;
 port_c.bit.b4 = sw_input[0].bit.b4;


 port_c.bit.b8 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0400)) == RESET);

 port_c.bit.b9 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0200)) == RESET);
