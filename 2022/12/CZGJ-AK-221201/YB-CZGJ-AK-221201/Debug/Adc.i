...
void Init_adc(void)
{
 ...
 adcStruct.m_ClockDiv = ((uint32_t)6<<(8));
...
void ReadAdcResult(void)
{
 ...
 buf_16 = ADC_Get_Conversion_Value(((ADC_SFRmap *) ((uint32_t)0x40000580)));
    ...
    switch(flag)
    {
      ...
      meter.MeterA2 = buf_16*(3300/4095.0);
      meter.MeterA2 = (510*meter.MeterA2)/(5000 - meter.MeterA2);
   ...
   case metera3:
      ...
      meter.MeterA3 = buf_16*(3300/4095.0);
      meter.MeterA3 = (510*meter.MeterA3)/(5000 - meter.MeterA3);
   ...
   case metera4:
      ...
      meter.MeterA4 = buf_16*(3300/4095.0);
      meter.MeterA4 = (510*meter.MeterA4)/(5000 - meter.MeterA4);
   ...
   case metera13:
     ...
     meter.MeterA13 = buf_16*(3300/4095.0);
     meter.MeterA13 = (510*meter.MeterA13)/(5000 - meter.MeterA13);
   ...
   case metera14:
     ...
     meter.MeterA14 = buf_16*(3300/4095.0);
     meter.MeterA14 = (510*meter.MeterA14)/(5000 - meter.MeterA14);
   ...
   Vbat = Vbat/100;
      { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (Vbat); log[0] = (Vbat); filter_count ++; } else { if (filter_count < 16) { sum += (Vbat); log[filter_count] = (Vbat); Vbat = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (Vbat); log[aver_count] = (Vbat); Vbat = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000000), 0x01);
        flag = meterE3E8;
        break;
   case meterE3E8:
        if(e3e8state == E3)
        {
     adc_100ma_fd[0] = buf_16*(3300/4095.0)/100;
   ...
   {
    adc_100ma_fd[3] = buf_16*(3300/4095.0)/100;
   ...
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x2000),e3e8state);;
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000001), 0x01);
        flag = meterE6E7;
       break;
   case meterE6E7:
        if(e6e7state == E6)
        {
     adc_100ma_fd[1] = buf_16*(3300/4095.0)/100;
   ...
   {
    adc_100ma_fd[2] = buf_16*(3300/4095.0)/100;
   ...
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0010),e6e7state);;
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000002), 0x01);
        flag = meterA16;
       break;
   case meterA16:
   adc_100ma_fd[4] = buf_16*(3300/4095.0);
