...
# 70 "../driver/Usart.c"
    USART_InitStructure.m_BaudRateInteger=195;
...
void USART_Sync_config(USART_SFRmap* USARTx)
{
 ...
 USART_Struct_Init(&USART_InitStructure);
    ...
    USART_InitStructure.m_StopBits=((uint32_t)0<<(18));
     ...
     USART_InitStructure.m_WordLength=((uint32_t)0<<(21));
     USART_InitStructure.m_Parity=((uint32_t)1<<(20));
...
void GPIO_USART2(void)
{
 ...
 GPIO_InitStructure.m_Pin = ((uint16_t)0x2000);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),&GPIO_InitStructure);
 ...
 GPIO_InitStructure.m_OpenDrain = GPIO_POD_PP;
 GPIO_InitStructure.m_Pin = ((uint16_t)0x8000);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),&GPIO_InitStructure);
 ...
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint32_t)0xD), ((uint8_t)0x05));
 GPIO_Pin_RMP_Config (((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint32_t)0xF), ((uint8_t)0x05));
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint16_t)0x2000), TRUE);
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint16_t)0x8000), TRUE);
...
void UartInitToT123(void)
{
 ...
 USART_ReceiveInt_config(((USART_SFRmap *) ((uint32_t)0x40000A80)),INT_USART2);

    INT_Interrupt_Priority_Config(INT_USART2,((uint32_t)3<<((1))),6);
}

void Uart2Send(uint8_t *pBuf, uint32_t cnt)
{
 USART_Send(((USART_SFRmap *) ((uint32_t)0x40000A80)),pBuf,cnt);
}
