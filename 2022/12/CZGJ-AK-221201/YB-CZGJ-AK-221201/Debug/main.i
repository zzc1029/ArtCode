...
# 120 "../source/main.c"
 ...
 (void)sch_add_task(display_task, 1, 9);
 ...
 (void)sch_add_task(j1939_tx_50ms, 6, 9);
 (void)sch_add_task(Acquisition_Task,26,99);
 (void)sch_add_task(ReadAdcResult, 1, 1);
 (void)sch_add_task(SystemLogic, 49, 9);
 (void)sch_add_task(feedback_diag, 9, 49);
 (void)sch_add_task(motor_task, 300, 4);
 (void)sch_add_task(roll_alarm_Task, 500, 199);
 (void)sch_add_task(BuzzLogic, 48, 1);


 while(1)
 {
  if((port_c.bit.b4 || port_a.bit.b2|| port_a.bit.b3) && (Art.bit.b8 == 0))
    {
     Art.bit.b8 = 1;
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040), SET);

    }
  BootloaderLoop();
  sch_dispatch_tasks();
        if(((SysTickPer1ms & 0x1F) == 0x10) && (time != SysTickPer1ms))
        {
            time = SysTickPer1ms;
            SendToT123();
        }
