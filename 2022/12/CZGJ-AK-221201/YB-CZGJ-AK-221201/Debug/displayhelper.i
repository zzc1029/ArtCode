...
# 1 "D:/zzc/project/pro_2021/pro_12/FYGJ-AK-211230/code/ART_BOOT/driver/keyfifo.h" 1
# 12 "D:/zzc/project/pro_2021/pro_12/FYGJ-AK-211230/code/ART_BOOT/driver/keyfifo.h"
...
# 1 "../source/display.h" 1
# 11 "../source/displayhelper.c" 2
...
void ChangeToPage(uint8_t menu)
{
    ...
    if(menu == PAGE_ARTSET)
    {
        ...
        switch(SetOption)
        {
            ...
            case NoEncryptSetPage:
                ...
                communicate_T123_data[6] = !Art.bit.b2;
                break;
            case EncryptSetPage:
                communicate_T123_data[5] = odometer_const;
                communicate_T123_data[6] = ((odometer_const%10000) >> 8);

                communicate_T123_data[7] = (((Pulse)>>0)&0xFF);
                communicate_T123_data[8] = (((Pulse)>>8)&0xFF);
   ...
   case KehuEncryptSetPage:
    ...
    if(ClearBufferDisable == 0)
        fifo_set_free(&SendBuff);
    {SendToT123Loop = 8; SendToT123Delay = 10; fifo_in(&SendBuff); };

}
# 168 "../source/displayhelper.c"
static u32 MainMesg(u8 key,u8 initpw)
{
    ...
    Main_Send(initpw);
 if(port_c.bit.b4 && (!port_a.bit.b2))
 {
     switch(key)
     {
         case IN_KEY2_SP:
 ...
 if(!port_c.bit.b4)
 {
# 227 "../source/displayhelper.c"
  return DIS_NOP_MENU;
 }
 else if((((_0CFF0B4A[1]) & (1<<(3))) > 0) && port_c.bit.b4)
  return DIS_YOUMEN_MENU;
 else if((((_18FF0152[1]) & (1<<(0))) > 0) && port_c.bit.b4)
  return DIS_EP_MENU;
 else
...
static u32 MenuMesg(u8 key,u8 initpw)
{
 ...
 if(sendflag)
 {
  ...
  communicate_T123_data[2] = choose_menu;
  fifo_in(&SendBuff);
 }
    else
    {
  ...
  communicate_T123_data[1] = PAGE_MENU;
  communicate_T123_data[2] = 0XF1;
  temp_u8.byte = 0;
  temp_u8.bit.b0 = !Art.bit.b17;
  temp_u8.bit.b1 = !Art.bit.b18;
  temp_u8.bit.b2 = !Art.bit.b19;
  temp_u8.bit.b3 = !Art.bit.b20;
  temp_u8.bit.b4 = !Art.bit.b21;
  ...
  communicate_T123_data[9] = Set_Ranyou_Alarm;
  communicate_T123_data[10] = Set_Fuel_Coef;
  fifo_in(&SendBuff);
    }
    else if(Para_time == 8)
    {
...
u8 ChangeTime(u8 key,u8 initpw)
{
    ...
    if((sendflag == 1))
    {
        ...
        communicate_T123_data[3] = index + 0;
        communicate_T123_data[4] = ((((data[index])/10)<<4) + (data[index])%10);
...
static u8 ChangeBuzz(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = NoEncryptSetPage;
        communicate_T123_data[3] = ((0 + (1*5)) + (1*1));
        communicate_T123_data[4] = !Art.bit.b2;
...
{
    if((Set_backlight_level != backlight_level)||(Set_buzz != Art.bit.b2))
    {
...
u32 NoEncryptSystemSet(u8 key,u8 initpw)
{
    ...
    if(initpw)
    {
        ...
        {SetOption = NoEncryptSetPage;ChangeToPage(PAGE_ARTSET);SetOption = 0;};
...
static u8 ChangeSubi(u8 key,u8 initpw)
{
 ...
 if(sendflag == 1)
 {
  ...
  communicate_T123_data[3] = index+(0 + (1*7));
  communicate_T123_data[4] = setbcd[index];
  fifo_in(&SendBuff);
  sendflag = 0;
 }
...
static u8 ChangePulse(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ ((0 + (1*7)) + (1*4));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeCoef(u8 key,u8 initpw)
{
 ...
 if(sendflag == 1)
 {
  ...
  communicate_T123_data[1] = PAGE_ARTSET;
  communicate_T123_data[2] = EncryptSetPage+kehu_mi;
  communicate_T123_data[3] = index+ (((0 + (1*7)) + (1*4))+(1*4));
  communicate_T123_data[4] = setbcd[index];
  fifo_in(&SendBuff);
  sendflag = 0;
 }
...
static u8 ChangeAir1Coef(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ ((((0 + (1*7)) + (1*4))+(1*4))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeAir2Coef(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ (((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeSpeedAlarm(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ ((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeAirAlarm(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ (((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeOilAlarm(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ ((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeRanYou(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ (((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeVideoAv1(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = ((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3));
        communicate_T123_data[4] = !Art.bit.b17;
...
static u8 ChangeVideoAv2(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = (((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1));
        communicate_T123_data[4] = !Art.bit.b18;
...
static u8 ChangeVideoAv3(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = ((((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1))+(1));
        communicate_T123_data[4] = !Art.bit.b19;
...
static u8 ChangeVideoAv4(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = (((((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1))+(1))+(1));
        communicate_T123_data[4] = !Art.bit.b20;
...
static u8 ChangeRain(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = ((((((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1))+(1))+(1)) + (1));
        communicate_T123_data[4] = !Art.bit.b21;
  ...
  if(!Art.bit.b21)
  {
   ...
   Set_Rain_Delay_Time = 240;
     ...
     Set_Rain_Delay_Time = temp;
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ (((((((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1))+(1))+(1)) + (1))+(1));
        communicate_T123_data[4] = setbcd[index];
...
static u8 ChangeFuelCoef(u8 key,u8 initpw)
{
    ...
    if(sendflag == 1)
    {
        ...
        communicate_T123_data[1] = PAGE_ARTSET;
        communicate_T123_data[2] = EncryptSetPage+kehu_mi;
        communicate_T123_data[3] = index+ ((((((((((((((((0 + (1*7)) + (1*4))+(1*4))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1*3))+(1))+(1))+(1)) + (1))+(1))+(1*3));
        communicate_T123_data[4] = setbcd[index];
...
u32 EncryptSystemSet(u8 key,u8 initpw)
{
 ...
 static u32 set_odo_org = 0;
    ...
    if(initpw)
    {
        {SetOption = PassWordPage;ChangeToPage(PAGE_ARTSET);SetOption = 0;};
        flag = 0;
   ...
   if(f > 0)
   {
     ...
     flag1 = 0;
     kehu_mi = 0;
                 display_total_miles(1);
                 ClearBufferDisable = 1;
                 {SetOption = EncryptSetPage;ChangeToPage(PAGE_ARTSET);SetOption = 0;};
                 ClearBufferDisable = 0;
             }
    else if(f == 2)
             {
     ...
     kehu_mi = 1;
                 ClearBufferDisable = 1;
                 {SetOption = KehuEncryptSetPage;ChangeToPage(PAGE_ARTSET);SetOption = 0;};
                 ClearBufferDisable = 0;
             }
   ...
   if(sendflagxx == 10)
   {
    ...
    communicate_T123_data[4] = Art.bit.b22;
...
void SaveChangeEncrypt(void)
{
    ...
    if((Set_odometer_const != odometer_const) ||(Veh_odo != Set_Veh_odo)||(Set_Pulse!=Pulse)||(Set_Coef!=Coef)||
       ...
       (Set_Oil_Alarm!= Oil_Alarm)||(Set_Ranyou_Alarm != Ranyou_Alarm)||(Art.bit.b17 != Art.bit.b3)||(Set_Air2_Coef != Air2_Coef)||
       (Art.bit.b18 != Art.bit.b4)||(Art.bit.b19 != Art.bit.b5)||(Art.bit.b20 != Art.bit.b6)||(Art.bit.b21!= Art.bit.b7)||
       (Set_Rain_Delay_Time != Rain_Delay_Time))
    {
  ...
  Rain_Delay_Time = Set_Rain_Delay_Time;
        ...
        Art.bit.b3 = Art.bit.b17;
        Art.bit.b4 = Art.bit.b18;
        Art.bit.b5 = Art.bit.b19;
        Art.bit.b6 = Art.bit.b20;
  Art.bit.b7 = Art.bit.b21;
...
{
    u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;
 ...
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}
...
void SendPOWER02(u8 initpw)
{
    ...
    communicate_T123_data[4] = tmp_buff[1];
 ...
 communicate_T123_data[10] = (DisplaySymbol[1].bit.b0|(DisplaySymbol[1].bit.b1 << 1));
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}
void SendPOWER03(u8 initpw)
{
 ...
 u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;
    ...
    communicate_T123_data[3] = (((vol)>>0)&0xFF);
    communicate_T123_data[4] = (((vol)>>8)&0xFF);
    communicate_T123_data[5] = (((cur)>>0)&0xFF);
    communicate_T123_data[6] = (((cur)>>8)&0xFF);
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}

static u32 MenuDIS_POWER_MENU(u8 key,u8 initpw)
{
    static u8 loop = 0;
    if(initpw)
    {
 ...
 if((!(port_a.bit.b2 || port_a.bit.b3))||port_c.bit.b4||(Ankai_Add_190703.bit.b5 == 1))
  return DIS_NOP_MENU;
 else
  return DIS_POWER_MENU;
}
# 2667 "../source/displayhelper.c"
static u32 NopMesg(u8 key,u8 initpw)
{
   static u8 lop = 0,ledtime = 0,flag = 0;
   ...
   else if(port_a.bit.b2||port_a.bit.b3)
   {
   ...
   case 3:
    ...
    else if((port_a.bit.b2 || port_a.bit.b3) && (Ankai_Add_190703.bit.b5 != 1))
    {
       flag = 0;
     return DIS_POWER_MENU;
    }
...
void module_information(uint8_t module)
{
 ...
 u16 temp;
    ...
    static TYPE_DWORD pre_bcm_fb_st_f,pre_bcm_fb_st_r,pre_bcm_fb_st_t;
    ...
    if(module == 0X01)
    {
        if((Art.bit.b24 == 0) || (pre_bcm_fb_st_f.dword != bcm_fb_st_f.dword)||
   ...
   temp = bcm_senor1_f*0.01*Air_Coef;
            communicate_T123_data[3] = temp;
            communicate_T123_data[4] = temp >> 8;

   temp = bcm_senor2_f*0.01*Air2_Coef;
            communicate_T123_data[5] = temp;
            communicate_T123_data[6] = temp >> 8;
    ...
    {
        if((Art.bit.b25 == 0) || (pre_bcm_fb_st_r.dword != bcm_fb_st_r.dword)||
           (pre_bcm_out_st_r.word != bcm_out_st_r.word)||
           (pre_bcm_sw1_r.word != bcm_sw1_r.word) || (pre_bcm_sw2_r.byte != bcm_sw2_r.byte))
        {
            Art.bit.b25 = 1;
            middle_power_state.BIT.b0 = (bcm_out_st_r.bit.b0 == 1) ? bcm_fb_st_r.BIT.b0 : 3;
            middle_power_state.BIT.b1 = (bcm_out_st_r.bit.b2 == 1) ? bcm_fb_st_r.BIT.b2 : 3;
            middle_power_state.BIT.b2 = (bcm_out_st_r.bit.b4 == 1) ? bcm_fb_st_r.BIT.b4 : 3;
            middle_power_state.BIT.b3 = (bcm_out_st_r.bit.b6 == 1) ? bcm_fb_st_r.BIT.b6 : 3;

            middle_power_state.BIT.b4 = (bcm_out_st_r.bit.b8 == 1) ? bcm_fb_st_r.BIT.b8 : 3;
            middle_power_state.BIT.b5 = (bcm_out_st_r.bit.b10 == 1) ? bcm_fb_st_r.BIT.b10 : 3;
            middle_power_state.BIT.b6 = (bcm_out_st_r.bit.b12 == 1) ? bcm_fb_st_r.BIT.b12 : 3;
            middle_power_state.BIT.b7 = (bcm_out_st_r.bit.b14 == 1) ? bcm_fb_st_r.BIT.b14 : 3;

            middle_power_state.BIT.b8 = (bcm_out_st_r.bit.b1 == 1) ? bcm_fb_st_r.BIT.b1 : 3;
            middle_power_state.BIT.b9 = (bcm_out_st_r.bit.b3 == 1) ? bcm_fb_st_r.BIT.b3 : 3;
            middle_power_state.BIT.b10 = (bcm_out_st_r.bit.b5 == 1) ? bcm_fb_st_r.BIT.b5 : 3;
            middle_power_state.BIT.b11 = (bcm_out_st_r.bit.b7 == 1) ? bcm_fb_st_r.BIT.b7 : 3;

            middle_power_state.BIT.b12 = (bcm_out_st_r.bit.b9 == 1) ? bcm_fb_st_r.BIT.b9 : 3;
            middle_power_state.BIT.b13 = (bcm_out_st_r.bit.b11 == 1) ? bcm_fb_st_r.BIT.b11 : 3;
            middle_power_state.BIT.b14 = (bcm_out_st_r.bit.b13 == 1) ? bcm_fb_st_r.BIT.b13 : 3;
    ...
    {
        if((Art.bit.b26 == 0) || (pre_bcm_fb_st_t.dword != bcm_fb_st_t.dword)||
...
void meter_information(void)
{
    ...
    if((meterx&0x03)==0x01)
    {
        ...
        communicate_T123_data[2] = 0x01;
        b2_add.bit.b7 = port_a.bit.b6;
        b2_add.bit.b6 = port_a.bit.b5;
        b2_add.bit.b5 = port_a.bit.b4;
        b2_add.bit.b4 = port_a.bit.b8;
        b2_add.bit.b3 = port_a.bit.b3;
        b2_add.bit.b2 = port_a.bit.b2;
        b2_add.bit.b1 = port_a.bit.b1;
        b2_add.bit.b0 = port_a.bit.b0;
        communicate_T123_data[3] = b2_add.byte;

        b2_add.bit.b7 = port_b.bit.b6;
        b2_add.bit.b6 = port_b.bit.b5;
        b2_add.bit.b5 = port_b.bit.b4;
        b2_add.bit.b4 = port_b.bit.b3;
        b2_add.bit.b3 = port_b.bit.b2;
        b2_add.bit.b2 = port_b.bit.b1;
        b2_add.bit.b1 = port_b.bit.b0;
        b2_add.bit.b0 = port_a.bit.b10;
        communicate_T123_data[4] = b2_add.byte;

        b2_add.bit.b7 = port_c.bit.b1;
        b2_add.bit.b6 = port_c.bit.b2;
        b2_add.bit.b5 = port_c.bit.b3;
        b2_add.bit.b4 = port_b.bit.b11;
        b2_add.bit.b3 = port_b.bit.b10;
        b2_add.bit.b2 = port_b.bit.b9;
        b2_add.bit.b1 = port_b.bit.b8;
        b2_add.bit.b0 = port_b.bit.b7;
        communicate_T123_data[5] = b2_add.byte;

        b2_add.bit.b7 = port_d.bit.b2;
        b2_add.bit.b6 = port_d.bit.b1;
        b2_add.bit.b5 = port_d.bit.b0;

        b2_add.bit.b4 = port_c.bit.b11;
        b2_add.bit.b3 = port_c.bit.b10;
        b2_add.bit.b2 = port_c.bit.b9;
        b2_add.bit.b1 = port_c.bit.b8;
        b2_add.bit.b0 = port_c.bit.b0;
        communicate_T123_data[6] = b2_add.byte;

        b2_add.bit.b7 = port_d.bit.b10;
        b2_add.bit.b6 = port_d.bit.b9;
        b2_add.bit.b5 = port_d.bit.b8;
        b2_add.bit.b4 = port_d.bit.b7;
        b2_add.bit.b3 = port_d.bit.b6;
        b2_add.bit.b2 = port_d.bit.b5;
        b2_add.bit.b1 = port_d.bit.b4;
        b2_add.bit.b0 = port_d.bit.b3;
        ...
        b2_add.bit.b3 = 0;
        b2_add.bit.b2 = 0;
        b2_add.bit.b1 = port_d.bit.b12;
        b2_add.bit.b0 = port_d.bit.b11;
...
void Meter_Add_Menu(u8 initpw)
{
 ...
 outpower_state.byte = 0;
    ...
    outpower_state.bits.bits3 = (output_s.bit.b4 == 1)?sw_diagnose[1].bits.bit4:3;
    outpower_state.bit.b4 = port_c.bit.b4;
    outpower_state.bit.b3 = port_d.bit.b15;
    outpower_state.bit.b2 = port_d.bit.b14;
    outpower_state.bit.b1 = port_d.bit.b13;
    outpower_state.bit.b0 = port_d.bit.b12;
    ...
    outpower_state.bits.bits3 = (output_s.bit.b3 == 1) ? sw_diagnose[0].bits.bit1 : 3;
    outpower_state.bits.bits2 = (output_s.bit.b2 == 1) ? sw_diagnose[0].bits.bit2 : 3;
    outpower_state.bits.bits1 = (output_s.bit.b1 == 1) ? sw_diagnose[0].bits.bit3 : 3;
    outpower_state.bits.bits0 = (output_s.bit.b0 == 1) ? sw_diagnose[0].bits.bit4 : 3;
...
u32 ArtMesg(u8 key,u8 initpw)
{
    ...
    switch(flag)
    {
        ...
        case FMode:
            module_information(0X01);
            break;



        case RMode:
            module_information(0X02);
            break;



        case TMode:
            module_information(0x03);
            break;
...
{
    u8 i;
    static u8 dis_mod_bak = DIS_MAIN_MENU;

    u8 TVSW[5];
    static u8 count = 0;
# 3316 "../source/displayhelper.c"
    TVSW[0] = 0 ;
    TVSW[1] = 0 ;
    TVSW[2] = 0 ;
    TVSW[3] = 0 ;
...
void roll_alarm(void)
{
 ...
 communicate_T123_data[5] = (((code)>>0)&0xFF);
 communicate_T123_data[6] = (((code)>>8)&0xFF);
...
void roll_alarm_Task(void)
{
    if((port_c.bit.b4&&(Art.bit.b28)) || port_a.bit.b2)
    {
        roll_alarm();
    }
}
...
# 3510 "../source/displayhelper.c"
 if((port_a.bit.b2 || port_a.bit.b3)||port_c.bit.b4||(Ankai_Add_190703.bit.b5 == 0))
  return DIS_NOP_MENU;
 else
  return DIS_PARK_MENU;
...
void display_task(void)
{
 ...
 VedioCheck();
    ...
    if(!port_c.bit.b4 && ((dis_mod >= DIS_HELP_MENU) && ((dis_mod <= DIS_CHOOSE_MENU))))
    {
       if(Art.bit.b50 == 0)
       {
...
void display_time_bar_soc(u8 initpw)
{
    ...
    communicate_T123_data[7] = tmp_buff[1];
...
void SendPAGE_MAIN04(u8 initpw)
{
 ...
 u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;
    ...
    communicate_T123_data[5] = (((cur)>>0)&0xFF);
    communicate_T123_data[6] = (((cur)>>8)&0xFF);
    communicate_T123_data[7] = (((Battery_High_Volt)>>0)&0xFF);
    communicate_T123_data[8] = (((Battery_High_Volt)>>8)&0xFF);
    communicate_T123_data[9] = (((Battery_Low_Volt)>>0)&0xFF);
    communicate_T123_data[10] = (((Battery_Low_Volt)>>8)&0xFF);
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
...
void SendPAGE_MAIN05(u8 initpw)
{
 ...
 u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;
    ...
    communicate_T123_data[3] = (((Drive_mile)>>0)&0xFF);
    communicate_T123_data[4] = (((Drive_mile)>>8)&0xFF);
    communicate_T123_data[5] = WaterTem;
...
void SendPAGE_MAIN06(u8 initpw)
{
 ...
 else
 {
  ...
  communicate_T123_data[4] = 100 - temp;
    ...
    communicate_T123_data[8] = Art.bit.b9;
 communicate_T123_data[9] = (_0CFF0D4A[4]*0.8);
 communicate_T123_data[10] = Fuel_Coef;
