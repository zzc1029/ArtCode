...
//#define DWORD_SWAP_2BIT(data)  ((((data) & 0xAAAAAAAA)>>1) | (((data) & 0x55555555)<<1))
   ...
   if(index < BCAN_ID_SUM)
   {
	   ...
	   switch(id)
	   {
		   ...
		   case 0x561:
			   ...
			   //bcm_fb_st_f.dword = DWORD_SWAP_2BIT(bcm_fb_st_f.dword);
			   break;
           //后部模块信息
		   case 0x682:
			   rbcm_off_line = 0;
		   ...
		   case 0x562:
			  ...
			  // bcm_fb_st_r.dword = DWORD_SWAP_2BIT(bcm_fb_st_r.dword);
			   break;	
           //顶部模块信息
		   case 0x683:
			   tbcm_off_line = 0;
		   ...
		   case 0x563:
			  ...
			  // bcm_fb_st_t.dword = DWORD_SWAP_2BIT(bcm_fb_st_t.dword);
			   break;
               //参数设置
          case 0x616:
