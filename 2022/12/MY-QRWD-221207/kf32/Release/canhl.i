# 1 "../driver/canhl.c"
# 1 "/cygdrive/h/workspace32/App/Release//"
# 1 "<command-line>"
# 1 "../driver/canhl.c"
# 12 "../driver/canhl.c"
# 1 "H:/workspace32/App/system/system_init.h" 1
# 14 "H:/workspace32/App/system/system_init.h"
...
# 15 "H:/workspace32/App/system/system_init.h" 2
...
# 16 "H:/workspace32/App/system/system_init.h" 2

# 1 "H:/workspace32/App/system/inc/KF32A_BASIC.h" 1
# 21 "H:/workspace32/App/system/inc/KF32A_BASIC.h"
...
# 18 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_adc.h" 1
# 15 "H:/workspace32/App/system/inc/kf32a_basic_adc.h"
# 1 "H:/workspace32/App/system/inc/KF32A_BASIC.h" 1
# 16 "H:/workspace32/App/system/inc/kf32a_basic_adc.h" 2
...
# 720 "H:/workspace32/App/system/inc/kf32a_basic_adc.h"
...
# 19 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_aes.h" 1
# 25 "H:/workspace32/App/system/inc/kf32a_basic_aes.h"
typedef struct
{
 uint32_t m_OFB;
...
# 106 "H:/workspace32/App/system/inc/kf32a_basic_aes.h"
...
# 20 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_bkp.h" 1
# 62 "H:/workspace32/App/system/inc/kf32a_basic_bkp.h"
void BKP_Reset (void);
...
# 21 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_can.h" 1
# 21 "H:/workspace32/App/system/inc/kf32a_basic_can.h"
typedef struct
{
...
# 319 "H:/workspace32/App/system/inc/kf32a_basic_can.h"
...
void CAN_Set_INT_Enable (CAN_SFRmap* CANx,
                    uint32_t InterruptType, FunctionalState NewState);
# 22 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_cfgl.h" 1
# 25 "H:/workspace32/App/system/inc/kf32a_basic_cfgl.h"
typedef struct
{
...
# 338 "H:/workspace32/App/system/inc/kf32a_basic_cfgl.h"
...
# 23 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_cmp.h" 1
# 29 "H:/workspace32/App/system/inc/kf32a_basic_cmp.h"
typedef struct
{
...
# 412 "H:/workspace32/App/system/inc/kf32a_basic_cmp.h"
void CMP_Reset (void);
...
# 24 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_crc.h" 1
# 25 "H:/workspace32/App/system/inc/kf32a_basic_crc.h"
typedef struct
{
...
# 81 "H:/workspace32/App/system/inc/kf32a_basic_crc.h"
void CRC_Reset ();
...
void CRC_SET_RSET ();
# 25 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_dac.h" 1
# 28 "H:/workspace32/App/system/inc/kf32a_basic_dac.h"
typedef struct
{
...
# 203 "H:/workspace32/App/system/inc/kf32a_basic_dac.h"
...
# 26 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_dma.h" 1
# 20 "H:/workspace32/App/system/inc/kf32a_basic_dma.h"
typedef struct
{
    uint8_t m_Channel;
...
# 127 "H:/workspace32/App/system/inc/kf32a_basic_dma.h"
...
void DMA_Finish_Transfer_INT_Enable (DMA_SFRmap* DMAx,
                    uint32_t Channel, FunctionalState NewState);
# 27 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_flash.h" 1
# 18 "H:/workspace32/App/system/inc/kf32a_basic_flash.h"
typedef enum
{
    LOCK = 0,
    UNLOCK = !LOCK
...
# 142 "H:/workspace32/App/system/inc/kf32a_basic_flash.h"
...
# 28 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_gpio.h" 1
# 33 "H:/workspace32/App/system/inc/kf32a_basic_gpio.h"
typedef enum
{
    GPIO_NOPULL = 0x00,
    GPIO_PULLUP = 0x01
}GPIOPU_TypeDef, GPIOPD_TypeDef;
# 47 "H:/workspace32/App/system/inc/kf32a_basic_gpio.h"
typedef enum
{
    GPIO_POD_PP = 0x00,
    GPIO_POD_OD = 0x01
...
# 73 "H:/workspace32/App/system/inc/kf32a_basic_gpio.h"
typedef enum
{
    GPIO_LOW_SPEED = 0,
    GPIO_HIGH_SPEED = 1
...
# 278 "H:/workspace32/App/system/inc/kf32a_basic_gpio.h"
...
# 29 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_i2c.h" 1
# 30 "H:/workspace32/App/system/inc/kf32a_basic_i2c.h"
typedef struct
{
    uint32_t m_Mode;
...
# 185 "H:/workspace32/App/system/inc/kf32a_basic_i2c.h"
...
# 30 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_int.h" 1
# 24 "H:/workspace32/App/system/inc/kf32a_basic_int.h"
typedef struct
{
    uint32_t m_Line;
...
# 143 "H:/workspace32/App/system/inc/kf32a_basic_int.h"
...
# 31 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_iwdt.h" 1
# 52 "H:/workspace32/App/system/inc/kf32a_basic_iwdt.h"
...
# 32 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_led.h" 1
# 20 "H:/workspace32/App/system/inc/kf32a_basic_led.h"
typedef struct
{
...
# 33 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_lcd.h" 1
# 20 "H:/workspace32/App/system/inc/kf32a_basic_lcd.h"
typedef struct
{
    uint64_t m_SegPin;
...
# 34 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_op.h" 1
# 195 "H:/workspace32/App/system/inc/kf32a_basic_op.h"
void OP_Reset(void);
...
# 35 "H:/workspace32/App/system/system_init.h" 2
...
# 36 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_pclk.h" 1
# 40 "H:/workspace32/App/system/inc/kf32a_basic_pclk.h"
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 37 "H:/workspace32/App/system/system_init.h" 2
...
# 38 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_qei.h" 1
# 21 "H:/workspace32/App/system/inc/kf32a_basic_qei.h"
typedef struct
{
...
# 148 "H:/workspace32/App/system/inc/kf32a_basic_qei.h"
...
# 39 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_rst.h" 1
# 44 "H:/workspace32/App/system/inc/kf32a_basic_rst.h"
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 40 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_rtc.h" 1
# 20 "H:/workspace32/App/system/inc/kf32a_basic_rtc.h"
typedef struct
{
    uint8_t m_Hours;
...
# 290 "H:/workspace32/App/system/inc/kf32a_basic_rtc.h"
void RTC_Reset (void);
...
# 41 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_spi.h" 1
# 30 "H:/workspace32/App/system/inc/kf32a_basic_spi.h"
typedef struct
{
    uint32_t m_Mode;
...
# 217 "H:/workspace32/App/system/inc/kf32a_basic_spi.h"
...
# 42 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_sysctl.h" 1
# 97 "H:/workspace32/App/system/inc/kf32a_basic_sysctl.h"
...
# 43 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_systick.h" 1
# 22 "H:/workspace32/App/system/inc/kf32a_basic_systick.h"
typedef struct
{
    uint32_t m_Period;
    uint32_t m_Clock;
...
# 46 "H:/workspace32/App/system/inc/kf32a_basic_systick.h"
...
# 44 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_tim.h" 1
# 169 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
typedef struct
{
    uint16_t m_Counter;
    uint16_t m_Period;
...
# 284 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
typedef enum
{
    DIR_DOWN = 0,
    DIR_UP = !DIR_DOWN
...
# 360 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
typedef struct
{
    uint32_t m_Counter;
    uint32_t m_Period;
...
# 596 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
...
# 1001 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
...
# 1161 "H:/workspace32/App/system/inc/kf32a_basic_tim.h"
typedef struct
{
    uint32_t m_Counter;
    uint32_t m_Period;
...
# 45 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_usart.h" 1
# 36 "H:/workspace32/App/system/inc/kf32a_basic_usart.h"
typedef struct
{
    uint32_t m_Mode;
...
# 325 "H:/workspace32/App/system/inc/kf32a_basic_usart.h"
...
# 46 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_usb.h" 1
# 20 "H:/workspace32/App/system/inc/kf32a_basic_usb.h"
typedef struct
{
    uint32_t m_Speed;
...
# 47 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/system/inc/kf32a_basic_wwdt.h" 1
# 66 "H:/workspace32/App/system/inc/kf32a_basic_wwdt.h"
...
# 48 "H:/workspace32/App/system/system_init.h" 2


# 1 "H:/workspace32/App/system/typedef.h" 1
# 11 "H:/workspace32/App/system/typedef.h"
typedef unsigned char u8;
typedef unsigned short u16;
typedef unsigned long u32;
typedef unsigned long long u64;
# 51 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/config.h" 1
# 12 "H:/workspace32/App/source/config.h"
# 1 "H:/workspace32/App/source/Artpatch.h" 1
# 29 "H:/workspace32/App/source/Artpatch.h"
enum
{
   J1_01 = 0,
   J1_02,
...
# 73 "H:/workspace32/App/source/Artpatch.h"
enum
{
  A1 = 0,
  A9,
...
# 13 "H:/workspace32/App/source/config.h" 2
# 52 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/system.h" 1
# 47 "H:/workspace32/App/source/system.h"
typedef struct
{
   uint16_t MeterA2;
   uint16_t MeterA3;
...
typedef struct
{
# 141 "H:/workspace32/App/source/system.h"
...
extern uint32_t A15Count,A5Count;

extern uint8_t communicate_T123_data[12];


extern uint32_t SysTickPer1ms,time,Set_Veh_odo;
extern TYPE_QWORD Art,Syslogic;
extern uint16_t adc_100ma_fd[];
extern uint8_t Uart2Receive[8],ReceIndex;
extern uint8_t tmp_buff[];
# 563 "H:/workspace32/App/source/system.h"
extern uint8_t BcanDelay,DcanDelay,PcanDelay,TcanDelay;

extern TYPE_BYTE DisplaySymbol[8];
extern uint8_t dis_mod;

extern uint8_t you_time,youqian_time,youzhong_time;
...
extern uint16_t eng_speed;
extern uint16_t veh_speed;
extern uint16_t veh_speed_display;
extern uint16_t veh_bar1;
extern uint16_t veh_bar2;
extern uint16_t veh_soc;
...
extern uint16_t Battery_Charge_Curr, Battery_chong_Curr, Battery_fang_Curr;
extern uint16_t Battery_High_Volt, Battery_Low_Volt, Charge_Remain_time, Drive_mile;
extern uint8_t An_Kai_Handle_Time,_0CFF0C4A[8],_0CFF0D4A[8],Aver_Dianhao,Break_Pent;
...
void Sendspeed(void);
# 53 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/sch.h" 1
# 17 "H:/workspace32/App/driver/sch.h"
typedef struct
{
...
# 54 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Usart.h" 1
# 14 "H:/workspace32/App/driver/Usart.h"
...
# 55 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/timer.h" 1
# 17 "H:/workspace32/App/driver/timer.h"
void TimerInit(void);
# 56 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/can.h" 1
# 17 "H:/workspace32/App/driver/can.h"
typedef enum
{
...
# 57 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Bcan.h" 1
# 11 "H:/workspace32/App/driver/Bcan.h"
...
# 58 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Pcan.h" 1
# 11 "H:/workspace32/App/driver/Pcan.h"
...
# 59 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Dcan.h" 1
# 12 "H:/workspace32/App/driver/Dcan.h"
...
# 60 "H:/workspace32/App/system/system_init.h" 2

# 1 "H:/workspace32/App/source/displayhelper.h" 1
# 25 "H:/workspace32/App/source/displayhelper.h"
enum
{
    TVNo = 0,
    TV1 = 1,
...
# 75 "H:/workspace32/App/source/displayhelper.h"
enum
{
 DIS_MAIN_MENU = 0x00,
 DIS_HELP_MENU,
 ...
 DIS_SELFTEST_MENU,
    ...
    DIS_PAGE5_MENU,
# 116 "H:/workspace32/App/source/displayhelper.h"
 DIS_ART_INFORMATION,
...
# 62 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/display.h" 1
# 14 "H:/workspace32/App/source/display.h"
extern uint8_t can_water_low,abswarn;
extern uint8_t Control_information_data7;
extern uint8_t ID_0CFF0B4A_data2,battery_1_data6,Control_information_data6;
extern uint8_t ID_18FF2A48_data5,ID_18FF2848_data7,veh_scr,_1CEBFF2F;
extern uint8_t _18FECA2F,_0CFE5A2F_data4,_0CFE5A2F_data1,ID_18FF2D47_data6,Control_information_data0;
extern uint8_t _18FF8001[8],_10FFC29E[8];
extern uint8_t batt_time,motor_tem,motor_flag,ID_18FF2D47_data5;
extern uint8_t _18FF8001[8],_18FF2D47[8],add[8],_18FF0152[8],_18FF3047[8],_18FF3147[8],_18FF3247[8];
extern uint8_t Box_High_Temp,Temp_jicha,ID_18FF2948_data6,Battery_Total_Count,_18FF2948[8];
extern uint8_t ID_18FF2E48_data0,ID_18FF2E48_data1,ID_18FF2E48_data2,ID_18FF2E48_data3;
extern uint8_t ID_18ff0257_data[8],_0CFFEB4A[8];

extern uint8_t elec_time,motor_state;
extern uint8_t ID_18FF2848_data5,_18FF2848[8],b_postion;
extern uint16_t Battery_System_Volt,Battery_Charge_Curr;
extern uint8_t _18FF2A48[8],Temp_Positive,ID_18FF2A48_data0,ID_18FF2A48_data1,ID_18FF2A48_data2;
extern uint16_t Remain_Energy;


extern uint16_t Battery_chong_Curr_1,Battery_fang_Curr_1;
extern uint16_t motor_torque,motor_dc_volt,motor_dc_curr,Battery_2_Remain_enery;

extern uint8_t ID_18FF2C48_data5,battery_2_data6,battery_2_soc;
extern uint16_t battery_2_system_volt,battery_2_system_curr;


extern uint16_t WaterTem;
extern uint16_t motor_pow[4];
extern uint8_t any_Remain_time,electric_shake;
extern TYPE_BYTE Ankai_Add_190703;


extern TYPE_BYTE Add_Comm,Low_Buzz;
extern uint8_t fog_alarm[4];
extern uint8_t ID_18FF2D48_data6,ID_18FF2D48_data5,ID_18FF2D48_data4;
extern uint16_t Battery_2_single_high_volt,Battery_2_single_low_volt;
extern uint16_t insulate_value;
extern uint8_t insulate_flag,Life;
extern uint8_t Model_Temperure[16];
extern uint8_t _18FF2B49[8],_0CFF324A[8];
extern uint8_t Control_information_data7,Control_information_data6,Control_information_data5;
extern uint8_t Control_information_data0,Control_information_data1;
extern uint8_t _0CFF0B4A[8],ID_0CFF0B4A_data2,abs_fault,ChargingRelay,FaultAlarmAdd;


extern uint8_t _18FF5B52[8],_18FF0257[8];
extern TYPE_BYTE add_fog[8];

extern uint8_t _18FFC13A[8],_18FF45F4[8],_10FFC09E[8],_10FFC19E[8],_0CFF114A[8];
extern uint8_t errcodemix[6];
extern uint8_t _18FF064A[8],_18FF2C47[8],_18FF5A52[8],_0CFF0A4A[8],_18FF0258[8];

extern uint8_t battery_1_soc;
extern uint16_t Single_mile;
...
extern uint8_t VCU_MA[100];

extern uint8_t BMS_MA[100];

extern uint8_t MOTOR_MA[100];

extern uint8_t DAQI_MA[100];

extern uint8_t TURN_MA[100];

extern uint8_t XIAOQONG_MA[100];

extern uint8_t DIYA_MA[100];

extern uint8_t VCU_Index,BMS_Index,MOTOR_Index,DAQI_Index,TURN_Index,XIAOQONG_Index,DIYA_Index;
extern uint8_t JudgeMAInBuff(u8 *p,u8 data);
# 177 "H:/workspace32/App/source/display.h"
void CAN_T123(void);
void AddAnkaiMenu(void);
# 63 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/watchdog.h" 1
# 14 "H:/workspace32/App/driver/watchdog.h"
void WWDT_Config_TH(uint32_t Threshold);
void WWDT_Clear(void);
# 64 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/canreceive.h" 1
# 11 "H:/workspace32/App/source/canreceive.h"
extern volatile uint8_t CanData[][8];
extern uint8_t timeout[];
void CopyData(uint8_t *Des,volatile uint8_t *Souc,uint8_t n);
...
# 65 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/key.h" 1
# 17 "H:/workspace32/App/driver/key.h"
...
void key_task(void);
# 66 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/gpio.h" 1
# 18 "H:/workspace32/App/driver/gpio.h"
void GPIOInit_Output_Config(GPIO_SFRmap* GPIOx,uint16_t GpioPin);
void GPIOInit_Input_Config(GPIO_SFRmap* GPIOx,uint16_t GpioPin);
# 67 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/T123.h" 1
# 73 "H:/workspace32/App/source/T123.h"
...
# 68 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/switch.h" 1
# 22 "H:/workspace32/App/source/switch.h"
extern TYPE_WORD port_a;
extern TYPE_WORD port_c;
extern TYPE_WORD port_d;
extern TYPE_WORD port_b;
# 90 "H:/workspace32/App/source/switch.h"
...
# 69 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/led.h" 1
# 23 "H:/workspace32/App/driver/led.h"
extern TYPE_BYTE led[3];
# 53 "H:/workspace32/App/driver/led.h"
void LedPortInit(void);
void led_out(void);
# 70 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/flash.h" 1
# 28 "H:/workspace32/App/driver/flash.h"
# 1 "H:/workspace32/App/system/system_init.h" 1
# 29 "H:/workspace32/App/driver/flash.h" 2
# 39 "H:/workspace32/App/driver/flash.h"
...
# 71 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/eeprom.h" 1
# 32 "H:/workspace32/App/source/eeprom.h"
typedef union
{
...
# 78 "H:/workspace32/App/source/eeprom.h"
...
void FLASH_READCODE_fun(uint32_t address,uint32_t *p_FlashBuffer,uint32_t length);
# 72 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/source/MeterConfig.h" 1
# 374 "H:/workspace32/App/source/MeterConfig.h"
...
# 661 "H:/workspace32/App/source/MeterConfig.h"
...
# 790 "H:/workspace32/App/source/MeterConfig.h"
...
# 73 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Adc.h" 1
# 13 "H:/workspace32/App/driver/Adc.h"
enum
{
   metera2 = 0,
   metera3 = 1,
...
# 74 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Emios.h" 1
# 22 "H:/workspace32/App/driver/Emios.h"
void PwmInit(void);
...
# 75 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Motor.h" 1
# 54 "H:/workspace32/App/driver/Motor.h"
...
# 76 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Output.h" 1
# 14 "H:/workspace32/App/driver/Output.h"
extern TYPE_BYTE output_s;
extern uint8_t feed_buff[];
# 31 "H:/workspace32/App/driver/Output.h"
enum
{
 E3,
 E8
...
# 77 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Rtc.h" 1
# 11 "H:/workspace32/App/driver/Rtc.h"
void RtcInit(void);
void get_date(void);
void set_date(void);

void config_rtc(void);
# 78 "H:/workspace32/App/system/system_init.h" 2
# 114 "H:/workspace32/App/system/system_init.h"
static void SetSysClock(void);
void SystemInit(void);
# 13 "../driver/canhl.c" 2
# 1 "H:/workspace32/App/source/bootloader.h" 1
# 33 "H:/workspace32/App/source/bootloader.h"
# 1 "H:/workspace32/App/driver/canhl.h" 1
# 16 "H:/workspace32/App/driver/canhl.h"
typedef enum
{
    CAN_ERROR_NOERROR = 0,
    CAN_ERROR_BUFFERFULL=1,
...
typedef void (*HandleCanRxMsg)(CAN_SFRmap *can, CAN_MessageTypeDef *msg);

CAN_ErrorT CAN_Transmit_Msg(CAN_SFRmap* CANx, CAN_MessageTypeDef * msg);
uint8_t can_init(CAN_SFRmap * can, uint32_t bps, HandleCanRxMsg func);
# 34 "H:/workspace32/App/source/bootloader.h" 2
# 50 "H:/workspace32/App/source/bootloader.h"
void BootloaderInit(CAN_SFRmap* can);
void BootloaderLoop(void);
void BootloaderHandleRxMsg(CAN_MessageTypeDef * RxMessage);
# 14 "../driver/canhl.c" 2
# 68 "../driver/canhl.c"
static CAN_InitTypeDef CAN0_InitStructure = { .m_Acceptance = 0x00000000, .m_AcceptanceMask = 0xFFFFFFFF}; static HandleCanRxMsg CAN0HandleRxMsg = 0; void __attribute__((interrupt)) _CAN0_exception(void) { uint8_t i; CAN_MessageTypeDef rxmsg; static uint8_t bus_off_count = 0; static uint8_t Receice_addr = 0x00; INT_Clear_Interrupt_Flag(INT_CAN0); if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)), ((uint32_t)1<<1)) != RESET) { CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)), ((uint32_t)1<<1)); bus_off_count = 0; } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)), ((uint32_t)1<<0)) != RESET) { CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001100)), Receice_addr, &rxmsg); Receice_addr += 0x10; CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001100)), 1); bus_off_count = 0; if (CAN0HandleRxMsg) (*CAN0HandleRxMsg)(((CAN_SFRmap *) ((uint32_t)0x40001100)), &rxmsg); } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)), ((uint32_t)1<<7)) != RESET) { bus_off_count++; CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)), ((uint32_t)1<<7)); if (bus_off_count > 20) { CAN_Reset(((CAN_SFRmap *) ((uint32_t)0x40001100))); CAN_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001100)), &CAN0_InitStructure); bus_off_count = 0; } else { CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001100)), FALSE); } } };
static CAN_InitTypeDef CAN1_InitStructure = { .m_Acceptance = 0x00000000, .m_AcceptanceMask = 0xFFFFFFFF}; static HandleCanRxMsg CAN1HandleRxMsg = 0; void __attribute__((interrupt)) _CAN1_exception(void) { uint8_t i; CAN_MessageTypeDef rxmsg; static uint8_t bus_off_count = 0; static uint8_t Receice_addr = 0x00; INT_Clear_Interrupt_Flag(INT_CAN1); if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)), ((uint32_t)1<<1)) != RESET) { CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)), ((uint32_t)1<<1)); bus_off_count = 0; } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)), ((uint32_t)1<<0)) != RESET) { CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001180)), Receice_addr, &rxmsg); Receice_addr += 0x10; CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001180)), 1); bus_off_count = 0; if (CAN1HandleRxMsg) (*CAN1HandleRxMsg)(((CAN_SFRmap *) ((uint32_t)0x40001180)), &rxmsg); } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)), ((uint32_t)1<<7)) != RESET) { bus_off_count++; CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)), ((uint32_t)1<<7)); if (bus_off_count > 20) { CAN_Reset(((CAN_SFRmap *) ((uint32_t)0x40001180))); CAN_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001180)), &CAN1_InitStructure); bus_off_count = 0; } else { CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001180)), FALSE); } } };
static CAN_InitTypeDef CAN2_InitStructure = { .m_Acceptance = 0x00000000, .m_AcceptanceMask = 0xFFFFFFFF}; static HandleCanRxMsg CAN2HandleRxMsg = 0; void __attribute__((interrupt)) _CAN2_exception(void) { uint8_t i; CAN_MessageTypeDef rxmsg; static uint8_t bus_off_count = 0; static uint8_t Receice_addr = 0x00; INT_Clear_Interrupt_Flag(INT_CAN2); if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)), ((uint32_t)1<<1)) != RESET) { CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)), ((uint32_t)1<<1)); bus_off_count = 0; } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)), ((uint32_t)1<<0)) != RESET) { CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001900)), Receice_addr, &rxmsg); Receice_addr += 0x10; CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001900)), 1); bus_off_count = 0; if (CAN2HandleRxMsg) (*CAN2HandleRxMsg)(((CAN_SFRmap *) ((uint32_t)0x40001900)), &rxmsg); } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)), ((uint32_t)1<<7)) != RESET) { bus_off_count++; CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)), ((uint32_t)1<<7)); if (bus_off_count > 20) { CAN_Reset(((CAN_SFRmap *) ((uint32_t)0x40001900))); CAN_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001900)), &CAN2_InitStructure); bus_off_count = 0; } else { CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001900)), FALSE); } } };
static CAN_InitTypeDef CAN3_InitStructure = { .m_Acceptance = (((0x520) & 0x7FF)<<21)|(((0)&1) << 20), .m_AcceptanceMask = (0x000FFFFF | (((0x00F) & 0x7FF)<<21)|(((1)&1) << 20))}; static HandleCanRxMsg CAN3HandleRxMsg = 0; void __attribute__((interrupt)) _CAN3_exception(void) { uint8_t i; CAN_MessageTypeDef rxmsg; static uint8_t bus_off_count = 0; static uint8_t Receice_addr = 0x00; INT_Clear_Interrupt_Flag(INT_CAN3); if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)), ((uint32_t)1<<1)) != RESET) { CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)), ((uint32_t)1<<1)); bus_off_count = 0; } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)), ((uint32_t)1<<0)) != RESET) { CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001980)), Receice_addr, &rxmsg); Receice_addr += 0x10; CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001980)), 1); bus_off_count = 0; if (CAN3HandleRxMsg) (*CAN3HandleRxMsg)(((CAN_SFRmap *) ((uint32_t)0x40001980)), &rxmsg); } if (CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)), ((uint32_t)1<<7)) != RESET) { bus_off_count++; CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)), ((uint32_t)1<<7)); if (bus_off_count > 20) { CAN_Reset(((CAN_SFRmap *) ((uint32_t)0x40001980))); CAN_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001980)), &CAN3_InitStructure); bus_off_count = 0; } else { CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001980)), FALSE); } } };
...
static void xGPIO_CAN(CAN_SFRmap *CANx)
{
 ...
 {
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001100)):
 {
  ...
  GPIO_Pin_Lock_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)), ((uint16_t)0x0004) | ((uint16_t)0x0008), TRUE);
 }
 break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001180)):
 {
  GPIO_InitStructure.m_Pin = ((uint16_t)0x0010) | ((uint16_t)0x0020);
  PCLK_CTL0_Peripheral_Clock_Enable(((uint32_t)1<<((0x0))), TRUE);
  GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x50000000)), &GPIO_InitStructure);
  ...
  GPIO_Pin_Lock_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)), GPIO_InitStructure.m_Pin, TRUE);
 }
 break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001900)):
 {
  PCLK_CTL0_Peripheral_Clock_Enable(((uint32_t)1<<((0x0))), TRUE);
 ...
 break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001980)):
 {
  ...
  GPIO_Pin_Lock_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)), GPIO_InitStructure.m_Pin, TRUE);
 }
 break;
 }
}
...
{
 CAN_InitTypeDef *CAN_InitStructure = (&CAN0_InitStructure);

 switch ((uint32_t)CANx)
 {
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001100)):
  CAN_InitStructure = (&CAN0_InitStructure);
  break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001180)):
  CAN_InitStructure = (&CAN1_InitStructure);
  break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001900)):
  CAN_InitStructure = (&CAN2_InitStructure);
  break;
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001980)):
  CAN_InitStructure = (&CAN3_InitStructure);
  break;
 }
...
static void xINT_CAN(CAN_SFRmap *CANx, HandleCanRxMsg func)
{
 ...
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001100)):
 {
  (CAN0HandleRxMsg) = func;
  INT_Interrupt_Priority_Config(INT_CAN0, 3, 0);
 ...
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001180)):
 {
  (CAN1HandleRxMsg) = func;
  INT_Interrupt_Priority_Config(INT_CAN1, 3, 0);
 ...
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001900)):
 {
  (CAN2HandleRxMsg) = func;
  INT_Interrupt_Priority_Config(INT_CAN2, 3, 0);
 ...
 case (uint32_t)((CAN_SFRmap *) ((uint32_t)0x40001980)):
 {
  (CAN3HandleRxMsg) = func;
  INT_Interrupt_Priority_Config(INT_CAN3, 3, 0);
 ...
 CAN_Set_INT_Enable(CANx, ((uint32_t)1<<1), TRUE);

 CAN_Set_INT_Enable(CANx, ((uint32_t)1<<0), TRUE);

 CAN_Set_INT_Enable(CANx, ((uint32_t)1<<7), TRUE);


}
# 252 "../driver/canhl.c"
CAN_ErrorT CAN_Transmit_Msg(CAN_SFRmap *CANx,
...
{
 xGPIO_CAN(can);
 xInit_CAN(can, bps, ((uint32_t)0<<(1)));
 xINT_CAN(can, func);
}
