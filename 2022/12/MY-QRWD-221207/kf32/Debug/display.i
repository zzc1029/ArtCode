...
volatile uint8_t VCU_MA[100];

volatile uint8_t BMS_MA[100];

volatile uint8_t MOTOR_MA[100];

volatile uint8_t DAQI_MA[100];

volatile uint8_t TURN_MA[100];

volatile uint8_t XIAOQONG_MA[100];

volatile uint8_t DIYA_MA[100];
...
void CAN_T123(void)
{
 ...
 if(1)
       BCan_Expend_Tx_Bytes(id,data,8);

 if(1)
       Can_Expend_Tx_Bytes(id,data,8);

 if(1)
       PCan_Expend_Tx_Bytes(id,data,8);

 if(1)
       DCan_Expend_Tx_Bytes(id,data,8);
}
...
void SendPAGE_BAT01(u8 initpw)
{
    ...
    communicate_T123_data[3] = Battery_Total_Count;
 ...
 if(((battery_1_data6&0x10)==0x10))
  ...
  communicate_T123_data[3] = communicate_T123_data[3]&0x7f;
    ...
    communicate_T123_data[5] = Box_High_Temp - Temp_jicha;
    communicate_T123_data[6] = Box_High_Temp;

    communicate_T123_data[7] = (((Battery_fang_Curr/10)>>0)&0xFF);
    communicate_T123_data[8] = (((Battery_fang_Curr/10)>>8)&0xFF);
    communicate_T123_data[9] = (((Battery_chong_Curr/10)>>0)&0xFF);
    communicate_T123_data[10] = (((Battery_chong_Curr/10)>>8)&0xFF);

    do { static u8 timeoutxxxxxxx; u8 change = 0; timeoutxxxxxxx ++; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if(timeoutxxxxxxx >= (10)) { timeoutxxxxxxx = 0; fifo_in(&SendBuff); } else { if((change>0) ||(initpw)) { fifo_in(&SendBuff); timeoutxxxxxxx = communicate_T123_data[2]; } } } while(0);
}
...
void SendPAGE_BAT02(u8 initpw)
{
    ...
    communicate_T123_data[3] = (b_postion >> 4)&0x0f;
    communicate_T123_data[4] = b_postion&0x0F;
    communicate_T123_data[5] = (ID_18FF2A48_data2 >> 4)&0x0f;
    communicate_T123_data[6] = ID_18FF2A48_data1;

    communicate_T123_data[7] = ID_18FF2A48_data2&0x0f;
    communicate_T123_data[8] = ID_18FF2A48_data0;
...
void SendPAGE_ECU01(u8 initpw)
{
    ...
    temp.bit.b5 = (((veh_bar1<Air_Alarm)||0) || ((veh_bar2<Air_Alarm)||0) || 0 || 0||(((Control_information_data7) & (1<<(2))) > 0));
    temp.bit.b4 = ((Control_information_data7&0x01)==0x01);
    temp.bit.b3 = ((Control_information_data7&0x02)==0x02);
    temp.bit.b2 = Art.bit.b40;
    temp.bit.b1 = ((Control_information_data6&0x01)==0x01);
    temp.bit.b0 = (((Control_information_data7) & (1<<(3))) > 0);
...
static u32 display_surface2(u8 key,u8 initpw)
{
...
void SendPAGE_MOTOR01(u8 initpw)
{
    ...
    communicate_T123_data[3] = (((insulate_value)>>0)&0xFF);
    communicate_T123_data[4] = (((insulate_value)>>8)&0xFF);

    communicate_T123_data[5] = insulate_flag;



    communicate_T123_data[8] = (((motor_dc_volt)>>0)&0xFF);
    communicate_T123_data[9] = (((motor_dc_volt)>>8)&0xFF);

    do { static u8 timeoutxxxxxxx; u8 change = 0; timeoutxxxxxxx ++; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if(timeoutxxxxxxx >= (15)) { timeoutxxxxxxx = 0; fifo_in(&SendBuff); } else { if((change>0) ||(initpw)) { fifo_in(&SendBuff); timeoutxxxxxxx = communicate_T123_data[2]; } } } while(0);
}
...
void SendPAGE_MOTOR02(u8 initpw)
{
    ...
    communicate_T123_data[3] = (((motor_dc_curr/10)>>0)&0xFF);
    communicate_T123_data[4] = (((motor_dc_curr/10)>>8)&0xFF);

    communicate_T123_data[5] = motor_tem;
    communicate_T123_data[6] = WaterTem;

    communicate_T123_data[7] = (((eng_speed)>>0)&0xFF);
    communicate_T123_data[8] = (((eng_speed)>>8)&0xFF);
...
void SendPAGE_MOTOR03(u8 initpw)
{
    ...
    communicate_T123_data[3] = (((motor_pow[0]/10)>>0)&0xFF);
    communicate_T123_data[4] = (((motor_pow[0]/10)>>8)&0xFF);
    communicate_T123_data[5] = (((motor_pow[1]/10)>>0)&0xFF);
    communicate_T123_data[6] = (((motor_pow[1]/10)>>8)&0xFF);
    communicate_T123_data[7] = (((motor_pow[2]/10)>>0)&0xFF);
    communicate_T123_data[8] = (((motor_pow[2]/10)>>8)&0xFF);
    communicate_T123_data[9] = (((motor_pow[3]/10)>>0)&0xFF);
    communicate_T123_data[10] = (((motor_pow[3]/10)>>8)&0xFF);
...
void SendERR01(u8 initpw)
{
 ...
 communicate_T123_data[2] = 0x01;
    ...
    temp.byte = 0;
    temp.bit2.bs0 = (((add[0])>>(6)) & ((1<<(2))-1));
    temp.bit2.bs1 = (((ID_18FF2848_data7)>>(0)) & ((1<<(2))-1));
    temp.bit2.bs2 = (((motor_state)>>(6)) & ((1<<(2))-1));
    temp.bit2.bs3 = (((add[4])>>(3)) & ((1<<(2))-1));

    communicate_T123_data[3] = temp.byte;

    temp.byte = 0;
    temp.bit2.bs0 = (((add[2])>>(3)) & ((1<<(2))-1));
    temp.bit2.bs1 = (((add[6])>>(6)) & ((1<<(2))-1));
    temp.bit2.bs2 = (((insulate_flag)>>(4)) & ((1<<(2))-1));
    temp.bit2.bs3 = (((add[8])>>(3)) & ((1<<(2))-1));
    communicate_T123_data[4] = temp.byte;

 communicate_T123_data[5] = (((insulate_value)>>0)&0xFF);
    communicate_T123_data[6] = (((insulate_value)>>8)&0xFF);
# 581 "../source/display.c"
 do { static u8 timeoutxxxxxxx; u8 change = 0; timeoutxxxxxxx ++; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if(timeoutxxxxxxx >= (10)) { timeoutxxxxxxx = 0; fifo_in(&SendBuff); } else { if((change>0) ||(initpw)) { fifo_in(&SendBuff); timeoutxxxxxxx = communicate_T123_data[2]; } } } while(0);
}
...
void SendERR02(u8 initpw)
{
 ...
 communicate_T123_data[3] = vcu_temp;
    communicate_T123_data[4] = bms_temp;
...
static u32 display_surface1(u8 key,u8 initpw)
{
    u8 i;
    if(initpw)
    {
