...
TYPE_BYTE bcm_sw2_f;
uint16_t bcm_frq_f;
uint16_t bcm_senor1_f;
uint16_t bcm_senor2_f;
TYPE_WORD bcm_out_st_f;
TYPE_DWORD bcm_fb_st_f;

TYPE_WORD bcm_sw1_r;
TYPE_BYTE bcm_sw2_r;
uint16_t bcm_frq_r;
uint16_t bcm_senor1_r;
uint16_t bcm_senor2_r;
TYPE_WORD bcm_out_st_r;
TYPE_DWORD bcm_fb_st_r;

TYPE_WORD bcm_sw1_t;
TYPE_BYTE bcm_sw2_t;
uint16_t bcm_frq_t;
uint16_t bcm_senor1_t;
uint16_t bcm_senor2_t;
TYPE_WORD bcm_out_st_t;
TYPE_DWORD bcm_fb_st_t;
...
void PortInit(void)
{
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)),((uint16_t)0x0004), Bit_RESET);


 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040));
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040), Bit_RESET);


    GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)),((uint16_t)0x0010),GPIO_MODE_OUT);
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)),((uint16_t)0x0010), Bit_RESET);

}
# 78 "../source/MeterConfig.c"
void power_task(void)
{
 ...
 {
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0200), SET);
  if((port_a.bit.b1||port_a.bit.b2||port_a.bit.b3||port_a.bit.b4||port_a.bit.b5||port_a.bit.b6||port_c.bit.b4||port_a.bit.b0 ||port_a.bit.b8||port_a.bit.b9||port_a.bit.b10))
  {
...
{
    fmode_mask.U32 = 0;
# 307 "../source/MeterConfig.c"
    fmode_mask.bit.b17 = 1;



    fmode_mask.bit.b15 = 0;
# 322 "../source/MeterConfig.c"
}
...
{
    rmode_mask.U32 = 0;
# 372 "../source/MeterConfig.c"
    rmode_mask.bit.b17 = 1;



    rmode_mask.bit.b15 = 0;
# 387 "../source/MeterConfig.c"
}
...
{
    tmode_mask.U32 = 0;
# 438 "../source/MeterConfig.c"
    tmode_mask.bit.b17 = 1;



    tmode_mask.bit.b15 = 0;
# 453 "../source/MeterConfig.c"
}

void initPWM_F(void)
{
    F_Set_PWM.word = 0x0000;
# 483 "../source/MeterConfig.c"
    F_Set_PWM.bit.b8 = 1;
    ...
    F_Set_PWM.bit.b10 = 1;
# 504 "../source/MeterConfig.c"
}

void initPWM_R(void)
{
    R_Set_PWM.word = 0x0000;
# 549 "../source/MeterConfig.c"
    R_Set_PWM.bit.b13 = 1;
...
void Send_PWM_Bcm(void)
{
    ...
    data[0] = F_Set_PWM.byte[1];
 data[1] = F_Set_PWM.byte[0];
    data[2] = R_Set_PWM.byte[1];
 data[3] = R_Set_PWM.byte[0];
    data[4] = T_Set_PWM.byte[1];
 data[5] = T_Set_PWM.byte[0];
    data[6] = 0;
 data[7] = 0;
...
void RainConfig(void)
{
    ctrl_cmd[6].bit.b0 = (port_c.bit.b4||port_a.bit.b0) && (port_c.bit.b4&&port_b.bit.b1);
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_c.bit.b4||port_a.bit.b0) && (port_c.bit.b4&&port_b.bit.b7);
    ctrl_cmd[6].bit.b2 = (port_c.bit.b4||port_a.bit.b0) && (port_c.bit.b4&&port_b.bit.b0);
    ctrl_cmd[6].bit.b3 = (port_c.bit.b4||port_a.bit.b0) && (port_c.bit.b4&&port_b.bit.b6);
    ...
    ctrl_cmd[6].bit.b4 = port_c.bit.b4;
    ctrl_cmd[6].bit.b5 = 0;
}
