...
void Page0x2A_01(u8 initpw)
{
	SendStart();
	communicate_T123_data[1] = PAGE_0x2A;
	communicate_T123_data[2] = 1;
	
	communicate_T123_data[3]   = TIRE.press[0];
    communicate_T123_data[4]   = (TIRE.press[0] >> 8);
    communicate_T123_data[5]   = TIRE.press[1];
    communicate_T123_data[6]   = (TIRE.press[1] >> 8);
	communicate_T123_data[7]   = TIRE.press[2];
	communicate_T123_data[8]   = (TIRE.press[2] >> 8);
	communicate_T123_data[9]   = TIRE.press[3];
	communicate_T123_data[10]	= (TIRE.press[3] >> 8);

	SendEnd();
}
void Page0x2A_02(u8 initpw)
{
	SendStart();
	communicate_T123_data[1] = PAGE_0x2A;
	communicate_T123_data[2] = 2;
	
	communicate_T123_data[3]   = TIRE.press[4];
    communicate_T123_data[4]   = (TIRE.press[4] >> 8);
    communicate_T123_data[5]   = TIRE.press[5];
    communicate_T123_data[6]   = (TIRE.press[5] >> 8);

	SendEnd();
}
void Page0x2A_03(u8 initpw)
{
	SendStart();
	communicate_T123_data[1] = PAGE_0x2A;
	communicate_T123_data[2] = 3;
	
	communicate_T123_data[3]   = TIRE.temperature[0];
    communicate_T123_data[4]   = TIRE.temperature[1];
    communicate_T123_data[5]   = TIRE.temperature[2];
    communicate_T123_data[6]   = TIRE.temperature[3];
    communicate_T123_data[7]   = TIRE.temperature[4];
    communicate_T123_data[8]   = TIRE.temperature[5];
