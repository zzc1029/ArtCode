...
void ReceCan(uint32_t id,volatile uint8_t *data)
{
 volatile static uint32_t sp1,sp2;
   ...
   {
        case 0x18FFC13A:
    CanData[Pcan1GetIndexFromID(0x18FFC13A)][5] = data[6];
    CanData[Pcan1GetIndexFromID(0x18FFC13A)][6] = data[5];
    break;
        case 0x0C02F4A7:
   Art.bit.b57 = 1;
   break;
  ...
  case 0x18FEF433:
   ...
   taiya.yali[data[0]] = ((((uint16_t)data[1 +1])<<8)+data[1]);
  ...
  case 0x0c08a79a:
   ...
   break;
  case 0x1800D0A8:
   CanData[Pcan1GetIndexFromID(0x1800D0A8)][BYTE2] = data[2];
   CanData[Pcan1GetIndexFromID(0x1800D0A8)][BYTE3] = data[1];
   CanData[Pcan1GetIndexFromID(0x1800D0A8)][BYTE4] = data[4];
   CanData[Pcan1GetIndexFromID(0x1800D0A8)][BYTE5] = data[3];
   for(index = 0;index < 8;index++)
    add1[index].byte = data[index];
   break;
  case 0x1801D0A8:
   CanData[Pcan1GetIndexFromID(0x1801D0A8)][BYTE3] = data[3];
   CanData[Pcan1GetIndexFromID(0x1801D0A8)][BYTE4] = data[2];
   for(index = 0;index < 8;index++)
    add2[index].byte = data[index];
   break;
  case 0x1800D0A9:
   CanData[Pcan1GetIndexFromID(0x1800D0A9)][BYTE2] = data[2];
   CanData[Pcan1GetIndexFromID(0x1800D0A9)][BYTE3] = data[1];
   CanData[Pcan1GetIndexFromID(0x1800D0A9)][BYTE4] = data[4];
   CanData[Pcan1GetIndexFromID(0x1800D0A9)][BYTE5] = data[3];
   for(index = 0;index < 8;index++)
    add3[index].byte = data[index];
   break;
  case 0x0C0AA79D:
   CanSend_Flag.bit.b0 = 1;
   for(index = 0;index < 8;index++)
  ...
  case 0x181ed0f3:
   ...
   break;
  case 0x180028f3:
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE2] = data[BYTE7];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE3] = data[BYTE2];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE4] = data[BYTE3];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE5] = data[BYTE4];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE6] = data[BYTE8];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE7] = data[BYTE5];
   CanData[Pcan1GetIndexFromID(0x180028f3)][BYTE8] = data[BYTE6];


   break;
  case 0x180128f3:
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE2] = data[BYTE7];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE3] = data[BYTE2];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE4] = data[BYTE3];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE5] = data[BYTE4];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE6] = data[BYTE8];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE7] = data[BYTE5];
   CanData[Pcan1GetIndexFromID(0x180128f3)][BYTE8] = data[BYTE6];


   break;
  case 0x180228f3:
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE2] = data[BYTE7];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE3] = data[BYTE2];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE4] = data[BYTE3];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE5] = data[BYTE4];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE6] = data[BYTE8];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE7] = data[BYTE5];
   CanData[Pcan1GetIndexFromID(0x180228f3)][BYTE8] = data[BYTE6];


   break;
  case 0x180328f3:
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE2] = data[BYTE7];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE3] = data[BYTE2];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE4] = data[BYTE3];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE5] = data[BYTE4];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE6] = data[BYTE8];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE7] = data[BYTE5];
   CanData[Pcan1GetIndexFromID(0x180328f3)][BYTE8] = data[BYTE6];


   break;
  case 0x180428f3:
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE2] = data[BYTE7];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE3] = data[BYTE2];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE4] = data[BYTE3];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE5] = data[BYTE4];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE6] = data[BYTE8];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE7] = data[BYTE5];
   CanData[Pcan1GetIndexFromID(0x180428f3)][BYTE8] = data[BYTE6];
