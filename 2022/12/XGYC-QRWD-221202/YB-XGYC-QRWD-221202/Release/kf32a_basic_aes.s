...
AES_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.text$AES_Configuration$scode_loacal_2:
	.align	1
	.stabs	"AES_Configuration:F(0,15)",36,0,50,AES_Configuration
	.stabs	"AESInitStruct:P(0,16)=*(1,1)",64,0,50,0
	.export	AES_Configuration
	.type	AES_Configuration, @function
AES_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,51,.LM5-.LFBB2
.LM5:
.LFBB2:
	.stabn	68,0,75,.LM6-.LFBB2
.LM6:
	LD	r5,#1073751808
	LD.w	r2,[r5]
...
.LBE7:
.LBE6:
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext4
.Ltext4:
...
.Lscope2:
	...
	.text$AES_Struct_Init$scode_loacal_3:
	.align	1
	.stabs	"AES_Struct_Init:F(0,15)",36,0,86,AES_Struct_Init
	.stabs	"AESInitStruct:P(0,16)",64,0,86,0
	.export	AES_Struct_Init
	.type	AES_Struct_Init, @function
AES_Struct_Init:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,87,.LM15-.LFBB3
.LM15:
.LFBB3:
...
.LM16:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,91,.LM17-.LFBB3
.LM17:
	ST.w	[r0+#1],r5
	.stabn	68,0,93,.LM18-.LFBB3
.LM18:
	ST.w	[r0+#2],r5
	.stabn	68,0,95,.LM19-.LFBB3
.LM19:
	ST.w	[r0+#3],r5
	.stabn	68,0,97,.LM20-.LFBB3
.LM20:
	ST.w	[r0+#4],r5
	.stabn	68,0,99,.LM21-.LFBB3
.LM21:
	ST.w	[r0+#5],r5
	.stabn	68,0,101,.LM22-.LFBB3
.LM22:
	JMP	lr
...
.Lscope3:
	...
	.text$AES_KEY0_DATA$scode_loacal_4:
	.align	1
	.stabs	"AES_KEY0_DATA:F(0,15)",36,0,108,AES_KEY0_DATA
	.stabs	"DATA:P(3,6)",64,0,108,0
	.export	AES_KEY0_DATA
	.type	AES_KEY0_DATA, @function
AES_KEY0_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,109,.LM23-.LFBB4
.LM23:
.LFBB4:
	.stabn	68,0,111,.LM24-.LFBB4
.LM24:
	LD	r5,#1073751808
	ST.w	[r5+#4],r0
	.stabn	68,0,112,.LM25-.LFBB4
.LM25:
	JMP	lr
...
.Lscope4:
	...
	.text$AES_KEY1_DATA$scode_loacal_5:
	.align	1
	.stabs	"AES_KEY1_DATA:F(0,15)",36,0,114,AES_KEY1_DATA
	.stabs	"DATA:P(3,6)",64,0,114,0
	.export	AES_KEY1_DATA
	.type	AES_KEY1_DATA, @function
AES_KEY1_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,115,.LM26-.LFBB5
.LM26:
.LFBB5:
	.stabn	68,0,117,.LM27-.LFBB5
.LM27:
	LD	r5,#1073751808
	ST.w	[r5+#5],r0
	.stabn	68,0,118,.LM28-.LFBB5
.LM28:
	JMP	lr
...
.Lscope5:
	...
	.text$AES_KEY2_DATA$scode_loacal_6:
	.align	1
	.stabs	"AES_KEY2_DATA:F(0,15)",36,0,120,AES_KEY2_DATA
	.stabs	"DATA:P(3,6)",64,0,120,0
	.export	AES_KEY2_DATA
	.type	AES_KEY2_DATA, @function
AES_KEY2_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,121,.LM29-.LFBB6
.LM29:
.LFBB6:
	.stabn	68,0,123,.LM30-.LFBB6
.LM30:
	LD	r5,#1073751808
	ST.w	[r5+#6],r0
	.stabn	68,0,124,.LM31-.LFBB6
.LM31:
	JMP	lr
...
.Lscope6:
	...
	.text$AES_KEY3_DATA$scode_loacal_7:
	.align	1
	.stabs	"AES_KEY3_DATA:F(0,15)",36,0,126,AES_KEY3_DATA
	.stabs	"DATA:P(3,6)",64,0,126,0
	.export	AES_KEY3_DATA
	.type	AES_KEY3_DATA, @function
AES_KEY3_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,127,.LM32-.LFBB7
.LM32:
.LFBB7:
	.stabn	68,0,129,.LM33-.LFBB7
.LM33:
	LD	r5,#1073751808
	ST.w	[r5+#7],r0
	.stabn	68,0,130,.LM34-.LFBB7
.LM34:
	JMP	lr
...
.Lscope7:
	...
	.text$AES_INPUT0_DATA$scode_loacal_8:
	.align	1
	.stabs	"AES_INPUT0_DATA:F(0,15)",36,0,137,AES_INPUT0_DATA
	.stabs	"DATA:P(3,6)",64,0,137,0
	.export	AES_INPUT0_DATA
	.type	AES_INPUT0_DATA, @function
AES_INPUT0_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,138,.LM35-.LFBB8
.LM35:
.LFBB8:
	.stabn	68,0,140,.LM36-.LFBB8
.LM36:
	LD	r5,#1073751808
	ST.w	[r5+#8],r0
	.stabn	68,0,141,.LM37-.LFBB8
.LM37:
	JMP	lr
...
.Lscope8:
	...
	.text$AES_INPUT1_DATA$scode_loacal_9:
	.align	1
	.stabs	"AES_INPUT1_DATA:F(0,15)",36,0,143,AES_INPUT1_DATA
	.stabs	"DATA:P(3,6)",64,0,143,0
	.export	AES_INPUT1_DATA
	.type	AES_INPUT1_DATA, @function
AES_INPUT1_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext11
.Ltext11:
...
.Lscope9:
	...
	.text$AES_INPUT2_DATA$scode_loacal_10:
	.align	1
	.stabs	"AES_INPUT2_DATA:F(0,15)",36,0,149,AES_INPUT2_DATA
	.stabs	"DATA:P(3,6)",64,0,149,0
	.export	AES_INPUT2_DATA
	.type	AES_INPUT2_DATA, @function
AES_INPUT2_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,150,.LM41-.LFBB10
.LM41:
.LFBB10:
	.stabn	68,0,152,.LM42-.LFBB10
.LM42:
	LD	r5,#1073751808
	ST.w	[r5+#10],r0
	.stabn	68,0,153,.LM43-.LFBB10
.LM43:
	JMP	lr
...
.Lscope10:
	...
	.text$AES_INPUT3_DATA$scode_loacal_11:
	.align	1
	.stabs	"AES_INPUT3_DATA:F(0,15)",36,0,155,AES_INPUT3_DATA
	.stabs	"DATA:P(3,6)",64,0,155,0
	.export	AES_INPUT3_DATA
	.type	AES_INPUT3_DATA, @function
AES_INPUT3_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,156,.LM44-.LFBB11
.LM44:
.LFBB11:
	.stabn	68,0,158,.LM45-.LFBB11
.LM45:
	LD	r5,#1073751808
	ST.w	[r5+#11],r0
	.stabn	68,0,159,.LM46-.LFBB11
.LM46:
	JMP	lr
...
.Lscope11:
	...
	.text$GET_AES_OUTPUT0_DATA$scode_loacal_12:
	.align	1
...
GET_AES_OUTPUT0_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,168,.LM47-.LFBB12
.LM47:
.LFBB12:
	.stabn	68,0,170,.LM48-.LFBB12
.LM48:
	LD	r5,#1073751808
	LD.w	r0,[r5+#12]
	.stabn	68,0,173,.LM49-.LFBB12
.LM49:
	JMP	lr
	.size	GET_AES_OUTPUT0_DATA, .-GET_AES_OUTPUT0_DATA
	.stabs	"DATA:r(3,6)",64,0,169,0
...
.Lscope12:
	...
	.text$GET_AES_OUTPUT1_DATA$scode_loacal_13:
	.align	1
...
GET_AES_OUTPUT1_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,176,.LM50-.LFBB13
.LM50:
.LFBB13:
	.stabn	68,0,178,.LM51-.LFBB13
.LM51:
	LD	r5,#1073751808
	LD.w	r0,[r5+#13]
	.stabn	68,0,181,.LM52-.LFBB13
.LM52:
	JMP	lr
	.size	GET_AES_OUTPUT1_DATA, .-GET_AES_OUTPUT1_DATA
	.stabs	"DATA:r(3,6)",64,0,177,0
...
.Lscope13:
	...
	.text$GET_AES_OUTPUT2_DATA$scode_loacal_14:
	.align	1
...
GET_AES_OUTPUT2_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,184,.LM53-.LFBB14
.LM53:
.LFBB14:
	.stabn	68,0,186,.LM54-.LFBB14
.LM54:
	LD	r5,#1073751808
	LD.w	r0,[r5+#14]
	.stabn	68,0,189,.LM55-.LFBB14
.LM55:
	JMP	lr
	.size	GET_AES_OUTPUT2_DATA, .-GET_AES_OUTPUT2_DATA
	.stabs	"DATA:r(3,6)",64,0,185,0
...
.Lscope14:
	...
	.text$GET_AES_OUTPUT3_DATA$scode_loacal_15:
	.align	1
...
GET_AES_OUTPUT3_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,192,.LM56-.LFBB15
.LM56:
.LFBB15:
	.stabn	68,0,194,.LM57-.LFBB15
.LM57:
	LD	r5,#1073751808
	LD.w	r0,[r5+#15]
	.stabn	68,0,197,.LM58-.LFBB15
.LM58:
	JMP	lr
	.size	GET_AES_OUTPUT3_DATA, .-GET_AES_OUTPUT3_DATA
	.stabs	"DATA:r(3,6)",64,0,193,0
...
.Lscope15:
	...
	.text$AES_Get_Flag_Status$scode_loacal_16:
	.align	1
...
AES_Get_Flag_Status:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext18
.Ltext18:
	.stabn	68,0,201,.LM59-.LFBB16
.LM59:
.LFBB16:
	.stabn	68,0,202,.LM60-.LFBB16
.LM60:
	LD	r5,#1073751808
	LD.w	r0,[r5]
	.stabn	68,0,212,.LM61-.LFBB16
.LM61:
	LSR	r0,#31
	JMP	lr
...
.Lscope16:
	...
	.text$AES_Start$scode_loacal_17:
	.align	1
	.stabs	"AES_Start:F(0,15)",36,0,221,AES_Start
	.export	AES_Start
	.type	AES_Start, @function
AES_Start:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,222,.LM62-.LFBB17
.LM62:
.LFBB17:
	.stabn	68,0,224,.LM63-.LFBB17
.LM63:
	LD	r5,#1073751808
	LD.w	r4,[r5]
	SET	r4,#7
	ST.w	[r5],r4
	.stabn	68,0,225,.LM64-.LFBB17
.LM64:
	JMP	lr
...
.Lscope17:
	...
	.text$AES_CLR_Flag_Status$scode_loacal_18:
	.align	1
	.stabs	"AES_CLR_Flag_Status:F(0,15)",36,0,234,AES_CLR_Flag_Status
	.export	AES_CLR_Flag_Status
	.type	AES_CLR_Flag_Status, @function
AES_CLR_Flag_Status:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_aes.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,235,.LM65-.LFBB18
.LM65:
.LFBB18:
	.stabn	68,0,237,.LM66-.LFBB18
.LM66:
	LD	r3,#1073751808
	LD.w	r5,[r3]
	SET	r5,#23
...
.LBE9:
.LBE8:
	.stabn	68,0,239,.LM68-.LFBB18
.LM68:
	LD.w	r4,[r5]
	CLR	r4,#23
	ST.w	[r5],r4
	.stabn	68,0,240,.LM69-.LFBB18
.LM69:
	JMP	lr
