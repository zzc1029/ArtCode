...
.L32:
	...
	ANL	r5,r5,r4
	JNZ	.L32
	.stabn	68,0,508,.LM170-.LFBB12
.LM170:
	LD	r5,#1073752448
// inline asm begin
	// 508 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #29
	.stabn	68,0,509,.LM171-.LFBB12
.LM171:
// inline asm end
	JMP	lr
...
.Ltext15:
	.stabn	68,0,517,.LM172-.LFBB13
.LM172:
.LFBB13:
	.stabn	68,0,519,.LM173-.LFBB13
.LM173:
	LD	r5,#1073752448
// inline asm begin
	// 519 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #28
	.stabn	68,0,520,.LM174-.LFBB13
.LM174:
// inline asm end
	LD	r3,#1073752456
	MOV	r4,#255
...
.L35:
	...
	ANL	r5,r5,r4
	JNZ	.L35
	.stabn	68,0,521,.LM175-.LFBB13
.LM175:
	LD	r5,#1073752448
// inline asm begin
	// 521 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #28
	.stabn	68,0,522,.LM176-.LFBB13
.LM176:
// inline asm end
	JMP	lr
...
.Ltext16:
	.stabn	68,0,530,.LM177-.LFBB14
.LM177:
.LFBB14:
	.stabn	68,0,532,.LM178-.LFBB14
.LM178:
	LD	r5,#1073752448
// inline asm begin
	// 532 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #28
	.stabn	68,0,533,.LM179-.LFBB14
.LM179:
	// 533 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #29
	.stabn	68,0,534,.LM180-.LFBB14
.LM180:
// inline asm end
	LD	r3,#1073752456
	MOV	r4,#255
...
.L38:
	...
	ANL	r5,r5,r4
	JNZ	.L38
	.stabn	68,0,535,.LM181-.LFBB14
.LM181:
	LD	r5,#1073752448
// inline asm begin
	// 535 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #28
	.stabn	68,0,536,.LM182-.LFBB14
.LM182:
	// 536 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #29
	.stabn	68,0,537,.LM183-.LFBB14
.LM183:
// inline asm end
	JMP	lr
...
.Ltext17:
	.stabn	68,0,545,.LM184-.LFBB15
.LM184:
.LFBB15:
	.stabn	68,0,547,.LM185-.LFBB15
.LM185:
	LD	r5,#1073752456
// inline asm begin
	// 547 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #29
	.stabn	68,0,548,.LM186-.LFBB15
.LM186:
// inline asm end
	LD	r3,#1073752456
	MOV	r4,#1
...
.L41:
	...
	ANL	r5,r5,r4
	JNZ	.L41
	.stabn	68,0,549,.LM187-.LFBB15
.LM187:
	LD	r5,#1073752456
// inline asm begin
	// 549 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #29
	.stabn	68,0,550,.LM188-.LFBB15
.LM188:
// inline asm end
	JMP	lr
...
.Ltext18:
	.stabn	68,0,558,.LM189-.LFBB16
.LM189:
.LFBB16:
	.stabn	68,0,560,.LM190-.LFBB16
.LM190:
	LD	r5,#1073752456
// inline asm begin
	// 560 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #28
	.stabn	68,0,561,.LM191-.LFBB16
.LM191:
	// 561 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #29
	.stabn	68,0,562,.LM192-.LFBB16
.LM192:
// inline asm end
	LD	r3,#1073752456
	MOV	r4,#1
...
.L44:
	...
	ANL	r5,r5,r4
	JNZ	.L44
	.stabn	68,0,563,.LM193-.LFBB16
.LM193:
	LD	r5,#1073752456
// inline asm begin
	// 563 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #28
	.stabn	68,0,564,.LM194-.LFBB16
.LM194:
	// 564 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #29
	.stabn	68,0,565,.LM195-.LFBB16
.LM195:
// inline asm end
	JMP	lr
...
.Ltext19:
	.stabn	68,0,573,.LM196-.LFBB17
.LM196:
.LFBB17:
	.stabn	68,0,575,.LM197-.LFBB17
.LM197:
	LD	r5,#1073752456
// inline asm begin
	// 575 "../system/src/kf32a_basic_cfgl.c" 1
	CLR [r5], #28
	.stabn	68,0,576,.LM198-.LFBB17
.LM198:
// inline asm end
	LD	r3,#1073752456
	MOV	r4,#1
...
.L47:
	...
	ANL	r5,r5,r4
	JNZ	.L47
	.stabn	68,0,577,.LM199-.LFBB17
.LM199:
	LD	r5,#1073752456
// inline asm begin
	// 577 "../system/src/kf32a_basic_cfgl.c" 1
	SET [r5], #28
	.stabn	68,0,578,.LM200-.LFBB17
.LM200:
// inline asm end
	JMP	lr
...
.Ltext20:
	.stabn	68,0,586,.LM201-.LFBB18
.LM201:
.LFBB18:
	.stabn	68,0,588,.LM202-.LFBB18
.LM202:
	LD	r5,#1073752456
	LD.w	r0,[r5+#2]
	LSR	r0,#1
	.stabn	68,0,598,.LM203-.LFBB18
.LM203:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Ltext21:
	.stabn	68,0,606,.LM204-.LFBB19
.LM204:
.LFBB19:
	.stabn	68,0,608,.LM205-.LFBB19
.LM205:
	LD	r5,#1073752456
	LD.w	r0,[r5+#2]
	.stabn	68,0,618,.LM206-.LFBB19
.LM206:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
