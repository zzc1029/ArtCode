...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_bkp.h",130,0,0,0
...
BKP_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext1
.Ltext1:
...
.LM1:
	LD	r5,#1073746944
// inline asm begin
	// 30 "../system/src/kf32a_basic_bkp.c" 1
	SET [r5], #31
	.stabn	68,0,31,.LM2-.LFBB1
.LM2:
	// 31 "../system/src/kf32a_basic_bkp.c" 1
	CLR [r5], #31
...
.LM8:
	LD	r3,#pmwrenbkp.1929
	ST.w	[r3],r4
	.stabn	68,0,69,.LM9-.LFBB2
.LM9:
// inline asm begin
	// 69 "../system/src/kf32a_basic_bkp.c" 1
	SET [r5], #0
	.stabn	68,0,73,.LM10-.LFBB2
.LM10:
// inline asm end
	LD	r5,#1073747328
	LD.w	r3,[r5]
...
.LM12:
	MOV	r4,#1
	LD	r5,#bkpregclrbkp.1930
	ST.w	[r5],r4
	.stabn	68,0,86,.LM13-.LFBB2
.LM13:
	LD	r5,#1073747328
	LD.w	r3,[r5]
	.stabn	68,0,87,.LM14-.LFBB2
.LM14:
	MOV	r4,#128
	ANL	r4,r3,r4
	JZ	.L8
.L21:
	.stabn	68,0,89,.LM15-.LFBB2
.LM15:
	MOV	r4,#1
	LD	r5,#bkpwrbkp.1931
	ST.w	[r5],r4
	.stabn	68,0,137,.LM16-.LFBB2
.LM16:
	JMP	lr
.L3:
	.stabn	68,0,102,.LM17-.LFBB2
.LM17:
	LD	r5,#pmwrenbkp.1929
	LD.w	r4,[r5]
	CMP	r4,#0
	JNZ	.L17
	.stabn	68,0,110,.LM18-.LFBB2
.LM18:
	MOV	r5,#1
	LSL	r5,#30
// inline asm begin
	// 110 "../system/src/kf32a_basic_bkp.c" 1
	CLR [r5], #0
	.stabn	68,0,114,.LM19-.LFBB2
.LM19:
// inline asm end
	LD	r5,#bkpregclrbkp.1930
	LD.w	r4,[r5]
...
.LM21:
	...
	JNZ	.L18
.L14:
	.stabn	68,0,134,.LM22-.LFBB2
.LM22:
	LD	r5,#1073747328
// inline asm begin
	// 134 "../system/src/kf32a_basic_bkp.c" 1
	CLR [r5], #7
...
.LM25:
	...
	JNZ	.L19
.L12:
	.stabn	68,0,122,.LM26-.LFBB2
.LM26:
	LD	r5,#1073747328
// inline asm begin
	// 122 "../system/src/kf32a_basic_bkp.c" 1
	CLR [r5], #22
...
// inline asm end
	...
	JZ	.L14
.L18:
	.stabn	68,0,128,.LM28-.LFBB2
.LM28:
	MOV	r4,#1
	ST.w	[r5],r4
	.stabn	68,0,137,.LM29-.LFBB2
.LM29:
	JMP	lr
.L16:
	.stabn	68,0,63,.LM30-.LFBB2
.LM30:
	LD	r5,#pmwrenbkp.1929
	ST.w	[r5],r3
...
.LM32:
	...
	JNZ	.L20
.L6:
	.stabn	68,0,80,.LM33-.LFBB2
.LM33:
	LD	r3,#bkpregclrbkp.1930
	ST.w	[r3],r4
	.stabn	68,0,82,.LM34-.LFBB2
.LM34:
// inline asm begin
	// 82 "../system/src/kf32a_basic_bkp.c" 1
	SET [r5], #22
	.stabn	68,0,86,.LM35-.LFBB2
.LM35:
// inline asm end
	LD	r5,#1073747328
	LD.w	r3,[r5]
	.stabn	68,0,87,.LM36-.LFBB2
.LM36:
	MOV	r4,#128
	ANL	r4,r3,r4
	JNZ	.L21
.L8:
	.stabn	68,0,93,.LM37-.LFBB2
.LM37:
	LD	r3,#bkpwrbkp.1931
	ST.w	[r3],r4
...
.LM38:
// inline asm begin
	// 95 "../system/src/kf32a_basic_bkp.c" 1
	SET [r5], #7
	.stabn	68,0,137,.LM39-.LFBB2
.LM39:
// inline asm end
	JMP	lr
	.size	BKP_Write_And_Read_Enable, .-BKP_Write_And_Read_Enable
	.stabs	"pmwrenbkp:V(3,6)",38,0,49,pmwrenbkp.1929
	.stabs	"bkpregclrbkp:V(3,6)",38,0,50,bkpregclrbkp.1930
	.stabs	"bkpwrbkp:V(3,6)",38,0,51,bkpwrbkp.1931
...
.Lscope2:
	...
	.text$BKP_Reset_Enable$scode_loacal_3:
	.align	1
	.stabs	"BKP_Reset_Enable:F(0,15)",36,0,152,BKP_Reset_Enable
	.stabs	"NewState:P(2,2)",64,0,152,0
	.export	BKP_Reset_Enable
	.type	BKP_Reset_Enable, @function
BKP_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,153,.LM40-.LFBB3
.LM40:
.LFBB3:
	.stabn	68,0,161,.LM41-.LFBB3
.LM41:
	LD	r5,#1073746944
	.stabn	68,0,158,.LM42-.LFBB3
.LM42:
	CMP	r0,#0
	JNZ	.L25
	.stabn	68,0,166,.LM43-.LFBB3
.LM43:
// inline asm begin
	// 166 "../system/src/kf32a_basic_bkp.c" 1
	CLR [r5], #31
...
// inline asm end
	JMP	lr
.L25:
	.stabn	68,0,161,.LM45-.LFBB3
.LM45:
// inline asm begin
	// 161 "../system/src/kf32a_basic_bkp.c" 1
	SET [r5], #31
	.stabn	68,0,168,.LM46-.LFBB3
.LM46:
// inline asm end
	JMP	lr
...
.LM50:
	CMP	r1,#0
	JNZ	.L29
	.stabn	68,0,200,.LM51-.LFBB4
.LM51:
	NOT	r5,r0
	ANL	r5,r5,r3
	ST.w	[r4],r5
	.stabn	68,0,202,.LM52-.LFBB4
.LM52:
	JMP	lr
.L29:
...
.Lscope4:
	...
	.text$BKP_Pin_Enable$scode_loacal_5:
	.align	1
	.stabs	"BKP_Pin_Enable:F(0,15)",36,0,214,BKP_Pin_Enable
	.stabs	"PinSel:P(3,6)",64,0,214,0
	.stabs	"NewState:P(2,2)",64,0,214,1
	.export	BKP_Pin_Enable
	.type	BKP_Pin_Enable, @function
BKP_Pin_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,215,.LM55-.LFBB5
.LM55:
.LFBB5:
...
.LM59:
	...
	ANL	r5,r5,r3
	ST.w	[r4],r5
	.stabn	68,0,234,.LM60-.LFBB5
.LM60:
	JMP	lr
.L33:
	.stabn	68,0,227,.LM61-.LFBB5
.LM61:
	ORL	r5,r0,r3
	ST.w	[r4],r5
	.stabn	68,0,234,.LM62-.LFBB5
.LM62:
	JMP	lr
	.size	BKP_Pin_Enable, .-BKP_Pin_Enable
	.stabs	"tmpreg:r(3,6)",64,0,216,0
...
.Lscope5:
	...
	.type	.text$BKP_RTC_Clock_Config$scode_local_6, @function
	.text$BKP_RTC_Clock_Config$scode_loacal_6:
	.align	1
	.stabs	"BKP_RTC_Clock_Config:F(0,15)",36,0,246,BKP_RTC_Clock_Config
	.stabs	"Source:P(3,6)",64,0,246,0
	.export	BKP_RTC_Clock_Config
	.type	BKP_RTC_Clock_Config, @function
BKP_RTC_Clock_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,247,.LM63-.LFBB6
.LM63:
.LFBB6:
...
.LBE5:
.LBE4:
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,252,.LM66-.LFBB6
.LM66:
	ST.w	[r5],r0
...
.Lscope6:
	...
	.type	.text$BKP_External_Clock_Bypass_Enable$scode_local_7, @function
	.text$BKP_External_Clock_Bypass_Enable$scode_loacal_7:
	.align	1
	.stabs	"BKP_External_Clock_Bypass_Enable:F(0,15)",36,0,264,BKP_External_Clock_Bypass_Enable
	.stabs	"Source:P(3,6)",64,0,264,0
	.stabs	"NewState:P(2,2)",64,0,264,1
	.export	BKP_External_Clock_Bypass_Enable
	.type	BKP_External_Clock_Bypass_Enable, @function
BKP_External_Clock_Bypass_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,265,.LM68-.LFBB7
.LM68:
.LFBB7:
	.stabn	68,0,273,.LM69-.LFBB7
.LM69:
	MOV	r5,#2
	LSL	r0,r5,r0
	.stabn	68,0,277,.LM70-.LFBB7
.LM70:
	LD	r4,#1073746944
	LD.w	r3,[r4]
	.stabn	68,0,274,.LM71-.LFBB7
.LM71:
	CMP	r1,#0
	JNZ	.L38
	.stabn	68,0,282,.LM72-.LFBB7
.LM72:
	NOT	r5,r0
	ANL	r5,r5,r3
	ST.w	[r4],r5
...
.LM73:
	JMP	lr
.L38:
	.stabn	68,0,277,.LM74-.LFBB7
.LM74:
	ORL	r5,r0,r3
	ST.w	[r4],r5
	.stabn	68,0,284,.LM75-.LFBB7
.LM75:
	JMP	lr
	.size	BKP_External_Clock_Bypass_Enable, .-BKP_External_Clock_Bypass_Enable
	.stabs	"tmpreg:r(3,6)",64,0,266,0
...
.Lscope7:
	...
	.type	.text$BKP_Data_Config$scode_local_8, @function
	.text$BKP_Data_Config$scode_loacal_8:
	.align	1
	.stabs	"BKP_Data_Config:F(0,15)",36,0,293,BKP_Data_Config
	.stabs	"OrderNumber:P(3,6)",64,0,293,0
	.stabs	"WriteData:P(3,6)",64,0,293,1
	.export	BKP_Data_Config
	.type	BKP_Data_Config, @function
BKP_Data_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,294,.LM76-.LFBB8
.LM76:
.LFBB8:
	.stabn	68,0,299,.LM77-.LFBB8
.LM77:
	ADD	r0,#16
	LSL	r0,#2
	LD	r5,#1073746944
...
.Lscope8:
	...
	.type	.text$BKP_Get_Data$scode_local_9, @function
	.text$BKP_Get_Data$scode_loacal_9:
	.align	1
	.stabs	"BKP_Get_Data:F(3,6)",36,0,308,BKP_Get_Data
	.stabs	"OrderNumber:P(3,6)",64,0,308,0
	.export	BKP_Get_Data
	.type	BKP_Get_Data, @function
BKP_Get_Data:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,309,.LM79-.LFBB9
.LM79:
.LFBB9:
...
.LM80:
	...
	LD	r5,#1073746944
	LD.w	r0,[r5+r0]
	.stabn	68,0,319,.LM81-.LFBB9
.LM81:
	JMP	lr
	.size	BKP_Get_Data, .-BKP_Get_Data
	.stabs	"tmpreg:r(3,6)",64,0,310,0
...
.Lscope9:
	...
	.type	.text$BKP_Pin_TAMP_INT_Enable$scode_local_10, @function
	.text$BKP_Pin_TAMP_INT_Enable$scode_loacal_10:
	.align	1
	.stabs	"BKP_Pin_TAMP_INT_Enable:F(0,15)",36,0,338,BKP_Pin_TAMP_INT_Enable
	.stabs	"PinSel:P(3,6)",64,0,338,0
	.stabs	"NewState:P(2,2)",64,0,338,1
	.export	BKP_Pin_TAMP_INT_Enable
	.type	BKP_Pin_TAMP_INT_Enable, @function
BKP_Pin_TAMP_INT_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,339,.LM82-.LFBB10
.LM82:
.LFBB10:
	.stabn	68,0,347,.LM83-.LFBB10
.LM83:
	MOV	r5,#255
	ADD	r5,r5,#1
	LSL	r0,r5,r0
	.stabn	68,0,351,.LM84-.LFBB10
.LM84:
	LD	r4,#1073746944
	LD.w	r3,[r4+#1]
	.stabn	68,0,348,.LM85-.LFBB10
.LM85:
	CMP	r1,#0
	JNZ	.L44
	.stabn	68,0,356,.LM86-.LFBB10
.LM86:
	NOT	r5,r0
	ANL	r5,r5,r3
	ST.w	[r4+#1],r5
	.stabn	68,0,358,.LM87-.LFBB10
.LM87:
	JMP	lr
.L44:
	.stabn	68,0,351,.LM88-.LFBB10
.LM88:
	ORL	r5,r0,r3
	ST.w	[r4+#1],r5
	.stabn	68,0,358,.LM89-.LFBB10
.LM89:
	JMP	lr
	.size	BKP_Pin_TAMP_INT_Enable, .-BKP_Pin_TAMP_INT_Enable
	.stabs	"tmpreg:r(3,6)",64,0,340,0
...
.Lscope10:
	...
	.type	.text$BKP_Get_Pin_TAMP_INT_Flag$scode_local_11, @function
	.text$BKP_Get_Pin_TAMP_INT_Flag$scode_loacal_11:
	.align	1
	.stabs	"BKP_Get_Pin_TAMP_INT_Flag:F(2,4)",36,0,369,BKP_Get_Pin_TAMP_INT_Flag
	.stabs	"PinSel:P(3,6)",64,0,369,0
	.export	BKP_Get_Pin_TAMP_INT_Flag
	.type	BKP_Get_Pin_TAMP_INT_Flag, @function
BKP_Get_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,370,.LM90-.LFBB11
.LM90:
.LFBB11:
	.stabn	68,0,378,.LM91-.LFBB11
.LM91:
	LD	r5,#1073746944
	LD.w	r5,[r5+#1]
	.stabn	68,0,377,.LM92-.LFBB11
.LM92:
	MOV	r4,#1
	LSL	r4,#16
	LSL	r0,r4,r0
	.stabn	68,0,378,.LM93-.LFBB11
.LM93:
	ANL	r0,r0,r5
	MOV	r5,#0
	SUB	r5,r5,r0
	ORL	r0,r5,r0
	.stabn	68,0,388,.LM94-.LFBB11
.LM94:
	LSR	r0,#31
	JMP	lr
...
.Lscope11:
	...
	.type	.text$BKP_Clear_Pin_TAMP_INT_Flag$scode_local_12, @function
	.text$BKP_Clear_Pin_TAMP_INT_Flag$scode_loacal_12:
	.align	1
	.stabs	"BKP_Clear_Pin_TAMP_INT_Flag:F(0,15)",36,0,399,BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"PinSel:P(3,6)",64,0,399,0
	.export	BKP_Clear_Pin_TAMP_INT_Flag
	.type	BKP_Clear_Pin_TAMP_INT_Flag, @function
BKP_Clear_Pin_TAMP_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_bkp.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,400,.LM95-.LFBB12
.LM95:
.LFBB12:
	.stabn	68,0,407,.LM96-.LFBB12
.LM96:
	MOV	r1,#1
	LSL	r1,r1,r0
	.stabn	68,0,408,.LM97-.LFBB12
.LM97:
	MOV	r2,#1
	LSL	r2,#16
	LSL	r2,r2,r0
	.stabn	68,0,409,.LM98-.LFBB12
.LM98:
	LD	r3,#1073746944
	LD.w	r5,[r3+#1]
	ORL	r5,r1,r5
...
.LM99:
	...
	CMP	r5,#0
	JNZ	.L47
	.stabn	68,0,411,.LM100-.LFBB12
.LM100:
	LD.w	r5,[r4+#1]
	NOT	r1,r1
	ANL	r1,r1,r5
	ST.w	[r4+#1],r1
	.stabn	68,0,412,.LM101-.LFBB12
.LM101:
	JMP	lr
	.size	BKP_Clear_Pin_TAMP_INT_Flag, .-BKP_Clear_Pin_TAMP_INT_Flag
	.stabs	"tmpreg:r(3,6)",64,0,401,1
	.stabs	"tmpreg1:r(3,6)",64,0,402,2
	.stabn	192,0,0,.LFBB12-.LFBB12
	.stabn	224,0,0,.Lscope12-.LFBB12
.Lscope12:
	.stabs	"",36,0,0,.Lscope12-.LFBB12
	.stabd	78,0,0
	.section .data$static$pmwrenbkp.1929
	.type	.data$static$pmwrenbkp.1929$scode_local_13, @function
	.data$static$pmwrenbkp.1929$scode_loacal_13:
	.align	2
	.type	pmwrenbkp.1929, @object
	.size	pmwrenbkp.1929, 4
pmwrenbkp.1929:
	.long	1
	.section .data$static$bkpregclrbkp.1930
	.type	.data$static$bkpregclrbkp.1930$scode_local_14, @function
	.data$static$bkpregclrbkp.1930$scode_loacal_14:
	.align	2
	.type	bkpregclrbkp.1930, @object
	.size	bkpregclrbkp.1930, 4
bkpregclrbkp.1930:
	.long	1
	.section .data$static$bkpwrbkp.1931
	.type	.data$static$bkpwrbkp.1931$scode_local_15, @function
	.data$static$bkpwrbkp.1931$scode_loacal_15:
	.align	2
	.type	bkpwrbkp.1931, @object
	.size	bkpwrbkp.1931, 4
bkpwrbkp.1931:
	.long	1
	.text
