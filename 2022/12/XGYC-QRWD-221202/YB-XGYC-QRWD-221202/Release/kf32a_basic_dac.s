...
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabs	"DAC_InitTypeDef:t(1,1)=(1,2)=s44m_TriggerEnable:(2,2),0,32;m_TriggerEvent:(3,6),32,32;m_TriggerDMAEnable:(2,2),64,32;m_Wave:(3,6),96,32;m_Mas:(3,6),128,32;m_Clock:(3,6),160,32;m_ClockDiv:(3,6),192,32;m_ReferenceVoltage:(3,6),224,32;m_OutputBuffer:(2,2),256,32;m_OutputPin:(3,6),288,32;m_Output:(3,6),320,32;;",128,0,52,0
	.stabs	"DAC_CALTypeDef:t(1,3)=(1,4)=s20m_PPositrim:(3,6),0,32;m_PNegatrim:(3,6),32,32;m_NPositrim:(3,6),64,32;m_NNegatrim:(3,6),96,32;m_Buftrim:(3,6),128,32;;",128,0,69,0
	.stabn	162,0,0,0
	.section .text$DAC_Reset
	.type	.text$DAC_Reset$scode_local_1, @function
	.text$DAC_Reset$scode_loacal_1:
	.align	1
	.stabs	"DAC_Reset:F(0,15)",36,0,51,DAC_Reset
	.stabs	"DACx:P(0,16)=*(2,61)",64,0,51,0
	.export	DAC_Reset
	.type	DAC_Reset, @function
DAC_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext1
.Ltext1:
...
.LM8:
	...
	LD	r6,#RST_CTL1_Peripheral_Reset_Enable
	LJMP	r6
	.stabn	68,0,60,.LM9-.LFBB1
.LM9:
	MOV	r0,#1
	LSL	r0,#14
	MOV	r1,#0
	LJMP	r6
	.stabn	68,0,61,.LM10-.LFBB1
.LM10:
	MOV	r0,#1
	LSL	r0,#14
	MOV	r1,#1
...
.Lscope1:
	...
	.text$DAC_Configuration$scode_loacal_2:
	.align	1
	.stabs	"DAC_Configuration:F(0,15)",36,0,81,DAC_Configuration
	.stabs	"DACx:P(0,16)",64,0,81,0
	.stabs	"dacInitStruct:P(0,17)=*(1,1)",64,0,81,1
	.export	DAC_Configuration
	.type	DAC_Configuration, @function
DAC_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,82,.LM11-.LFBB2
.LM11:
.LFBB2:
	.stabn	68,0,110,.LM12-.LFBB2
.LM12:
	LD.w	r3,[r0]
...
.LBE11:
.LBE10:
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,110,.LM19-.LFBB2
.LM19:
	ST.w	[r0],r5
	.stabn	68,0,123,.LM20-.LFBB2
.LM20:
	LD.w	r3,[r0+#3]
	.stabn	68,0,119,.LM21-.LFBB2
.LM21:
	LD.w	r4,[r1+#5]
	LD.w	r2,[r1+#6]
	ORL	r5,r4,r2
...
.LBE13:
.LBE12:
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,123,.LM26-.LFBB2
.LM26:
	ST.w	[r0+#3],r5
	.stabn	68,0,128,.LM27-.LFBB2
.LM27:
	LD.w	r4,[r0+#1]
.LBB14:
.LBB15:
...
.LBE15:
.LBE14:
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,128,.LM29-.LFBB2
.LM29:
	ST.w	[r0+#1],r5
	.stabn	68,0,129,.LM30-.LFBB2
.LM30:
	JMP	lr
...
.Lscope2:
	...
	.text$DAC_Struct_Init$scode_loacal_3:
	.align	1
	.stabs	"DAC_Struct_Init:F(0,15)",36,0,137,DAC_Struct_Init
	.stabs	"dacInitStruct:P(0,17)",64,0,137,0
	.export	DAC_Struct_Init
	.type	DAC_Struct_Init, @function
DAC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,138,.LM31-.LFBB3
.LM31:
.LFBB3:
...
.LM32:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,142,.LM33-.LFBB3
.LM33:
	ST.w	[r0+#1],r5
	.stabn	68,0,144,.LM34-.LFBB3
.LM34:
	ST.w	[r0+#2],r5
	.stabn	68,0,146,.LM35-.LFBB3
.LM35:
	ST.w	[r0+#3],r5
	.stabn	68,0,148,.LM36-.LFBB3
.LM36:
	ST.w	[r0+#4],r5
	.stabn	68,0,150,.LM37-.LFBB3
.LM37:
	ST.w	[r0+#5],r5
	.stabn	68,0,152,.LM38-.LFBB3
.LM38:
	ST.w	[r0+#6],r5
	.stabn	68,0,154,.LM39-.LFBB3
.LM39:
	ST.w	[r0+#7],r5
	.stabn	68,0,156,.LM40-.LFBB3
.LM40:
	ST.w	[r0+#8],r5
	.stabn	68,0,158,.LM41-.LFBB3
.LM41:
	ST.w	[r0+#9],r5
	.stabn	68,0,160,.LM42-.LFBB3
.LM42:
	ST.w	[r0+#10],r5
	.stabn	68,0,161,.LM43-.LFBB3
.LM43:
	JMP	lr
...
.Lscope3:
	...
	.text$DAC_Cmd$scode_loacal_4:
	.align	1
	.stabs	"DAC_Cmd:F(0,15)",36,0,171,DAC_Cmd
	.stabs	"DACx:P(0,16)",64,0,171,0
	.stabs	"NewState:P(2,2)",64,0,171,1
	.export	DAC_Cmd
	.type	DAC_Cmd, @function
DAC_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,172,.LM44-.LFBB4
.LM44:
.LFBB4:
	.stabn	68,0,177,.LM45-.LFBB4
.LM45:
	CMP	r1,#0
	JNZ	.L12
	.stabn	68,0,185,.LM46-.LFBB4
.LM46:
// inline asm begin
	// 185 "../system/src/kf32a_basic_dac.c" 1
	CLR [r0], #0
	.stabn	68,0,187,.LM47-.LFBB4
.LM47:
// inline asm end
	JMP	lr
.L12:
	.stabn	68,0,180,.LM48-.LFBB4
.LM48:
// inline asm begin
	// 180 "../system/src/kf32a_basic_dac.c" 1
	SET [r0], #0
	.stabn	68,0,187,.LM49-.LFBB4
.LM49:
// inline asm end
	JMP	lr
...
.Lscope4:
	...
	.text$DAC_Software_Trigger_Cmd$scode_loacal_5:
	.align	1
	.stabs	"DAC_Software_Trigger_Cmd:F(0,15)",36,0,197,DAC_Software_Trigger_Cmd
	.stabs	"DACx:P(0,16)",64,0,197,0
	.stabs	"NewState:P(2,2)",64,0,197,1
	.export	DAC_Software_Trigger_Cmd
	.type	DAC_Software_Trigger_Cmd, @function
DAC_Software_Trigger_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,198,.LM50-.LFBB5
.LM50:
.LFBB5:
	.stabn	68,0,203,.LM51-.LFBB5
.LM51:
	CMP	r1,#0
	JNZ	.L16
...
.LM52:
// inline asm begin
	// 211 "../system/src/kf32a_basic_dac.c" 1
	CLR [r0], #14
...
// inline asm end
	JMP	lr
.L16:
	.stabn	68,0,206,.LM54-.LFBB5
.LM54:
// inline asm begin
	// 206 "../system/src/kf32a_basic_dac.c" 1
	SET [r0], #14
	.stabn	68,0,213,.LM55-.LFBB5
.LM55:
// inline asm end
	JMP	lr
...
.Lscope5:
	...
	.text$DAC_DMA_Cmd$scode_loacal_6:
	.align	1
	.stabs	"DAC_DMA_Cmd:F(0,15)",36,0,223,DAC_DMA_Cmd
	.stabs	"DACx:P(0,16)",64,0,223,0
	.stabs	"NewState:P(2,2)",64,0,223,1
	.export	DAC_DMA_Cmd
	.type	DAC_DMA_Cmd, @function
DAC_DMA_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,224,.LM56-.LFBB6
.LM56:
.LFBB6:
	.stabn	68,0,229,.LM57-.LFBB6
.LM57:
	CMP	r1,#0
	JNZ	.L20
	.stabn	68,0,237,.LM58-.LFBB6
.LM58:
// inline asm begin
	// 237 "../system/src/kf32a_basic_dac.c" 1
	CLR [r0], #1
...
// inline asm end
	JMP	lr
.L20:
	.stabn	68,0,232,.LM60-.LFBB6
.LM60:
// inline asm begin
	// 232 "../system/src/kf32a_basic_dac.c" 1
	SET [r0], #1
	.stabn	68,0,239,.LM61-.LFBB6
.LM61:
// inline asm end
	JMP	lr
...
.Lscope6:
	...
	.text$DAC_Output_Buffer_Config$scode_loacal_7:
	.align	1
	.stabs	"DAC_Output_Buffer_Config:F(0,15)",36,0,249,DAC_Output_Buffer_Config
	.stabs	"DACx:P(0,16)",64,0,249,0
	.stabs	"NewState:P(2,2)",64,0,249,1
	.export	DAC_Output_Buffer_Config
	.type	DAC_Output_Buffer_Config, @function
DAC_Output_Buffer_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext13
.Ltext13:
...
.LM63:
	ADD	r0,#12
	.stabn	68,0,255,.LM64-.LFBB7
.LM64:
	CMP	r1,#0
	JNZ	.L24
	.stabn	68,0,263,.LM65-.LFBB7
.LM65:
// inline asm begin
	// 263 "../system/src/kf32a_basic_dac.c" 1
	CLR [r0], #6
	.stabn	68,0,265,.LM66-.LFBB7
.LM66:
// inline asm end
	JMP	lr
.L24:
	.stabn	68,0,258,.LM67-.LFBB7
.LM67:
// inline asm begin
	// 258 "../system/src/kf32a_basic_dac.c" 1
	SET [r0], #6
	.stabn	68,0,265,.LM68-.LFBB7
.LM68:
// inline asm end
	JMP	lr
...
.Lscope7:
	...
	.text$DAC_Output_Port_Config$scode_loacal_8:
	.align	1
	.stabs	"DAC_Output_Port_Config:F(0,15)",36,0,275,DAC_Output_Port_Config
	.stabs	"DACx:P(0,16)",64,0,275,0
	.stabs	"NewState:P(2,2)",64,0,275,1
	.export	DAC_Output_Port_Config
	.type	DAC_Output_Port_Config, @function
DAC_Output_Port_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,276,.LM69-.LFBB8
.LM69:
.LFBB8:
...
.LM71:
	CMP	r1,#0
	JNZ	.L28
	.stabn	68,0,289,.LM72-.LFBB8
.LM72:
// inline asm begin
	// 289 "../system/src/kf32a_basic_dac.c" 1
	CLR [r0], #0
	.stabn	68,0,291,.LM73-.LFBB8
.LM73:
// inline asm end
	JMP	lr
.L28:
...
.LM74:
// inline asm begin
	// 284 "../system/src/kf32a_basic_dac.c" 1
	SET [r0], #0
	.stabn	68,0,291,.LM75-.LFBB8
.LM75:
// inline asm end
	JMP	lr
...
.Lscope8:
	...
	.text$DAC_Write_Output_Data$scode_loacal_9:
	.align	1
	.stabs	"DAC_Write_Output_Data:F(0,15)",36,0,310,DAC_Write_Output_Data
	.stabs	"DACx:P(0,16)",64,0,310,0
	.stabs	"Value:P(3,6)",64,0,310,1
	.export	DAC_Write_Output_Data
	.type	DAC_Write_Output_Data, @function
DAC_Write_Output_Data:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,311,.LM76-.LFBB9
.LM76:
.LFBB9:
	.stabn	68,0,316,.LM77-.LFBB9
.LM77:
	ST.w	[r0+#1],r1
	.stabn	68,0,317,.LM78-.LFBB9
.LM78:
	JMP	lr
...
.Lscope9:
	...
	.text$DAC_Read_Output_Data$scode_loacal_10:
	.align	1
	.stabs	"DAC_Read_Output_Data:F(3,6)",36,0,325,DAC_Read_Output_Data
	.stabs	"DACx:P(0,16)",64,0,325,0
	.export	DAC_Read_Output_Data
	.type	DAC_Read_Output_Data, @function
DAC_Read_Output_Data:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,326,.LM79-.LFBB10
.LM79:
.LFBB10:
	.stabn	68,0,330,.LM80-.LFBB10
.LM80:
	LD.w	r5,[r0+#2]
	MOV	r4,#0
	SUB	r4,r4,r5
	ORL	r0,r4,r5
	.stabn	68,0,331,.LM81-.LFBB10
.LM81:
	LSR	r0,#31
	JMP	lr
...
.Lscope10:
	...
	.text$DAC_Calibration_Config$scode_loacal_11:
	.align	1
	.stabs	"DAC_Calibration_Config:F(0,15)",36,0,349,DAC_Calibration_Config
	.stabs	"DACx:P(0,16)",64,0,349,0
	.stabs	"dacCalStruct:P(0,18)=*(1,3)",64,0,349,1
	.export	DAC_Calibration_Config
	.type	DAC_Calibration_Config, @function
DAC_Calibration_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,350,.LM82-.LFBB11
.LM82:
.LFBB11:
	.stabn	68,0,371,.LM83-.LFBB11
.LM83:
	LD.w	r3,[r0+#5]
	.stabn	68,0,367,.LM84-.LFBB11
.LM84:
	LD.w	r4,[r1+#1]
	LSL	r4,#24
...
.LM85:
	...
	LSL	r5,#28
	ORL	r5,r4,r5
	.stabn	68,0,368,.LM86-.LFBB11
.LM86:
	LD.w	r4,[r1+#2]
	LSL	r4,#20
	.stabn	68,0,367,.LM87-.LFBB11
.LM87:
	ORL	r5,r5,r4
	.stabn	68,0,369,.LM88-.LFBB11
.LM88:
	LD.w	r4,[r1+#3]
	LSL	r4,#16
	.stabn	68,0,368,.LM89-.LFBB11
.LM89:
	ORL	r5,r5,r4
	.stabn	68,0,370,.LM90-.LFBB11
.LM90:
	LD.w	r4,[r1+#4]
	LSL	r4,#15
	.stabn	68,0,366,.LM91-.LFBB11
.LM91:
	ORL	r5,r5,r4
.LBB16:
.LBB17:
...
.LBE17:
.LBE16:
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,371,.LM93-.LFBB11
.LM93:
	ST.w	[r0+#5],r5
	.stabn	68,0,372,.LM94-.LFBB11
.LM94:
	JMP	lr
...
.Lscope11:
	...
	.text$DAC_Calibration_Struct_Init$scode_loacal_12:
	.align	1
	.stabs	"DAC_Calibration_Struct_Init:F(0,15)",36,0,380,DAC_Calibration_Struct_Init
	.stabs	"dacCalStruct:P(0,18)",64,0,380,0
	.export	DAC_Calibration_Struct_Init
	.type	DAC_Calibration_Struct_Init, @function
DAC_Calibration_Struct_Init:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_dac.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,381,.LM95-.LFBB12
.LM95:
.LFBB12:
	.stabn	68,0,383,.LM96-.LFBB12
.LM96:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,385,.LM97-.LFBB12
.LM97:
	ST.w	[r0+#1],r5
	.stabn	68,0,387,.LM98-.LFBB12
.LM98:
	ST.w	[r0+#2],r5
	.stabn	68,0,389,.LM99-.LFBB12
.LM99:
	ST.w	[r0+#3],r5
	.stabn	68,0,391,.LM100-.LFBB12
.LM100:
	ST.w	[r0+#4],r5
	.stabn	68,0,392,.LM101-.LFBB12
.LM101:
	JMP	lr
