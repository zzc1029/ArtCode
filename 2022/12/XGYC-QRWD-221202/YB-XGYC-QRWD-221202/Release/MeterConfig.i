...
void power_task(void)
{
 ...
 {
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008), SET);
  if((port_a.bit.b3||port_a.bit.b2||port_a.bit.b1||port_a.bit.b0||port_a.bit.b5||port_a.bit.b7||port_a.bit.b6))
  {
...
{
    fmode_mask.U32 = 0;
# 349 "../source/MeterConfig.c"
    fmode_mask.bit.b17 = 1;



    fmode_mask.bit.b15 = 0;
# 364 "../source/MeterConfig.c"
}
...
{
    rmode_mask.U32 = 0;
# 414 "../source/MeterConfig.c"
    rmode_mask.bit.b17 = 1;



    rmode_mask.bit.b15 = 0;
# 429 "../source/MeterConfig.c"
}
...
{
    tmode_mask.U32 = 0;
# 480 "../source/MeterConfig.c"
    tmode_mask.bit.b17 = 1;



    tmode_mask.bit.b15 = 0;
# 495 "../source/MeterConfig.c"
}

void initPWM_F(void)
{
    F_Set_PWM.word = 0x0000;
# 519 "../source/MeterConfig.c"
    F_Set_PWM.bit.b6 = 1;
...
# 619 "../source/MeterConfig.c"
    T_Set_PWM.bit.b5 = 1;


    T_Set_PWM.bit.b6 = 1;
# 649 "../source/MeterConfig.c"
}
...
void RainConfig(void)
{
    ctrl_cmd[6].bit.b0 = (port_a.bit.b7||port_a.bit.b3) && (port_a.bit.b7&&port_d.bit.b5);
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_a.bit.b7||port_a.bit.b3) && (port_a.bit.b7&&port_d.bit.b6);
    ctrl_cmd[6].bit.b2 = (port_a.bit.b7||port_a.bit.b3) && (port_a.bit.b7&&port_d.bit.b8);
    ctrl_cmd[6].bit.b3 = (port_a.bit.b7||port_a.bit.b3) && (port_a.bit.b7&&port_d.bit.b7);
