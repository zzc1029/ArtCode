...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_exic.h",130,0,0,0
...
EXIC_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.stabs	"EXICInitStruct:P(0,16)=*(1,1)",64,0,58,0
	.export	EXIC_Configuration
	.type	EXIC_Configuration, @function
EXIC_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext2
.Ltext2:
...
.LM9:
	...
	LD.w	r7,[r0]
	ORL	r1,r4,r7
	.stabn	68,0,95,.LM10-.LFBB2
.LM10:
	LD.w	r4,[r0+#11]
	ORL	r1,r1,r4
	.stabn	68,0,96,.LM11-.LFBB2
.LM11:
	LD.w	r7,[r0+#12]
	ORL	r1,r1,r7
	.stabn	68,0,97,.LM12-.LFBB2
.LM12:
	ORL	r1,r1,r3
	.stabn	68,0,98,.LM13-.LFBB2
.LM13:
	ORL	r1,r1,r2
...
.LBE7:
.LBE6:
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,109,.LM33-.LFBB2
.LM33:
	ST.w	[r5],r4
	.stabn	68,0,117,.LM34-.LFBB2
.LM34:
	LD.w	r1,[r5+#1]
	.stabn	68,0,115,.LM35-.LFBB2
.LM35:
	ORL	r3,r2,r3
.LBB8:
.LBB9:
...
.LBE9:
.LBE8:
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,117,.LM37-.LFBB2
.LM37:
	ST.w	[r5+#1],r3
	.stabn	68,0,120,.LM38-.LFBB2
.LM38:
	POP	r6
	POP	r7
	JMP	lr
...
.Lscope2:
	...
	.stabs	"EXICInitStruct:P(0,16)",64,0,127,0
	.export	EXIC_Struct_Init
	.type	EXIC_Struct_Init, @function
EXIC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext7
.Ltext7:
...
.LM40:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,132,.LM41-.LFBB3
.LM41:
	ST.w	[r0+#1],r5
	.stabn	68,0,134,.LM42-.LFBB3
.LM42:
	ST.w	[r0+#2],r5
	.stabn	68,0,136,.LM43-.LFBB3
.LM43:
	ST.w	[r0+#3],r5
	.stabn	68,0,138,.LM44-.LFBB3
.LM44:
	ST.w	[r0+#4],r5
	.stabn	68,0,140,.LM45-.LFBB3
.LM45:
	ST.w	[r0+#5],r5
	.stabn	68,0,142,.LM46-.LFBB3
.LM46:
	ST.w	[r0+#6],r5
	.stabn	68,0,144,.LM47-.LFBB3
.LM47:
	ST.w	[r0+#7],r5
	.stabn	68,0,146,.LM48-.LFBB3
.LM48:
	ST.w	[r0+#8],r5
	.stabn	68,0,148,.LM49-.LFBB3
.LM49:
	ST.w	[r0+#9],r5
	.stabn	68,0,150,.LM50-.LFBB3
.LM50:
	ST.w	[r0+#10],r5
	.stabn	68,0,152,.LM51-.LFBB3
.LM51:
	MOV	r4,#1
	LSL	r4,#30
	ST.w	[r0+#11],r4
...
.LM53:
	ST.w	[r0+#13],r5
	.stabn	68,0,158,.LM54-.LFBB3
.LM54:
	MOV	r5,#64
	ST.w	[r0+#14],r5
	.stabn	68,0,159,.LM55-.LFBB3
.LM55:
	JMP	lr
...
EXIC_Get_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,167,.LM56-.LFBB4
.LM56:
.LFBB4:
...
EXIC_Clear_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext9
.Ltext9:
...
.LM60:
	...
	JZ	.L5
.L8:
	.stabn	68,0,190,.LM61-.LFBB5
.LM61:
	LD.w	r4,[r5+#2]
	CLR	r4,#0
	ST.w	[r5+#2],r4
	.stabn	68,0,188,.LM62-.LFBB5
.LM62:
	LD.w	r4,[r5+#2]
	ANL	r4,r4,r3
	JNZ	.L8
.L5:
	.stabn	68,0,192,.LM63-.LFBB5
.LM63:
	JMP	lr
...
EXIC_Get_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,200,.LM64-.LFBB6
.LM64:
.LFBB6:
	.stabn	68,0,202,.LM65-.LFBB6
.LM65:
	LD	r5,#1073752064
	LD.w	r0,[r5+#2]
	LSR	r0,#1
	.stabn	68,0,212,.LM66-.LFBB6
.LM66:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
EXIC_Clear_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,219,.LM67-.LFBB7
.LM67:
.LFBB7:
	.stabn	68,0,221,.LM68-.LFBB7
.LM68:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r3,#2
...
.Lscope7:
	...
	.stabs	"DATA:P(3,6)",64,0,233,0
	.export	EXIC_Write_Buff
	.type	EXIC_Write_Buff, @function
EXIC_Write_Buff:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,234,.LM72-.LFBB8
.LM72:
.LFBB8:
	.stabn	68,0,235,.LM73-.LFBB8
.LM73:
	LD	r5,#1073752064
	ST.w	[r5+#4],r0
	.stabn	68,0,236,.LM74-.LFBB8
.LM74:
	JMP	lr
...
EXIC_Read_Buff:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_exic.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,244,.LM75-.LFBB9
.LM75:
.LFBB9:
	.stabn	68,0,246,.LM76-.LFBB9
.LM76:
	LD	r5,#1073752064
	LD.w	r0,[r5+#5]
	.stabn	68,0,248,.LM77-.LFBB9
.LM77:
	JMP	lr
