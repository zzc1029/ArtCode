...
void SendPAGE_MAIN04(u8 initpw)
{
 ...
 Send_To_DP_Data[3] = CanData[Pcan1GetIndexFromID(0x1818D0F3)][0];
    Send_To_DP_Data[4] = CanData[Pcan1GetIndexFromID(0x1818D0F3)][1];
    Send_To_DP_Data[5] = CanData[Pcan1GetIndexFromID(0x1818D0F3)][2];
    Send_To_DP_Data[6] = CanData[Pcan1GetIndexFromID(0x1818D0F3)][3];

    Send_To_DP_Data[7] = CanData[Pcan1GetIndexFromID(0x181AD0F3)][4];
    Send_To_DP_Data[8] = CanData[Pcan1GetIndexFromID(0x181AD0F3)][5];
    Send_To_DP_Data[9] = CanData[Pcan1GetIndexFromID(0x181AD0F3)][6];
    Send_To_DP_Data[10] = CanData[Pcan1GetIndexFromID(0x181AD0F3)][7];
...
void SendPAGE_MAIN05(u8 initpw)
{
 ...
 Send_To_DP_Data[3] = CanData[Pcan1GetIndexFromID(0x181DD0F3)][0];
    Send_To_DP_Data[4] = CanData[Pcan1GetIndexFromID(0x181DD0F3)][3];
    Send_To_DP_Data[5] = CanData[Pcan1GetIndexFromID(0x0C04A1A7)][0];
    Send_To_DP_Data[6] = CanData[Pcan1GetIndexFromID(0x0C04A1A7)][1];

    Send_To_DP_Data[7] = CanData[Pcan1GetIndexFromID(0x0C08A1A7)][0];
    Send_To_DP_Data[8] = CanData[Pcan1GetIndexFromID(0x0C08A1A7)][1];
    Send_To_DP_Data[9] = CanData[Pcan1GetIndexFromID(0x0C0AA1A7)][4];
    Send_To_DP_Data[10] = CanData[Pcan1GetIndexFromID(0x0C0AA1A7)][5];
...
void SendPAGE_MAIN06(u8 initpw)
{
 ...
 Send_To_DP_Data[3] = CanData[Pcan1GetIndexFromID(0x0C01A70A)][5];
    Send_To_DP_Data[4] = CanData[Pcan1GetIndexFromID(0x0C01A70A)][6];
    Send_To_DP_Data[5] = CanData[Pcan1GetIndexFromID(0x0C01A70A)][7];
    Send_To_DP_Data[6] = CanData[Pcan1GetIndexFromID(0x1818D0F3)][4];
...
u32 MenuDIS_VCU_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_VCU_MENU; };
u32 MenuDIS_MCU_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_MCU_MENU; };
u32
# 193 "../source/display.c"
 MenuDIS_BMS_MENU
# 175 "../source/display.c"
 (u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } { static u8 page = 0; const u8 PAGE_NUM = 3; switch(key) { case IN_KEY2_SP: page++; page = (page >= PAGE_NUM) ? 0 : page; ChangeToSubPage(DIS_BMS_MENU, page); break; case IN_KEY3_SP: page = (page == 0) ? PAGE_NUM : page; page--; ChangeToSubPage(DIS_BMS_MENU, page); break; } }; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_BMS_MENU; }
# 193 "../source/display.c"
  ;

u32 MenuDIS_BATCELL_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_BATCELL_MENU; };

u32
# 216 "../source/display.c"
 MenuDIS_FUZU_MENU
# 197 "../source/display.c"
 (u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } { static u8 page = 0; const u8 PAGE_NUM = 4; switch(key) { case IN_KEY2_SP: page++; page = (page >= PAGE_NUM) ? 0 : page; ChangeToSubPage(DIS_FUZU_MENU, page); break; case IN_KEY3_SP: page = (page == 0) ? PAGE_NUM : page; page--; ChangeToSubPage(DIS_FUZU_MENU, page); break; } }; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_FUZU_MENU; }
# 216 "../source/display.c"
  ;

u32 MenuDIS_PARAM_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_PARAM_MENU; };
u32 MenuDIS_TMS_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_TMS_MENU; };
...
u32
# 273 "../source/display.c"
 MenuDIS_MIEHUO_MENU
# 253 "../source/display.c"
 (u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } { static u8 loop = 0; u8 xiang; for(xiang=0;xiang<10;xiang++) { if(MIEHUO.box[xiang] == 0) break; } if(xiang != 0) { if(loop == 0) SendPAGE_0x21_1(1); else if(loop < xiang) SendPAGE_0x21_x(1,loop); loop++; if(loop >= xiang) loop = 0; } }; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_MIEHUO_MENU; }
# 273 "../source/display.c"
  ;

u32 MenuDIS_AP_MENU(u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } {}; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_AP_MENU; };
...
void SendPAGE_0x22(u8 initpw)
{
 ...
 Send_To_DP_Data[1] = 0x01;
    Send_To_DP_Data[2] = 1;
 if((CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE1] & 0xC0) == 0x00)
 {
  Send_To_DP_Data[3] = CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE3];
  Send_To_DP_Data[4] = CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE4];
  Send_To_DP_Data[5] = 0;
  Send_To_DP_Data[6] = 0;
 }
 else if((CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE1] & 0xC0) == 0x40)
 {
  Send_To_DP_Data[3] = 0;
  Send_To_DP_Data[4] = 0;
  Send_To_DP_Data[5] = CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE3];
  Send_To_DP_Data[6] = CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE4];
 }
 else
 {
  Send_To_DP_Data[3] = 0;
...
u32
 ...
 MenuDIS_RUNHUA_MENU
# 310 "../source/display.c"
 (u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } { SendPAGE_0x22(1); }; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_RUNHUA_MENU; }
...
void SendPAGE_0x2301(u8 initpw)
{
 ...
 Send_To_DP_Data[3] = (((taiya.yali[0])>>0)&0xFF);
 Send_To_DP_Data[4] = (((taiya.yali[0])>>8)&0xFF);
 Send_To_DP_Data[5] = taiya.wendu[0];

 Send_To_DP_Data[6] = (((taiya.yali[1])>>0)&0xFF);
 Send_To_DP_Data[7] = (((taiya.yali[1])>>8)&0xFF);
 Send_To_DP_Data[8] = taiya.wendu[1];

 Send_To_DP_Data[9] = (((taiya.yali[2])>>0)&0xFF);
 Send_To_DP_Data[10] = (((taiya.yali[2])>>8)&0xFF);
...
void SendPAGE_0x2302(u8 initpw)
{
 ...
 Send_To_DP_Data[4] = (((taiya.yali[3])>>0)&0xFF);
 Send_To_DP_Data[5] = (((taiya.yali[3])>>8)&0xFF);

 Send_To_DP_Data[6] = taiya.wendu[3];

 Send_To_DP_Data[8] = (((taiya.yali[4])>>0)&0xFF);
 Send_To_DP_Data[9] = (((taiya.yali[4])>>8)&0xFF);
...
void SendPAGE_0x2303(u8 initpw)
{
 ...
 Send_To_DP_Data[3] = (((taiya.yali[5])>>0)&0xFF);
 Send_To_DP_Data[4] = (((taiya.yali[5])>>8)&0xFF);
...
u32
 ...
 MenuDIS_TAIYA_MENU
# 380 "../source/display.c"
 (u8 key, u8 initpw) { if (initpw) { SendKeyToGPU(CMD_DIS_PAGE); } { SendPAGE_0x2301(1); SendPAGE_0x2302(1); SendPAGE_0x2303(1); }; if (key == IN_KEY1_SP) { return DIS_CHOOSE_MENU; } return DIS_TAIYA_MENU; }




  ;
# 451 "../source/display.c"
void InitDisplay()
{
    InitDisplayHelper();

 AddMenu(MenuDIS_VCU_MENU,DIS_VCU_MENU);
    AddMenu(MenuDIS_MCU_MENU,DIS_MCU_MENU);
    AddMenu(MenuDIS_BMS_MENU,DIS_BMS_MENU);
    AddMenu(MenuDIS_BATCELL_MENU,DIS_BATCELL_MENU);
    AddMenu(MenuDIS_FUZU_MENU,DIS_FUZU_MENU);
    AddMenu(MenuDIS_PARAM_MENU,DIS_PARAM_MENU);
 AddMenu(MenuDIS_TMS_MENU,DIS_TMS_MENU);
 AddMenu(MenuDIS_MIEHUO_MENU,DIS_MIEHUO_MENU);

    AddMenu(MenuDIS_AP_MENU,DIS_AP_MENU);
 AddMenu(MenuDIS_RUNHUA_MENU,DIS_RUNHUA_MENU);
