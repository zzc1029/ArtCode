...
.Ltext0:
	...
	.text$SYSTICK_Configuration$scode_loacal_1:
	.align	1
	.stabs	"SYSTICK_Configuration:F(0,15)",36,0,43,SYSTICK_Configuration
	.stabs	"Clock:P(3,6)",64,0,43,0
	.stabs	"SysTickINT:P(3,6)",64,0,43,1
	.stabs	"Reload:P(3,6)",64,0,44,2
	.export	SYSTICK_Configuration
	.type	SYSTICK_Configuration, @function
SYSTICK_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,45,.LM0-.LFBB1
.LM0:
.LFBB1:
	.stabn	68,0,54,.LM1-.LFBB1
.LM1:
	LD	r5,#1075839136
// inline asm begin
	// 54 "../system/src/kf32a_basic_systick.c" 1
	CLR [r5], #0
...
.Ltext2:
	.stabn	68,0,14361,.LM5-.LFBB1
.LM5:
	CLR	r4,#1
	CLR	r4,#2
.LBE5:
.LBE4:
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext3
.Ltext3:
...
.Ltext4:
	.stabn	68,0,14361,.LM7-.LFBB1
.LM7:
	ORL	r1,r0,r1
.LBE6:
.LBE7:
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext5
.Ltext5:
...
.Lscope1:
	...
	.text$SYSTICK_Cmd$scode_loacal_2:
	.align	1
	.stabs	"SYSTICK_Cmd:F(0,15)",36,0,87,SYSTICK_Cmd
	.stabs	"NewState:P(2,2)",64,0,87,0
	.export	SYSTICK_Cmd
	.type	SYSTICK_Cmd, @function
SYSTICK_Cmd:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext6
.Ltext6:
...
.LM11:
	LD	r5,#1075839136
	.stabn	68,0,93,.LM12-.LFBB2
.LM12:
	CMP	r0,#0
	JNZ	.L6
	.stabn	68,0,101,.LM13-.LFBB2
.LM13:
// inline asm begin
	// 101 "../system/src/kf32a_basic_systick.c" 1
	CLR [r5], #0
	.stabn	68,0,103,.LM14-.LFBB2
.LM14:
// inline asm end
	JMP	lr
.L6:
...
.LM15:
// inline asm begin
	// 96 "../system/src/kf32a_basic_systick.c" 1
	SET [r5], #0
...
.Lscope2:
	...
	.text$SYSTICK_Clock_Config$scode_loacal_3:
	.align	1
	.stabs	"SYSTICK_Clock_Config:F(0,15)",36,0,114,SYSTICK_Clock_Config
	.stabs	"SysClock:P(3,6)",64,0,114,0
	.export	SYSTICK_Clock_Config
	.type	SYSTICK_Clock_Config, @function
SYSTICK_Clock_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,115,.LM17-.LFBB3
.LM17:
.LFBB3:
	.stabn	68,0,123,.LM18-.LFBB3
.LM18:
	LD	r5,#1075839136
...
.LM20:
// inline asm begin
	// 128 "../system/src/kf32a_basic_systick.c" 1
	CLR [r5], #2
	.stabn	68,0,130,.LM21-.LFBB3
.LM21:
// inline asm end
	JMP	lr
.L10:
...
.LM22:
// inline asm begin
	// 123 "../system/src/kf32a_basic_systick.c" 1
	SET [r5], #2
	.stabn	68,0,130,.LM23-.LFBB3
.LM23:
// inline asm end
	JMP	lr
...
.Lscope3:
	...
	.text$SYSTICK_Systick_INT_Enable$scode_loacal_4:
	.align	1
	.stabs	"SYSTICK_Systick_INT_Enable:F(0,15)",36,0,139,SYSTICK_Systick_INT_Enable
	.stabs	"SysClock:P(3,6)",64,0,139,0
	.export	SYSTICK_Systick_INT_Enable
	.type	SYSTICK_Systick_INT_Enable, @function
SYSTICK_Systick_INT_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,140,.LM24-.LFBB4
.LM24:
.LFBB4:
	.stabn	68,0,148,.LM25-.LFBB4
.LM25:
	LD	r5,#1075839136
	.stabn	68,0,145,.LM26-.LFBB4
.LM26:
	CMP	r0,#0
	JNZ	.L14
	.stabn	68,0,153,.LM27-.LFBB4
.LM27:
// inline asm begin
	// 153 "../system/src/kf32a_basic_systick.c" 1
	CLR [r5], #1
	.stabn	68,0,155,.LM28-.LFBB4
.LM28:
// inline asm end
	JMP	lr
.L14:
	.stabn	68,0,148,.LM29-.LFBB4
.LM29:
// inline asm begin
	// 148 "../system/src/kf32a_basic_systick.c" 1
	SET [r5], #1
...
.Lscope4:
	...
	.text$SYSTICK_Get_Count_Zero_Flag$scode_loacal_5:
	.align	1
...
SYSTICK_Get_Count_Zero_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,164,.LM31-.LFBB5
.LM31:
.LFBB5:
	.stabn	68,0,166,.LM32-.LFBB5
.LM32:
	LD	r5,#1075839136
	LD.w	r0,[r5]
	LSR	r0,#16
	.stabn	68,0,176,.LM33-.LFBB5
.LM33:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope5:
	...
	.text$SYSTICK_Reload_Config$scode_loacal_6:
	.align	1
	.stabs	"SYSTICK_Reload_Config:F(0,15)",36,0,185,SYSTICK_Reload_Config
	.stabs	"Reload:P(3,6)",64,0,185,0
	.export	SYSTICK_Reload_Config
	.type	SYSTICK_Reload_Config, @function
SYSTICK_Reload_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,186,.LM34-.LFBB6
.LM34:
.LFBB6:
	.stabn	68,0,191,.LM35-.LFBB6
.LM35:
	LD	r5,#1075839136
	ST.w	[r5+#1],r0
	.stabn	68,0,192,.LM36-.LFBB6
.LM36:
	JMP	lr
...
.Lscope6:
	...
	.text$SYSTICK_Counter_Updata$scode_loacal_7:
	.align	1
...
SYSTICK_Counter_Updata:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,202,.LM37-.LFBB7
.LM37:
.LFBB7:
	.stabn	68,0,205,.LM38-.LFBB7
.LM38:
	MOV	r4,#0
	LD	r5,#1075839136
	ST.w	[r5+#2],r4
	.stabn	68,0,206,.LM39-.LFBB7
.LM39:
	JMP	lr
...
.Lscope7:
	...
	.text$SYSTICK_Get_Reload$scode_loacal_8:
	.align	1
...
SYSTICK_Get_Reload:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,215,.LM40-.LFBB8
.LM40:
.LFBB8:
	.stabn	68,0,219,.LM41-.LFBB8
.LM41:
	LD	r5,#1075839136
	LD.w	r0,[r5+#1]
	.stabn	68,0,222,.LM42-.LFBB8
.LM42:
	LD	r5,#16777215
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope8:
	...
	.text$SYSTICK_Get_Counter$scode_loacal_9:
	.align	1
...
SYSTICK_Get_Counter:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_systick.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,231,.LM43-.LFBB9
.LM43:
.LFBB9:
	.stabn	68,0,235,.LM44-.LFBB9
.LM44:
	LD	r5,#1075839136
	LD.w	r0,[r5+#2]
