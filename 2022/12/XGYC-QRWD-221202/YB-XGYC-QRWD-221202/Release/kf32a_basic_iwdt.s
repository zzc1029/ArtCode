...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_iwdt.h",130,0,0,0
...
.LBE7:
.LBE6:
	.stabs	"../system/src/kf32a_basic_iwdt.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,46,.LM3-.LFBB1
.LM3:
	ST.w	[r5],r0
	.stabn	68,0,47,.LM4-.LFBB1
.LM4:
	JMP	lr
...
.LBE9:
.LBE8:
	.stabs	"../system/src/kf32a_basic_iwdt.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope2:
	...
	.text$IWDT_Enable$scode_loacal_3:
	.align	1
...
IWDT_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_iwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,74,.LM11-.LFBB3
.LM11:
.LFBB3:
	.stabn	68,0,82,.LM12-.LFBB3
.LM12:
	LD	r5,#1073746432
	.stabn	68,0,79,.LM13-.LFBB3
.LM13:
	CMP	r0,#0
	JNZ	.L7
...
.LM14:
// inline asm begin
	// 87 "../system/src/kf32a_basic_iwdt.c" 1
	CLR [r5], #31
...
// inline asm end
	JMP	lr
.L7:
	.stabn	68,0,82,.LM16-.LFBB3
.LM16:
// inline asm begin
	// 82 "../system/src/kf32a_basic_iwdt.c" 1
	SET [r5], #31
...
.Lscope3:
	...
	.text$IWDT_Feed_The_Dog$scode_loacal_4:
	.align	1
...
IWDT_Feed_The_Dog:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_iwdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,98,.LM18-.LFBB4
.LM18:
.LFBB4:
	.stabn	68,0,99,.LM19-.LFBB4
.LM19:
	LD	r4,#1437226410
	LD	r5,#1073746432
	ST.w	[r5+#1],r4
