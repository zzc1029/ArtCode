...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_wwdt.h",130,0,0,0
...
WWDT_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.stabs	"Threshold:P(3,6)",64,0,44,0
	.export	WWDT_Threshold_Config
	.type	WWDT_Threshold_Config, @function
WWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,45,.LM5-.LFBB2
.LM5:
.LFBB2:
...
.LBE7:
.LBE6:
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,53,.LM9-.LFBB2
.LM9:
	ST.w	[r5],r4
...
.LBE9:
.LBE8:
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,87,.LM14-.LFBB3
.LM14:
	ST.w	[r5],r0
	.stabn	68,0,88,.LM15-.LFBB3
.LM15:
	JMP	lr
...
.Lscope3:
	...
	.text$WWDT_Enable$scode_loacal_4:
	.align	1
	.stabs	"WWDT_Enable:F(0,15)",36,0,96,WWDT_Enable
	.stabs	"NewState:P(2,2)",64,0,96,0
	.export	WWDT_Enable
	.type	WWDT_Enable, @function
WWDT_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,97,.LM16-.LFBB4
.LM16:
.LFBB4:
	.stabn	68,0,105,.LM17-.LFBB4
.LM17:
	LD	r5,#1073746560
	.stabn	68,0,102,.LM18-.LFBB4
.LM18:
	CMP	r0,#0
	JNZ	.L8
	.stabn	68,0,110,.LM19-.LFBB4
.LM19:
// inline asm begin
	// 110 "../system/src/kf32a_basic_wwdt.c" 1
	CLR [r5], #0
	.stabn	68,0,112,.LM20-.LFBB4
.LM20:
// inline asm end
	JMP	lr
.L8:
...
.LM21:
// inline asm begin
	// 105 "../system/src/kf32a_basic_wwdt.c" 1
	SET [r5], #0
	.stabn	68,0,112,.LM22-.LFBB4
.LM22:
// inline asm end
	JMP	lr
...
.Lscope4:
	...
	.text$WWDT_Counter_Config$scode_loacal_5:
	.align	1
	.stabs	"WWDT_Counter_Config:F(0,15)",36,0,120,WWDT_Counter_Config
	.stabs	"Counter:P(3,6)",64,0,120,0
	.export	WWDT_Counter_Config
	.type	WWDT_Counter_Config, @function
WWDT_Counter_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,121,.LM23-.LFBB5
.LM23:
.LFBB5:
...
.Lscope5:
	...
	.text$WWDT_Get_Counter$scode_loacal_6:
	.align	1
...
WWDT_Get_Counter:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,136,.LM26-.LFBB6
.LM26:
.LFBB6:
...
.Lscope6:
	...
	.text$WWDT_INT_Enable$scode_loacal_7:
	.align	1
	.stabs	"WWDT_INT_Enable:F(0,15)",36,0,159,WWDT_INT_Enable
	.stabs	"NewState:P(2,2)",64,0,159,0
	.export	WWDT_INT_Enable
	.type	WWDT_INT_Enable, @function
WWDT_INT_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,160,.LM29-.LFBB7
.LM29:
.LFBB7:
	.stabn	68,0,168,.LM30-.LFBB7
.LM30:
	LD	r5,#1073746560
	.stabn	68,0,165,.LM31-.LFBB7
.LM31:
	CMP	r0,#0
	JNZ	.L14
	.stabn	68,0,173,.LM32-.LFBB7
.LM32:
// inline asm begin
	// 173 "../system/src/kf32a_basic_wwdt.c" 1
	CLR [r5], #1
	.stabn	68,0,175,.LM33-.LFBB7
.LM33:
// inline asm end
	JMP	lr
.L14:
	.stabn	68,0,168,.LM34-.LFBB7
.LM34:
// inline asm begin
	// 168 "../system/src/kf32a_basic_wwdt.c" 1
	SET [r5], #1
	.stabn	68,0,175,.LM35-.LFBB7
.LM35:
// inline asm end
	JMP	lr
...
.Lscope7:
	...
	.text$WWDT_Get_INT_Flag$scode_loacal_8:
	.align	1
...
WWDT_Get_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,184,.LM36-.LFBB8
.LM36:
.LFBB8:
	.stabn	68,0,186,.LM37-.LFBB8
.LM37:
	LD	r5,#1073746560
	LD.w	r0,[r5]
	LSR	r0,#2
	.stabn	68,0,196,.LM38-.LFBB8
.LM38:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope8:
	...
	.text$WWDT_Clear_INT_Flag$scode_loacal_9:
	.align	1
...
WWDT_Clear_INT_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,205,.LM39-.LFBB9
.LM39:
.LFBB9:
	.stabn	68,0,207,.LM40-.LFBB9
.LM40:
	LD	r5,#1073746560
// inline asm begin
	// 207 "../system/src/kf32a_basic_wwdt.c" 1
	SET [r5], #15
	.stabn	68,0,208,.LM41-.LFBB9
.LM41:
// inline asm end
	LD	r3,#1073746560
	MOV	r4,#4
.L17:
	...
	ANL	r5,r5,r4
	JNZ	.L17
	.stabn	68,0,209,.LM42-.LFBB9
.LM42:
	LD	r5,#1073746560
// inline asm begin
	// 209 "../system/src/kf32a_basic_wwdt.c" 1
	CLR [r5], #15
	.stabn	68,0,210,.LM43-.LFBB9
.LM43:
// inline asm end
	JMP	lr
