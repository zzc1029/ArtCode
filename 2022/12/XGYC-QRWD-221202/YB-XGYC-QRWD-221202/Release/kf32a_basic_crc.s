...
CRC_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.text$CRC_Configuration$scode_loacal_2:
	.align	1
	.stabs	"CRC_Configuration:F(0,15)",36,0,49,CRC_Configuration
	.stabs	"CRCInitStruct:P(0,16)=*(1,1)",64,0,49,0
	.export	CRC_Configuration
	.type	CRC_Configuration, @function
CRC_Configuration:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext2
.Ltext2:
...
.LBE5:
.LBE4:
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,68,.LM11-.LFBB2
.LM11:
	ST.w	[r5],r4
	.stabn	68,0,71,.LM12-.LFBB2
.LM12:
	JMP	lr
...
.Lscope2:
	...
	.text$CRC_Struct_Init$scode_loacal_3:
	.align	1
	.stabs	"CRC_Struct_Init:F(0,15)",36,0,79,CRC_Struct_Init
	.stabs	"CRCInitStruct:P(0,16)",64,0,79,0
	.export	CRC_Struct_Init
	.type	CRC_Struct_Init, @function
CRC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,80,.LM13-.LFBB3
.LM13:
.LFBB3:
	.stabn	68,0,82,.LM14-.LFBB3
.LM14:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,84,.LM15-.LFBB3
.LM15:
	ST.w	[r0+#1],r5
	.stabn	68,0,86,.LM16-.LFBB3
.LM16:
	ST.w	[r0+#2],r5
	.stabn	68,0,88,.LM17-.LFBB3
.LM17:
	ST.w	[r0+#3],r5
	.stabn	68,0,89,.LM18-.LFBB3
.LM18:
	JMP	lr
...
.Lscope3:
	...
	.text$CRC_INPUT_DATA$scode_loacal_4:
	.align	1
	.stabs	"CRC_INPUT_DATA:F(0,15)",36,0,97,CRC_INPUT_DATA
	.stabs	"DATA:P(3,6)",64,0,97,0
	.export	CRC_INPUT_DATA
	.type	CRC_INPUT_DATA, @function
CRC_INPUT_DATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,98,.LM19-.LFBB4
.LM19:
.LFBB4:
	.stabn	68,0,100,.LM20-.LFBB4
.LM20:
	LD	r5,#1073751680
	ST.w	[r5+#1],r0
	.stabn	68,0,101,.LM21-.LFBB4
.LM21:
	JMP	lr
...
.Lscope4:
	...
	.text$CRC_GET_RESULT$scode_loacal_5:
	.align	1
...
CRC_GET_RESULT:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,109,.LM22-.LFBB5
.LM22:
.LFBB5:
	.stabn	68,0,112,.LM23-.LFBB5
.LM23:
	LD	r5,#1073751680
	LD.w	r0,[r5+#2]
	.stabn	68,0,114,.LM24-.LFBB5
.LM24:
	JMP	lr
	.size	CRC_GET_RESULT, .-CRC_GET_RESULT
	.stabs	"DATA:r(3,6)",64,0,111,0
...
.Lscope5:
	...
	.text$CRC_SET_INITVALUE$scode_loacal_6:
	.align	1
	.stabs	"CRC_SET_INITVALUE:F(0,15)",36,0,121,CRC_SET_INITVALUE
	.stabs	"DATA:P(3,6)",64,0,121,0
	.export	CRC_SET_INITVALUE
	.type	CRC_SET_INITVALUE, @function
CRC_SET_INITVALUE:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,122,.LM25-.LFBB6
.LM25:
.LFBB6:
	.stabn	68,0,124,.LM26-.LFBB6
.LM26:
	LD	r5,#1073751680
	ST.w	[r5+#3],r0
	.stabn	68,0,125,.LM27-.LFBB6
.LM27:
	JMP	lr
...
.Lscope6:
	...
	.text$CRC_SET_PLN$scode_loacal_7:
	.align	1
	.stabs	"CRC_SET_PLN:F(0,15)",36,0,132,CRC_SET_PLN
	.stabs	"DATA:P(3,6)",64,0,132,0
	.export	CRC_SET_PLN
	.type	CRC_SET_PLN, @function
CRC_SET_PLN:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,133,.LM28-.LFBB7
.LM28:
.LFBB7:
	.stabn	68,0,135,.LM29-.LFBB7
.LM29:
	LD	r5,#1073751680
	ST.w	[r5+#4],r0
	.stabn	68,0,136,.LM30-.LFBB7
.LM30:
	JMP	lr
...
.Lscope7:
	...
	.text$CRC_SET_RXOR$scode_loacal_8:
	.align	1
...
CRC_SET_RXOR:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,144,.LM31-.LFBB8
.LM31:
.LFBB8:
	.stabn	68,0,146,.LM32-.LFBB8
.LM32:
	LD	r5,#1073751680
	ST.w	[r5+#5],r0
	.stabn	68,0,147,.LM33-.LFBB8
.LM33:
	JMP	lr
...
.Lscope8:
	...
	.text$CRC_SET_IDATA$scode_loacal_9:
	.align	1
	.stabs	"CRC_SET_IDATA:F(0,15)",36,0,154,CRC_SET_IDATA
	.stabs	"DATA:P(3,6)",64,0,154,0
	.export	CRC_SET_IDATA
	.type	CRC_SET_IDATA, @function
CRC_SET_IDATA:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,155,.LM34-.LFBB9
.LM34:
.LFBB9:
	.stabn	68,0,157,.LM35-.LFBB9
.LM35:
	LD	r5,#1073751680
	ST.w	[r5+#6],r0
...
.Lscope9:
	...
	.text$CRC_GET_TEMP$scode_loacal_10:
	.align	1
...
CRC_GET_TEMP:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,166,.LM37-.LFBB10
.LM37:
.LFBB10:
	.stabn	68,0,169,.LM38-.LFBB10
.LM38:
	LD	r5,#1073751680
	LD.w	r0,[r5+#7]
...
.Lscope10:
	...
	.text$CRC_SET_RSET$scode_loacal_11:
	.align	1
...
CRC_SET_RSET:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_crc.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,179,.LM40-.LFBB11
.LM40:
.LFBB11:
	.stabn	68,0,181,.LM41-.LFBB11
.LM41:
	LD	r5,#1073751680
	LD.w	r4,[r5]
	SET	r4,#0
	ST.w	[r5],r4
	.stabn	68,0,182,.LM42-.LFBB11
.LM42:
	JMP	lr
