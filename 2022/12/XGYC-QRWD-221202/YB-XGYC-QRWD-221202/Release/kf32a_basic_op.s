...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_op.h",130,0,0,0
	...
	.text$OP_Reset$scode_loacal_1:
	.align	1
	.stabs	"OP_Reset:F(0,15)",36,0,29,OP_Reset
	.export	OP_Reset
	.type	OP_Reset, @function
OP_Reset:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.stabd	78,0,0
	.section .text$OP_CAL_Configure
	.type	.text$OP_CAL_Configure$scode_local_2, @function
	.text$OP_CAL_Configure$scode_loacal_2:
	.align	1
	.stabs	"OP_CAL_Configure:F(0,15)",36,0,42,OP_CAL_Configure
	.stabs	"OPx:P(3,6)",64,0,42,0
	.stabs	"CAL_VALUE:P(3,6)",64,0,42,1
	.export	OP_CAL_Configure
	.type	OP_CAL_Configure, @function
OP_CAL_Configure:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,43,.LM5-.LFBB2
.LM5:
.LFBB2:
	.stabn	68,0,48,.LM6-.LFBB2
.LM6:
	CMP	r0,#0
	JZ	.L8
...
.LM8:
	CMP	r0,#2
	JZ	.L10
	.stabn	68,0,72,.LM9-.LFBB2
.LM9:
	CMP	r0,#3
	JZ	.L11
	.stabn	68,0,80,.LM10-.LFBB2
.LM10:
	JMP	lr
.L8:
...
.LBE35:
.LBE34:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext4
.Ltext4:
...
.LBE37:
.LBE36:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext6
.Ltext6:
...
.LBE39:
.LBE38:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,60,.LM23-.LFBB2
.LM23:
	ST.w	[r5],r1
...
.LBE41:
.LBE40:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,68,.LM28-.LFBB2
.LM28:
	ST.w	[r5],r1
	.stabn	68,0,80,.LM29-.LFBB2
.LM29:
	JMP	lr
	.size	OP_CAL_Configure, .-OP_CAL_Configure
.Lscope2:
	.stabs	"",36,0,0,.Lscope2-.LFBB2
	.stabd	78,0,0
	.section .text$OP_GAIN_SELSECT
	.type	.text$OP_GAIN_SELSECT$scode_local_3, @function
	.text$OP_GAIN_SELSECT$scode_loacal_3:
	.align	1
	.stabs	"OP_GAIN_SELSECT:F(0,15)",36,0,87,OP_GAIN_SELSECT
	.stabs	"OPx:P(3,6)",64,0,87,0
	.stabs	"GAIN_VALUE:P(3,6)",64,0,87,1
	.export	OP_GAIN_SELSECT
	.type	OP_GAIN_SELSECT, @function
OP_GAIN_SELSECT:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext11
.Ltext11:
...
.LM34:
	JMP	lr
.L16:
	.stabn	68,0,97,.LM35-.LFBB3
.LM35:
	LD	r5,#1073752576
	LD.w	r3,[r5+#1]
	.stabn	68,0,96,.LM36-.LFBB3
.LM36:
	LSL	r1,#16
.LBB42:
.LBB43:
...
.LBE43:
.LBE42:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,97,.LM38-.LFBB3
.LM38:
	ST.w	[r5+#1],r1
	.stabn	68,0,118,.LM39-.LFBB3
.LM39:
	JMP	lr
.L18:
	.stabn	68,0,113,.LM40-.LFBB3
.LM40:
	LD	r5,#1073752576
	LD.w	r3,[r5+#1]
	.stabn	68,0,112,.LM41-.LFBB3
.LM41:
	LSL	r1,#24
.LBB44:
.LBB45:
...
.LBE45:
.LBE44:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,113,.LM43-.LFBB3
.LM43:
	ST.w	[r5+#1],r1
	.stabn	68,0,118,.LM44-.LFBB3
.LM44:
	JMP	lr
.L17:
	.stabn	68,0,105,.LM45-.LFBB3
.LM45:
	LD	r5,#1073752576
	LD.w	r3,[r5+#1]
	.stabn	68,0,104,.LM46-.LFBB3
.LM46:
	LSL	r1,#20
.LBB46:
.LBB47:
...
.LBE47:
.LBE46:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,105,.LM48-.LFBB3
.LM48:
	ST.w	[r5+#1],r1
	.stabn	68,0,118,.LM49-.LFBB3
.LM49:
	JMP	lr
	.size	OP_GAIN_SELSECT, .-OP_GAIN_SELSECT
.Lscope3:
	.stabs	"",36,0,0,.Lscope3-.LFBB3
	.stabd	78,0,0
	.section .text$OP3_POSITIVE_INPUT_SELSECT
	.type	.text$OP3_POSITIVE_INPUT_SELSECT$scode_local_4, @function
	.text$OP3_POSITIVE_INPUT_SELSECT$scode_loacal_4:
	.align	1
	.stabs	"OP3_POSITIVE_INPUT_SELSECT:F(0,15)",36,0,125,OP3_POSITIVE_INPUT_SELSECT
	.stabs	"SEL:P(3,6)",64,0,125,0
	.export	OP3_POSITIVE_INPUT_SELSECT
	.type	OP3_POSITIVE_INPUT_SELSECT, @function
OP3_POSITIVE_INPUT_SELSECT:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext18
.Ltext18:
	.stabn	68,0,126,.LM50-.LFBB4
.LM50:
.LFBB4:
	.stabn	68,0,130,.LM51-.LFBB4
.LM51:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
.LBB48:
...
.LBE49:
.LBE48:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext20
.Ltext20:
...
.LM54:
	JMP	lr
	.size	OP3_POSITIVE_INPUT_SELSECT, .-OP3_POSITIVE_INPUT_SELSECT
.Lscope4:
	.stabs	"",36,0,0,.Lscope4-.LFBB4
	.stabd	78,0,0
	.section .text$OP_OUTPUT_EN
	.type	.text$OP_OUTPUT_EN$scode_local_5, @function
	.text$OP_OUTPUT_EN$scode_loacal_5:
	.align	1
	.stabs	"OP_OUTPUT_EN:F(0,15)",36,0,140,OP_OUTPUT_EN
	.stabs	"OPx:P(3,6)",64,0,140,0
	.stabs	"NewState:P(2,2)",64,0,140,1
	.export	OP_OUTPUT_EN
	.type	OP_OUTPUT_EN, @function
OP_OUTPUT_EN:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext21
.Ltext21:
	.stabn	68,0,141,.LM55-.LFBB5
.LM55:
.LFBB5:
	.stabn	68,0,146,.LM56-.LFBB5
.LM56:
	CMP	r0,#0
	JNZ	.L21
	.stabn	68,0,150,.LM57-.LFBB5
.LM57:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,149,.LM58-.LFBB5
.LM58:
	LSL	r1,#4
.LBB50:
.LBB51:
...
.Ltext22:
	.stabn	68,0,14361,.LM59-.LFBB5
.LM59:
	CLR	r4,#4
	ORL	r1,r1,r4
.LBE51:
.LBE50:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext23
.Ltext23:
	.stabn	68,0,150,.LM60-.LFBB5
.LM60:
	ST.w	[r5+#1],r1
.L20:
	.stabn	68,0,178,.LM61-.LFBB5
.LM61:
	JMP	lr
.L21:
	.stabn	68,0,154,.LM62-.LFBB5
.LM62:
	CMP	r0,#1
	JNZ	.L23
	.stabn	68,0,158,.LM63-.LFBB5
.LM63:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,157,.LM64-.LFBB5
.LM64:
	LSL	r1,#5
.LBB52:
.LBB53:
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/KF32A_BASIC.h",132,0,0,.Ltext24
.Ltext24:
	.stabn	68,0,14361,.LM65-.LFBB5
.LM65:
	CLR	r4,#5
	ORL	r1,r1,r4
.LBE53:
.LBE52:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext25
.Ltext25:
	.stabn	68,0,158,.LM66-.LFBB5
.LM66:
	ST.w	[r5+#1],r1
	.stabn	68,0,178,.LM67-.LFBB5
.LM67:
	JMP	lr
.L23:
	.stabn	68,0,162,.LM68-.LFBB5
.LM68:
	CMP	r0,#2
	JNZ	.L24
	.stabn	68,0,166,.LM69-.LFBB5
.LM69:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,165,.LM70-.LFBB5
.LM70:
	LSL	r1,#6
.LBB54:
.LBB55:
...
.Ltext26:
	.stabn	68,0,14361,.LM71-.LFBB5
.LM71:
	CLR	r4,#6
	ORL	r1,r1,r4
.LBE55:
.LBE54:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext27
.Ltext27:
	.stabn	68,0,166,.LM72-.LFBB5
.LM72:
	ST.w	[r5+#1],r1
...
.LM73:
	JMP	lr
.L24:
	.stabn	68,0,170,.LM74-.LFBB5
.LM74:
	CMP	r0,#3
	JNZ	.L20
	.stabn	68,0,174,.LM75-.LFBB5
.LM75:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,173,.LM76-.LFBB5
.LM76:
	LSL	r1,#7
.LBB56:
.LBB57:
...
.Ltext28:
	.stabn	68,0,14361,.LM77-.LFBB5
.LM77:
	CLR	r4,#7
	ORL	r1,r1,r4
.LBE57:
.LBE56:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext29
.Ltext29:
	.stabn	68,0,174,.LM78-.LFBB5
.LM78:
	ST.w	[r5+#1],r1
	.stabn	68,0,178,.LM79-.LFBB5
.LM79:
	JMP	lr
	.size	OP_OUTPUT_EN, .-OP_OUTPUT_EN
.Lscope5:
	.stabs	"",36,0,0,.Lscope5-.LFBB5
	.stabd	78,0,0
	.section .text$OP_MODULE_EN
	.type	.text$OP_MODULE_EN$scode_local_6, @function
	.text$OP_MODULE_EN$scode_loacal_6:
	.align	1
	.stabs	"OP_MODULE_EN:F(0,15)",36,0,185,OP_MODULE_EN
	.stabs	"OPx:P(3,6)",64,0,185,0
	.stabs	"NewState:P(2,2)",64,0,185,1
	.export	OP_MODULE_EN
	.type	OP_MODULE_EN, @function
OP_MODULE_EN:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext30
.Ltext30:
	.stabn	68,0,186,.LM80-.LFBB6
.LM80:
.LFBB6:
	.stabn	68,0,191,.LM81-.LFBB6
.LM81:
	CMP	r0,#0
	JNZ	.L26
	.stabn	68,0,195,.LM82-.LFBB6
.LM82:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
.LBB58:
...
.Ltext31:
	.stabn	68,0,14361,.LM83-.LFBB6
.LM83:
	CLR	r4,#0
	ORL	r1,r1,r4
.LBE59:
.LBE58:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext32
.Ltext32:
	.stabn	68,0,195,.LM84-.LFBB6
.LM84:
	ST.w	[r5+#1],r1
.L25:
	.stabn	68,0,223,.LM85-.LFBB6
.LM85:
	JMP	lr
.L26:
	.stabn	68,0,199,.LM86-.LFBB6
.LM86:
	CMP	r0,#1
	JNZ	.L28
	.stabn	68,0,203,.LM87-.LFBB6
.LM87:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,202,.LM88-.LFBB6
.LM88:
	ADD	r1,r1,r1
.LBB60:
.LBB61:
...
.Ltext33:
	.stabn	68,0,14361,.LM89-.LFBB6
.LM89:
	CLR	r4,#1
	ORL	r1,r1,r4
.LBE61:
.LBE60:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext34
.Ltext34:
	.stabn	68,0,203,.LM90-.LFBB6
.LM90:
	ST.w	[r5+#1],r1
	.stabn	68,0,223,.LM91-.LFBB6
.LM91:
	JMP	lr
.L28:
	.stabn	68,0,207,.LM92-.LFBB6
.LM92:
	CMP	r0,#2
	JNZ	.L29
	.stabn	68,0,211,.LM93-.LFBB6
.LM93:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,210,.LM94-.LFBB6
.LM94:
	LSL	r1,#2
.LBB62:
.LBB63:
...
.Ltext35:
	.stabn	68,0,14361,.LM95-.LFBB6
.LM95:
	CLR	r4,#2
	ORL	r1,r1,r4
.LBE63:
.LBE62:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext36
.Ltext36:
	.stabn	68,0,211,.LM96-.LFBB6
.LM96:
	ST.w	[r5+#1],r1
	.stabn	68,0,223,.LM97-.LFBB6
.LM97:
	JMP	lr
.L29:
	.stabn	68,0,215,.LM98-.LFBB6
.LM98:
	CMP	r0,#3
	JNZ	.L25
	.stabn	68,0,219,.LM99-.LFBB6
.LM99:
	LD	r5,#1073752576
	LD.w	r4,[r5+#1]
	.stabn	68,0,218,.LM100-.LFBB6
.LM100:
	LSL	r1,#3
.LBB64:
.LBB65:
...
.Ltext37:
	.stabn	68,0,14361,.LM101-.LFBB6
.LM101:
	CLR	r4,#3
	ORL	r1,r1,r4
.LBE65:
.LBE64:
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext38
.Ltext38:
	.stabn	68,0,219,.LM102-.LFBB6
.LM102:
	ST.w	[r5+#1],r1
	.stabn	68,0,223,.LM103-.LFBB6
.LM103:
	JMP	lr
	.size	OP_MODULE_EN, .-OP_MODULE_EN
.Lscope6:
