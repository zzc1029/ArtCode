...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_pclk.h",130,0,0,0
...
.Lscope1:
	...
	.stabs	"PCLK_CTL1_bit:P(3,6)",64,0,86,0
	.stabs	"NewState:P(2,2)",64,0,87,1
	.export	PCLK_CTL1_Peripheral_Clock_Enable
	.type	PCLK_CTL1_Peripheral_Clock_Enable, @function
PCLK_CTL1_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_pclk.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,88,.LM7-.LFBB2
.LM7:
.LFBB2:
	.stabn	68,0,95,.LM8-.LFBB2
.LM8:
	LD	r5,#1073751616
	LD.w	r4,[r5+#1]
...
.Lscope2:
	...
	.stabs	"PCLK_CTL2_bit:P(3,6)",64,0,128,0
	.stabs	"NewState:P(2,2)",64,0,129,1
	.export	PCLK_CTL2_Peripheral_Clock_Enable
	.type	PCLK_CTL2_Peripheral_Clock_Enable, @function
PCLK_CTL2_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_pclk.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,130,.LM14-.LFBB3
.LM14:
.LFBB3:
	.stabn	68,0,137,.LM15-.LFBB3
.LM15:
	LD	r5,#1073751616
	LD.w	r4,[r5+#2]
	.stabn	68,0,135,.LM16-.LFBB3
.LM16:
	CMP	r1,#0
	JNZ	.L13
	.stabn	68,0,141,.LM17-.LFBB3
.LM17:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,143,.LM18-.LFBB3
.LM18:
	JMP	lr
.L13:
...
.Lscope3:
	...
	.stabs	"PCLK_CTL3_bit:P(3,6)",64,0,163,0
	.stabs	"NewState:P(2,2)",64,0,164,1
	.export	PCLK_CTL3_Peripheral_Clock_Enable
	.type	PCLK_CTL3_Peripheral_Clock_Enable, @function
PCLK_CTL3_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_pclk.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,165,.LM21-.LFBB4
.LM21:
.LFBB4:
	.stabn	68,0,172,.LM22-.LFBB4
.LM22:
	LD	r5,#1073751616
	LD.w	r4,[r5+#3]
	.stabn	68,0,170,.LM23-.LFBB4
.LM23:
	CMP	r1,#0
	JNZ	.L17
	.stabn	68,0,176,.LM24-.LFBB4
.LM24:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,178,.LM25-.LFBB4
.LM25:
	JMP	lr
.L17:
	.stabn	68,0,172,.LM26-.LFBB4
.LM26:
	ORL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,178,.LM27-.LFBB4
.LM27:
	JMP	lr
