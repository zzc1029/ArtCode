...
.Ltext0:
	...
	.stabs	"H:/art_service/code/YB_2022/12/XGYC-QRWD-221202/YB-XGYC-QRWD-221202/system/inc/kf32a_basic_rst.h",130,0,0,0
...
.Lscope1:
	...
	.stabs	"RST_CTL1_bit:P(3,6)",64,0,87,0
	.stabs	"NewState:P(2,2)",64,0,88,1
	.export	RST_CTL1_Peripheral_Reset_Enable
	.type	RST_CTL1_Peripheral_Reset_Enable, @function
RST_CTL1_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_rst.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,89,.LM7-.LFBB2
.LM7:
.LFBB2:
	.stabn	68,0,96,.LM8-.LFBB2
.LM8:
	LD	r5,#1073747200
	LD.w	r4,[r5+#1]
...
.LM9:
	CMP	r1,#0
	JNZ	.L9
	.stabn	68,0,100,.LM10-.LFBB2
.LM10:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#1],r0
	.stabn	68,0,102,.LM11-.LFBB2
.LM11:
	JMP	lr
.L9:
...
.Lscope2:
	...
	.stabs	"RST_CTL2_bit:P(3,6)",64,0,129,0
	.stabs	"NewState:P(2,2)",64,0,130,1
	.export	RST_CTL2_Peripheral_Reset_Enable
	.type	RST_CTL2_Peripheral_Reset_Enable, @function
RST_CTL2_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_rst.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,131,.LM14-.LFBB3
.LM14:
.LFBB3:
	.stabn	68,0,138,.LM15-.LFBB3
.LM15:
	LD	r5,#1073747200
	LD.w	r4,[r5+#2]
	.stabn	68,0,136,.LM16-.LFBB3
.LM16:
	CMP	r1,#0
	JNZ	.L13
	.stabn	68,0,142,.LM17-.LFBB3
.LM17:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,144,.LM18-.LFBB3
.LM18:
	JMP	lr
.L13:
	.stabn	68,0,138,.LM19-.LFBB3
.LM19:
	ORL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,144,.LM20-.LFBB3
.LM20:
	JMP	lr
...
.Lscope3:
	...
	.stabs	"RST_CTL3_bit:P(3,6)",64,0,164,0
	.stabs	"NewState:P(2,2)",64,0,165,1
	.export	RST_CTL3_Peripheral_Reset_Enable
	.type	RST_CTL3_Peripheral_Reset_Enable, @function
RST_CTL3_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_rst.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,166,.LM21-.LFBB4
.LM21:
.LFBB4:
	.stabn	68,0,173,.LM22-.LFBB4
.LM22:
	LD	r5,#1073747200
	LD.w	r4,[r5+#3]
	.stabn	68,0,171,.LM23-.LFBB4
.LM23:
	CMP	r1,#0
	JNZ	.L17
	.stabn	68,0,177,.LM24-.LFBB4
.LM24:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,179,.LM25-.LFBB4
.LM25:
	JMP	lr
.L17:
	.stabn	68,0,173,.LM26-.LFBB4
.LM26:
	ORL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,179,.LM27-.LFBB4
.LM27:
	JMP	lr
