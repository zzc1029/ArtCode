...
static void Rool_Alarm_Handle(void)
{
    ...
    tip_code2.bit.b5 = (((veh_bar1<Air_Alarm)||0) || ((veh_bar2<Air_Alarm)||0));
    tip_code2.bit.b6 = 0;
    tip_code2.bit.b7 = 0;
 ...
 tip_code2.bit.b15 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(7))) > 0);
    tip_code2.bit.b16 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(6))) > 0);
    tip_code2.bit.b17 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(5))) > 0);
    tip_code2.bit.b18 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(4))) > 0);
    tip_code2.bit.b19 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(3))) > 0);
    tip_code2.bit.b20 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(2))) > 0);
    tip_code2.bit.b21 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(1))) > 0);
    tip_code2.bit.b22 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(0))) > 0);
    tip_code2.bit.b23 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(7))) > 0);
    tip_code2.bit.b24 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(6))) > 0);
    tip_code2.bit.b25 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(5))) > 0);
    tip_code2.bit.b26 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(4))) > 0);
    tip_code2.bit.b27 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(3))) > 0);
    tip_code2.bit.b28 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(2))) > 0);
    tip_code2.bit.b29 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(1))) > 0);
    tip_code2.bit.b30 = (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][6]) & (1<<(0))) > 0);

 tip_code2.bit.b31 = ((CanData[Pcan1GetIndexFromID(0x18FE521E)][BYTE8] & 0x02) == 0x02);
    tip_code2.bit.b32 = ((CanData[Pcan1GetIndexFromID(0x18FE521E)][BYTE8] & 0x04) == 0x04);
    tip_code2.bit.b33 = 0;
    tip_code2.bit.b34 = 0;
    tip_code2.bit.b35 = bcm_sw2_t.bit.b0 && (veh_speed_display > 30);
    tip_code2.bit.b36 = bcm_sw1_t.bit.b14 && (veh_speed_display > 30);
    tip_code2.bit.b37 = 0;
    tip_code2.bit.b38 = CanData[Pcan1GetIndexFromID(0x1819D0F3)][4] == 1;

    tip_code2.bit.b39 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(1))) > 0);
    tip_code2.bit.b40 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(0))) > 0);
    tip_code2.bit.b41 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7]) & (1<<(1))) > 0);
    tip_code2.bit.b42 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7]) & (1<<(0))) > 0);

    tip_code2.bit.b43 = 0;
    tip_code2.bit.b44 = 0;

    tip_code2.bit.b45 = (((CanData[Pcan1GetIndexFromID(0x0C02A70A)][1]) & (1<<(7))) > 0) || (((CanData[Pcan1GetIndexFromID(0x0C03A70A)][0]) & (1<<(6))) > 0) || (((CanData[Pcan1GetIndexFromID(0x0C03A70A)][1]) & (1<<(0))) > 0);
    tip_code2.bit.b46 = (((CanData[Pcan1GetIndexFromID(0x0C02A70A)][2]) & (1<<(1))) > 0);
    tip_code2.bit.b47 = 0;
    tip_code2.bit.b48 = 0;
    tip_code2.bit.b49 = 0;
    tip_code2.bit.b50 = 0;
    ...
    tip_code2.bit.b57 = 0;
    tip_code2.bit.b58 = 0;
    tip_code2.bit.b59 = (bcm_sw1_t.bit.b3);
    tip_code2.bit.b60 = 0;
    ...
    tip_code3.bit.b9 = (bcm_sw1_t.bit.b1);
    tip_code3.bit.b10 = (bcm_sw1_t.bit.b0);
    tip_code3.bit.b11 = (bcm_sw1_t.bit.b2);
    tip_code3.bit.b12 = 0;
    tip_code3.bit.b13 = port_a.bit.b0;
    tip_code3.bit.b14 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(7))) > 0);
    tip_code3.bit.b15 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(6))) > 0);
    tip_code3.bit.b16 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(5))) > 0);

    tip_code3.bit.b17 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(4))) > 0);
    tip_code3.bit.b18 = 0;
    tip_code3.bit.b19 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7]) & (1<<(4))) > 0);
    tip_code3.bit.b20 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7]) & (1<<(3))) > 0);
    tip_code3.bit.b21 = (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7]) & (1<<(2))) > 0);
    tip_code3.bit.b22 = 0;
 ...
 tip_code3.bit.b43 = 0;
    ...
    tip_code3.bit.b44 = 0;
 tip_code3.bit.b45 = ((CanData[Pcan1GetIndexFromID(0x18FE521E)][BYTE8] & 0x08) == 0x08);
 tip_code3.bit.b46 = ((CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE1] & 0x03) == 0x02);
 tip_code3.bit.b47 = ((CanData[Pcan1GetIndexFromID(0x18FFA898)][BYTE1] & 0xC0) == 0x80);
 tip_code3.bit.b48 = 0;
 tip_code3.bit.b49 = 0;
 tip_code3.bit.b50 = 0;
 tip_code3.bit.b51 = 0;
 ...
 tip_code3.bit.b60 = ((MIEHUO.alarm_level[0] > 0) && (MIEHUO.alarm_level[0] < 5));
 tip_code3.bit.b61 = ((MIEHUO.alarm_level[1] > 0) && (MIEHUO.alarm_level[1] < 5));
 tip_code3.bit.b62 = ((MIEHUO.alarm_level[2] > 0) && (MIEHUO.alarm_level[2] < 5));
 tip_code3.bit.b63 = ((MIEHUO.alarm_level[3] > 0) && (MIEHUO.alarm_level[3] < 5));
 tip_code4.bit.b0 = ((MIEHUO.alarm_level[4] > 0) && (MIEHUO.alarm_level[4] < 5));
 tip_code4.bit.b1 = ((MIEHUO.alarm_level[5] > 0) && (MIEHUO.alarm_level[5] < 5));


 tip_code4.bit.b2 = led[4].bit.b7;

 tip_code4.bit.b3 = bcm_sw2_f.bit.b0;

 tip_code4.bit.b4 = led[5].bit.b1;

    tip_code4.bit.b5 = (((taiya.fault_status[0]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));
 tip_code4.bit.b6 = (((taiya.fault_status[1]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));
 tip_code4.bit.b7 = (((taiya.fault_status[2]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));
 tip_code4.bit.b8 = (((taiya.fault_status[3]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));
 tip_code4.bit.b9 = (((taiya.fault_status[4]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));
 tip_code4.bit.b10 = (((taiya.fault_status[5]) & (((1<<(2))-1) << (2))) == ((1)<<(2)));

 tip_code4.bit.b11 = (((taiya.fault_status[0]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));
 tip_code4.bit.b12 = (((taiya.fault_status[1]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));
 tip_code4.bit.b13 = (((taiya.fault_status[2]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));
 tip_code4.bit.b14 = (((taiya.fault_status[3]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));
 tip_code4.bit.b15 = (((taiya.fault_status[4]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));
 tip_code4.bit.b16 = (((taiya.fault_status[5]) & (((1<<(2))-1) << (4))) == ((1)<<(4)));

 tip_code4.bit.b17 = (((taiya.fault_status[0]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));
 tip_code4.bit.b18 = (((taiya.fault_status[1]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));
 tip_code4.bit.b19 = (((taiya.fault_status[2]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));
 tip_code4.bit.b20 = (((taiya.fault_status[3]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));
 tip_code4.bit.b21 = (((taiya.fault_status[4]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));
 tip_code4.bit.b22 = (((taiya.fault_status[5]) & (((1<<(2))-1) << (6))) == ((1)<<(6)));

 tip_code4.bit.b23 = (((taiya.error[0]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));
 tip_code4.bit.b24 = (((taiya.error[1]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));
 tip_code4.bit.b25 = (((taiya.error[2]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));
 tip_code4.bit.b26 = (((taiya.error[3]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));
 tip_code4.bit.b27 = (((taiya.error[4]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));
 tip_code4.bit.b28 = (((taiya.error[5]) & (((1<<(3))-1) << (5))) == ((1)<<(5)));

 tip_code4.bit.b29 = (((taiya.error[0]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));
 tip_code4.bit.b30 = (((taiya.error[1]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));
 tip_code4.bit.b31 = (((taiya.error[2]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));
 tip_code4.bit.b32 = (((taiya.error[3]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));
 tip_code4.bit.b33 = (((taiya.error[4]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));
 tip_code4.bit.b34 = (((taiya.error[5]) & (((1<<(3))-1) << (5))) == ((2)<<(5)));





 if(bcm_sw2_t.bit.b0 || bcm_sw1_t.bit.b14)
 {

    if((((!Art.bit.b44) && (bcm_sw2_t.bit.b0)) || ((!Art.bit.b45) && (bcm_sw1_t.bit.b14)))&&(veh_speed_display > 30))
    {
    pre_door_time = 20;

       Art.bit.b44 = bcm_sw2_t.bit.b0;
       Art.bit.b45 = bcm_sw1_t.bit.b14;
    }
 ...
 else
 {
  ...
  Art.bit.b46 = ((led[2].bit.b5 ||led[3].bit.b3) && (veh_speed_display > 30)) || led[0].bit.b7 || led[2].bit.b4 || led[1].bit.b2 || led[3].bit.b5 || led[0].bit.b0 ||(bcm_sw1_t.bit.b10)
       || (CanData[Pcan1GetIndexFromID(0x1818D0F3)][5] > 0) || (CanData[Pcan1GetIndexFromID(0x1818D0F3)][6] > 0)||((veh_speed_display >= (Speed_Alarm*10)))||bcm_sw2_f.bit.b0
      || led[1].bit.b7 || ((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1] & 0xF3) > 0) || ((CanData[Pcan1GetIndexFromID(0x181BD0F3)][7] & 0x1F) > 0) || led[1].bit.b6 || (pre_door_time > 0)||
      bcm_sw1_t.bit.b0||led[5].bit.b2||(tip_code4.bit.b34||tip_code4.bit.b33||tip_code4.bit.b32|| tip_code4.bit.b16||tip_code4.bit.b17||tip_code4.bit.b18||tip_code4.bit.b19||tip_code4.bit.b20||tip_code4.bit.b21||tip_code4.bit.b22||tip_code4.bit.b23||tip_code4.bit.b24 ||tip_code4.bit.b25||tip_code4.bit.b26||tip_code4.bit.b27||tip_code4.bit.b28||tip_code4.bit.b29||tip_code4.bit.b30||tip_code4.bit.b31 ||tip_code4.bit.b5||tip_code4.bit.b6||tip_code4.bit.b7||tip_code4.bit.b8||tip_code4.bit.b9||tip_code4.bit.b10||tip_code4.bit.b11||tip_code4.bit.b12||tip_code4.bit.b13 ||tip_code4.bit.b14||tip_code4.bit.b15)||(!bcm_sw1_r.bit.b0);



    Art.bit.b47 = tip_code2.bit.b5 ;
...
void j1939_tx_100ms(void)
{
 ...
 temp_u8.byte = 0;
 temp_u8.bit.b0 = (((veh_bar1<Air_Alarm)||0) || ((veh_bar2<Air_Alarm)||0));
 temp_u8.bit.b1 = bcm_sw1_f.bit.b7;
 temp_u8.bit.b2 = (!bcm_sw2_r.bit.b0);
    temp_u8.bit.b3 = bcm_sw2_t.bit.b0;
    temp_u8.bit.b4 = bcm_sw1_t.bit.b14;
    temp_u8.bit.b5 = port_a.bit.b7;
    temp_u8.bit.b6 = port_a.bit.b3;
    temp_u8.bit.b7 = (port_a.bit.b2);
 buffer[0] = temp_u8.byte;
 temp_u8.byte = 0;
 temp_u8.bit.b0 = (((((bcm_fb_st_r.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_r.word>>A12)&0x01));
 temp_u8.bit.b1 = (((((bcm_fb_st_f.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_f.word>>A12)&0x01));
 temp_u8.bit.b2 = 0;
    temp_u8.bit.b3 = 0;
 if(port_b.bit.b10)
  youtime = 10;
 if(youtime > 0)
  youtime--;
    ...
    temp_u8.bit.b5 = (((((bcm_fb_st_f.dword)>>(A5*2))&0x03) == 0) && ((bcm_out_st_f.word>>A5)&0x01));
    temp_u8.bit.b6 = (((((bcm_fb_st_f.dword)>>(A4*2))&0x03) == 0) && ((bcm_out_st_f.word>>A4)&0x01));
 if(port_b.bit.b9)
  zuotime = 10;
 if(zuotime > 0)
  zuotime--;
 ...
 temp_u8.byte = 0;
 temp_u8.bit.b0 = (((veh_bar1<Air_Alarm)||0) || ((veh_bar2<Air_Alarm)||0));
 temp_u8.bit.b1 = bcm_sw1_r.bit.b2;
 temp_u8.bit.b2 = 0;
    temp_u8.bit.b3 = 0;
    temp_u8.bit.b4 = (CanData[Pcan1GetIndexFromID(0x18FFF7F6)][BYTE2] == 2) || (CanData[Pcan1GetIndexFromID(0x18FFF7F6)][BYTE2] == 3) || (CanData[Pcan1GetIndexFromID(0x18FFF7F6)][BYTE2] == 4);
    temp_u8.bit.b5 = 0;
    temp_u8.bit.b6 = 0;
    temp_u8.bit.b7 = 0;
 ...
 buffer[4] = ((unsigned char)((datatemp) >> 0));
 buffer[5] = ((unsigned char)((datatemp) >> 8));
 datatemp = veh_bar2 * 100;
    buffer[6] = ((unsigned char)((datatemp) >> 0));
    buffer[7] = ((unsigned char)((datatemp) >> 8));

 PCan1_Expend_Tx_Bytes(0x0C19A7A1,buffer,8);
 PCan2_Expend_Tx_Bytes(0x0C19A7A1,buffer,8);
 ...
 if(time < 10)
  ...
  PCan1_Expend_Tx_Bytes(0x0C1AA7A1,buffer,8);
  PCan2_Expend_Tx_Bytes(0x0C1AA7A1,buffer,8);
  ...
  PCan1_Expend_Tx_Bytes(0x18FEE617,buffer,8);
  PCan2_Expend_Tx_Bytes(0x18FEE617,buffer,8);

        if(Art.bit.b57)
        {
           Art.bit.b57 = 0;
     PCan1_Expend_Tx_Bytes(0x0C02F4A7,(u8 *)CanData[Pcan1GetIndexFromID(0x0C02F4A7)],8);
  }
  if(Art.bit.b58)
  {
          Art.bit.b58 = 0;
    PCan2_Expend_Tx_Bytes(0x0C09A7F4,(u8 *)CanData[Pcan1GetIndexFromID(0x0C09A7F4)],8);
  }
# 769 "../source/system.c"
    }
...
void send_to_can2(void)
{
 ...
 PCan2_Expend_Tx_Bytes(0x0C0AA79D,buffer,8);

 if(CanSend_Flag.bit.b1)
 {
  for(i = 0;i < 8;i++)
 ...
 PCan2_Expend_Tx_Bytes(0x0C04A1A7,buffer,8);

 if(CanSend_Flag.bit.b2)
 {
  for(i = 0;i < 8;i++)
 ...
 PCan2_Expend_Tx_Bytes(0x0C06A1A7,buffer,8);

 if(CanSend_Flag.bit.b3)
 {
  for(i = 0;i < 8;i++)
   buffer[i] = DCDC1[i];
 }
 ...
 PCan2_Expend_Tx_Bytes(0x0C079AA7,buffer,8);
}
...
void BCMConfig(void)
{
 ...
 TYPE_BYTE moudle_out_flag;
    ...
    ctrl_cmd[0].bit.b3 = (((port_a.bit.b7||port_a.bit.b3) && port_b.bit.b10) || (port_a.bit.b2)) && (blinker > 17);
 ctrl_cmd[0].bit.b4 = (((port_a.bit.b7||port_a.bit.b3) && port_b.bit.b9) || (port_a.bit.b2)) && (blinker > 17);
    ctrl_cmd[0].bit.b5 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b6;
    ctrl_cmd[0].bit.b6 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b7;
 ctrl_cmd[0].bit.b7 = (port_a.bit.b7||port_a.bit.b3) && (!port_b.bit.b7) && port_b.bit.b8;
    ctrl_cmd[1].bit.b0 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b6 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(0))) > 0);
    ctrl_cmd[1].bit.b1 = (port_a.bit.b7||port_a.bit.b3) && port_d.bit.b2;
    ctrl_cmd[1].bit.b2 = (port_a.bit.b7||port_a.bit.b3);
    ctrl_cmd[1].bit.b3 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE2]) & (1<<(6))) > 0);
    ctrl_cmd[1].bit.b4 = ctrl_cmd[1].bit.b3;
    ctrl_cmd[1].bit.b5 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE2]) & (1<<(7))) > 0);
    ctrl_cmd[1].bit.b6 = ctrl_cmd[1].bit.b5;
    ctrl_cmd[1].bit.b7 = 0;
...
# 980 "../source/system.c"
 ctrl_cmd[2].bit.b2 = (port_a.bit.b7||port_a.bit.b3);

    ctrl_cmd[2].bit.b3 = 0;
    ctrl_cmd[2].bit.b4 = port_a.bit.b7 && (bcm_sw1_f.bit.b6);
    ctrl_cmd[2].bit.b5 = port_a.bit.b7;
    ctrl_cmd[2].bit.b6 = (port_a.bit.b7||port_a.bit.b3) && ((bcm_sw1_f.bit.b6)||((OnOffStatus&0x80) == 0x80));
    ctrl_cmd[2].bit.b7 = port_a.bit.b7 && port_b.bit.b6 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(0))) > 0) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(1))) > 0);
    ctrl_cmd[3].bit.b0 = (port_a.bit.b7||port_a.bit.b3) && bcm_sw1_t.bit.b14 && port_b.bit.b6;
 ctrl_cmd[3].bit.b1 = port_a.bit.b7;

    ctrl_cmd[3].bit.b2 = port_a.bit.b7 && (((DriverOperateStatus&0x0f)==13));
    ctrl_cmd[3].bit.b3 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b6;
    ctrl_cmd[3].bit.b4 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b6;
    ctrl_cmd[3].bit.b5 = (port_a.bit.b7||port_a.bit.b3) && port_c.bit.b0;

    ctrl_cmd[3].bit.b6 = port_a.bit.b7 && ((CanData[Pcan1GetIndexFromID(0x0C0AA79D)][BYTE8] & 0x80)==0x80);
    ctrl_cmd[3].bit.b7 = 0;
    ...
    ctrl_cmd[4].bit.b0 = ctrl_cmd[0].bit.b3;
    ctrl_cmd[4].bit.b1 = ctrl_cmd[0].bit.b4;
    ctrl_cmd[4].bit.b2 = (port_a.bit.b7||port_a.bit.b3) && bcm_sw1_t.bit.b14 && port_b.bit.b6;
    ctrl_cmd[4].bit.b3 = (port_a.bit.b7||port_a.bit.b3) && bcm_sw2_t.bit.b0 && port_b.bit.b6;
    ctrl_cmd[4].bit.b4 = (port_a.bit.b7||port_a.bit.b3) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE2]) & (1<<(0))) > 0);
    ctrl_cmd[4].bit.b5 = (port_a.bit.b7||port_a.bit.b3) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(4))) > 0);
 ctrl_cmd[4].bit.b6 = (port_a.bit.b7||port_a.bit.b3) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(5))) > 0);
    ctrl_cmd[4].bit.b7 = (port_a.bit.b7||port_a.bit.b3) && port_b.bit.b6;
    ctrl_cmd[5].bit.b0 = (port_a.bit.b7||port_a.bit.b3);
 ctrl_cmd[5].bit.b1 = port_a.bit.b7 && (((DriverOperateStatus&0x0f)==13));
    ctrl_cmd[5].bit.b2 = (port_a.bit.b7||port_a.bit.b3) && ((bcm_sw1_f.bit.b6)||((OnOffStatus&0x80) == 0x80));
    ctrl_cmd[5].bit.b3 = (port_a.bit.b7||port_a.bit.b3) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(6))) > 0);
 ctrl_cmd[5].bit.b4 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE2]) & (1<<(5))) > 0);
    ctrl_cmd[5].bit.b5 = (port_a.bit.b7||port_a.bit.b3);
    ctrl_cmd[5].bit.b6 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(3))) > 0);
  ...
  output_s.bit.b0 = port_a.bit.b7 && (!port_b.bit.b6);
  output_s.bit.b1 = port_a.bit.b7 && (veh_speed_display > 30);
  output_s.bit.b2 = port_a.bit.b7 && ((ctrl_cmd[1].bit.b3 && ctrl_cmd[1].bit.b4)||(ctrl_cmd[1].bit.b5 && ctrl_cmd[1].bit.b6));
  output_s.bit.b3 = (port_a.bit.b7||port_a.bit.b3) && (!(((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE1]) & (1<<(2))) > 0));
  output_s.bit.b4 = 0;
...
TYPE_BYTE Last_Syb ;
void SymbolConfig (void)
{
    u16 temp;
    static u8 timex = 0, timexx = 0, timexxx = 120, epb_time, asr_time, car1_time, car2_time, person1_time, person2_time;
    Last_Syb.byte = 0;
    temp = GetU16From2U8 (CanData[Pcan1GetIndexFromID (0x18F201F3)][BYTE5], CanData[Pcan1GetIndexFromID (0x18F201F3)][BYTE4], 1);
    if (temp > 36000)
    {
        if (timex <= 5)
        {
    ...
    Last_Syb.bit.b3 = ((CanData[Pcan1GetIndexFromID (0x18F208F3)][BYTE7] & 0x80) == 0x80);
...
void LED_Handle(void)
{
 ...
 lizuo = (({ static uint8_t time = 0; uint8_t re = 0; if(((((DriverOperateStatus&0x0f)==14)) && (!bcm_sw1_f.bit.b1))) { if(time >= 20) { re = 1; } else { time++; } } else { time = 0; } re; }) && ((SystemStatus&0x40) == 0x40));

 led[0].bit.b7 = port_a.bit.b7 && (((!bcm_sw1_f.bit.b3))||((!bcm_sw1_f.bit.b2))||((!bcm_sw1_f.bit.b4))||((!bcm_sw1_f.bit.b5)));
 led[0].bit.b6 = port_a.bit.b7 && ((((((bcm_fb_st_f.dword)>>(A11*2))&0x03) == 0) && ((bcm_out_st_f.word>>A11)&0x01)) && (((((bcm_fb_st_t.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_t.word>>A12)&0x01))&& (((((bcm_fb_st_r.dword)>>(A14*2))&0x03) == 0) && ((bcm_out_st_r.word>>A14)&0x01))&& (((((bcm_fb_st_r.dword)>>(A7*2))&0x03) == 0) && ((bcm_out_st_r.word>>A7)&0x01)));
 led[0].bit.b5 = port_a.bit.b7 && ((((((bcm_fb_st_t.dword)>>(A6*2))&0x03) == 0) && ((bcm_out_st_t.word>>A6)&0x01)) && (((((bcm_fb_st_r.dword)>>(A4*2))&0x03) == 0) && ((bcm_out_st_r.word>>A4)&0x01)));
 led[0].bit.b4 = port_a.bit.b7 && bcm_sw2_f.bit.b0 && (Art.bit.b47 ? (blinker < 11) :(blinker < 21));
 led[0].bit.b3 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][BYTE7]) & (1<<(5))) > 0);
 led[0].bit.b2 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x181BD0F3)][BYTE2]) & (1<<(0))) > 0);
 led[0].bit.b1 = port_a.bit.b7 && ((OnOffStatus&0x80) == 0x80);
 led[0].bit.b0 = port_a.bit.b7 && ((SystemStatus&0x30)==0x30);

 led[1].bit.b7 = port_a.bit.b7 &&CanData[Pcan1GetIndexFromID(0x1819D0F3)][BYTE5] == 1;
    led[1].bit.b6 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x0C02A70A)][BYTE2]) & (1<<(7))) > 0) || (((CanData[Pcan1GetIndexFromID(0x0C02A70A)][BYTE3]) & (1<<(1))) > 0) || (((CanData[Pcan1GetIndexFromID(0x0C03A70A)][BYTE1]) & (1<<(6))) > 0) || (((CanData[Pcan1GetIndexFromID(0x0C03A70A)][BYTE2]) & (1<<(0))) > 0);
    led[1].bit.b5 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x1818D0F3)][BYTE8]) & (1<<(5))) > 0);
    led[1].bit.b4 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x1818D0F3)][BYTE8]) & (1<<(6))) > 0);
    led[1].bit.b3 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x1818D0F3)][BYTE8]) & (1<<(1))) == 0);
    led[1].bit.b2 = port_a.bit.b7 && 0;
    led[1].bit.b1 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x0C04A1A7)][4]) & (1<<(4))) > 0);
    led[1].bit.b0 = port_a.bit.b7 &&(((CanData[Pcan1GetIndexFromID(0x181BD0F3)][1]) & (1<<(3))) == 0);


 led[2].bit.b7 = port_a.bit.b7 && ((SystemStatus&0x30)==0x20);
    led[2].bit.b6 = port_a.bit.b7 && 0;
    led[2].bit.b5 = port_a.bit.b7 && ({ static uint8_t time = 0; uint8_t re = 0; if(((((DriverOperateStatus&0x0f)==14)) && (!bcm_sw1_f.bit.b1))) { if(time >= 50) { re = 1; } else { time++; } } else { time = 0; } re; });
    led[2].bit.b4 = port_a.bit.b7 && ((bcm_sw1_t.bit.b1)||(bcm_sw1_t.bit.b3)||(bcm_sw1_t.bit.b0)||(bcm_sw1_t.bit.b2));
    led[2].bit.b3 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][BYTE7]) & (1<<(2))) > 0);
    led[2].bit.b2 = port_a.bit.b7 && port_d.bit.b15;
    led[2].bit.b1 = port_a.bit.b7 && ((veh_speed_display >= (Speed_Alarm*10)));
    led[2].bit.b0 = port_a.bit.b7 && 0;

 led[3].bit.b7 = port_a.bit.b7 && (!bcm_sw2_r.bit.b0);
    led[3].bit.b6 = port_a.bit.b7 && ((SystemStatus&0x40) == 0x40);
    led[3].bit.b5 = port_a.bit.b7 && bcm_sw1_r.bit.b2;
    led[3].bit.b4 = port_a.bit.b7 && 0;
 led[3].bit.b3 = port_a.bit.b7 && (port_a.bit.b7 && bcm_sw1_f.bit.b0);
    led[3].bit.b2 = port_a.bit.b7 && ((SystemStatus&0x30)==0x30);
    led[3].bit.b1 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x1818D0F3)][5]) & (1<<(3))) > 0);
    led[3].bit.b0 = port_a.bit.b7 && 0;



 if((bcm_sw1_t.bit.b10) )
  led[4].bit.b7 = port_a.bit.b7;
 else if(bcm_sw1_t.bit.b14)
  led[4].bit.b7 = 0;
 led[4].bit.b6 = port_a.bit.b7 && (RearCurrent[A11] > 10);
    led[4].bit.b5 = port_a.bit.b7 && bcm_sw1_f.bit.b14;
    led[4].bit.b4 = port_a.bit.b7 && ((DriverOperateStatus&0x0f)==0x0f);
    led[4].bit.b3 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x0C04A1A7)][4]) & (1<<(3))) > 0);
    led[4].bit.b2 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x0C04A1A7)][4]) & (1<<(2))) > 0);
    led[4].bit.b1 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x0C04A1A7)][4]) & (1<<(1))) > 0);
    led[4].bit.b0 = port_a.bit.b7 && (((CanData[Pcan1GetIndexFromID(0x0C04A1A7)][4]) & (1<<(0))) > 0);

    led[5].bit.b0 = (port_a.bit.b7||port_a.bit.b3) && (((CanData[Pcan1GetIndexFromID(0x18FA0118)][BYTE2]) & (1<<(0))) > 0);
 if(port_a.bit.b7 && bcm_sw1_t.bit.b4)
 {
      if(canjiflag)
      {
         canjiflag = 0;
 ...
 led[5].bit.b1 = port_a.bit.b7 && (canjitime > 0);
 if(canjitime > 0)
    canjitime--;



 led[5].bit.b2 = port_a.bit.b7 && (((tip_code4.bit.b34||tip_code4.bit.b33||tip_code4.bit.b32|| tip_code4.bit.b16||tip_code4.bit.b17||tip_code4.bit.b18||tip_code4.bit.b19||tip_code4.bit.b20||tip_code4.bit.b21||tip_code4.bit.b22||tip_code4.bit.b23||tip_code4.bit.b24 ||tip_code4.bit.b25||tip_code4.bit.b26||tip_code4.bit.b27||tip_code4.bit.b28||tip_code4.bit.b29||tip_code4.bit.b30||tip_code4.bit.b31 ||tip_code4.bit.b5||tip_code4.bit.b6||tip_code4.bit.b7||tip_code4.bit.b8||tip_code4.bit.b9||tip_code4.bit.b10||tip_code4.bit.b11||tip_code4.bit.b12||tip_code4.bit.b13 ||tip_code4.bit.b14||tip_code4.bit.b15)) );
 led[5].bit.b3 = port_a.bit.b7 && (!bcm_sw1_r.bit.b0) && (Art.bit.b47 ? (blinker < 11) :(blinker < 21));
 ...
 if(blink > 9)
  blink = 0;
    ...
    ledlogic.bit.b0 = ctrl_cmd[0].bit.b4;
    ledlogic.bit.b1 = (port_a.bit.b7||port_a.bit.b3) && (((((bcm_fb_st_f.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_f.word>>A12)&0x01));
    ledlogic.bit.b2 = (port_a.bit.b7||port_a.bit.b3) && (((((bcm_fb_st_f.dword)>>(A4*2))&0x03) == 0) && ((bcm_out_st_f.word>>A4)&0x01));
    ledlogic.bit.b3 = (port_a.bit.b7||port_a.bit.b3) && (((((bcm_fb_st_f.dword)>>(A5*2))&0x03) == 0) && ((bcm_out_st_f.word>>A5)&0x01));
    ledlogic.bit.b4 = (port_a.bit.b7||port_a.bit.b3) && (((((bcm_fb_st_r.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_r.word>>A12)&0x01));
    ledlogic.bit.b5 = (port_a.bit.b7||port_a.bit.b3) && bcm_sw1_f.bit.b7;
    ledlogic.bit.b6 = port_a.bit.b7 && (((veh_bar1<Air_Alarm)||0) || ((veh_bar2<Air_Alarm)||0));
    ledlogic.bit.b7 = ((port_a.bit.b7||port_a.bit.b3) || port_a.bit.b1)&& bcm_sw2_t.bit.b0;
    ledlogic.bit.b8 = ((port_a.bit.b7||port_a.bit.b3) || port_a.bit.b1) && bcm_sw1_t.bit.b14;
    ledlogic.bit.b9 = (port_a.bit.b7||port_a.bit.b3);
    ledlogic.bit.b10 = ctrl_cmd[0].bit.b3;


    Art.bit.b48 = 0;
}
# 1280 "../source/system.c"
void LCDLEDControl()
{
    u8 i;
 ...
 if(timeout) timeout--;
    ...
    switch(veh_status)
    {
        ...
        case 0:
            if(port_a.bit.b7 || port_a.bit.b0)
            {
...
void BuzzLogic(void)
{
 static u16 buzzdelay = 800;
    ...
    {
        if((port_b.bit.b9 || port_b.bit.b10 || (port_a.bit.b2)))
        {
