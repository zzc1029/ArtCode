...
# 1 "H:/workspace32/App/driver/typedef.h" 1
# 11 "H:/workspace32/App/driver/typedef.h"
...
# 11 "H:/workspace32/App/source/system.h"
extern uint8_t BCanSendDisable;
extern uint8_t BcanDelay,TcanDelay,DcanDelay,PcanDelay,Pcan3Delay;
...
# 1 "H:/workspace32/App/driver/canreceive.h" 1
# 11 "H:/workspace32/App/driver/canreceive.h"
...
# 17 "H:/workspace32/App/driver/Bcan.h"
typedef enum
{
...
# 1 "H:/workspace32/App/driver/pcan1.h" 1
# 12 "H:/workspace32/App/driver/pcan1.h"
...
# 1 "H:/workspace32/App/driver/Pcan2.h" 1
# 11 "H:/workspace32/App/driver/Pcan2.h"
...
# 61 "H:/workspace32/App/system/system_init.h" 2
# 1 "H:/workspace32/App/driver/Pcan3.h" 1
# 11 "H:/workspace32/App/driver/Pcan3.h"
...
# 11 "H:/workspace32/App/driver/Dcan.h"
...
# 119 "H:/workspace32/App/system/system_init.h"
static void SetSysClock(void);
void SystemInit(void);
# 11 "../source/kf_it.c" 2

volatile int BootFlag = 0;
...
void __attribute__((interrupt))_CAN2_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<1)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<1));
 }

 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<7)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<7));
  Pcan1Inint();
 }
...
void __attribute__((interrupt))_CAN0_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<1)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<1));
 }
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<7)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<7));
  BcanInit();
 }
}
...
void __attribute__((interrupt))_CAN3_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<1)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<1));
 }
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<7)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<7));
  Pcan2Inint();
 }
}
...
void __attribute__((interrupt))_CAN1_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<1)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<1));
 }

 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<7)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<7));
  Pcan1Inint();
 }
...
void __attribute__((interrupt))_CAN4_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)1<<1)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)1<<1));
 }
