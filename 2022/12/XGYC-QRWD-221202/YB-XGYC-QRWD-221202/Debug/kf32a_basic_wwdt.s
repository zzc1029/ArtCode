...
.Ltext0:
	...
	.stabs	"H:/workspace32/App/system/inc/kf32a_basic_wwdt.h",130,0,0,0
...
.Lscope1:
	...
	.type	.text$WWDT_Reset$scode_local_2, @function
	.text$WWDT_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$WWDT_Threshold_Config$scode_local_3, @function
	.text$WWDT_Threshold_Config$scode_loacal_3:
	.align	1
...
WWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext3
.Ltext3:
...
.Lscope3:
	...
	.type	.text$WWDT_Prescaler_Config$scode_local_4, @function
	.text$WWDT_Prescaler_Config$scode_loacal_4:
	.align	1
...
WWDT_Counter_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_wwdt.c",132,0,0,.Ltext6
.Ltext6:
