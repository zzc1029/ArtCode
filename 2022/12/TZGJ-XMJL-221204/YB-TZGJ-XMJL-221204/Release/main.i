...
# 102 "C:/Program Files (x86)/ChipON IDE/KungFu32/ChipONCC32/include/Sys/stdio.h"
...
void main()
{
 ...
 (void)sch_add_task(ReadAdcResult, 1, 1);
 (void)sch_add_task(key_task, 1, 2);
 (void)sch_add_task(TestCan, 6, 9);
 (void)sch_add_task(switch_task, 7, 9);
 (void)sch_add_task(SystemLogic, 8, 9);
 (void)sch_add_task(feedback_diag, 9, 49);

 (void)sch_add_task(GetCaptureHZ, 10, 99);

 (void)sch_add_task(Acquisition_Task,26,99);

    (void)sch_add_task(display_task, 700, 9);
 (void)sch_add_task(Constant_display_Task, 99, 9);
 (void)sch_add_task(roll_alarm_Task, 500, 249);
 (void)sch_add_task(roll_symbol, 501, 249);
  ...
  (void)sch_add_task(BuzzLogic, 48, 1);
...
void check_failed(uint8_t* file, uint32_t line)
{
   ...
   while(1)
   {
    fprintf(((STREAM *)0x40000A80UL),"Wrong parameters value: file %s on line %d\r\n", file, line);
   }
}
