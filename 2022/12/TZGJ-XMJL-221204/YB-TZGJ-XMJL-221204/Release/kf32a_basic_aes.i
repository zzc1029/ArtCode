...
# 15 "D:/ARTStanHome/Desktop/TZGJ-XMJL-221204/YB-TZGJ-XMJL-221204/system/inc/kf32a_basic_aes.h" 2
...
# 15 "../system/src/kf32a_basic_aes.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 16 "../system/src/kf32a_basic_aes.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 17 "../system/src/kf32a_basic_aes.c" 2
# 36 "../system/src/kf32a_basic_aes.c"
void
AES_Reset ()
{
...
AES_Configuration (AES_InitTypeDef* AESInitStruct)
{
 ...
 ((void)0);
 ((void)0);
# 68 "../system/src/kf32a_basic_aes.c"
