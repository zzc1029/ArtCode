...
# 10 "../driver/watchdog.c" 2


uint32_t WWDGCNT_DATA = 0;
# 51 "../driver/watchdog.c"
void WWDT_Config_TH(uint32_t Threshold)
{
 WWDT_Reset();
 WWDT_Threshold_Config(Threshold);
 WWDT_Prescaler_Config(((uint32_t)0xA<<(3)));
 WWDT_Enable (TRUE);
...
# 71 "../driver/watchdog.c"
void WWDT_Clear(void)
{
 WWDGCNT_DATA = WWDT_Get_Counter();
 if((WWDGCNT_DATA > 0x1F) && (WWDGCNT_DATA < 0x3F))
 {
