...
static void xGPIO_Pcan2(void)
{
 ...
 GPIO_InitStructure.m_Pin = ((uint16_t)0x0002)|((uint16_t)0x0004);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x50000100)),&GPIO_InitStructure);
 PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((19))),TRUE);
 PCLK_CTL0_Peripheral_Clock_Enable(((uint32_t)1<<((0x4))),TRUE);
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint32_t)0x1),((uint8_t)0x09));
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint32_t)0x2),((uint8_t)0x09));
}
# 38 "../driver/Pcan2.c"
static void xINT_PCAN2(CAN_SFRmap* CANx)
{
 ...
 INT_Interrupt_Priority_Config(INT_CAN3,((uint32_t)3<<((1))),1);
 INT_Clear_Interrupt_Flag(INT_CAN3);
 INT_Interrupt_Enable(INT_CAN3,TRUE);
...
{
  xGPIO_Pcan2();
  xInit_CAN(((CAN_SFRmap *) ((uint32_t)0x40001980)),CAN_BAUDRATE_250K,((uint32_t)0<<(1)));
  xINT_PCAN2(((CAN_SFRmap *) ((uint32_t)0x40001980)));
}
...
SendCanFifo PCan2Sendbuffx[((1<<(6)))];
...
void InitPCan2Send(void)
{
    Pcan2_fifo_init(&PCan2SendBuff,PCan2Sendbuffx,((1<<(6))));
...
uint32_t PCan2_Standard_Tx_Bytes(uint16_t id,uint8_t * buffer,uint8_t len)
{
    ...
    temp = (PCan2SendBuff.max_len - PCan2SendBuff.wr_index + PCan2SendBuff.rd_index);
 if(1 > temp)
    {
 ...
 PCan2SendBuff.buff[temp].Pcan1GetIndexFromID = id;
 PCan2SendBuff.buff[temp].len = len;
 PCan2SendBuff.buff[temp].type = ((uint32_t)0);
...
uint32_t PCan2_Expend_Tx_Bytes(uint32_t id,uint8_t * buffer,uint8_t len)
{
  ...
  PCan2SendBuff.buff[temp].Pcan1GetIndexFromID = id;
  PCan2SendBuff.buff[temp].len = len;
  PCan2SendBuff.buff[temp].type = ((uint32_t)1);
  PCan2SendBuff.buff[temp].sended = CANSENDED;
  PCan2SendBuff.wr_index += 1;
  return 1;
}
...
uint32_t PCan2SendFifo(void)
{
    ...
    temp = (PCan2SendBuff.wr_index - PCan2SendBuff.rd_index);
    if(temp < 1)
    {
        return 0;
    }
 ...
 PCan2domsg.Pcan1GetIndexFromID = PCan2SendBuff.buff[temp].Pcan1GetIndexFromID;
...
void PCan2SendTo(void)
{
   ...
   CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001980)),PCan2domsg.Pcan1GetIndexFromID,PCan2domsg.data,PCan2domsg.len,((uint32_t)0),PCan2domsg.type);
     }
     break;
     case CANDELAYING:
     if((CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)((uint32_t)1<<((19)))))))
     {
    __asm volatile("CLR [%0], #%1"::"r"(&(((CAN_SFRmap *) ((uint32_t)0x40001980))->CTLR)),"i"((8)));
     PCan2domsg.sended = CANSENDED;
     }
     break;
  default:
   ...
   if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)((uint32_t)1<<((23))))))
   {
    Pcan2Inint();
   }
}
