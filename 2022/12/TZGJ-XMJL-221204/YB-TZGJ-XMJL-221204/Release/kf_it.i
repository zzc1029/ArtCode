...
void __attribute__((interrupt))_CAN2_exception (void)
{
 uint8_t i;
 uint32_t id;
 static uint8_t Receice_addr = 0x00;
 static uint8_t bus_off_count = 0;
 CAN_MessageTypeDef CAN_MessageStructrue;

 INT_Clear_Interrupt_Flag(INT_CAN2);


 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<0)) != RESET)
 {

  CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001900)),Receice_addr,&CAN_MessageStructrue);

  Receice_addr += 0x10;

  CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001900)),1);
        bus_off_count = 0;
  if(CAN_MessageStructrue.m_RemoteTransmit != ((uint32_t)0))
  {
...
void __attribute__((interrupt))_CAN0_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<0)) != RESET)
 {

  CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001100)),Receice_addr,&CAN_MessageStructrue);

  Receice_addr+=0x10;

  CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001100)),1);
        bus_off_count = 0;
  if(CAN_MessageStructrue.m_RemoteTransmit != ((uint32_t)0))
  {
...
void __attribute__((interrupt))_CAN3_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<0)) != RESET)
 {

  CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001980)),Receice_addr,&CAN_MessageStructrue);

  Receice_addr+=0x10;

  CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001980)),1);
        bus_off_count = 0;
  if(CAN_MessageStructrue.m_RemoteTransmit != ((uint32_t)0))
  {
...
void __attribute__((interrupt))_CAN1_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<0)) != RESET)
 {

  CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40001180)),Receice_addr,&CAN_MessageStructrue);

  Receice_addr+=0x10;

  CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40001180)),1);
        bus_off_count = 0;
  if(CAN_MessageStructrue.m_RemoteTransmit != ((uint32_t)0))
  {
...
void __attribute__((interrupt))_CAN4_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)1<<7)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)1<<7));




          CAN_Reset(((CAN_SFRmap *) ((uint32_t)0x40002880)));
    Pcan3Inint();
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)1<<0)) != RESET)
 {

  CAN_Receive_Message_Configuration(((CAN_SFRmap *) ((uint32_t)0x40002880)),Receice_addr,&CAN_MessageStructrue);

  Receice_addr+=0x10;

  CAN_Release_Receive_Buffer(((CAN_SFRmap *) ((uint32_t)0x40002880)),1);
...
void __attribute__((interrupt))_T0_exception (void)
{
 ...
 GPTIM_Clear_Updata_INT_Flag(((GPTIM_SFRmap *) ((uint32_t)0x40000880)));
 GPTIM_Clear_Overflow_INT_Flag(((GPTIM_SFRmap *) ((uint32_t)0x40000880)));
 sch_update();
    if(rs485style.len > 0)
 {
...
{
 GPTIM_Clear_Updata_INT_Flag(((GPTIM_SFRmap *) ((uint32_t)0x40000180)));
 GPTIM_Clear_Overflow_INT_Flag(((GPTIM_SFRmap *) ((uint32_t)0x40000180)));
 SysTickPer1ms++;
...
{
  if(INT_Get_External_Flag(((uint32_t)14)) != RESET)
  {
   INT_External_Clear_Flag(((uint32_t)14));
   A5Count++;
  }
...
{
  if(INT_Get_External_Flag(((uint32_t)1)) != RESET)
  {
   INT_External_Clear_Flag(((uint32_t)1));
   A15Count++;
  }
