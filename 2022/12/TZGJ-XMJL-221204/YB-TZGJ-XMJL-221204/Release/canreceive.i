...
volatile uint8_t CanData[(sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0]))][8];
uint8_t timeout[(sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0]))];
...
{
 uint16_t i;
 for(i=0;i<((sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0])));i++)
 {
  if(PCan1IdTable[i] == id)
   return i;
 }
 return ((sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0])));
}
...
{
 if(index<((sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0]))))
 {
...
{
   volatile u32 id = 0;
   if(CAN_MessageStructrue.m_FrameFormat == ((uint32_t)1))
...
void ReceCan(uint32_t id,volatile uint8_t *data)
{
 ...
 switch(id)
 {
  ...
  case 0x18FEF433:
   ...
   taiya.yali[data[0]] = data[1];
   taiya.wendu[data[0]] = ((((uint16_t)data[2 +1])<<8)+data[2]);
  ...
  case 0x18FECA0B:
   abstime[0] = 0;
   ABS_DTC[0] = ((((uint32_t)data[5])<<24)+(((uint32_t)data[4])<<16)+(((uint32_t)data[3])<<8)+data[2]);
   ABS_DTC[1] = 0;
   ABS_DTC[2] = 0;
   ABS_DTC[3] = 0;
   break;
   ...
   abstime[1] = 0;
     if(data[0] == 1)
     {
     ABS_DTC[0] = ((((uint32_t)data[6])<<24)+(((uint32_t)data[5])<<16)+(((uint32_t)data[4])<<8)+data[3]);
     lastcode = data[7];
     }
     else if(data[0] == 2)
     {
      ABS_DTC[1] = ((((uint32_t)data[3])<<24)+(((uint32_t)data[2])<<16)+(((uint32_t)data[1])<<8)+lastcode);
      ABS_DTC[2] = ((((uint32_t)data[7])<<24)+(((uint32_t)data[6])<<16)+(((uint32_t)data[5])<<8)+data[4]);
     }
     else if(data[0] == 3)
     {
      ABS_DTC[3] = ((((uint32_t)data[4])<<24)+(((uint32_t)data[3])<<16)+(((uint32_t)data[2])<<8)+data[1]);
     }
     break;
   ...
   temp_u16 = ((((uint16_t)data[1])<<8)+data[0]);
   ...
   eng_speed = ((((uint16_t)data[3])<<8)+data[2]);
   if(eng_speed >= 15000)
 ...
 case 0x18FFF897:
  ...
  veh_soc = data[4];
  {
   if((((data[7]) & (1<<(2))) == 0))
   {
    uint16_t temp = ((((uint16_t)data[2 +1])<<8)+data[2]) + (32000-6000);
    i = Pcan1GetIndexFromID(0x18FFF897);
    if(i>=((sizeof(PCan1IdTable)/sizeof(PCan1IdTable[0]))))
     break;

    CanData[i][2] = ((uint8_t)(((temp)>>0)&0xFF));
    CanData[i][3] = ((uint8_t)(((temp)>>8)&0xFF));
   }
  }
...
# 499 "../driver/canreceive.c"
  ...
  case 0x181F051F:
   for(i=0;i<3;i++)
    PeiDianOutCur[data[0] * 3 + i] = ((((uint16_t)data[i*2 + 3])<<8)+data[i*2 + 2]);
   break;
  case 0x181F071F:
