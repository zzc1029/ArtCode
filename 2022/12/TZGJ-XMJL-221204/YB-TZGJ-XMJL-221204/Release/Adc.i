...
void AdcPortInit(void)
{
   ...
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0004),GPIO_MODE_AN);
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0008),GPIO_MODE_AN);
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0010),GPIO_MODE_AN);
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0002),GPIO_MODE_AN);
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0020),GPIO_MODE_AN);
   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0001),GPIO_MODE_AN);
}
...
void Init_adc(void)
{
 ...
 ADC_Reset (((ADC_SFRmap *) ((uint32_t)0x40000580)));


 adcStruct.m_Clock = ((uint32_t)1<<(1));



 adcStruct.m_ClockDiv = ((uint32_t)4<<(8));

 adcStruct.m_ScanMode = FALSE;

 adcStruct.m_ContinuousMode = ((uint32_t)0<<(18));

 adcStruct.m_DataAlign = ((uint32_t)1<<(3));

 adcStruct.m_ExternalTrig_EN = FALSE;

 adcStruct.m_ExternalTrig = ((uint32_t)0x28<<(4));

 adcStruct.m_HPExternalTrig_EN = FALSE;

 adcStruct.m_HPExternalTrig = ((uint32_t)0x0<<(20));

 adcStruct.m_VoltageRef=((uint32_t)1<<(17));

 adcStruct.m_NumOfConv = 1;

 adcStruct.m_NumOfHPConv = 1;
 ADC_Configuration (((ADC_SFRmap *) ((uint32_t)0x40000580)), &adcStruct);

 ADC_Cmd (((ADC_SFRmap *) ((uint32_t)0x40000580)), TRUE);
...
void AdcInit(void)
{
 ...
 ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000017), 0x01);
 ADC_Software_Start_Conv(((ADC_SFRmap *) ((uint32_t)0x40000580)));
...
void ReadAdcResult(void)
{
 while(!ADC_Get_INT_Flag(((ADC_SFRmap *) ((uint32_t)0x40000580)),((uint32_t)0x000C0B0D)));
 buf_16 = ADC_Get_Conversion_Value(((ADC_SFRmap *) ((uint32_t)0x40000580)));
    ...
    switch(flag)
    {
      ...
      meter.MeterA2 = buf_16*(3300/4096.0);
      meter.MeterA2 = (510/2*meter.MeterA2)/(5000 - meter.MeterA2);




   { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (meter.MeterA2); log[0] = (meter.MeterA2); filter_count ++; } else { if (filter_count < 16) { sum += (meter.MeterA2); log[filter_count] = (meter.MeterA2); meter.MeterA2 = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (meter.MeterA2); log[aver_count] = (meter.MeterA2); meter.MeterA2 = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000015), 0x01);
        flag = metera3;
        break;
   ...
   buf_16 = buf_16<<1;
   meter.MeterA3 = buf_16*(3300/4096.0);

   { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (meter.MeterA3); log[0] = (meter.MeterA3); filter_count ++; } else { if (filter_count < 16) { sum += (meter.MeterA3); log[filter_count] = (meter.MeterA3); meter.MeterA3 = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (meter.MeterA3); log[aver_count] = (meter.MeterA3); meter.MeterA3 = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
      ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000013), 0x01);
        flag = metera4;
        break;
   ...
   buf_16 = buf_16<<1;
   meter.MeterA4 = buf_16*(3300/4096.0);

   { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (meter.MeterA4); log[0] = (meter.MeterA4); filter_count ++; } else { if (filter_count < 16) { sum += (meter.MeterA4); log[filter_count] = (meter.MeterA4); meter.MeterA4 = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (meter.MeterA4); log[aver_count] = (meter.MeterA4); meter.MeterA4 = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000016), 0x01);
        flag = metera13;
        break;
   ...
   buf_16 = buf_16<<1;
   meter.MeterA13 = buf_16*(3300/4096.0);

   { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (meter.MeterA13); log[0] = (meter.MeterA13); filter_count ++; } else { if (filter_count < 16) { sum += (meter.MeterA13); log[filter_count] = (meter.MeterA13); meter.MeterA13 = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (meter.MeterA13); log[aver_count] = (meter.MeterA13); meter.MeterA13 = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000014), 0x01);
        flag = metera14;
        break;
   ...
   buf_16 = buf_16<<1;
   meter.MeterA14 = buf_16*(3300/4096.0);

   { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (meter.MeterA14); log[0] = (meter.MeterA14); filter_count ++; } else { if (filter_count < 16) { sum += (meter.MeterA14); log[filter_count] = (meter.MeterA14); meter.MeterA14 = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (meter.MeterA14); log[aver_count] = (meter.MeterA14); meter.MeterA14 = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000012), 0x01);
        flag = metervbat;
        break;

   case metervbat:
   Vbat= (buf_16*3300/4096.0);
   Vbat = Vbat*16*1.03;
   Vbat = Vbat/100;
      { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (Vbat); log[0] = (Vbat); filter_count ++; } else { if (filter_count < 16) { sum += (Vbat); log[filter_count] = (Vbat); Vbat = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (Vbat); log[aver_count] = (Vbat); Vbat = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };


        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x0000000A), 0x01);
        flag = meterE3E8;
        break;
   case meterE3E8:
        if(e3e8state == E3)
        {
     adc_100ma_fd[0] = buf_16*(3300/4096.0)/100;
     adc_100ma_fd[0] = (uint16_t)adc_100ma_fd[0] * 2250/1200;
        { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (adc_100ma_fd[0]); log[0] = (adc_100ma_fd[0]); filter_count ++; } else { if (filter_count < 16) { sum += (adc_100ma_fd[0]); log[filter_count] = (adc_100ma_fd[0]); adc_100ma_fd[0] = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (adc_100ma_fd[0]); log[aver_count] = (adc_100ma_fd[0]); adc_100ma_fd[0] = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
     e3e8state = E8;
        }
   else
   {
    adc_100ma_fd[3] = buf_16*(3300/4096.0)/100;
    adc_100ma_fd[3] = (uint16_t)adc_100ma_fd[3] * 2250/1200;
    { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (adc_100ma_fd[3]); log[0] = (adc_100ma_fd[3]); filter_count ++; } else { if (filter_count < 16) { sum += (adc_100ma_fd[3]); log[filter_count] = (adc_100ma_fd[3]); adc_100ma_fd[3] = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (adc_100ma_fd[3]); log[aver_count] = (adc_100ma_fd[3]); adc_100ma_fd[3] = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
    e3e8state = E3;
   }
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0200),e3e8state);;
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000004), 0x01);
        flag = meterE6E7;
       break;
   case meterE6E7:
        if(e6e7state == E6)
        {
     adc_100ma_fd[1] = buf_16*(3300/4096.0)/100;
     adc_100ma_fd[1] = (uint16_t)adc_100ma_fd[1] * 2250/1200;
        { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (adc_100ma_fd[1]); log[0] = (adc_100ma_fd[1]); filter_count ++; } else { if (filter_count < 16) { sum += (adc_100ma_fd[1]); log[filter_count] = (adc_100ma_fd[1]); adc_100ma_fd[1] = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (adc_100ma_fd[1]); log[aver_count] = (adc_100ma_fd[1]); adc_100ma_fd[1] = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
     e6e7state = E7;
        }
   else
   {
    adc_100ma_fd[2] = buf_16*(3300/4096.0)/100;
    adc_100ma_fd[2] = (uint16_t)adc_100ma_fd[2] * 2250/1200;
    { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (adc_100ma_fd[2]); log[0] = (adc_100ma_fd[2]); filter_count ++; } else { if (filter_count < 16) { sum += (adc_100ma_fd[2]); log[filter_count] = (adc_100ma_fd[2]); adc_100ma_fd[2] = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (adc_100ma_fd[2]); log[aver_count] = (adc_100ma_fd[2]); adc_100ma_fd[2] = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
    e6e7state = E6;
   }
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0100),e6e7state);;
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x0000000D), 0x01);
        flag = meterA16;
       break;
   case meterA16:
   adc_100ma_fd[4] = buf_16*(3300/4096.0);
   adc_100ma_fd[4] = (uint16_t)adc_100ma_fd[4] * 2250/1200;
      { static uint8_t aver_count = 0,filter_count = 0; static uint16_t log[16]; static uint32_t sum; if (filter_count == 0) { sum = (adc_100ma_fd[4]); log[0] = (adc_100ma_fd[4]); filter_count ++; } else { if (filter_count < 16) { sum += (adc_100ma_fd[4]); log[filter_count] = (adc_100ma_fd[4]); adc_100ma_fd[4] = sum / (filter_count + 1); filter_count ++; } else { sum = sum - log[aver_count]; sum += (adc_100ma_fd[4]); log[aver_count] = (adc_100ma_fd[4]); adc_100ma_fd[4] = sum / 16; aver_count++; if (aver_count > 15) { aver_count = 0; } } } };
        ADC_Regular_Channel_Config (((ADC_SFRmap *) ((uint32_t)0x40000580)), ((uint32_t)0x00000017), 0x01);
        flag = metera2;
       break;
 }
