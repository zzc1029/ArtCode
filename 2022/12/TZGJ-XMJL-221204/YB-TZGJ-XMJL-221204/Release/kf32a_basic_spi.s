...
// inline asm end
	MOV	r4,#16
.L97:
	.stabn	68,0,990,.LM243-.LFBB37
.LM243:
	LD.w	r5,[r0+#3]
	ANL	r5,r5,r4
	JNZ	.L97
	.stabn	68,0,991,.LM244-.LFBB37
.LM244:
// inline asm begin
	// 991 "../system/src/kf32a_basic_spi.c" 1
	CLR [r3], #16
	// 0 "" 2
	.stabn	68,0,992,.LM245-.LFBB37
.LM245:
// inline asm end
	JMP	lr
...
.Ltext62:
	.stabn	68,0,1001,.LM246-.LFBB38
.LM246:
.LFBB38:
	.stabn	68,0,1006,.LM247-.LFBB38
.LM247:
	MOV	r5,#12
	ADD	r3,r0,r5
// inline asm begin
	...
	SET [r3], #17
	// 0 "" 2
	.stabn	68,0,1007,.LM248-.LFBB38
.LM248:
// inline asm end
	MOV	r4,#32
.L100:
	.stabn	68,0,1007,.LM249-.LFBB38
.LM249:
	LD.w	r5,[r0+#3]
	ANL	r5,r5,r4
	JNZ	.L100
	.stabn	68,0,1008,.LM250-.LFBB38
.LM250:
// inline asm begin
	// 1008 "../system/src/kf32a_basic_spi.c" 1
	CLR [r3], #17
	// 0 "" 2
	.stabn	68,0,1009,.LM251-.LFBB38
.LM251:
// inline asm end
	JMP	lr
