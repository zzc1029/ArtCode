...
# 9 "../driver/eeprom.c" 2
# 17 "../driver/eeprom.c"
uint8_t Air_Alarm,Speed_Alarm,Oil_Alarm,Ranyou_Alarm,Air_Coef,Air2_Coef,Coef;
uint8_t Rain_Delay_Time,Fuel_Coef;
uint8_t backlight_level,Bus_Type;
uint16_t odometer_const,odometer_const_2012,Pulse;
...
uint8_t Set_buzz,Coef_2012,Oil_Alarm_2012;
...
uint32_t mileaddress = 0X0007B400;
...
uint32_t SaveVehodo(void)
{
    ...
    if(mileaddress >= (0X0007F400 - 16))
    {

     { INT_All_Enable (FALSE); FLASH_Wipe_Configuration_RAM (((uint32_t)0),0X0007F800); INT_All_Enable (TRUE);};

  WriteDlong(0X0007F800,Veh_odo,Veh_trip);
  EraseMile();
     mileaddress = 0X0007B400;
...
void EraseMile(void)
{
   uint32_t odoadd = 0X0007B400,i = 0,delay = 5000;
   for(i = 0;i < 16;i++)
   {
       delay = 5000;
       { INT_All_Enable (FALSE); FLASH_Wipe_Configuration_RAM (((uint32_t)0),odoadd); INT_All_Enable (TRUE);};
    odoadd = odoadd + 0x400;
    while(delay > 0)
     delay--;
   }
...
uint32_t ReadVehodo(void)
{
   ...
   miles = ReadAdd(0X0007F800);
   if(miles == 0XFFFFFFFF)
   {
      for(odoadd = 0X0007B400; odoadd < (0X0007F400 - 16);)
      {
         miles = 0;
...
uint32_t paraddress = 0X0007F400;

const EEPROMDataStru ConstInit =
{
 .Data.Switch.b0 = 1,
 .Data.Switch.b1 = 1,
 .Data.Switch.b2 = 1,
...
{
 MeterPara.Data.Switch.b0 = Art.bit.b3;
 MeterPara.Data.Switch.b1 = Art.bit.b4;
 MeterPara.Data.Switch.b2 = Art.bit.b5;
 MeterPara.Data.Switch.b3 = Art.bit.b6;
 MeterPara.Data.Switch.b4 = Art.bit.b7;
 MeterPara.Data.Switch.b5 = Art.bit.b2;
...
{
   SaveDataToMeter();
   if(paraddress >= (0X0007F800 - 64))
   {

  { INT_All_Enable (FALSE); FLASH_Wipe_Configuration_RAM (((uint32_t)0),0X0007FC00); INT_All_Enable (TRUE);};

  paraddress = 0X0007FC00;

     DownPara(paraddress);

  { INT_All_Enable (FALSE); FLASH_Wipe_Configuration_RAM (((uint32_t)0),0X0007F400); INT_All_Enable (TRUE);};

  paraddress = 0X0007F400;
...
{
    Art.bit.b3 = MeterPara.Data.Switch.b0;
 Art.bit.b4 = MeterPara.Data.Switch.b1;
 Art.bit.b5 = MeterPara.Data.Switch.b2;
 Art.bit.b6 = MeterPara.Data.Switch.b3;
 Art.bit.b7 = MeterPara.Data.Switch.b4;
    Art.bit.b2 = MeterPara.Data.Switch.b5;
 ...
 Oil_Alarm_2012 = MeterPara.Data.oil_alarm;
 Coef_2012 = MeterPara.Data.coef;
 odometer_const_2012 = MeterPara.Data.subi;
...
uint32_t ReadMeterPara(void)
{
   ...
   miles = ReadAdd(0X0007FC00);
   if(miles == 0XFFFFFFFF)
   {
      for(odoadd = 0X0007F400; odoadd < (0X0007F800 - 64);)
      {
         miles = 0;
         miles = ReadAdd(odoadd);
      if(miles == 0XFFFFFFFF)
