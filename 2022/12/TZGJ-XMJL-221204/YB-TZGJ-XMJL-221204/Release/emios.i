...
void buzz_init(void)
{
 ...
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)) ,((uint16_t)0x0080), GPIO_MODE_RMP);
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)), ((uint32_t)0x7), ((uint8_t)0x01));

 TIM_Reset(((CCP_SFRmap *) ((uint32_t)0x40000280)));

 CCP_PWM_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint16_t)3),((uint16_t)0xC));
 CCP_Channel_Output_Control(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint16_t)3),((uint32_t)0x0));
 CCP_Set_Compare_Result(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint16_t)3),1);

 GPTIM_Updata_Immediately_Config(((CCP_SFRmap *) ((uint32_t)0x40000280)),TRUE);
 GPTIM_Updata_Enable(((CCP_SFRmap *) ((uint32_t)0x40000280)),TRUE);
 GPTIM_Work_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint32_t)0 << (1)));
 GPTIM_Set_Counter(((CCP_SFRmap *) ((uint32_t)0x40000280)),0);
 GPTIM_Set_Period(((CCP_SFRmap *) ((uint32_t)0x40000280)),10000);
 GPTIM_Set_Prescaler(((CCP_SFRmap *) ((uint32_t)0x40000280)),12000);
 GPTIM_Counter_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint32_t)0x4 << (8)));

 GPTIM_Clock_Config(((CCP_SFRmap *) ((uint32_t)0x40000280)),((uint32_t)0x0 << (5)));
 GPTIM_Cmd(((CCP_SFRmap *) ((uint32_t)0x40000280)),TRUE);
}
# 55 "../driver/emios.c"
void CCPx_PWM_GPIO_Init(GPIO_SFRmap* GPIOx,uint16_t GpioPin,uint8_t PinRemap)
{
  static uint16_t GpioPinNum;

 GPIO_Write_Mode_Bits(GPIOx,GpioPin,GPIO_MODE_RMP);

 if(GpioPin==((uint16_t)0x0001))
 {
  GpioPinNum =((uint32_t)0x0);
 }else if(GpioPin==((uint16_t)0x0002))
 {
  GpioPinNum =((uint32_t)0x1);
 }else if(GpioPin==((uint16_t)0x0004))
 {
  GpioPinNum =((uint32_t)0x2);
 }else if(GpioPin==((uint16_t)0x0008))
 {
  GpioPinNum =((uint32_t)0x3);
 }else if(GpioPin==((uint16_t)0x0010))
 {
  GpioPinNum =((uint32_t)0x4);
 }else if(GpioPin==((uint16_t)0x0020))
 {
  GpioPinNum =((uint32_t)0x5);
 }else if(GpioPin==((uint16_t)0x0040))
 {
  GpioPinNum =((uint32_t)0x6);
 }else if(GpioPin==((uint16_t)0x0080))
 {
  GpioPinNum =((uint32_t)0x7);
 }else if(GpioPin==((uint16_t)0x0100))
 {
  GpioPinNum =((uint32_t)0x8);
 }else if(GpioPin==((uint16_t)0x0200))
 {
  GpioPinNum =((uint32_t)0x9);
 }else if(GpioPin==((uint16_t)0x0400))
 {
  GpioPinNum =((uint32_t)0xA);
 }else if(GpioPin==((uint16_t)0x0800))
 {
  GpioPinNum =((uint32_t)0xB);
 }else if(GpioPin==((uint16_t)0x1000))
 {
  GpioPinNum =((uint32_t)0xC);
 }else if(GpioPin==((uint16_t)0x2000))
 {
  GpioPinNum =((uint32_t)0xD);
 }else if(GpioPin==((uint16_t)0x4000))
 {
  GpioPinNum =((uint32_t)0xE);
 }else if(GpioPin==((uint16_t)0x8000))
 {
  GpioPinNum =((uint32_t)0xF);
 }

 GPIO_Pin_RMP_Config(GPIOx,GpioPinNum,PinRemap);
...
void CCPx_PWM_PPX_Duty(CCP_SFRmap* CCPx, uint32_t Channel,uint16_t Period,uint16_t Duty)
{
 ...
 CCP_PWM_Mode_Config(CCPx,Channel,((uint16_t)0xC));
 CCP_Channel_Output_Control(CCPx,Channel,((uint32_t)0x0));
 CCP_Set_Compare_Result(CCPx,Channel,Duty);
 GPTIM_Updata_Immediately_Config(CCPx,TRUE);
 GPTIM_Updata_Enable(CCPx,TRUE);
 GPTIM_Work_Mode_Config(CCPx,((uint32_t)0 << (1)));
 GPTIM_Set_Counter(CCPx,0);
 GPTIM_Set_Period(CCPx,Period);
 GPTIM_Set_Prescaler(CCPx,119);

  GPTIM_Counter_Mode_Config(CCPx,((uint32_t)0x4 << (8)));



 GPTIM_Clock_Config(CCPx,((uint32_t)0x0 << (5)));
 GPTIM_Cmd(CCPx,TRUE);
...
void PwmInit(void)
{
   CCPx_PWM_GPIO_Init(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0400),((uint8_t)0x04));
   CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40001A80)),((uint16_t)3),2000,0);
   PCLK_CTL0_Peripheral_Clock_Enable(((uint32_t)1<<((0x1))),TRUE);
   PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((5))),TRUE);


   CCPx_PWM_GPIO_Init(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0040),((uint8_t)0x01));
   PCLK_CTL0_Peripheral_Clock_Enable(((uint32_t)1<<((0x0))),TRUE);
   PCLK_CTL1_Peripheral_Clock_Enable(((uint32_t)1<<((4))),TRUE);
   CCPx_PWM_PPX_Duty_C3(((CCP_SFRmap *) ((uint32_t)0x40000200)),((uint16_t)1),0,0);
...
void SetBackGround(uint8_t level)
{
  ...
  if(level < 11)
  {
    ...
    if((backlight_level != ledgroundpre) || Art.bit.b49)
    {
      ledgroundpre = backlight_level;
     CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40001A80)),((uint16_t)3),2000,200*(backlight_level+1));
   Art.bit.b49 = 0;
    }
  }
...
void BACKGROUND_OFF(void)
{
 CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40001A80)),((uint16_t)3),0,0);
    Art.bit.b49 = 1;
}
...
void SetFreqOut(int freq)
{
 if(freq != 0)
 {
  ...
  CCPx_PWM_PPX_Duty_C3(((CCP_SFRmap *) ((uint32_t)0x40000200)),((uint16_t)1),50000/freq - 1,(50000/freq - 1)/2);
 }
 else
 {
...
void EXIT_INTx_Config(uint32_t EintNum,uint32_t PeripheralSource)
{
 ...
 EXIT_InitStructure.m_Line = EintNum;
 EXIT_InitStructure.m_Mask = TRUE;
 EXIT_InitStructure.m_Rise = TRUE;
 EXIT_InitStructure.m_Fall = FALSE;
 EXIT_InitStructure.m_Source = PeripheralSource;
 INT_External_Configuration(&EXIT_InitStructure);
 INT_External_Source_Enable(EintNum,PeripheralSource);


    if(EintNum==((uint32_t)0))
    {
     INT_Interrupt_Enable(INT_EINT0,TRUE);
    }else if(EintNum==((uint32_t)1))
    {
     INT_Interrupt_Enable(INT_EINT1,TRUE);
    }else if(EintNum==((uint32_t)2))
    {
     INT_Interrupt_Enable(INT_EINT2,TRUE);
    }else if(EintNum==((uint32_t)3))
    {
     INT_Interrupt_Enable(INT_EINT3,TRUE);
    }else if(EintNum==((uint32_t)4))
    {
     INT_Interrupt_Enable(INT_EINT4,TRUE);
    }else if((EintNum>=((uint32_t)5))&&(EintNum<=((uint32_t)9)))
    {
     INT_Interrupt_Enable(INT_EINT9TO5,TRUE);
    }else if((EintNum>=((uint32_t)10))&&(EintNum<=((uint32_t)15)))
    {
     INT_Interrupt_Enable(INT_EINT15TO10,TRUE);
    }
...
void CaptureModeInit(void)
{
 ...
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x4000));
 EXIT_INTx_Config(((uint32_t)14),((uint32_t)3));
    INT_Interrupt_Priority_Config(INT_EINT15TO10,((uint32_t)3<<((1))),7);

 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0002));
 EXIT_INTx_Config(((uint32_t)1),((uint32_t)2));
 INT_Interrupt_Priority_Config(INT_EINT1,((uint32_t)3<<((1))),7);
}
