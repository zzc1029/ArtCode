...
void get_date(void)
{
 ...
 rtc.secs = (((tmp_buff[0])&0x0F) + ((tmp_buff[0])>>4)*10);
    rtc.mins = (((tmp_buff[1])&0x0F) + ((tmp_buff[1])>>4)*10);
    rtc.hours = (((tmp_buff[2])&0x0F) + ((tmp_buff[2])>>4)*10);
    rtc.day = (((tmp_buff[3])&0x0F) + ((tmp_buff[3])>>4)*10);
    rtc.month = (((tmp_buff[4])&0x0F) + ((tmp_buff[4])>>4)*10);
    rtc.year = (((tmp_buff[5])&0x0F) + ((tmp_buff[5])>>4)*10);
}
...
void set_date(void)
{
 uint8_t tmp_buff[7];
    ...
    tmp_buff[0] = ((((rtc.secs)/10)<<4) + (rtc.secs)%10);
    tmp_buff[1] = ((((rtc.mins)/10)<<4) + (rtc.mins)%10);
    tmp_buff[2] = ((((rtc.hours)/10)<<4) + (rtc.hours)%10)|0x80;
    tmp_buff[3] = ((((rtc.day)/10)<<4) + (rtc.day)%10);
    tmp_buff[4] = ((((rtc.month)/10)<<4) + (rtc.month)%10);
    tmp_buff[5] = ((((rtc.year)/10)<<4) + (rtc.year)%10);
