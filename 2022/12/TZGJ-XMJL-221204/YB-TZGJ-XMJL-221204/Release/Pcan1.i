...
# 14 "../driver/Pcan1.c" 2
 ...
 static void xGPIO_Pcan1(void)
 {
  ...
  GPIO_InitStructure.m_Pin = ((uint16_t)0x0001)|((uint16_t)0x0002);
  ...
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint32_t)0x0),((uint8_t)0x09));
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint32_t)0x1),((uint8_t)0x09));
 }
# 42 "../driver/Pcan1.c"
 static void xINT_PCAN1(CAN_SFRmap* CANx)
 {
  ...
  INT_Interrupt_Priority_Config(INT_CAN2,((uint32_t)3<<((1))),2);
  INT_Clear_Interrupt_Flag(INT_CAN2);
  INT_Interrupt_Enable(INT_CAN2,TRUE);
 ...
 {
   xGPIO_Pcan1();
   xInit_CAN(((CAN_SFRmap *) ((uint32_t)0x40001900)),CAN_BAUDRATE_250K,((uint32_t)0<<(1)));
   xINT_PCAN1(((CAN_SFRmap *) ((uint32_t)0x40001900)));
 }


 SendToCan PCan1SendBuff;

 SendCanFifo PCan1Sendbuffx[((1<<(6)))];
 ...
 void InitPCan1Send(void)
 {
  Pcan1_fifo_init(&PCan1SendBuff,PCan1Sendbuffx,((1<<(6))));
 ...
 uint32_t PCan1_Standard_Tx_Bytes(uint16_t id,uint8_t * buffer,uint8_t len)
 {
  ...
  temp = (PCan1SendBuff.max_len - PCan1SendBuff.wr_index + PCan1SendBuff.rd_index);
  if(1 > temp)
  {
  ...
  PCan1SendBuff.buff[temp].Pcan1GetIndexFromID = id;
  PCan1SendBuff.buff[temp].len = len;
  PCan1SendBuff.buff[temp].type = ((uint32_t)0);
 ...
 uint32_t PCan1_Expend_Tx_Bytes(uint32_t id,uint8_t * buffer,uint8_t len)
 {
  ...
  PCan1SendBuff.buff[temp].Pcan1GetIndexFromID = id;
  PCan1SendBuff.buff[temp].len = len;
  PCan1SendBuff.buff[temp].type = ((uint32_t)1);
  PCan1SendBuff.buff[temp].sended = CANSENDED;
  PCan1SendBuff.wr_index += 1;
  return 1;
 }
 ...
 uint32_t PCan1SendFifo(void)
 {
  ...
  temp = (PCan1SendBuff.wr_index - PCan1SendBuff.rd_index);
  if(temp < 1)
  {
   return 0;
  }
  ...
  PCan1domsg.Pcan1GetIndexFromID = PCan1SendBuff.buff[temp].Pcan1GetIndexFromID;
 ...
 switch(PCan1domsg.sended)
 {
   case CANSENDED:
    ...
    CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001900)),PCan1domsg.Pcan1GetIndexFromID,PCan1domsg.data,PCan1domsg.len,((uint32_t)0),PCan1domsg.type);
     }
     break;
   case CANDELAYING:
     if((CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)((uint32_t)1<<((19)))))))
     {
      __asm volatile("CLR [%0], #%1"::"r"(&(((CAN_SFRmap *) ((uint32_t)0x40001900))->CTLR)),"i"((8)));
      PCan1domsg.sended = CANSENDED;
     }
     break;
   default:
    ...
    if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)((uint32_t)1<<((23))))))
    {
     Pcan1Inint();
    }
 }
