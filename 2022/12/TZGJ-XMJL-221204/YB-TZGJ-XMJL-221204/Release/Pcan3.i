...
static void xGPIO_Pcan3(void)
{
 ...
 GPIO_InitStructure.m_Pin = ((uint16_t)0x0020)|((uint16_t)0x0040);
 ...
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint32_t)0x5),((uint8_t)0x09));
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint32_t)0x6),((uint8_t)0x09));
}
# 38 "../driver/Pcan3.c"
static void xINT_PCAN3(CAN_SFRmap* CANx)
{
 ...
 INT_Interrupt_Priority_Config(INT_CAN4,((uint32_t)3<<((1))),1);
...
{
  xGPIO_Pcan3();
  xInit_CAN(((CAN_SFRmap *) ((uint32_t)0x40002880)),CAN_BAUDRATE_250K,((uint32_t)0<<(1)));
  xINT_PCAN3(((CAN_SFRmap *) ((uint32_t)0x40002880)));
}
...
SendCanFifo PCan3Sendbuffx[((1<<(6)))];
...
void InitPCan3Send(void)
{
    Pcan3_fifo_init(&PCan3SendBuff,PCan3Sendbuffx,((1<<(6))));
...
uint32_t PCan3_Standard_Tx_Bytes(uint16_t id,uint8_t * buffer,uint8_t len)
{
    ...
    temp = (PCan3SendBuff.max_len - PCan3SendBuff.wr_index + PCan3SendBuff.rd_index);
 if(1 > temp)
    {
 ...
 PCan3SendBuff.buff[temp].Pcan1GetIndexFromID = id;
 PCan3SendBuff.buff[temp].len = len;
 PCan3SendBuff.buff[temp].type = ((uint32_t)0);
...
uint32_t PCan3_Expend_Tx_Bytes(uint32_t id,uint8_t * buffer,uint8_t len)
{
 ...
 PCan3SendBuff.buff[temp].Pcan1GetIndexFromID = id;
 PCan3SendBuff.buff[temp].len = len;
 PCan3SendBuff.buff[temp].type = ((uint32_t)1);
 PCan3SendBuff.buff[temp].sended = CANSENDED;
 PCan3SendBuff.wr_index += 1;
 return 1;
...
uint32_t PCan3SendFifo(void)
{
    ...
    temp = (PCan3SendBuff.wr_index - PCan3SendBuff.rd_index);
    if(temp < 1)
    {
        return 0;
    }
 ...
 PCan3domsg.Pcan1GetIndexFromID = PCan3SendBuff.buff[temp].Pcan1GetIndexFromID;
...
void PCan3SendTo(void)
{
   ...
   CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40002880)),PCan3domsg.Pcan1GetIndexFromID,PCan3domsg.data,PCan3domsg.len,((uint32_t)0),PCan3domsg.type);
     }
     break;
     case CANDELAYING:
     if((CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)((uint32_t)1<<((19)))))))
     {
   __asm volatile("CLR [%0], #%1"::"r"(&(((CAN_SFRmap *) ((uint32_t)0x40002880))->CTLR)),"i"((8)));
     PCan3domsg.sended = CANSENDED;
     }
     break;
  default:
   ...
   if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40002880)),((uint32_t)((uint32_t)1<<((23))))))
   {
    Pcan3Inint();
   }
}
