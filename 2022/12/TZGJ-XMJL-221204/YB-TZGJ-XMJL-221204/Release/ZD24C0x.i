...
# 10 "../driver/ZD24C0x.c" 2
# 1 "../driver/ZD240Cx.h" 1
# 11 "../driver/ZD24C0x.c" 2
# 1 "../driver/Iic.h" 1
# 31 "../driver/Iic.h"
void iic_init(void);
...
# 12 "../driver/ZD24C0x.c" 2
 ...
 void ZD_iic_init(void)
 {
   GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000));;
   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0002));

   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0002), SET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000), SET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), SET);
 }

  void ZD_start(void)
  {
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0002), RESET);
 delay_(1);
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000), SET);
 delay_(1);
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), SET);
 delay_(1);
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000), RESET);
 delay_(1);

 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), RESET);
 delay_(1);
  }
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), SET);
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000),GPIO_MODE_IN,GPIO_NOPULL,GPIO_POD_OD);
 delay_(1);
 while((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000)) > 0) && (i < 255))
   i++;
  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), RESET);
 delay_(1);
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
 ...
 for(i = 0;i < 8; i++)
 {
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), SET);
   delay_(1);
   k = (k<<1)|GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000));
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x1000), RESET);
   delay_(1);
 }
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x500001C0)),((uint16_t)0x2000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
 return k;
  ...
  {
 ZD_start();
 ZD_write_byte(0XA0|(((address/256)&0x07) << 1));
 ZD_respons();
 ...
 ZD_respons();
 ZD_start();
 ZD_write_byte(0XA0 | (((address/256)&0x07) << 1) | 0x01);
 ZD_respons();
 date = ZD_read_byte();
 ZD_stop();
 return date;
