...
// inline asm end
	...
	LSL	r4,#24
.L62:
	.stabn	68,0,903,.LM232-.LFBB30
.LM232:
	LD.w	r5,[r3]
	ANL	r5,r5,r4
	JNZ	.L62
	.stabn	68,0,904,.LM233-.LFBB30
.LM233:
	LD	r5,#1073743888
// inline asm begin
...
.Ltext67:
	.stabn	68,0,913,.LM235-.LFBB31
.LM235:
.LFBB31:
	.stabn	68,0,915,.LM236-.LFBB31
.LM236:
	LD	r5,#1073743888
// inline asm begin
...
// inline asm end
	...
	LSL	r4,#25
.L65:
	.stabn	68,0,916,.LM238-.LFBB31
.LM238:
	LD.w	r5,[r3]
	ANL	r5,r5,r4
	JNZ	.L65
	.stabn	68,0,917,.LM239-.LFBB31
.LM239:
	LD	r5,#1073743888
// inline asm begin
...
.Ltext68:
	.stabn	68,0,926,.LM241-.LFBB32
.LM241:
.LFBB32:
	.stabn	68,0,928,.LM242-.LFBB32
.LM242:
	LD	r5,#1073743888
// inline asm begin
...
// inline asm end
	...
	LSL	r4,#26
.L68:
	.stabn	68,0,929,.LM244-.LFBB32
.LM244:
	LD.w	r5,[r3]
	ANL	r5,r5,r4
	JNZ	.L68
	.stabn	68,0,930,.LM245-.LFBB32
.LM245:
	LD	r5,#1073743888
// inline asm begin
...
.Ltext69:
	.stabn	68,0,939,.LM247-.LFBB33
.LM247:
.LFBB33:
	.stabn	68,0,941,.LM248-.LFBB33
.LM248:
	LD	r5,#1073743888
// inline asm begin
...
// inline asm end
	...
	LSL	r4,#27
.L71:
	.stabn	68,0,942,.LM250-.LFBB33
.LM250:
	LD.w	r5,[r3]
	ANL	r5,r5,r4
	JNZ	.L71
	.stabn	68,0,943,.LM251-.LFBB33
.LM251:
	LD	r5,#1073743888
// inline asm begin
...
.Ltext70:
	.stabn	68,0,953,.LM253-.LFBB34
.LM253:
.LFBB34:
	.stabn	68,0,960,.LM254-.LFBB34
.LM254:
	LD	r5,#1073743888
	.stabn	68,0,957,.LM255-.LFBB34
.LM255:
	CMP	r0,#0
	JNZ	.L76
	.stabn	68,0,965,.LM256-.LFBB34
.LM256:
// inline asm begin
	// 965 "../system/src/kf32a_basic_cmp.c" 1
	CLR [r5], #12
	// 0 "" 2
	.stabn	68,0,967,.LM257-.LFBB34
.LM257:
// inline asm end
	JMP	lr
.L76:
	.stabn	68,0,960,.LM258-.LFBB34
.LM258:
// inline asm begin
	// 960 "../system/src/kf32a_basic_cmp.c" 1
	SET [r5], #12
	// 0 "" 2
	.stabn	68,0,967,.LM259-.LFBB34
.LM259:
// inline asm end
	JMP	lr
...
.Ltext71:
	.stabn	68,0,970,.LM260-.LFBB35
.LM260:
.LFBB35:
	.stabn	68,0,977,.LM261-.LFBB35
.LM261:
	LD	r5,#1073743888
	.stabn	68,0,974,.LM262-.LFBB35
.LM262:
	CMP	r0,#0
	JNZ	.L80
	.stabn	68,0,982,.LM263-.LFBB35
.LM263:
// inline asm begin
	// 982 "../system/src/kf32a_basic_cmp.c" 1
	CLR [r5], #13
	// 0 "" 2
	.stabn	68,0,984,.LM264-.LFBB35
.LM264:
// inline asm end
	JMP	lr
.L80:
	.stabn	68,0,977,.LM265-.LFBB35
.LM265:
// inline asm begin
	// 977 "../system/src/kf32a_basic_cmp.c" 1
	SET [r5], #13
	// 0 "" 2
	.stabn	68,0,984,.LM266-.LFBB35
.LM266:
// inline asm end
	JMP	lr
...
.Ltext72:
	.stabn	68,0,987,.LM267-.LFBB36
.LM267:
.LFBB36:
	.stabn	68,0,994,.LM268-.LFBB36
.LM268:
	LD	r5,#1073743888
	.stabn	68,0,991,.LM269-.LFBB36
.LM269:
	CMP	r0,#0
	JNZ	.L84
	.stabn	68,0,999,.LM270-.LFBB36
.LM270:
// inline asm begin
	// 999 "../system/src/kf32a_basic_cmp.c" 1
	CLR [r5], #14
	// 0 "" 2
	.stabn	68,0,1001,.LM271-.LFBB36
.LM271:
// inline asm end
	JMP	lr
.L84:
	.stabn	68,0,994,.LM272-.LFBB36
.LM272:
// inline asm begin
	// 994 "../system/src/kf32a_basic_cmp.c" 1
	SET [r5], #14
	// 0 "" 2
	.stabn	68,0,1001,.LM273-.LFBB36
.LM273:
// inline asm end
	JMP	lr
...
.Ltext73:
	.stabn	68,0,1004,.LM274-.LFBB37
.LM274:
.LFBB37:
	.stabn	68,0,1011,.LM275-.LFBB37
.LM275:
	LD	r5,#1073743888
	.stabn	68,0,1008,.LM276-.LFBB37
.LM276:
	CMP	r0,#0
	JNZ	.L88
	.stabn	68,0,1016,.LM277-.LFBB37
.LM277:
// inline asm begin
	// 1016 "../system/src/kf32a_basic_cmp.c" 1
	CLR [r5], #15
	// 0 "" 2
	.stabn	68,0,1018,.LM278-.LFBB37
.LM278:
// inline asm end
	JMP	lr
.L88:
	.stabn	68,0,1011,.LM279-.LFBB37
.LM279:
// inline asm begin
	// 1011 "../system/src/kf32a_basic_cmp.c" 1
	SET [r5], #15
	// 0 "" 2
	.stabn	68,0,1018,.LM280-.LFBB37
.LM280:
// inline asm end
	JMP	lr
...
.Ltext74:
	.stabn	68,0,1031,.LM281-.LFBB38
.LM281:
.LFBB38:
	.stabn	68,0,1035,.LM282-.LFBB38
.LM282:
	LD	r5,#1073743888
	LD.w	r4,[r5]
.LBB80:
...
.Ltext76:
	.stabn	68,0,1035,.LM284-.LFBB38
.LM284:
	ST.w	[r5],r0
	.stabn	68,0,1038,.LM285-.LFBB38
.LM285:
	JMP	lr
...
.Ltext77:
	.stabn	68,0,1048,.LM286-.LFBB39
.LM286:
.LFBB39:
	.stabn	68,0,1052,.LM287-.LFBB39
.LM287:
	LD	r5,#1073743888
	LD.w	r4,[r5]
.LBB82:
...
.Ltext79:
	.stabn	68,0,1052,.LM289-.LFBB39
.LM289:
	ST.w	[r5],r0
	.stabn	68,0,1055,.LM290-.LFBB39
.LM290:
	JMP	lr
...
.Ltext80:
	.stabn	68,0,1063,.LM291-.LFBB40
.LM291:
.LFBB40:
	.stabn	68,0,1070,.LM292-.LFBB40
.LM292:
	LD	r5,#1073743888
	.stabn	68,0,1067,.LM293-.LFBB40
.LM293:
	CMP	r0,#0
	JNZ	.L94
	.stabn	68,0,1075,.LM294-.LFBB40
.LM294:
// inline asm begin
	// 1075 "../system/src/kf32a_basic_cmp.c" 1
	CLR [r5], #4
	// 0 "" 2
	.stabn	68,0,1077,.LM295-.LFBB40
.LM295:
// inline asm end
	JMP	lr
.L94:
	.stabn	68,0,1070,.LM296-.LFBB40
.LM296:
// inline asm begin
	// 1070 "../system/src/kf32a_basic_cmp.c" 1
	SET [r5], #4
	// 0 "" 2
	.stabn	68,0,1077,.LM297-.LFBB40
.LM297:
// inline asm end
	JMP	lr
...
.Ltext81:
	.stabn	68,0,1087,.LM298-.LFBB41
.LM298:
.LFBB41:
	.stabn	68,0,1091,.LM299-.LFBB41
.LM299:
	LD	r5,#1073743888
	LD.w	r4,[r5]
.LBB84:
...
.Ltext83:
	.stabn	68,0,1091,.LM301-.LFBB41
.LM301:
	ST.w	[r5],r0
	.stabn	68,0,1094,.LM302-.LFBB41
.LM302:
	JMP	lr
