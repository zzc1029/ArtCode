...
{
  GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0010));
  GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0020));

  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0010), RESET);
  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0020), RESET);
...
void USART_Async_config(USART_SFRmap *USARTx)
{
 ...
 USART_Struct_Init(&USART_InitStructure);
    ...
    USART_InitStructure.m_BaudRateBRCKS = ((uint32_t)0<<(1));
# 70 "../driver/RS485.c"
    USART_InitStructure.m_BaudRateInteger=781;
...
void ConfigRS485(USART_SFRmap *USARTx)
{
 ...
 GPIO_InitStructure.m_Pin = ((uint16_t)0x0040);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x50000040)),&GPIO_InitStructure);
 ...
 GPIO_InitStructure.m_OpenDrain = GPIO_POD_PP;
 GPIO_InitStructure.m_Pin = ((uint16_t)0x0080);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x50000040)),&GPIO_InitStructure);



 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint32_t)0x6), ((uint8_t)0x05));
 GPIO_Pin_RMP_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint32_t)0x7), ((uint8_t)0x05));
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint16_t)0x0040), TRUE);
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x500001C0)) ,((uint16_t)0x0080), TRUE);
 ...
 USART_Async_config(((USART_SFRmap *) ((uint32_t)0x40000980)));

 USART_ReceiveInt_config(((USART_SFRmap *) ((uint32_t)0x40000980)),INT_USART0);

    INT_Interrupt_Priority_Config(INT_USART0,((uint32_t)3<<((1))),6);
}
# 159 "../driver/RS485.c"
...
void UartSend(uint8_t *pBuf, uint32_t cnt)
{
    GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0010), SET); GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0020), SET);;
 USART_Send(((USART_SFRmap *) ((uint32_t)0x40000980)),pBuf,cnt);
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0010), RESET); GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0020), RESET);;
}
...
void __attribute__((interrupt))_USART0_exception (void)
{
 ...
 if(USART_Get_Receive_BUFR_Ready_Flag(((USART_SFRmap *) ((uint32_t)0x40000980))))
 {
     if(rs485style.len < 1<<6)
     {
        if(rs485style.len == 0)
        {
              rs485style.timeout = 0;
     }
     rs485style.data[rs485style.len++] = USART_ReceiveData(((USART_SFRmap *) ((uint32_t)0x40000980)));
     }
 }
}
