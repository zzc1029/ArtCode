...
.LBB32:
.LBB33:
	.stabs	"D:/ARTStanHome/Desktop/TZGJ-XMJL-221204/YB-TZGJ-XMJL-221204/system/inc/KF32A_BASIC.h",132,0,0,.Ltext30
.Ltext30:
...
// inline asm end
	...
	LSL	r4,#10
.L57:
	.stabn	68,0,777,.LM167-.LFBB28
.LM167:
	LD.w	r5,[r0]
	ANL	r5,r5,r4
	JNZ	.L57
	.stabn	68,0,778,.LM168-.LFBB28
.LM168:
// inline asm begin
	// 778 "../system/src/kf32a_basic_qei.c" 1
	CLR [r3], #5
	// 0 "" 2
	.stabn	68,0,779,.LM169-.LFBB28
.LM169:
// inline asm end
	JMP	lr
...
.Ltext47:
	.stabn	68,0,788,.LM170-.LFBB29
.LM170:
.LFBB29:
	.stabn	68,0,793,.LM171-.LFBB29
.LM171:
	MOV	r5,#20
	ADD	r3,r0,r5
// inline asm begin
	...
	SET [r3], #4
	// 0 "" 2
	.stabn	68,0,794,.LM172-.LFBB29
.LM172:
// inline asm end
	MOV	r4,#1
	LSL	r4,#9
.L60:
	.stabn	68,0,794,.LM173-.LFBB29
.LM173:
	LD.w	r5,[r0]
	ANL	r5,r5,r4
	JNZ	.L60
	.stabn	68,0,795,.LM174-.LFBB29
.LM174:
// inline asm begin
	// 795 "../system/src/kf32a_basic_qei.c" 1
	CLR [r3], #4
	// 0 "" 2
	.stabn	68,0,796,.LM175-.LFBB29
.LM175:
// inline asm end
	JMP	lr
...
.Ltext48:
	.stabn	68,0,805,.LM176-.LFBB30
.LM176:
.LFBB30:
	.stabn	68,0,810,.LM177-.LFBB30
.LM177:
	MOV	r5,#20
	ADD	r3,r0,r5
// inline asm begin
	...
	SET [r3], #3
	// 0 "" 2
	.stabn	68,0,811,.LM178-.LFBB30
.LM178:
// inline asm end
	MOV	r4,#255
	ADD	r4,r4,#1
.L63:
	.stabn	68,0,811,.LM179-.LFBB30
.LM179:
	LD.w	r5,[r0]
	ANL	r5,r5,r4
	JNZ	.L63
	.stabn	68,0,812,.LM180-.LFBB30
.LM180:
// inline asm begin
	// 812 "../system/src/kf32a_basic_qei.c" 1
	CLR [r3], #3
	// 0 "" 2
	.stabn	68,0,813,.LM181-.LFBB30
.LM181:
// inline asm end
	JMP	lr
...
.Ltext49:
	.stabn	68,0,823,.LM182-.LFBB31
.LM182:
.LFBB31:
	.stabn	68,0,832,.LM183-.LFBB31
.LM183:
	ADD	r0,#20
	.stabn	68,0,829,.LM184-.LFBB31
.LM184:
	CMP	r1,#0
	JNZ	.L68
	.stabn	68,0,837,.LM185-.LFBB31
.LM185:
// inline asm begin
	// 837 "../system/src/kf32a_basic_qei.c" 1
	CLR [r0], #2
	// 0 "" 2
	.stabn	68,0,839,.LM186-.LFBB31
.LM186:
// inline asm end
	JMP	lr
.L68:
	.stabn	68,0,832,.LM187-.LFBB31
.LM187:
// inline asm begin
	// 832 "../system/src/kf32a_basic_qei.c" 1
	SET [r0], #2
	// 0 "" 2
	.stabn	68,0,839,.LM188-.LFBB31
.LM188:
// inline asm end
	JMP	lr
...
.Ltext50:
	.stabn	68,0,849,.LM189-.LFBB32
.LM189:
.LFBB32:
	.stabn	68,0,858,.LM190-.LFBB32
.LM190:
	ADD	r0,#20
	.stabn	68,0,855,.LM191-.LFBB32
.LM191:
	CMP	r1,#0
	JNZ	.L72
	.stabn	68,0,863,.LM192-.LFBB32
.LM192:
// inline asm begin
	// 863 "../system/src/kf32a_basic_qei.c" 1
	CLR [r0], #1
	// 0 "" 2
	.stabn	68,0,865,.LM193-.LFBB32
.LM193:
// inline asm end
	JMP	lr
.L72:
	.stabn	68,0,858,.LM194-.LFBB32
.LM194:
// inline asm begin
	// 858 "../system/src/kf32a_basic_qei.c" 1
	SET [r0], #1
	// 0 "" 2
	.stabn	68,0,865,.LM195-.LFBB32
.LM195:
// inline asm end
	JMP	lr
...
.Ltext51:
	.stabn	68,0,875,.LM196-.LFBB33
.LM196:
.LFBB33:
	.stabn	68,0,884,.LM197-.LFBB33
.LM197:
	ADD	r0,#20
	.stabn	68,0,881,.LM198-.LFBB33
.LM198:
	CMP	r1,#0
	JNZ	.L76
	.stabn	68,0,889,.LM199-.LFBB33
.LM199:
// inline asm begin
	// 889 "../system/src/kf32a_basic_qei.c" 1
	CLR [r0], #0
	// 0 "" 2
	.stabn	68,0,891,.LM200-.LFBB33
.LM200:
// inline asm end
	JMP	lr
.L76:
	.stabn	68,0,884,.LM201-.LFBB33
.LM201:
// inline asm begin
	// 884 "../system/src/kf32a_basic_qei.c" 1
	SET [r0], #0
	// 0 "" 2
	.stabn	68,0,891,.LM202-.LFBB33
.LM202:
// inline asm end
	JMP	lr
