...
# 22 "../driver/output.c" 2

uint16_t adc_100ma_fd[5];
SW_DIAGNOSE_PW sw_diagnose[5/2];

TYPE_BYTE output_s;
OP_Protect_PW op_protection[5];
uint16_t short_out[5]={0};
uint8_t feed_buff[5/2] = {0, 0};


uint16_t modle_protect[5] = {40,40,40,40,40};

void OutPowerInit(void)
{


   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040));

   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0008));

   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0004));

   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0080));

   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x1000));

   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040),RESET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0008),RESET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0004),RESET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0080),RESET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x1000),RESET);




   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0200));

   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0100));




   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0400),GPIO_MODE_AN);

   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0010),GPIO_MODE_AN);



   GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x2000),GPIO_MODE_AN);
}
...
void OpenPower(uint8_t i,BitAction res)
{
   ...
   {
     case 0:
       GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040),res);
      break;
  case 1:
      GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0008),res);
      break;
  case 2:
      GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0004),res);
       break;
  case 3:
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0080),res);
     break;
  case 4:
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x1000),res);
     break;
  default:
     break;
   }
...
void feedback_diag(void)
{
  ...
  value= 0;
        ...
        {
           case 0:
           value = GPIO_Read_Output_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0040));
           break;
           case 1:
           value = GPIO_Read_Output_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0008));
           break;
           case 2:
           value = GPIO_Read_Output_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0004));
           break;
           case 3:
           value = GPIO_Read_Output_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000180)),((uint16_t)0x0080));
           break;
           case 4:
           value = GPIO_Read_Output_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x1000));
           break;
  }
        if(value)
        {
