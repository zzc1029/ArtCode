...
// inline asm end
	MOV	r4,#4
.L123:
	.stabn	68,0,1232,.LM289-.LFBB41
.LM289:
	LD.w	r5,[r0+#6]
	ANL	r5,r5,r4
	JNZ	.L123
	.stabn	68,0,1233,.LM290-.LFBB41
.LM290:
// inline asm begin
	// 1233 "../system/src/kf32a_basic_btim.c" 1
	CLR [r3], #2
	// 0 "" 2
	.stabn	68,0,1234,.LM291-.LFBB41
.LM291:
// inline asm end
	JMP	lr
...
.Ltext56:
	.stabn	68,0,1243,.LM292-.LFBB42
.LM292:
.LFBB42:
	.stabn	68,0,1248,.LM293-.LFBB42
.LM293:
	MOV	r5,#28
	ADD	r3,r0,r5
// inline asm begin
	...
	SET [r3], #1
	// 0 "" 2
	.stabn	68,0,1249,.LM294-.LFBB42
.LM294:
// inline asm end
	MOV	r4,#2
.L126:
	.stabn	68,0,1249,.LM295-.LFBB42
.LM295:
	LD.w	r5,[r0+#6]
	ANL	r5,r5,r4
	JNZ	.L126
	.stabn	68,0,1250,.LM296-.LFBB42
.LM296:
// inline asm begin
	// 1250 "../system/src/kf32a_basic_btim.c" 1
	CLR [r3], #1
	// 0 "" 2
	.stabn	68,0,1251,.LM297-.LFBB42
.LM297:
// inline asm end
	JMP	lr
...
.Ltext57:
	.stabn	68,0,1261,.LM298-.LFBB43
.LM298:
.LFBB43:
	.stabn	68,0,1266,.LM299-.LFBB43
.LM299:
	MOV	r5,#28
	ADD	r3,r0,r5
// inline asm begin
	...
	SET [r3], #0
	// 0 "" 2
	.stabn	68,0,1267,.LM300-.LFBB43
.LM300:
// inline asm end
	MOV	r4,#1
.L129:
	.stabn	68,0,1267,.LM301-.LFBB43
.LM301:
	LD.w	r5,[r0+#6]
	ANL	r5,r5,r4
	JNZ	.L129
	.stabn	68,0,1268,.LM302-.LFBB43
.LM302:
// inline asm begin
	// 1268 "../system/src/kf32a_basic_btim.c" 1
	CLR [r3], #0
	// 0 "" 2
	.stabn	68,0,1269,.LM303-.LFBB43
.LM303:
// inline asm end
	JMP	lr
