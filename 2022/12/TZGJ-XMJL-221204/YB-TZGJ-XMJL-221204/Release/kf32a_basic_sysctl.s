...
.Ltext0:
	...
	.stabs	"D:/ARTStanHome/Desktop/TZGJ-XMJL-221204/YB-TZGJ-XMJL-221204/system/inc/kf32a_basic_sysctl.h",130,0,0,0
...
SYSCTL_Get_V_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext1
.Ltext1:
...
SYSCTL_Get_C_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,53,.LM3-.LFBB2
.LM3:
.LFBB2:
...
SYSCTL_Get_Z_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,74,.LM6-.LFBB3
.LM6:
.LFBB3:
	.stabn	68,0,76,.LM7-.LFBB3
.LM7:
	LD	r5,#1075839152
	LD.w	r0,[r5]
	LSR	r0,#30
	.stabn	68,0,86,.LM8-.LFBB3
.LM8:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
SYSCTL_Get_N_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,95,.LM9-.LFBB4
.LM9:
.LFBB4:
	.stabn	68,0,97,.LM10-.LFBB4
.LM10:
	LD	r5,#1075839152
	LD.w	r0,[r5]
	.stabn	68,0,107,.LM11-.LFBB4
.LM11:
	LSR	r0,#31
	JMP	lr
...
.Lscope4:
	...
	.stabs	"NewState:P(2,2)",64,0,116,0
	.export	SYSCTL_Set_V_Flag
	.type	SYSCTL_Set_V_Flag, @function
SYSCTL_Set_V_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,117,.LM12-.LFBB5
.LM12:
.LFBB5:
	.stabn	68,0,125,.LM13-.LFBB5
.LM13:
	LD	r5,#1075839152
	.stabn	68,0,122,.LM14-.LFBB5
.LM14:
	CMP	r0,#0
	JNZ	.L9
	.stabn	68,0,130,.LM15-.LFBB5
.LM15:
// inline asm begin
	// 130 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #28
	// 0 "" 2
	.stabn	68,0,132,.LM16-.LFBB5
.LM16:
// inline asm end
	JMP	lr
.L9:
	.stabn	68,0,125,.LM17-.LFBB5
.LM17:
// inline asm begin
	// 125 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #28
	// 0 "" 2
	.stabn	68,0,132,.LM18-.LFBB5
.LM18:
// inline asm end
	JMP	lr
...
.Lscope5:
	...
	.stabs	"NewState:P(2,2)",64,0,141,0
	.export	SYSCTL_Set_C_Flag
	.type	SYSCTL_Set_C_Flag, @function
SYSCTL_Set_C_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,142,.LM19-.LFBB6
.LM19:
.LFBB6:
	.stabn	68,0,150,.LM20-.LFBB6
.LM20:
	LD	r5,#1075839152
	.stabn	68,0,147,.LM21-.LFBB6
.LM21:
	CMP	r0,#0
	JNZ	.L13
	.stabn	68,0,155,.LM22-.LFBB6
.LM22:
// inline asm begin
	// 155 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #29
	// 0 "" 2
	.stabn	68,0,157,.LM23-.LFBB6
.LM23:
// inline asm end
	JMP	lr
.L13:
	.stabn	68,0,150,.LM24-.LFBB6
.LM24:
// inline asm begin
	// 150 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #29
	// 0 "" 2
	.stabn	68,0,157,.LM25-.LFBB6
.LM25:
// inline asm end
	JMP	lr
...
.Lscope6:
	...
	.stabs	"NewState:P(2,2)",64,0,166,0
	.export	SYSCTL_Set_Z_Flag
	.type	SYSCTL_Set_Z_Flag, @function
SYSCTL_Set_Z_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,167,.LM26-.LFBB7
.LM26:
.LFBB7:
	.stabn	68,0,175,.LM27-.LFBB7
.LM27:
	LD	r5,#1075839152
	.stabn	68,0,172,.LM28-.LFBB7
.LM28:
	CMP	r0,#0
	JNZ	.L17
	.stabn	68,0,180,.LM29-.LFBB7
.LM29:
// inline asm begin
	// 180 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #30
	// 0 "" 2
	.stabn	68,0,182,.LM30-.LFBB7
.LM30:
// inline asm end
	JMP	lr
.L17:
	.stabn	68,0,175,.LM31-.LFBB7
.LM31:
// inline asm begin
	// 175 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #30
	// 0 "" 2
	.stabn	68,0,182,.LM32-.LFBB7
.LM32:
// inline asm end
	JMP	lr
...
.Lscope7:
	...
	.stabs	"NewState:P(2,2)",64,0,190,0
	.export	SYSCTL_Set_N_Flag
	.type	SYSCTL_Set_N_Flag, @function
SYSCTL_Set_N_Flag:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,191,.LM33-.LFBB8
.LM33:
.LFBB8:
	.stabn	68,0,199,.LM34-.LFBB8
.LM34:
	LD	r5,#1075839152
	.stabn	68,0,196,.LM35-.LFBB8
.LM35:
	CMP	r0,#0
	JNZ	.L21
	.stabn	68,0,204,.LM36-.LFBB8
.LM36:
// inline asm begin
	// 204 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #31
	// 0 "" 2
	.stabn	68,0,206,.LM37-.LFBB8
.LM37:
// inline asm end
	JMP	lr
.L21:
	.stabn	68,0,199,.LM38-.LFBB8
.LM38:
// inline asm begin
	// 199 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #31
	// 0 "" 2
	.stabn	68,0,206,.LM39-.LFBB8
.LM39:
// inline asm end
	JMP	lr
...
.Lscope8:
	...
	.stabs	"NewState:P(2,2)",64,0,214,0
	.export	SYSCTL_Sleep_On_Exit_Enable
	.type	SYSCTL_Sleep_On_Exit_Enable, @function
SYSCTL_Sleep_On_Exit_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,215,.LM40-.LFBB9
.LM40:
.LFBB9:
	.stabn	68,0,223,.LM41-.LFBB9
.LM41:
	LD	r5,#1075839156
	.stabn	68,0,220,.LM42-.LFBB9
.LM42:
	CMP	r0,#0
	JNZ	.L25
	.stabn	68,0,228,.LM43-.LFBB9
.LM43:
// inline asm begin
	// 228 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #1
	// 0 "" 2
	.stabn	68,0,230,.LM44-.LFBB9
.LM44:
// inline asm end
	JMP	lr
.L25:
	.stabn	68,0,223,.LM45-.LFBB9
.LM45:
// inline asm begin
	// 223 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #1
	// 0 "" 2
	.stabn	68,0,230,.LM46-.LFBB9
.LM46:
// inline asm end
	JMP	lr
...
.Lscope9:
	...
	.text$SYSCTL_Deep_Sleep_Enable$scode_loacal_10:
	.align	1
	.stabs	"SYSCTL_Deep_Sleep_Enable:F(0,15)",36,0,238,SYSCTL_Deep_Sleep_Enable
	.stabs	"NewState:P(2,2)",64,0,238,0
	.export	SYSCTL_Deep_Sleep_Enable
	.type	SYSCTL_Deep_Sleep_Enable, @function
SYSCTL_Deep_Sleep_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,239,.LM47-.LFBB10
.LM47:
.LFBB10:
	.stabn	68,0,247,.LM48-.LFBB10
.LM48:
	LD	r5,#1075839156
	.stabn	68,0,244,.LM49-.LFBB10
.LM49:
	CMP	r0,#0
	JNZ	.L29
	.stabn	68,0,252,.LM50-.LFBB10
.LM50:
// inline asm begin
	// 252 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #2
	// 0 "" 2
	.stabn	68,0,254,.LM51-.LFBB10
.LM51:
// inline asm end
	JMP	lr
.L29:
	.stabn	68,0,247,.LM52-.LFBB10
.LM52:
// inline asm begin
	// 247 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #2
	// 0 "" 2
	.stabn	68,0,254,.LM53-.LFBB10
.LM53:
// inline asm end
	JMP	lr
...
.Lscope10:
	...
	.text$SYSCTL_Interrupt_Awake_Enable$scode_loacal_11:
	.align	1
	.stabs	"SYSCTL_Interrupt_Awake_Enable:F(0,15)",36,0,262,SYSCTL_Interrupt_Awake_Enable
	.stabs	"NewState:P(2,2)",64,0,262,0
	.export	SYSCTL_Interrupt_Awake_Enable
	.type	SYSCTL_Interrupt_Awake_Enable, @function
SYSCTL_Interrupt_Awake_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,263,.LM54-.LFBB11
.LM54:
.LFBB11:
	.stabn	68,0,271,.LM55-.LFBB11
.LM55:
	LD	r5,#1075839156
	.stabn	68,0,268,.LM56-.LFBB11
.LM56:
	CMP	r0,#0
	JNZ	.L33
	.stabn	68,0,276,.LM57-.LFBB11
.LM57:
// inline asm begin
	// 276 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #4
	// 0 "" 2
	.stabn	68,0,278,.LM58-.LFBB11
.LM58:
// inline asm end
	JMP	lr
.L33:
	.stabn	68,0,271,.LM59-.LFBB11
.LM59:
// inline asm begin
	// 271 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #4
	// 0 "" 2
	.stabn	68,0,278,.LM60-.LFBB11
.LM60:
// inline asm end
	JMP	lr
...
.Lscope11:
	...
	.text$SYSCTL_Stack_Align_State$scode_loacal_12:
	.align	1
...
SYSCTL_Stack_Align_State:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,287,.LM61-.LFBB12
.LM61:
.LFBB12:
	.stabn	68,0,289,.LM62-.LFBB12
.LM62:
	LD	r5,#1075839152
	LD.w	r0,[r5+#1]
	LSR	r0,#9
	.stabn	68,0,299,.LM63-.LFBB12
.LM63:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope12:
	...
	.text$SYSCTL_Super_User_Config$scode_loacal_13:
	.align	1
	.stabs	"SYSCTL_Super_User_Config:F(0,15)",36,0,307,SYSCTL_Super_User_Config
	.stabs	"NewState:P(2,2)",64,0,307,0
	.export	SYSCTL_Super_User_Config
	.type	SYSCTL_Super_User_Config, @function
SYSCTL_Super_User_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,308,.LM64-.LFBB13
.LM64:
.LFBB13:
	.stabn	68,0,316,.LM65-.LFBB13
.LM65:
	LD	r5,#1075839156
	.stabn	68,0,313,.LM66-.LFBB13
.LM66:
	CMP	r0,#0
	JNZ	.L38
	.stabn	68,0,321,.LM67-.LFBB13
.LM67:
// inline asm begin
	// 321 "../system/src/kf32a_basic_sysctl.c" 1
	CLR [r5], #15
	// 0 "" 2
	.stabn	68,0,323,.LM68-.LFBB13
.LM68:
// inline asm end
	JMP	lr
.L38:
	.stabn	68,0,316,.LM69-.LFBB13
.LM69:
// inline asm begin
	// 316 "../system/src/kf32a_basic_sysctl.c" 1
	SET [r5], #15
	// 0 "" 2
	.stabn	68,0,323,.LM70-.LFBB13
.LM70:
// inline asm end
	JMP	lr
...
.Lscope13:
	...
	.text$SYSCTL_Stack_Pointer_State$scode_loacal_14:
	.align	1
...
SYSCTL_Stack_Pointer_State:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,332,.LM71-.LFBB14
.LM71:
.LFBB14:
	.stabn	68,0,334,.LM72-.LFBB14
.LM72:
	LD	r5,#1075839152
	LD.w	r0,[r5+#1]
	LSR	r0,#16
	.stabn	68,0,344,.LM73-.LFBB14
.LM73:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope14:
	...
	.text$SYSCTL_Stack_Pointer_Config$scode_loacal_15:
	.align	1
	.stabs	"SYSCTL_Stack_Pointer_Config:F(0,15)",36,0,354,SYSCTL_Stack_Pointer_Config
	.stabs	"PresentSP:P(3,6)",64,0,354,0
	.export	SYSCTL_Stack_Pointer_Config
	.type	SYSCTL_Stack_Pointer_Config, @function
SYSCTL_Stack_Pointer_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,355,.LM74-.LFBB15
.LM74:
.LFBB15:
	.stabn	68,0,360,.LM75-.LFBB15
.LM75:
	LD	r5,#1075839152
	LD.w	r4,[r5+#1]
.LBB14:
...
.Ltext16:
	.stabn	68,0,14361,.LM76-.LFBB15
.LM76:
	CLR	r4,#16
	ORL	r0,r0,r4
.LBE15:
.LBE14:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,360,.LM77-.LFBB15
.LM77:
	ST.w	[r5+#1],r0
	.stabn	68,0,361,.LM78-.LFBB15
.LM78:
	JMP	lr
...
.Ltext19:
	.stabn	68,0,14361,.LM81-.LFBB16
.LM81:
	LD	r4,#65533
	ANL	r4,r3,r4
.LBE17:
.LBE16:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,377,.LM82-.LFBB16
.LM82:
	LD	r3,#100270080
	ORL	r4,r4,r3
	.stabn	68,0,378,.LM83-.LFBB16
.LM83:
	ADD	r0,r0,r0
.LBB19:
.LBB18:
...
.Ltext21:
	.stabn	68,0,14361,.LM84-.LFBB16
.LM84:
	ORL	r4,r4,r0
.LBE18:
.LBE19:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext22
.Ltext22:
	.stabn	68,0,379,.LM85-.LFBB16
.LM85:
	ST.w	[r5+#2],r4
	.stabn	68,0,382,.LM86-.LFBB16
.LM86:
	JMP	lr
...
.Lscope16:
	...
	.text$SYSCTL_System_Reset_Enable$scode_loacal_17:
	.align	1
	.stabs	"SYSCTL_System_Reset_Enable:F(0,15)",36,0,390,SYSCTL_System_Reset_Enable
	.stabs	"NewState:P(2,2)",64,0,390,0
	.export	SYSCTL_System_Reset_Enable
	.type	SYSCTL_System_Reset_Enable, @function
SYSCTL_System_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext23
.Ltext23:
	.stabn	68,0,391,.LM87-.LFBB17
.LM87:
.LFBB17:
	.stabn	68,0,400,.LM88-.LFBB17
.LM88:
	LD	r5,#1075839152
	LD.w	r3,[r5+#2]
.LBB20:
...
.Ltext24:
	.stabn	68,0,14361,.LM89-.LFBB17
.LM89:
	LD	r4,#65531
	ANL	r4,r3,r4
.LBE21:
.LBE20:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext25
.Ltext25:
	.stabn	68,0,398,.LM90-.LFBB17
.LM90:
	LD	r3,#100270080
	ORL	r4,r4,r3
	.stabn	68,0,399,.LM91-.LFBB17
.LM91:
	LSL	r0,#2
.LBB23:
.LBB22:
...
.Ltext26:
	.stabn	68,0,14361,.LM92-.LFBB17
.LM92:
	ORL	r4,r4,r0
.LBE22:
.LBE23:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext27
.Ltext27:
	.stabn	68,0,400,.LM93-.LFBB17
.LM93:
	ST.w	[r5+#2],r4
...
.Lscope17:
	...
	.text$SYSCTL_Vector_Offset_Config$scode_loacal_18:
	.align	1
	.stabs	"SYSCTL_Vector_Offset_Config:F(0,15)",36,0,411,SYSCTL_Vector_Offset_Config
	.stabs	"VectorOffset:P(3,6)",64,0,411,0
	.export	SYSCTL_Vector_Offset_Config
	.type	SYSCTL_Vector_Offset_Config, @function
SYSCTL_Vector_Offset_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext28
.Ltext28:
	.stabn	68,0,412,.LM95-.LFBB18
.LM95:
.LFBB18:
	.stabn	68,0,416,.LM96-.LFBB18
.LM96:
	LD	r5,#1075839152
	LD.w	r4,[r5+#3]
	ST.w	[r5+#3],r0
	.stabn	68,0,419,.LM97-.LFBB18
.LM97:
	JMP	lr
...
.Lscope18:
	...
	.text$SYSCTL_Ram_Space_Config$scode_loacal_19:
	.align	1
	.stabs	"SYSCTL_Ram_Space_Config:F(0,15)",36,0,428,SYSCTL_Ram_Space_Config
	.stabs	"RamSpace:P(3,6)",64,0,428,0
	.export	SYSCTL_Ram_Space_Config
	.type	SYSCTL_Ram_Space_Config, @function
SYSCTL_Ram_Space_Config:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext29
.Ltext29:
	.stabn	68,0,429,.LM98-.LFBB19
.LM98:
.LFBB19:
	.stabn	68,0,436,.LM99-.LFBB19
.LM99:
	LD	r5,#1075839152
	LD.w	r3,[r5+#5]
.LBB24:
...
.LBE25:
.LBE24:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext31
.Ltext31:
	.stabn	68,0,436,.LM101-.LFBB19
.LM101:
	ST.w	[r5+#5],r0
	.stabn	68,0,439,.LM102-.LFBB19
.LM102:
	JMP	lr
...
.LBE27:
.LBE26:
	.stabs	"../system/src/kf32a_basic_sysctl.c",132,0,0,.Ltext34
.Ltext34:
	.stabn	68,0,457,.LM106-.LFBB20
.LM106:
	ST.w	[r5+#6],r0
	.stabn	68,0,458,.LM107-.LFBB20
.LM107:
	JMP	lr
