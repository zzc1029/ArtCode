...
# 9 "../source/MeterConfig.c" 2




volatile TYPE_WORD bcm_sw1_f;
volatile TYPE_BYTE bcm_sw2_f;
volatile uint16_t bcm_frq_f;
volatile uint16_t bcm_senor1_f;
volatile uint16_t bcm_senor2_f;
volatile TYPE_WORD bcm_out_st_f;
volatile TYPE_DWORD bcm_fb_st_f;

volatile TYPE_WORD bcm_sw1_r;
volatile TYPE_BYTE bcm_sw2_r;
volatile uint16_t bcm_frq_r;
volatile uint16_t bcm_senor1_r;
volatile uint16_t bcm_senor2_r;
volatile TYPE_WORD bcm_out_st_r;
volatile TYPE_DWORD bcm_fb_st_r;

volatile TYPE_WORD bcm_sw1_t;
volatile TYPE_BYTE bcm_sw2_t;
volatile uint16_t bcm_frq_t;
volatile uint16_t bcm_senor1_t;
volatile uint16_t bcm_senor2_t;
volatile TYPE_WORD bcm_out_st_t;
volatile TYPE_DWORD bcm_fb_st_t;
...
void PortInit(void)
{
 ...
 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008));
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008),SET);


 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0080));
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0080), Bit_RESET);


 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0008));
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0008), SET);


 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0004));




 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0010));
...
# 89 "../source/MeterConfig.c"
void power_task(void)
{
 static uint8_t power_off_delay;


 if((0 == power_state.byte))
 {
     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008), SET);
  if((port_a.bit.b3 || port_a.bit.b2 || port_a.bit.b1 || port_a.bit.b0 || port_a.bit.b7))
  {
   power_state.bit.b0 = 1;
   power_state.bit.b1 = 0;
  }
  else
  {
   power_state.bit.b0 = 0;
   power_state.bit.b1 = 1;
  }
 }
 else if(power_state.bit.b0)
 {
  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008), SET);
  if(!(port_a.bit.b3 || port_a.bit.b2 || port_a.bit.b1 || port_a.bit.b0 || port_a.bit.b7))
  {
 ...
 else if(power_state.bit.b1)
 {
  ...
  if(0 == power_off_delay)
  {
   power_state.byte = 0;
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0008), RESET);
  }
 }
}
...
void InitSwitch()
{
    ...
    port_mask.byte[5].bit.b0 = 0;
# 264 "../source/MeterConfig.c"
    port_mask.byte[1].bit.b6 = 0;


    port_mask.byte[1].bit.b7 = 0;



    port_mask.byte[0].bit.b0 = 0;


    port_mask.byte[0].bit.b1 = 0;


    port_mask.byte[0].bit.b2 = 0;
# 299 "../source/MeterConfig.c"
}
...
{
    fmode_mask.U32 = 0;
# 353 "../source/MeterConfig.c"
    fmode_mask.bit.b17 = 1;



    fmode_mask.bit.b15 = 0;
# 368 "../source/MeterConfig.c"
}
...
{
    rmode_mask.U32 = 0;
# 418 "../source/MeterConfig.c"
    rmode_mask.bit.b17 = 1;



    rmode_mask.bit.b15 = 0;
# 433 "../source/MeterConfig.c"
}
...
{
    tmode_mask.U32 = 0;
# 484 "../source/MeterConfig.c"
    tmode_mask.bit.b17 = 1;



    tmode_mask.bit.b15 = 0;
# 499 "../source/MeterConfig.c"
}

void initPWM_F(void)
{
    F_Set_PWM.word = 0x0000;
# 550 "../source/MeterConfig.c"
}

void initPWM_R(void)
{
    R_Set_PWM.word = 0x0000;
# 601 "../source/MeterConfig.c"
}
...
# 623 "../source/MeterConfig.c"
    T_Set_PWM.bit.b5 = 1;
# 653 "../source/MeterConfig.c"
}
...
void RainConfig(void)
{
    ctrl_cmd[6].bit.b0 = (port_a.bit.b7||port_a.bit.b3) && ((port_a.bit.b7||port_a.bit.b3)&&bcm_sw1_f.bit.b9);
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_a.bit.b7||port_a.bit.b3) && ((port_a.bit.b7||port_a.bit.b3)&&bcm_sw1_f.bit.b8);
    ctrl_cmd[6].bit.b2 = (port_a.bit.b7||port_a.bit.b3) && ((port_a.bit.b7||port_a.bit.b3)&&bcm_sw1_f.bit.b6);
    ctrl_cmd[6].bit.b3 = (port_a.bit.b7||port_a.bit.b3) && ((port_a.bit.b7||port_a.bit.b3)&&bcm_sw1_f.bit.b7);

    if(ctrl_cmd[6].bit.b2 ==1)
    {
        ctrl_cmd[6].bit.b0 = 0;
        ctrl_cmd[6].bit.b1 = 0;
        ctrl_cmd[6].bit.b3 = 0;
    }
    ctrl_cmd[6].bit.b4 = port_a.bit.b7;
    ctrl_cmd[6].bit.b5 = port_a.bit.b3;
}
