...
# 16 "D:/ARTStanHome/Desktop/TZGJ-XMJL-221204/YB-TZGJ-XMJL-221204/system/inc/kf32a_basic_cmp.h" 2
...
# 16 "../system/src/kf32a_basic_cmp.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 17 "../system/src/kf32a_basic_cmp.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../system/src/kf32a_basic_cmp.c" 2
# 75 "../system/src/kf32a_basic_cmp.c"
void
CMP_Reset ()
{
...
CMP_Configuration (CMP_SFRmap * CMPx, CMP_InitTypeDef* CMPInitStruct)
{
    ...
    if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000800)))
    {
     ...
     ((void)0);
     ((void)0);
# 121 "../system/src/kf32a_basic_cmp.c"
    ...
    else if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000804)))
    {
     ...
     ((void)0);
     ((void)0);
# 170 "../system/src/kf32a_basic_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      (CMPInitStruct->m_NegativeInput) |
      (CMPInitStruct->m_FallTriggerEnable << (19)) |
      (CMPInitStruct->m_RiseTriggerEnable << (18)) |
    ...
    else if(CMPx==((CMP_SFRmap *) ((uint32_t)0x40000808)))
    {
        ((void)0);
         ...
         ((void)0);
         ((void)0);
# 218 "../system/src/kf32a_basic_cmp.c"
        tmpreg = ((CMPInitStruct->m_PositiveInput ) |
          (CMPInitStruct->m_NegativeInput) |
          (CMPInitStruct->m_FallTriggerEnable << (19)) |
          (CMPInitStruct->m_RiseTriggerEnable << (18)) |
  ...
  ((void)0);
  ((void)0);
# 266 "../system/src/kf32a_basic_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      (CMPInitStruct->m_NegativeInput) |
      (CMPInitStruct->m_Clock) |
      (CMPInitStruct->m_FrequencyDivision) |
...
# 345 "../system/src/kf32a_basic_cmp.c"
void
...
# 368 "../system/src/kf32a_basic_cmp.c"
void
...
# 391 "../system/src/kf32a_basic_cmp.c"
void
...
# 414 "../system/src/kf32a_basic_cmp.c"
void
...
# 437 "../system/src/kf32a_basic_cmp.c"
void
...
# 460 "../system/src/kf32a_basic_cmp.c"
void
...
# 484 "../system/src/kf32a_basic_cmp.c"
void
...
# 516 "../system/src/kf32a_basic_cmp.c"
void
...
# 534 "../system/src/kf32a_basic_cmp.c"
void
...
# 605 "../system/src/kf32a_basic_cmp.c"
void
...
# 717 "../system/src/kf32a_basic_cmp.c"
FlagStatus
...
# 881 "../system/src/kf32a_basic_cmp.c"
void
...
# 1029 "../system/src/kf32a_basic_cmp.c"
void
