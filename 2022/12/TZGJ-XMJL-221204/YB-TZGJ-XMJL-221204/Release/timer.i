...
void GENERAL_TIMER_Tx_Config(GPTIM_SFRmap* GPTIMx,InterruptIndex Peripheral,uint32_t num)
{
 ...
 GPTIM_Work_Mode_Config(GPTIMx,((uint32_t)0 << (1)));
 GPTIM_Set_Counter(GPTIMx,0);
 GPTIM_Set_Period(GPTIMx,num);
 GPTIM_Set_Prescaler(GPTIMx,23);
 GPTIM_Counter_Mode_Config(GPTIMx,((uint32_t)0x3 << (8)));
 GPTIM_Clock_Config(GPTIMx,((uint32_t)0x0 << (5)));

 GPTIM_Overflow_INT_Enable(GPTIMx,TRUE);
 INT_Interrupt_Enable(Peripheral,TRUE);
 INT_Clear_Interrupt_Flag(Peripheral);
...
void TastTimerInit(void)
{
 ...
 GENERAL_TIMER_Tx_Config(((GPTIM_SFRmap *) ((uint32_t)0x40000880)),INT_T0,50000);
...
INT_Interrupt_Priority_Config(INT_T0,((uint32_t)3<<((1))),4);
...
void MotorTimerInit(void)
{
 ...
 GENERAL_TIMER_Tx_Config(((GPTIM_SFRmap *) ((uint32_t)0x40000180)),INT_T2,4000);
 INT_Interrupt_Priority_Config(INT_T2,((uint32_t)3<<((1))),5);
}
