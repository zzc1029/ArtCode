# 1 "../system/system_init.c"
# 1 "D:\\ARTStanHome\\Desktop\\TZGJ-XMJL-221204\\YB-TZGJ-XMJL-221204\\Release//"
# 1 "<command-line>"
# 1 "../system/system_init.c"
# 11 "../system/system_init.c"
# 1 "../system/system_init.h" 1
# 14 "../system/system_init.h"
...
# 88 "../system/system_init.h" 2
# 123 "../system/system_init.h"
static void SetSysClock(void);
void SystemInit(void);
# 12 "../system/system_init.c" 2
...
static void SetSysClock(void)
{
 ...
 PM_EXTHF_PIN_Selection_Config(((uint32_t)1<<(15)));
 OSC_EXTHF_Software_Enable(TRUE);
 OSC_EXTHF_Start_Delay_Config(((uint32_t)0));
 OSC_PLL_Input_Source_Config(((uint32_t)0x1));
 delay_C = 0xA39;
 while (delay_C--);
# 174 "../system/system_init.c"
...
void Config_Out_Clock(void)
{
 ...
 OSC_SCLK_Output_Select(((uint32_t)0x0));
 OSC_SCLK_Output_Division_Config(((uint32_t)0x4));

 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x0200), GPIO_MODE_RMP);
 GPIO_Pin_RMP_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint32_t)0x9), ((uint8_t)0x00));
 GPIO_Pin_Lock_Config (((GPIO_SFRmap *) ((uint32_t)0x50000040)) ,((uint16_t)0x0200), TRUE);
}
...
void OSC_EXTHLF_Config(void)
{
 ...
 OSC_INTHF_Software_Enable(ENABLE);
 (((FLASH_SFRmap *) ((uint32_t)0x40200100))->CFG) = 0xC7;
 OSC_SCK_Division_Config(((uint32_t)0x0));
 OSC_SCK_Source_Config(((uint32_t)0x0));
 while (OSC_Get_INTHF_INT_Flag() != SET);

 OSC_Backup_Write_Read_Enable(ENABLE);
 __asm volatile("SET [%0], #%1"::"r"(&((((PM_SFRmap *) ((uint32_t)0x40001580))->CTL0))),"i"((22)));



 PM_EXTLF_PIN_Selection_Config(((uint32_t)1<<(19)));
 OSC_EXTLF_Software_Enable(ENABLE);


 GPIO_InitTypeDef GPIO_InitStructure;
 GPIO_Struct_Init(&GPIO_InitStructure);
 GPIO_InitStructure.m_Pin = ((uint16_t)0x0200);
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0200),Bit_RESET);
 delay_C = 0xc8;
 while (delay_C--);


 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)), ((uint16_t)0x0200),GPIO_MODE_AN);
 OSC_High_Speed_Enable (ENABLE);
 PM_EXTHF_PIN_Selection_Config(((uint32_t)1<<(15)));
 OSC_EXTHF_Software_Enable(ENABLE);
 OSC_EXTHF_Start_Delay_Config(((uint32_t)7));
...
# 282 "../system/system_init.c"
 ...
 OSC_Clock_Failure_Check_Enable(ENABLE);


 OSC_HFCK_Division_Config(((uint32_t)0x0));
 OSC_HFCK_Source_Config(((uint32_t)0x2));
 OSC_HFCK_Enable(ENABLE);

 OSC_LFCK_Division_Config(((uint32_t)0x0));
 OSC_LFCK_Source_Config (((uint32_t)0x1));
 OSC_LFCK_Enable (ENABLE);


 OSC_SCLK_Output_Division_Config(((uint32_t)0x7));
 OSC_SCLK_Output_Enable(ENABLE);
