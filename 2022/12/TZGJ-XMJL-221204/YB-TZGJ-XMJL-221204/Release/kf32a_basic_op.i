...
# 14 "D:/ARTStanHome/Desktop/TZGJ-XMJL-221204/YB-TZGJ-XMJL-221204/system/inc/kf32a_basic_op.h" 2
...
# 16 "../system/src/kf32a_basic_op.c" 2
...
void RST_CTL3_Peripheral_Reset_Enable(uint32_t RST_CTL3Periph,
                    FunctionalState NewState);
# 17 "../system/src/kf32a_basic_op.c" 2
...
void PCLK_CTL3_Peripheral_Clock_Enable (uint32_t PCLK_CTL3_bit,
                    FunctionalState NewState);
# 18 "../system/src/kf32a_basic_op.c" 2
# 28 "../system/src/kf32a_basic_op.c"
void
OP_Reset(void)
{
...
void OP_CAL_Configure( uint32_t OPx , uint32_t CAL_VALUE)
{
  uint32_t tmpreg = 0;
    ...
    if(OPx==0)
    {
     ...
     tmpreg = CAL_VALUE << (0);
     ((OP_SFRmap *) ((uint32_t)0x40002A00))->CAL = SFR_Config (((OP_SFRmap *) ((uint32_t)0x40002A00))->CAL,
         ~((uint32_t)0x3f<<((0))),
         tmpreg);
    }
    else if(OPx==1)
...
void OP_GAIN_SELSECT(uint32_t OPx , uint32_t GAIN_VALUE)
{
 uint32_t tmpreg = 0;
    ...
    if(OPx==0)
    {
     ...
     tmpreg = GAIN_VALUE << (16);
     ((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0 = SFR_Config (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0,
            ~((uint32_t)0xf<<((16))),
            tmpreg);
    }
    else if(OPx==1)
