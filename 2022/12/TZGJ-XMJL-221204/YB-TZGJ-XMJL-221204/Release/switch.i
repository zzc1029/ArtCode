...
# 10 "../driver/switch.c" 2

void HC165PortInit(void)
{

  GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0200));

  GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100));

  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0080));


  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100), RESET);
  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0200), RESET);



  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0800));

  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x4000));

  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0001));


  GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0080));
# 51 "../driver/switch.c"
}
...
TYPE_WORD port_d;
TYPE_WORD port_b;
TYPE_BYTE sw_input[6] = {0, 0, 0, 0, 0,0};
TYPE_BYTE dumpx;
...
void switch_task(void)
{
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0100), SET);
 dump=0;
 for(j = 0; j < 5; j++)
 {
  for(i=0;i<8;i++)
  {
   ...
   dump = (dump<<1);
   dump |= GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0080));
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0200), SET);
   for(k = 0; k < 9; k++)
   {
    asm("nop");
   }
  }
  sw_input[j].byte = dump ^ port_mask.byte[j].byte;
 }
    ...
    dumpx.byte = 0;
    dumpx.bit.b0 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0800)) == SET);
    dumpx.bit.b1 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0001)) == RESET);
    dumpx.bit.b2 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x4000)) == SET);
    dumpx.bit.b3 = (GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0080)) == SET);
    dumpx.bit.b4 = 0;
    dumpx.bit.b5 = 0;

    sw_input[5].byte = dumpx.byte ^ port_mask.byte[5].byte;



    port_a.bit.b0 = sw_input[1].bit.b6;
    port_a.bit.b1 = sw_input[1].bit.b7;
    port_a.bit.b2 = sw_input[0].bit.b0;
    port_a.bit.b3 = sw_input[0].bit.b1;
    port_a.bit.b4 = sw_input[0].bit.b2;
    port_a.bit.b5 = sw_input[5].bit.b2;
    port_a.bit.b6 = sw_input[5].bit.b0;
    port_a.bit.b7 = sw_input[5].bit.b3;

    port_d.bit.b0 = sw_input[1].bit.b2;
    port_d.bit.b1 = sw_input[1].bit.b0;
    port_d.bit.b2 = sw_input[2].bit.b6;
    port_d.bit.b3 = sw_input[2].bit.b4;
    port_d.bit.b4 = sw_input[2].bit.b2;
    port_d.bit.b5 = sw_input[2].bit.b0;
    port_d.bit.b6 = sw_input[3].bit.b6;
    port_d.bit.b7 = sw_input[3].bit.b4;
    port_d.bit.b8 = sw_input[1].bit.b3;
    port_d.bit.b9 = sw_input[1].bit.b1;
    port_d.bit.b10 = sw_input[2].bit.b7;
    port_d.bit.b11 = sw_input[2].bit.b5;
    port_d.bit.b12 = sw_input[2].bit.b3;
    port_d.bit.b13 = sw_input[2].bit.b1;
    port_d.bit.b14 = sw_input[3].bit.b7;
    port_d.bit.b15 = sw_input[3].bit.b5;

    port_b.bit.b0 = sw_input[3].bit.b2;
    port_b.bit.b1 = sw_input[3].bit.b0;
    port_b.bit.b2 = sw_input[4].bit.b6;
    port_b.bit.b3 = sw_input[4].bit.b4;
    port_b.bit.b4 = sw_input[4].bit.b2;
    port_b.bit.b5 = sw_input[4].bit.b0;
    port_b.bit.b6 = sw_input[3].bit.b3;
    port_b.bit.b7 = sw_input[3].bit.b1;
    port_b.bit.b8 = sw_input[4].bit.b7;
    port_b.bit.b9 = sw_input[4].bit.b5;
    port_b.bit.b10 = sw_input[4].bit.b3;
    port_b.bit.b11 = sw_input[4].bit.b1;


    port_c.bit.b0 = sw_input[1].bit.b4;
    port_c.bit.b1 = sw_input[1].bit.b5;
    port_c.bit.b2 = sw_input[0].bit.b3;
    port_c.bit.b3 = sw_input[0].bit.b4;
    port_c.bit.b4 = sw_input[0].bit.b5;
    port_c.bit.b5 = sw_input[0].bit.b6;

    port_c.bit.b6 = sw_input[0].bit.b7;
    port_c.bit.b7 = sw_input[5].bit.b1;
    port_c.bit.b8 = sw_input[5].bit.b2;
# 239 "../driver/switch.c"
}
