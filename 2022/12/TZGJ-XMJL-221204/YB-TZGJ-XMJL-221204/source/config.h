...
//温度资源
#define VBATTEMPSOUTCE  bcm_senor2_f
...
#define FFOG_SW				PTD15//TestBitTrue(CanData[ID(0x18FF9117)][BYTE1],4)//PTD15//前雾灯
#define RFOG_SW				PTD13//TestBitTrue(CanData[ID(0x18FF9117)][BYTE1],3)//PTD13  	//后雾灯  //reset switch
//刹车
#define BREAK_SW            (R_SW_P18)
#define ELEC_BREAK          TestBitTrue(CanData[ID(0x18FFEA97)][1],7)	
#define BREAK_ALL           (BREAK_SW||ELEC_BREAK||ASR_BREAK)
...
#define FRONT_DOOR_OPEN_SW      PTA12
#define FRONT_DOOR_CLOSE_SW     PTA20
#define MID_DOOR_OPEN_SW        T_SW_P22
#define MID_DOOR_CLOSE_SW       T_SW_P37

#define FRONT_DOOR_OPEN_CLOSE_SW	UNUSED//F_SW_P17
#define FRONT_DOOR_OPEN_CLOSE_CAN	UNUSED//TestBitTrue(CanData[ID(0x18FF9117)][BYTE4],0)
#define MIDDLE_DOOR_OPEN_CLOSE_CAN	UNUSED//TestBitTrue(CanData[ID(0x18FF9117)][BYTE4],1)


#define  ALL_DOOR			(LED_FRONT_DOOR_SW || LED_MIDDLE_DOOR_SW)

//常用开关
#define PASSAGE_GET_OUT_SW  (PTB7)//下客门铃

#define WATER_BATT_SW           T_SW_P33
...
#define EMERGENCY_OUTSIDE_GAI_SW 		PTB3
#define EMERGENCY_OUTSIDE_XUANZHUAN_SW 	PTB4
...
#define DRIVER_AWAY_SW      	(!F_SW_P37) //司机离座开关
...
#define RIGUANGDENG_ZUO_CAN		F_SW_P18//(TestBits(CanData[ID(0x18FF9117)][BYTE1],6,2,1)||TestBits(CanData[ID(0x18FF9117)][BYTE1],6,2,2))	
#define RIGUANGDENG_YOU_CAN		F_SW_P33//TestBits(CanData[ID(0x18FF9117)][BYTE1],6,2,2)

#define FAN_CAN					F_SW_P19//TestBitTrue(CanData[ID(0x18FF9117)][BYTE3],1)
#define DRIVER_CAN				F_SW_P20//TestBitTrue(CanData[ID(0x18FF9117)][BYTE1],0)
#define DAOCHENGPING_CAN		F_SW_P34//TestBitTrue(CanData[ID(0x18FF9117)][BYTE2],6)
...
//1 近光灯
#define  LED_LBEAM_SW_FEEDBACK     (B40_FRONT_FEEDBACK(A3)&& B40_FRONT_FEEDBACK(A11) && LBEAM_SW)
//1 前雾灯
...
//1 刹车灯
#define  LED_BREAK_SW_FEEDBACK     (B40_REAR_FEEDBACK(A11))
...
//一般情况下无需配置的项目
#define  LED_ABS_SW           (ABS_SW||ABS_ON||ABS_TIMEOUT)
...
#define ASR_ON				(TestBits(CanData[ID(0x18F0010B)][BYTE6],6,2,1) || TestBits(CanData[ID(0x18F0010B)][BYTE3],2,2,1))

#define ABS_ON              TestBits(CanData[ID(0x18F0010B)][BYTE6],0,2,0) && TestBits(CanData[ID(0x18F0010B)][BYTE6],4,2,1)
#define ABS_TIMEOUT         (timeout[ID(0x18F0010B)] > 50)

//ASR break
#define ASR_BREAK			TestBits(CanData[ID(0x18F0010B)][BYTE1],6,2,1)
