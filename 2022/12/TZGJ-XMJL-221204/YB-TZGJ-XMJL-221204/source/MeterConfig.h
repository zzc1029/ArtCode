...
#define Mask_A20     port_mask.byte[5].bit.b0
#define Mask_C17     port_mask.byte[5].bit.b1
#define Mask_A12     port_mask.byte[5].bit.b2
#define Mask_E2      port_mask.byte[5].bit.b3


#define Mask_B6      port_mask.byte[4].bit.b0
#define Mask_B12     port_mask.byte[4].bit.b1
#define Mask_B5      port_mask.byte[4].bit.b2
#define Mask_B11     port_mask.byte[4].bit.b3
#define Mask_B4      port_mask.byte[4].bit.b4
#define Mask_B10     port_mask.byte[4].bit.b5
#define Mask_B3      port_mask.byte[4].bit.b6
#define Mask_B9      port_mask.byte[4].bit.b7

#define Mask_B2      port_mask.byte[3].bit.b0
#define Mask_B8      port_mask.byte[3].bit.b1
#define Mask_B1      port_mask.byte[3].bit.b2
#define Mask_B7      port_mask.byte[3].bit.b3
#define Mask_D8      port_mask.byte[3].bit.b4
#define Mask_D16     port_mask.byte[3].bit.b5
#define Mask_D7      port_mask.byte[3].bit.b6
#define Mask_D15     port_mask.byte[3].bit.b7

#define Mask_D6      port_mask.byte[2].bit.b0
#define Mask_D14     port_mask.byte[2].bit.b1
#define Mask_D5      port_mask.byte[2].bit.b2
#define Mask_D13     port_mask.byte[2].bit.b3
#define Mask_D4      port_mask.byte[2].bit.b4
#define Mask_D12     port_mask.byte[2].bit.b5
#define Mask_D3      port_mask.byte[2].bit.b6
#define Mask_D11     port_mask.byte[2].bit.b7

#define Mask_D2      port_mask.byte[1].bit.b0
#define Mask_D10     port_mask.byte[1].bit.b1
#define Mask_D1      port_mask.byte[1].bit.b2
#define Mask_D9      port_mask.byte[1].bit.b3
#define Mask_C10     port_mask.byte[1].bit.b4
#define Mask_C11     port_mask.byte[1].bit.b5
#define Mask_A10     port_mask.byte[1].bit.b6   //  控火C22&C23
#define Mask_A9      port_mask.byte[1].bit.b7

#define Mask_A8      port_mask.byte[0].bit.b0  // 控火A16，17，18
#define Mask_A7      port_mask.byte[0].bit.b1
#define Mask_A19     port_mask.byte[0].bit.b2
#define Mask_C12     port_mask.byte[0].bit.b3
#define Mask_C13     port_mask.byte[0].bit.b4
#define Mask_C14     port_mask.byte[0].bit.b5
#define Mask_C15     port_mask.byte[0].bit.b6
#define Mask_C16     port_mask.byte[0].bit.b7


#define LED0_B7               led[0].bit.b7
#define LED0_B6               led[0].bit.b6
#define LED0_B5               led[0].bit.b5
#define LED0_B4               led[0].bit.b4
#define LED0_B3               led[0].bit.b3
#define LED0_B2               led[0].bit.b2
#define LED0_B1               led[0].bit.b1
#define LED0_B0               led[0].bit.b0

#define LED1_B7               led[1].bit.b7
#define LED1_B6               led[1].bit.b6
#define LED1_B5               led[1].bit.b5
#define LED1_B4               led[1].bit.b4
#define LED1_B3               led[1].bit.b3
#define LED1_B2               led[1].bit.b2
#define LED1_B1               led[1].bit.b1
#define LED1_B0               led[1].bit.b0


#define LED2_B7               led[2].bit.b7
#define LED2_B6               led[2].bit.b6
#define LED2_B5               led[2].bit.b5
#define LED2_B4               led[2].bit.b4
#define LED2_B3               led[2].bit.b3
#define LED2_B2               led[2].bit.b2
#define LED2_B1               led[2].bit.b1
#define LED2_B0               led[2].bit.b0

#define LED3_B7               led[3].bit.b7
#define LED3_B6               led[3].bit.b6
#define LED3_B5               led[3].bit.b5
#define LED3_B4               led[3].bit.b4
#define LED3_B3               led[3].bit.b3
#define LED3_B2               led[3].bit.b2
#define LED3_B1               led[3].bit.b1
#define LED3_B0               led[3].bit.b0

#define LED4_B7               led[4].bit.b7
#define LED4_B6               led[4].bit.b6
#define LED4_B5               led[4].bit.b5
#define LED4_B4               led[4].bit.b4
#define LED4_B3               led[4].bit.b3
#define LED4_B2               led[4].bit.b2
#define LED4_B1               led[4].bit.b1
#define LED4_B0               led[4].bit.b0

#define LED5_B7               led[5].bit.b7
#define LED5_B6               led[5].bit.b6
#define LED5_B5               led[5].bit.b5
#define LED5_B4               led[5].bit.b4
#define LED5_B3               led[5].bit.b3
#define LED5_B2               led[5].bit.b2
#define LED5_B1               led[5].bit.b1
#define LED5_B0               led[5].bit.b0


#define LED6_B7               led[6].bit.b7
#define LED6_B6               led[6].bit.b6
#define LED6_B5               led[6].bit.b5
#define LED6_B4               led[6].bit.b4
#define LED6_B3               led[6].bit.b3
#define LED6_B2               led[6].bit.b2
#define LED6_B1               led[6].bit.b1
#define LED6_B0               led[6].bit.b0

#define LED7_B7               led[7].bit.b7
#define LED7_B6               led[7].bit.b6
#define LED7_B5               led[7].bit.b5
#define LED7_B4               led[7].bit.b4
#define LED7_B3               led[7].bit.b3
#define LED7_B2               led[7].bit.b2
#define LED7_B1               led[7].bit.b1
#define LED7_B0               led[7].bit.b0

#define LED8_B7               led[8].bit.b7
#define LED8_B6               led[8].bit.b6
#define LED8_B5               led[8].bit.b5
#define LED8_B4               led[8].bit.b4
#define LED8_B3               led[8].bit.b3
#define LED8_B2               led[8].bit.b2
#define LED8_B1               led[8].bit.b1
#define LED8_B0               led[8].bit.b0

#define LED9_B7               led[9].bit.b7
#define LED9_B6               led[9].bit.b6
#define LED9_B5               led[9].bit.b5
#define LED9_B4               led[9].bit.b4
#define LED9_B3               led[9].bit.b3
#define LED9_B2               led[9].bit.b2
#define LED9_B1               led[9].bit.b1
#define LED9_B0               led[9].bit.b0

#define LED10_B7              led[10].bit.b7
#define LED10_B6              led[10].bit.b6
#define LED10_B5              led[10].bit.b5
#define LED10_B4              led[10].bit.b4
#define LED10_B3              led[10].bit.b3
#define LED10_B2              led[10].bit.b2
#define LED10_B1              led[10].bit.b1
#define LED10_B0              led[10].bit.b0
...
extern volatile TYPE_WORD   bcm_sw1_f;      //front bcm switch  15 switch from hc165
extern volatile TYPE_BYTE   bcm_sw2_f;      //front bcm switch   Pin-A17 A41
extern volatile uint16_t    bcm_frq_f;      //front bcm input frequence
extern volatile uint16_t    bcm_senor1_f;   //front bcm senor pin A25
extern volatile uint16_t    bcm_senor2_f;   //front bcm senor pin A40
extern volatile TYPE_WORD   bcm_out_st_f;   //front bcm output states ON & OFF
extern volatile TYPE_DWORD  bcm_fb_st_f;    //front bcm feedback states

extern volatile TYPE_WORD   bcm_sw1_r;      //rear bcm switch   15 switch from hc165
extern volatile TYPE_BYTE   bcm_sw2_r;      //rear bcm switch    Pin-A17 A41
extern volatile uint16_t    bcm_frq_r;      //rear bcm input frequence
extern volatile uint16_t    bcm_senor1_r;   //rear bcm senor pin A25
extern volatile uint16_t    bcm_senor2_r;   //rear bcm senor pin A40
extern volatile TYPE_WORD   bcm_out_st_r;   //rear bcm output states ON & OFF
extern volatile TYPE_DWORD  bcm_fb_st_r;    //rear bcm feedback states

extern volatile TYPE_WORD   bcm_sw1_t;      //top bcm switch    15 switch from hc165
extern volatile TYPE_BYTE   bcm_sw2_t;      //top bcm switch     Pin-A17 A41
extern volatile uint16_t    bcm_frq_t;      //top bcm input frequence
extern volatile uint16_t    bcm_senor1_t;   //top bcm senor pin A25
extern volatile uint16_t    bcm_senor2_t;   //top bcm senor pin A40
extern volatile TYPE_WORD   bcm_out_st_t;   //top bcm output states ON & OFF
extern volatile TYPE_DWORD  bcm_fb_st_t;    //top bcm feedback states
extern TYPE_BYTE   ctrl_cmd[8];

extern TYPE_WORD F_Set_PWM,R_Set_PWM,T_Set_PWM;


#define POWER_KEEP(state)   GPIO_Set_Output_Data_Bits(GPIOD_SFR,GPIO_PIN_MASK_3, state)	
