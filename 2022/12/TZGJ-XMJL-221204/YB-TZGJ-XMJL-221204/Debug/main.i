...
void buzz_init()
{
 ...
 GPIO_Write_Mode_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000140)) ,((uint16_t)0x0004), GPIO_MODE_RMP);
 GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000140)), ((uint32_t)0x2), ((uint8_t)0x01));

 TIM_Reset(((CCP_SFRmap *) ((uint32_t)0x40000100)));

 CCP_PWM_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),((uint16_t)0xC));
 CCP_Channel_Output_Control(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),((uint32_t)0x0));
 CCP_Set_Compare_Result(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),2500);

 GPTIM_Updata_Immediately_Config(((CCP_SFRmap *) ((uint32_t)0x40000100)),TRUE);
 GPTIM_Updata_Enable(((CCP_SFRmap *) ((uint32_t)0x40000100)),TRUE);
 GPTIM_Work_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint32_t)0 << (1)));
 GPTIM_Set_Counter(((CCP_SFRmap *) ((uint32_t)0x40000100)),0);
 GPTIM_Set_Period(((CCP_SFRmap *) ((uint32_t)0x40000100)),5000);
 GPTIM_Set_Prescaler(((CCP_SFRmap *) ((uint32_t)0x40000100)),12000);
 GPTIM_Counter_Mode_Config(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint32_t)0x4 << (8)));

 GPTIM_Clock_Config(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint32_t)0x0 << (5)));
 GPTIM_Cmd(((CCP_SFRmap *) ((uint32_t)0x40000100)),TRUE);
