...
.Ltext0:
	...
	.stabs	"H:/workspace32/App/system/inc/kf32a_basic_op.h",130,0,0,0
...
.Lscope1:
	...
	.type	.text$OP_Reset$scode_local_2, @function
	.text$OP_Reset$scode_loacal_2:
	.align	1
...
.Lscope2:
	...
	.type	.text$OP_CAL_Configure$scode_local_3, @function
	.text$OP_CAL_Configure$scode_loacal_3:
	.align	1
	.stabs	"OP_CAL_Configure:F(0,15)",36,0,42,OP_CAL_Configure
	.stabs	"OPx:p(3,6)",160,0,42,4
	.stabs	"CAL_VALUE:p(3,6)",160,0,42,8
	.export	OP_CAL_Configure
	.type	OP_CAL_Configure, @function
OP_CAL_Configure:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,43,.LM8-.LFBB3
.LM8:
.LFBB3:
	PUSH	lr
	PUSH	r6
	...
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,44,.LM9-.LFBB3
.LM9:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,48,.LM10-.LFBB3
.LM10:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JNZ	.L5
	.stabn	68,0,51,.LM11-.LFBB3
.LM11:
	LD.w	r5,[sp+#2]
	ST.w	[sp],r5
	.stabn	68,0,52,.LM12-.LFBB3
.LM12:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5]
...
.Lscope3:
	...
	.type	.text$OP_GAIN_SELSECT$scode_local_4, @function
	.text$OP_GAIN_SELSECT$scode_loacal_4:
	.align	1
	.stabs	"OP_GAIN_SELSECT:F(0,15)",36,0,87,OP_GAIN_SELSECT
	.stabs	"OPx:p(3,6)",160,0,87,4
	.stabs	"GAIN_VALUE:p(3,6)",160,0,87,8
...
.LM28:
	...
	CMP	r5,#1
	JNZ	.L12
	.stabn	68,0,104,.LM29-.LFBB4
.LM29:
	LD.w	r5,[sp+#2]
	LSL	r5,#20
	ST.w	[sp],r5
	.stabn	68,0,105,.LM30-.LFBB4
.LM30:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
	...
	JMP	.L9
.L12:
	.stabn	68,0,109,.LM31-.LFBB4
.LM31:
	LD.w	r5,[sp+#1]
	CMP	r5,#2
	JNZ	.L9
	.stabn	68,0,112,.LM32-.LFBB4
.LM32:
	LD.w	r5,[sp+#2]
	LSL	r5,#24
	ST.w	[sp],r5
...
.Lscope4:
	...
	.type	.text$OP3_POSITIVE_INPUT_SELSECT$scode_local_5, @function
	.text$OP3_POSITIVE_INPUT_SELSECT$scode_loacal_5:
	.align	1
	.stabs	"OP3_POSITIVE_INPUT_SELSECT:F(0,15)",36,0,125,OP3_POSITIVE_INPUT_SELSECT
	.stabs	"SEL:p(3,6)",160,0,125,0
	.export	OP3_POSITIVE_INPUT_SELSECT
	.type	OP3_POSITIVE_INPUT_SELSECT, @function
OP3_POSITIVE_INPUT_SELSECT:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,126,.LM35-.LFBB5
.LM35:
.LFBB5:
	PUSH	lr
	PUSH	r6
...
.Lscope5:
	...
	.type	.text$OP_OUTPUT_EN$scode_local_6, @function
	.text$OP_OUTPUT_EN$scode_loacal_6:
	.align	1
	.stabs	"OP_OUTPUT_EN:F(0,15)",36,0,140,OP_OUTPUT_EN
	.stabs	"OPx:p(3,6)",160,0,140,4
	.stabs	"NewState:p(2,2)",160,0,140,8
	.export	OP_OUTPUT_EN
...
.LFBB6:
	...
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,142,.LM39-.LFBB6
.LM39:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,146,.LM40-.LFBB6
.LM40:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JNZ	.L15
...
.LM42:
	...
	ST.w	[r6+#1],r5
.L15:
	.stabn	68,0,154,.LM43-.LFBB6
.LM43:
	LD.w	r5,[sp+#1]
	CMP	r5,#1
	JNZ	.L16
	.stabn	68,0,157,.LM44-.LFBB6
.LM44:
	LD.w	r5,[sp+#2]
	LSL	r5,#5
	ST.w	[sp],r5
	.stabn	68,0,158,.LM45-.LFBB6
.LM45:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
	...
	ST.w	[r6+#1],r5
.L16:
	.stabn	68,0,162,.LM46-.LFBB6
.LM46:
	LD.w	r5,[sp+#1]
	CMP	r5,#2
	JNZ	.L17
	.stabn	68,0,165,.LM47-.LFBB6
.LM47:
	LD.w	r5,[sp+#2]
	LSL	r5,#6
	ST.w	[sp],r5
	.stabn	68,0,166,.LM48-.LFBB6
.LM48:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
	...
	ST.w	[r6+#1],r5
.L17:
	.stabn	68,0,170,.LM49-.LFBB6
.LM49:
	LD.w	r5,[sp+#1]
	CMP	r5,#3
	JNZ	.L14
	.stabn	68,0,173,.LM50-.LFBB6
.LM50:
	LD.w	r5,[sp+#2]
	LSL	r5,#7
	ST.w	[sp],r5
	.stabn	68,0,174,.LM51-.LFBB6
.LM51:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
...
.Lscope6:
	...
	.type	.text$OP_MODULE_EN$scode_local_7, @function
	.text$OP_MODULE_EN$scode_loacal_7:
	.align	1
	.stabs	"OP_MODULE_EN:F(0,15)",36,0,185,OP_MODULE_EN
	.stabs	"OPx:p(3,6)",160,0,185,4
	.stabs	"NewState:p(2,2)",160,0,185,8
	.export	OP_MODULE_EN
	.type	OP_MODULE_EN, @function
OP_MODULE_EN:
	.stabd	46,0,0
	.stabs	"../system/src/kf32a_basic_op.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,186,.LM53-.LFBB7
.LM53:
.LFBB7:
	PUSH	lr
	PUSH	r6
	...
	ST.w	[sp+#1],r0
	ST.w	[sp+#2],r1
	.stabn	68,0,187,.LM54-.LFBB7
.LM54:
	MOV	r5,#0
	ST.w	[sp],r5
	.stabn	68,0,191,.LM55-.LFBB7
.LM55:
	LD.w	r5,[sp+#1]
	CMP	r5,#0
	JNZ	.L20
	.stabn	68,0,194,.LM56-.LFBB7
.LM56:
	LD.w	r5,[sp+#2]
	ST.w	[sp],r5
	.stabn	68,0,195,.LM57-.LFBB7
.LM57:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
	...
	ST.w	[r6+#1],r5
.L20:
	.stabn	68,0,199,.LM58-.LFBB7
.LM58:
	LD.w	r5,[sp+#1]
	CMP	r5,#1
	JNZ	.L21
	.stabn	68,0,202,.LM59-.LFBB7
.LM59:
	LD.w	r5,[sp+#2]
	ADD	r5,r5,r5
	ST.w	[sp],r5
	.stabn	68,0,203,.LM60-.LFBB7
.LM60:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
	...
	ST.w	[r6+#1],r5
.L21:
	.stabn	68,0,207,.LM61-.LFBB7
.LM61:
	LD.w	r5,[sp+#1]
	CMP	r5,#2
	JNZ	.L22
	.stabn	68,0,210,.LM62-.LFBB7
.LM62:
	LD.w	r5,[sp+#2]
	LSL	r5,#2
	ST.w	[sp],r5
	.stabn	68,0,211,.LM63-.LFBB7
.LM63:
	LD	r6,#1073752576
	LD	r5,#1073752576
	LD.w	r5,[r5+#1]
