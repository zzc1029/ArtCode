...
# 3 "src\\init_section.c"

static void init_start(void)
{
}
__attribute__((used)) const init_fn_t __stan_init_init_start __attribute__((section(".init_fn." "0"))) = init_start;
...
__attribute__((used)) const init_fn_t __stan_init_init_board_start __attribute__((section(".init_fn." "0.end"))) = init_board_start;

static void init_board_end(void)
{
	Enable_Irq();
}
__attribute__((used)) const init_fn_t __stan_init_init_board_end __attribute__((section(".init_fn." "3.end"))) = init_board_end;

static void init_app_end(void)
{
}
__attribute__((used)) const init_fn_t __stan_init_init_app_end __attribute__((section(".init_fn." "6.end"))) = init_app_end;

static void app_end(void)
{
}
__attribute__((used)) const init_fn_t __stan_init_app_end __attribute__((section(".init_fn." "7.end"))) = app_end;
...
void auto_init()
{
	...
	for (fn_ptr = &__stan_init_init_board_start; fn_ptr < &__stan_init_init_app_end; fn_ptr++)
	{
		(*fn_ptr)();
	}
}
...
__inline void auto_loop()
{
	...
	for (fn_ptr = (&__stan_init_init_app_end)+1; fn_ptr < &__stan_init_app_end; fn_ptr++)
	{
		(*fn_ptr)();
	}
