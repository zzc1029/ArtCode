		...
		if(mod_addr == 3)
    {
				...
				while (1)
				{
						...
						if((KEY_ON == 0) && (KEY_ACC == 0))
						{
								...
								PoutS[9]. cmd = ({ static int8_t timeout37 = 0; static int8_t first37 = 0; if (timeout37) timeout37--; if ((in_sw[1] & 0x04)) { if (first37 == 0) { first37 = 1; timeout37 = 10; } } else { first37 = 0; } timeout37 > 0; }); 
								PoutS[2]. cmd = ({ static int8_t timeout38 = 0; static int8_t first38 = 0; if (timeout38) timeout38--; if ((in_sw[1] & 0x02)) { if (first38 == 0) { first38 = 1; timeout38 = 10; } } else { first38 = 0; } timeout38 > 0; });
						...
						do { do { LC_LABEL49: ((pt)->lc) = &&LC_LABEL49; } while(0); if(!(((int) (systick_ms - time) >= 0))) { return 0; } } while(0);
				}
				};
    }
		return 0;
