# 1 "RTE\\Device\\BF7006AM64\\BF7006AMxx_timer.c"
...
# 14 "RTE\\Device\\BF7006AM64\\BF7006AMxx_timer.c"
...
void timer_init(uint32_t timerx,uint8_t timer_cfg,uint16_t timer_mod)
{
	((*((volatile uint32_t *)((uint32_t)((timerx) + 0x00U))))) = timer_cfg;
	((*((volatile uint32_t *)((uint32_t)((timerx) + 0x04U))))) = timer_mod;
	if(timerx == (uint32_t)((((uint32_t)0x50000000) + (uint32_t)0xB0000) + (uint32_t)0x0000)){
		if((timer_cfg & ((uint32_t)(0x01UL<<((uint8_t)(5))))) != 0U){
...
void timer_enable(uint32_t timerx)
{
	((*((volatile uint32_t *)((uint32_t)((timerx) + 0x00U))))) |= ((uint32_t)(0x01UL<<((uint8_t)(0))));
}
...
void timer_mod_set(uint32_t timerx,uint16_t count)
{
	((*((volatile uint32_t *)((uint32_t)((timerx) + 0x04U))))) = count;
}
...
uint16_t timer_cnt_get(uint32_t timerx)
{
	return ((*((volatile uint32_t *)((uint32_t)((timerx) + 0x08U)))));
}
...
void timer_intflag_clr(uint32_t timerx)
{
	((*((volatile uint32_t *)((uint32_t)((timerx) + 0x00U))))) |= ((uint32_t)(0x01UL<<((uint8_t)(6))));
}
...
FlagStatus timer_intflag_get(uint32_t timerx)
{
	uint32_t intflag = ((*((volatile uint32_t *)((uint32_t)((timerx) + 0x00U)))));
	if((intflag & ((uint32_t)(0x01UL<<((uint8_t)(6))))) != 0x00U ){
		return SET;
	}else{
		return RESET;
	}
