# 1 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
...
# 51 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
...
# 52 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"



 
# 62 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
...
# 171 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"



 
uint32_t SystemCoreClock = (uint32_t)(uint32_t)32000000;   
...
{
    if(((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x0CU))))) == 0x7c6bU){

            SystemCoreClock = ((uint32_t) 8000000);

    }else{
        switch(((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x0CU)))))){
        case 0x9abdU:
...
void SystemInit (void)
{
    ...
    system_clk_sel(0x8d9cU,0x9abdU,0x3);
...
# 245 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
    bor_init(ENABLE,ENABLE);
...
# 271 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
    lvdt_init(ENABLE,0,ENABLE);



# 281 "RTE\\Startup\\BF7006AM64\\system_BF7006AMxx.c"
    reset_filter(ENABLE);
