...
static int protothread_pluse (struct pt *pt)
{
    ...
    while (1)
    {
        do { do { LC_LABEL43: ((pt)->lc) = &&LC_LABEL43; } while(0); if(!((pluse_flag > 0))) { return 0; } } while(0);
        pluse_flag = 0;
...

        {
            ...
            {
                do { do { LC_LABEL65: ((pt)->lc) = &&LC_LABEL65; } while(0); if(!((EepromFlag == 0))) { return 0; } } while(0);
                EepromFlag = 1;
                do { ((&ptx))->lc = 0; do { do { LC_LABEL67: (((((pt))))->lc) = &&LC_LABEL67; } while(0); if(!(!((((save_odo_pt (&ptx))) < 2)))) { return 0; } } while(0); } while(0);
                EepromFlag = 0;
...
__attribute__((used)) const init_fn_t __stan_init_pluse_init __attribute__((section(".init_fn." "4"))) = pluse_init;
