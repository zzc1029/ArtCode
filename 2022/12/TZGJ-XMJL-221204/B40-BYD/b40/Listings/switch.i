...
static void GetKeyIn()
{
    ...
    gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(2)))));
    NOP();
    gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(2)))));

    key_in = 0;
    for (i = 0; i < 16; i++)
    {
        gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0074), ((uint32_t)(0x01UL<<((uint8_t)(2)))));
        key_in <<= 1;
        key_in |= gpio_bit_get(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(5)))));
        gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0074), ((uint32_t)(0x01UL<<((uint8_t)(2)))));
    }
    ...
    in_sw[2] = ((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(4)))))) != 0x00U) == 0;
    in_sw[2] <<= 1;
    in_sw[2] += ((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(3)))))) != 0x00U);
}
...
int protothread_add_smooth (struct pt *pt)
{
    ...
    while (1)
    {
        ...
        { time = systick_ms + (1); do { do { LC_LABEL91: ((pt)->lc) = &&LC_LABEL91; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };

        {
            static uint16_t add = 0xFF; 
            static uint16_t kh1 = 0;  
            add <<= 1;
            add |= ((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(4)))))) != 0x00U);

            kh1 <<= 1;
            kh1 |= ((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(3)))))) != 0x00U);
...
int protothread_in (struct pt *pt)
{
    ...
    while (1)
    {
        { time = systick_ms + (20); do { do { LC_LABEL120: ((pt)->lc) = &&LC_LABEL120; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
...
int protothread_mod_addr_init (struct pt *pt)
{
    ...
    static uint32_t time;
		...
		{ time = systick_ms + (333); do { do { LC_LABEL136: ((pt)->lc) = &&LC_LABEL136; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
		wdt_clear();						
		{ time = systick_ms + (333); do { do { LC_LABEL138: ((pt)->lc) = &&LC_LABEL138; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
		wdt_clear();
		{ time = systick_ms + (333); do { do { LC_LABEL140: ((pt)->lc) = &&LC_LABEL140; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
		wdt_clear();

     
    while (1)
    {
        { time = systick_ms + (10); do { do { LC_LABEL146: ((pt)->lc) = &&LC_LABEL146; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };

        GetKeyIn();
        mod_addr_s0 = ((in_sw[1] >> 4) & 3);

        { time = systick_ms + (10); do { do { LC_LABEL151: ((pt)->lc) = &&LC_LABEL151; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };

        GetKeyIn();
        if (mod_addr_s0 == ((in_sw[1] >> 4) & 3))
        {
            break;
        }
...
static void din_init()
{
    (&pt1)->lc = 0;
		...
		gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0074), ((uint32_t)(0x01UL<<((uint8_t)(4)))));

}
__attribute__((used)) const init_fn_t __stan_init_din_init __attribute__((section(".init_fn." "4"))) = din_init;
...
{
    while (protothread_mod_addr_init (&pt1) != 3);
    (&pt1)->lc = 0;
}
__attribute__((used)) const init_fn_t __stan_init_mod_addr_init __attribute__((section(".init_fn." "5"))) = mod_addr_init;
