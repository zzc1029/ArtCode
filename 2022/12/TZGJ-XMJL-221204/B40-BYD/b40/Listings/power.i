...
int protothread_power (struct pt *pt)
{
    ...
    while (1)
    {
        { time = systick_ms + (1000); do { do { LC_LABEL34: ((pt)->lc) = &&LC_LABEL34; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
				if(((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0074)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(3)))))) == 0x00U))
				{
					{ time = systick_ms + (1000); do { do { LC_LABEL37: ((pt)->lc) = &&LC_LABEL37; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); }; 
					
					
					do { do { LC_LABEL40: ((pt)->lc) = &&LC_LABEL40; } while(0); if(!((EepromFlag == 0))) { return 0; } } while(0);
					EepromFlag = 1;
					do { ((&ptx))->lc = 0; do { do { LC_LABEL42: (((((pt))))->lc) = &&LC_LABEL42; } while(0); if(!(!((((save_odo_pt (&ptx))) < 2)))) { return 0; } } while(0); } while(0);
					EepromFlag = 0;
					
					gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), ((uint32_t)(0x01UL<<((uint8_t)(1)))));  					
				}
				else
				{
					gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), ((uint32_t)(0x01UL<<((uint8_t)(1)))));				
				}
    }
...
__attribute__((used)) const init_fn_t __stan_init_power_init __attribute__((section(".init_fn." "1"))) = power_init;
