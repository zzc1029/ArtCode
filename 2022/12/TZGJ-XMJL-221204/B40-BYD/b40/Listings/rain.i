...
inline void rain_cmd_parse(uint16_t cmd)
{
    ...
    if(cmd & 0x30)
    {
        ...
        slow = (cmd & 2) == 0x02;
        inter = (cmd & 8) == 0x08; 
        rain_spray_cmd = (RainSprayCmd)((cmd & 4) == 0x04);  
    }
    else
    {
        fast = 0;
        slow = 0;
        inter = 0; 
        rain_spray_cmd = Disable; 
    }

    if((cmd & 0x40) == 0)
    {
        PoutS[2].cmd = (rain_spray_cmd == Enable);
    }
...
{
    return (bool) (((((*((volatile uint32_t *)((uint32_t)((((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064)) + 0x00U)))))&(((uint32_t)(0x01UL<<((uint8_t)(4)))))) != 0x00U) == 0);
}
...
int protothread_rain(struct pt *pt)
{
    ...
    while(1)
    {
        ...
        {
            case RainNone:
                do { do { LC_LABEL131: ((pt)->lc) = &&LC_LABEL131; } while(0); if(!((rain_cmd != None) || (rain_spray_cmd != Disable))) { return 0; } } while(0);
                status = RainOp;
                break;
            ...
            case RainOp:
                ...
                do { do { LC_LABEL154: ((pt)->lc) = &&LC_LABEL154; } while(0); if(!((!IsResetPostion()))) { return 0; } } while(0);
																
                { time = systick_ms + (10); do { do { LC_LABEL156: ((pt)->lc) = &&LC_LABEL156; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
                do { do { LC_LABEL157: ((pt)->lc) = &&LC_LABEL157; } while(0); if(!((!IsResetPostion()))) { return 0; } } while(0);
            ...
            case RainWaitReset:
                {
                    ...
                    do { do { LC_LABEL167: ((pt)->lc) = &&LC_LABEL167; } while(0); if(!((rain_spray_cmd != last) || (rain_cmd != lastc) || (IsResetPostion()))) { return 0; } } while(0);
                ...
                break;
						...
						case RainOpEnd:						
								...
								{ time = systick_ms + (10); do { do { LC_LABEL198: ((pt)->lc) = &&LC_LABEL198; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
            ...
            case RainLowEnable:
                {									
                    ...
                    { time = systick_ms + (wiper_brake_delay_ms); do { do { LC_LABEL219: ((pt)->lc) = &&LC_LABEL219; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
										...
										if(wiper_brake_pwm_enable)
                    {
                        ...
                        for(i = 0; i < 50; i +=5 )
                        {
                            ...
                            time += i;
                            gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), ((uint32_t)(0x01UL<<((uint8_t)(3)))));  

                            do { do { LC_LABEL232: ((pt)->lc) = &&LC_LABEL232; } while(0); if(!(((int)(pwmtime - time) >= 0))) { return 0; } } while(0);

                            time += 50 - i;
                            gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), ((uint32_t)(0x01UL<<((uint8_t)(3)))));

                            do { do { LC_LABEL237: ((pt)->lc) = &&LC_LABEL237; } while(0); if(!(((int)(pwmtime - time) >= 0))) { return 0; } } while(0);
                        }
                    }
                }
                ...
                gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), ((uint32_t)(0x01UL<<((uint8_t)(3)))));
                time = systick_ms + 500;
                do { do { LC_LABEL244: ((pt)->lc) = &&LC_LABEL244; } while(0); if(!(((int)(systick_ms - time) >= 0) || (rain_cmd > Inter) || (rain_spray_cmd != Disable))) { return 0; } } while(0);
                gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), ((uint32_t)(0x01UL<<((uint8_t)(3)))));

                { time = systick_ms + (10); do { do { LC_LABEL247: ((pt)->lc) = &&LC_LABEL247; } while(0); if(!(((int)(systick_ms - time) >= 0))) { return 0; } } while(0); };
            ...
            case RainInterDelay:
                ...
                do { do { LC_LABEL265: ((pt)->lc) = &&LC_LABEL265; } while(0); if(!(((int)(systick_ms - time) >= 0) || (rain_cmd != Inter) || (rain_spray_cmd != Disable))) { return 0; } } while(0);
                if(rain_cmd != None)
                {
                    status = RainOp;
                }
        ...
        do { PT_YIELD_FLAG = 0; do { LC_LABEL276: ((pt)->lc) = &&LC_LABEL276; } while(0); if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
    }
...
__attribute__((used)) const init_fn_t __stan_init_rain_init __attribute__((section(".init_fn." "2"))) = rain_init;
