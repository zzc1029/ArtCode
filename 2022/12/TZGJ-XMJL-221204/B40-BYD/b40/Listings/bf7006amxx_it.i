...
# 36 "src\\BF7006AMxx_it.c"
# 39 "src\\BF7006AMxx_it.c"
...
{
    uint32_t state = ((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x108U)))));
     
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(4))))) != 0x00U)
    {
    }
     
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(3))))) != 0x00U)
    {
    }
     
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(0))))) != 0x00U)
    {
        xtal_timeout = 1;
    }
     
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(1))))) != 0x00U)
    {
        if ((((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x10CU))))) & ((uint32_t)(0x01UL<<((uint8_t)(1))))) == 0x00U)
        {
            ((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x04U))))) &= ~((uint32_t)(0x01UL<<((uint8_t)(0))));
        }
    }
    ((*((volatile uint32_t *)((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0x10000) + 0x108U))))) = state;
}
...
void TIMER0_IRQHandler (void)
{
    ...
    systick_ms ++;
    timer_intflag_clr (((((uint32_t)0x50000000) + (uint32_t)0xB0000) + (uint32_t)0x0000));
}
...
void TIMER1_IRQHandler (void)
{
    ...
    extern volatile uint32_t pwmtime; 
    pwmtime ++;
    timer_intflag_clr (((((uint32_t)0x50000000) + (uint32_t)0xB0000) + (uint32_t)0x4000));
}
...
void CAN_WAKE_IRQHandler (void)
{
    ...
    can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(4)))));
}
...
void CAN_ERR_IRQHandler (void)
{
    ...
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(7))))) != 0x00U)           
    {
        can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(7)))));
    }
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(6))))) != 0x00U)           
    {
        (void)can_read_arbitration_lost_code();
        can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(6)))));
    }
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(5))))) != 0x00U)           
    {
        can_transmit_abort();
        can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(5)))));
    }
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(3))))) != 0x00U)           
    {
        can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(3)))));
    }
    if ((state & ((uint32_t)(0x01UL<<((uint8_t)(2))))) != 0x00U)            
    {
        if ((can_status_get() & ((uint32_t)(0x01UL<<((uint8_t)(7))))) == ((uint32_t)(0x01UL<<((uint8_t)(7)))))  
        {					
						Can_ReInit();
        }
        can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(2)))));
    }
}
...
void CAN_RX_IRQHandler (void)
{
    ...
    (void)can_interrupt_flag_get();
		can_isr();
    can_int_flag_clr (((uint32_t)(0x01UL<<((uint8_t)(0)))));
}
...
{
    extern uint16_t pluse_count;
    uint8_t stateD = get_gpio_port_interrupt_state ((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048));

    
    pluse_count ++;

    clr_gpio_interrupt_state ((uint32_t)((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), stateD);
}
