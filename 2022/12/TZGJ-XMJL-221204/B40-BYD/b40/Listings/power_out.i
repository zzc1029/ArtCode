...
PoutControl PoutS[15] =
{
 {.name = "A01",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), .pin = ((uint32_t)(0x01UL<<((uint8_t)(4)))), .adc_ch = 01, .sc_threshold=420, .oct_threshold = 5000,.sct_threshold = 500, .magic = 665600, .oc_threshold = 180,.pwmable = 0, .pwmstart = 3, .pwmend = 50}, 
 {.name = "A09",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(7)))), .adc_ch = 20, .sc_threshold=420, .oct_threshold = 5000,.sct_threshold = 500, .magic = 665600, .oc_threshold = 180,.pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A02",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0084), .pin = ((uint32_t)(0x01UL<<((uint8_t)(5)))), .adc_ch = 10, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A10",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0038), .pin = ((uint32_t)(0x01UL<<((uint8_t)(0)))), .adc_ch = 05, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A03",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(2)))), .adc_ch = 02, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A11",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x001C), .pin = ((uint32_t)(0x01UL<<((uint8_t)(0)))), .adc_ch = 13, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A04",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(3)))), .adc_ch = 19, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A12",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0038), .pin = ((uint32_t)(0x01UL<<((uint8_t)(1)))), .adc_ch = 06, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A05",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(4)))), .adc_ch = 11, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A13",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0000), .pin = ((uint32_t)(0x01UL<<((uint8_t)(0)))), .adc_ch = 14, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A06",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(5)))), .adc_ch = 03, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A14",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0038), .pin = ((uint32_t)(0x01UL<<((uint8_t)(2)))), .adc_ch = 21, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A07",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0074), .pin = ((uint32_t)(0x01UL<<((uint8_t)(7)))), .adc_ch = 04, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A42",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x001C), .pin = ((uint32_t)(0x01UL<<((uint8_t)(1)))), .adc_ch = 07, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50},
 {.name = "A08",.gpio_periph = ((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0048), .pin = ((uint32_t)(0x01UL<<((uint8_t)(6)))), .adc_ch = 12, .sc_threshold=380, .oct_threshold = 5000,.sct_threshold = 500, .magic = 512000, .oc_threshold = 150, .pwmable = 0, .pwmstart = 3, .pwmend = 50}
};
...
void GetCurAndErr(uint16_t index, uint16_t adc)
{
    ...
    p->cur_100ma = (p->cur_100ma >> 3) + ((((adc * p->magic) >> 22) * 7) >> 3); 
...
static int protothread_out(struct pt *pt, PoutControl *p)
{
    ...
    while(1)
    {
        switch(p->status)
        {
            case PS_Off: 
								ClearDiag(p);
                ((*((volatile uint32_t *)((uint32_t)((p->gpio_periph) + 0x00U))))) &= ~(p->pin);  
                do { do { LC_LABEL182: ((pt)->lc) = &&LC_LABEL182; } while(0); if(!((p->cmd > 0))) { return 0; } } while(0); 
                p->status = PS_Start;
                break;
            ...
            case PS_Start: 
                ...
                if(p->pwmable)
                {
                    ...
                    for(p->pwmi = p->pwmstart; p->pwmi < p->pwmend; p->pwmi ++)
                    {
                        ...
                        do { do { LC_LABEL196: ((pt)->lc) = &&LC_LABEL196; } while(0); if(!(((int)(pwmtime - p->time) >= 0))) { return 0; } } while(0);
                        ...
                        do { do { LC_LABEL208: ((pt)->lc) = &&LC_LABEL208; } while(0); if(!(((int)(pwmtime - p->time) >= 0))) { return 0; } } while(0);
            ...
            case PS_On: 
								...
								((*((volatile uint32_t *)((uint32_t)((p->gpio_periph) + 0x00U))))) |= p->pin;
								do { do { LC_LABEL227: ((pt)->lc) = &&LC_LABEL227; } while(0); if(!((p->cmd == 0) || (GetDiag(p)))) { return 0; } } while(0);
            ...
            case PS_Err: 
                ...
                else
                {
                    ...
                    do { do { LC_LABEL247: ((pt)->lc) = &&LC_LABEL247; } while(0); if(!(((int)(systick_ms - p->time) >= 0) || (p->cmd == 0))) { return 0; } } while(0);

                    gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(0)))));
                    p->time = systick_ms + 2;
                    do { do { LC_LABEL251: ((pt)->lc) = &&LC_LABEL251; } while(0); if(!(((int)(systick_ms - p->time) >= 0))) { return 0; } } while(0);
                    gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(0)))));

                    p->status = (p->cmd == 0) ? PS_Off : PS_Start;
                }
                break;
						case PS_Idle: 
								do { do { LC_LABEL258: ((pt)->lc) = &&LC_LABEL258; } while(0); if(!(p->errcount < 3)) { return 0; } } while(0);
							
								gpio_bit_reset(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(0)))));
								p->time = systick_ms + 2;
								do { do { LC_LABEL262: ((pt)->lc) = &&LC_LABEL262; } while(0); if(!(((int)(systick_ms - p->time) >= 0))) { return 0; } } while(0);
								gpio_bit_set(((((uint32_t)0x50000000) + (uint32_t)0xA0000) + (uint32_t)0x0064), ((uint32_t)(0x01UL<<((uint8_t)(0)))));
...
SwitchEnd:
        do { PT_YIELD_FLAG = 0; do { LC_LABEL273: ((pt)->lc) = &&LC_LABEL273; } while(0); if(PT_YIELD_FLAG == 0) { return 1; } } while(0);
         
    }
    };
}

static struct pt pts[15];
        ...
        (pts + i)->lc = 0;
				...
				switch(mod_addr)
				{
					case 1:						
								...
								if(strstr("A01 A09", PoutS[i].name))
								{
										PoutS[i].pwmstart = 40;  
										PoutS[i].pwmend = 60;
...
__attribute__((used)) const init_fn_t __stan_init_power_out_init __attribute__((section(".init_fn." "6"))) = power_out_init;
