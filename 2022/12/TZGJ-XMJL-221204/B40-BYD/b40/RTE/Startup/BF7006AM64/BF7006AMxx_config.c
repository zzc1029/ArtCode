...
//    <i>WDT enable in deep sleep mode
    wdt_config(0x180);//0b0000 0001 1000 0000

//    <o>Overflow count<0x0-0xFFFF:0x1><#/0x1>
    wdt_overflow_count(16000); //32KHz 0.5s
...
//    </e>
//  </e>
    timer_init(TIMER1,0x7B,400); // 0111 1011  32MHz/8/400 = 10KHz  //start
#endif
#endif
}
#endif
