 ...
 *  $Id: reg_tw.h,v 1.10 2013/09/09 07:50:23 dos1236 Exp $
 *  $Author: dos1236 $
 *  $Revision: 1.10 $
 *
...
/*****************************************************************************/	
	...
	*/
	...
	#define OSD1_RAM_AH    			0xA3
	#define OSD1_RAM_DL    			0xA4
	#define OSD1_RAM_DH    			0xA4
	//-----------------------------------------------------------------------//
...
/*****************************************************************************/
...
#if 0
	/* >>>>>>>>>>>>>>>>>>>> SPI INTERFACE <<<<<<<<<<<<<<<<<<<<<<<<<< */
	#define SPI_INSTRUCTION_REG				0xF0
	#define SPI_ADDRESS_REG1				0xF1
	#define SPI_ADDRESS_REG2				0xF2
	#define SPI_ADDRESS_REG3				0xF3
	#define SPI_WR_DATA_REG					0xF4
	#define SPI_COMMAND_REG					0xF5
	...
	#define SPI_RD_BACK_DATA_REG1			0xF6
	#define SPI_RD_BACK_DATA_REG2			0xF7
	#define SPI_RD_BACK_DATA_REG3			0xF8
	#define SPI_DMA_ADDR_REG1				0xF9
	#define SPI_DMA_ADDR_REG2				0xFA
	#define SPI_DMA_COUNT_REG1				0xFB
	#define SPI_DMA_COUNT_REG2				0xFC
		#define SPI_DMA_COUNT_BIT				0x1FFF
	#define SPI_DMA_CTRL_REG				0xFC
		#define SPI_DMA_GO						0x80	// Done
		#define SPI_DMA2CHIP					0x40
		#define SPI_DMA_HOLDUP					0x20
		#define SPI_DMA_CNT_BIT					0x1F
	#define I8051_BIU_REG1					0xFD
		#define SPI_PRE_WREN					0x10	// Ready
	#define I8051_BIU_REG2					0xFE
		...
		#define DMA_WRITE					0x80
		#define DMA_READ					0xC0
...
/*****************************************************************************/
	...
	#define I2CM_STATUS			0xE0
	#define I2CM_MASK			0xE1
	#define I2CM_SLAVE_ADDR		0xE3
	#define I2CM_COMMAND		0xE4
	#define I2CM_DATA0			0xE5
	#define I2CM_DATA1			0xE6
	#define I2CM_INSTRUCT		0xE7
...
/*****************************************************************************/
    ...
    #define SOSD_SW_TC_REG1                 0x9A    /* Page 3 */
	#define SOSD_SW_TC_REG2                 0x9B    /* Page 3 */
		#define SOSD_SW_TC2_BIT              	0x07
    #define SOSD_TC_CTRL_REG                0x9B    /* Page 3 */
		#define SOSD_TC_EN						0x80
		#define SOSD_TC_V_MODE					0x40
...
/*****************************************************************************/
    ...
    /* >>>>>>>>>>>>>>>>>>>> SPI INTERFACE <<<<<<<<<<<<<<<<<<<<<<<<<< */
    /* SPI For 51 */
    #define SPI_INSTRUCTION_REG         0x60
    #define SPI_ADDRESS_REG1            0x61
    #define SPI_ADDRESS_REG2            0x62
    #define SPI_ADDRESS_REG3            0x63
    #define SPI_WR_DATA_REG             0x64
    #define SPI_COMMAND_REG             0x65
        #define SPI_ISSUE_CMD               0x80    // Busy
        #define SPI_WR_LENGTH               0x70
        #define SPI_WR_1B                   0x40
        #define SPI_WR_3B                   0x50
    ...
    #define SPI_RD_BACK_DATA_REG1       0x66
    #define SPI_RD_BACK_DATA_REG2       0x67
    #define SPI_RD_BACK_DATA_REG3       0x68
    #define SPI_DMA_ADDR_REG1           0x69
    #define SPI_DMA_ADDR_REG2           0x6A
        #define OSDRAM_DATA_PORT            0xF0AB
    #define SPI_DMA_COUNT_REG1          0x6B
    #define SPI_DMA_COUNT_REG2          0x6C
        #define SPI_DMA_COUNT_BIT           0x1FFF
    #define SPI_DMA_CTRL_REG            0x6C
        #define SPI_DMA_GO                  0x80    // Done
        #define SPI_DMA2CHIP                0x40
        #define SPI_DMA_HOLDUP              0x20
        #define SPI_DMA_CNT_BIT             0x1F

    #define SPI_4X_ENABLE_REG           0x6D
        #define SPI_PRE_WREN                0x10
        #define SPI_4X_I8051                0x02
        #define SPI_4X_DMA                  0x01
    #define SPI_TOGGLE_WR_DATA          0x6E
    ...
    /* >>>>>>>>>>>>>>>>>>>> oSPI INTERFACE <<<<<<<<<<<<<<<<<<<<<<<<<< */
    #define OSPI_INSTRUCTION_REG        0x70    
    #define OSPI_ADDRESS_REG1           0x71    
    #define OSPI_ADDRESS_REG2           0x72    
    #define OSPI_ADDRESS_REG3           0x73    
    #define OSPI_WR_DATA_REG            0x74    
    #define OSPI_COMMAND_REG            0x75    
    ...
    #define OSPI_DMA_CTRL_REG2          0x76    
        #define OSPI_DMA2SLUT               0x40
        #define OSPI_RD_MUX                 0x30
        
    #define OSPI_TOGGLE_WR_DATA         0x77

    #define SOSD_CLK_SEL_REG            0x78    
    ...
    /* SPI Arbitrator */
    #define SPI_ARB_EN_I8051            0x80    
    #define SPI_ARB_EN_DMA              0x81    
    #define SPI_DMA_BURST_SIZE          0x81    
    #define SPI_HP_REG                  0x82    
