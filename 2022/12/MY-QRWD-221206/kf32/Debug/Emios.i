...
void PwmInit(void)
{
   CCPx_PWM_GPIO_Init(((GPIO_SFRmap *) ((uint32_t)0x50000080)),((uint16_t)0x0800),((uint8_t)0x01));
   CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),2000,0);
   ...
   CCPx_PWM_PPX_Duty_C3(((CCP_SFRmap *) ((uint32_t)0x40000200)),((uint16_t)2),0,0);
...
void SetBackGround(uint8_t level)
{
  ...
  if(level < 11)
  {
    ...
    if((backlight_level != ledgroundpre) || Art.bit.b51)
    {
      ledgroundpre = backlight_level;
     CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),2000,200*backlight_level);
   Art.bit.b51 = 0;
    }
  }
...
void BACKGROUND_OFF(void)
{
 CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40000100)),((uint16_t)2),0,0);
    Art.bit.b51 = 1;
}
...
void SetFreqOut(int freq)
{
 if(freq != 0)
 {
  ...
  CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40000200)),((uint16_t)1),50000/freq - 1,(50000/freq - 1)/2);
 }
 else
 {

  CCPx_PWM_PPX_Duty(((CCP_SFRmap *) ((uint32_t)0x40000200)),((uint16_t)1),0,0);
 }
...
void CCPx_Capture_Mode_init(CCP_SFRmap* CCPx)
{
 ...
 TIM_Reset(CCPx);
 CCP_PWM_Input_Measurement_Config(CCPx,TRUE);
 GPTIM_Slave_Mode_Config(CCPx,((uint32_t)6 << (5)));
 GPTIM_Trigger_Select_Config(CCPx,((uint32_t)0xE << (8)));


 CCP_Capture_Mode_Config(CCPx, ((uint16_t)1),((uint16_t)0x4));
 CCP_Capture_Mode_Config(CCPx, ((uint16_t)2),((uint16_t)0x5));
...
{
# 447 "../driver/Emios.c"
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)),((uint16_t)0x0004));
 EXIT_INTx_Config(((uint32_t)2),((uint32_t)3));
     INT_Interrupt_Priority_Config(INT_EINT2,((uint32_t)3<<((1))),7);
}
