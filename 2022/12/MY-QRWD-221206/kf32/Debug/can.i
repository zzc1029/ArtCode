...
void Can1SendFifo(void)
{
   ...
   TcanDelay = 10;
   if(Candomsg.type == ((uint32_t)0))
    CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001100)),Candomsg.ID,Candomsg.data,Candomsg.len,((uint32_t)0),((uint32_t)0));
   else
    CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001100)),Candomsg.ID,Candomsg.data,Candomsg.len,((uint32_t)0),((uint32_t)1));
     }
     break;
     case DELAYING:

    if((TcanDelay == 0) || (CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)((uint32_t)1<<((19)))))))
    {
             Candomsg.sended = SENDED;
