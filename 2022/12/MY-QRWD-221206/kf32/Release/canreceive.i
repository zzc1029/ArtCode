...
void ReceCan(uint32_t id,volatile uint8_t *data)
{
 ...
 switch(id)
 {
  ...
  case 0x0c08a1a7:
   ...
   break;
  case 0x0c09a1a7:
   CopyData(VCUSofeVersion,data,8);
   CopyData(_0C09A1A7_DATA,data,8);
   CAN1_2_CAN2.bit.b2 = 1;
   break;
  case 0x0c0aa1a7:
   SystemMode = data[0];
   SystemStatus = data[1];
  ...
  case 0x0C04A70A:
   ...
   CAN1_2_CAN2.bit.b13 = 1;
   break;
  case 0x1818d0f3:
   Art.bit.b56 = 1;
   can_err_time = 0;
   CopyData(_1818D0F3_DATA,data,8);
   CAN1_2_CAN2.bit.b14 = 1;
  ...
  case 0x0CFFF3A7:
   ...
   CAN1_2_CAN2.bit.b32 = 1;
   break;
  case 0x0CFEEC21:
   CopyData(_0CFEEC21_DATA,data,8);
   CAN1_2_CAN2.bit.b33 = 1;
   break;
  case 0x18eba1a5:
   CopyData(_18EBA1A5_DATA,data,8);
   CAN1_2_CAN2.bit.b34 = 1;
