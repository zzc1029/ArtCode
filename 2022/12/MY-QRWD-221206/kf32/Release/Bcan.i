...
void BCanSendTo(void)
{
   ...
   CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001980)),BCandomsg.ID,BCandomsg.data,BCandomsg.len,((uint32_t)0),BCandomsg.type);
     }
     break;
     case DELAYING:
...
void Can3_Rx_Isr(CAN_MessageTypeDef CAN_MessageStructrue)
{
   ...
   if(index < ((sizeof(BCanIdTable)/sizeof(BCanIdTable[0]))))
   {
    ...
    switch(id)
    {
     ...
     case 0x690:
       CopyData(FrontCurrent,Bdata,8);
    break;
     case 0x691:
       CopyData(FrontCurrent + 8,Bdata,8);
    break;
     ...
     case 0x692:
       CopyData(RearCurrent,Bdata,8);
    break;
     case 0x693:
       CopyData(RearCurrent + 8,Bdata,8);
    break;
     ...
     case 0x694:
       CopyData(TopCurrent,Bdata,8);
    break;
     case 0x695:
       CopyData(TopCurrent + 8,Bdata,8);
    break;
