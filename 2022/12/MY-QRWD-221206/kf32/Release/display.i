...
void Send0x24_1 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((tempxx)>>0)&0xFF);
    communicate_T123_data[4] = (((tempxx)>>8)&0xFF);
    communicate_T123_data[5] = (((cur1)>>0)&0xFF);
    communicate_T123_data[6] = (((cur1)>>8)&0xFF);
    communicate_T123_data[7] = (((cur2)>>0)&0xFF);
    communicate_T123_data[8] = (((cur2)>>8)&0xFF);
    communicate_T123_data[9] = (((cur3)>>0)&0xFF);
    communicate_T123_data[10] = (((cur3)>>8)&0xFF);
...
void Send0x24_2 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((BMS.itotal_anode_riso)>>0)&0xFF);
    communicate_T123_data[4] = (((BMS.itotal_anode_riso)>>8)&0xFF);
    communicate_T123_data[5] = (((BMS.itotal_cathode_riso)>>0)&0xFF);
    communicate_T123_data[6] = (((BMS.itotal_cathode_riso)>>8)&0xFF);
    communicate_T123_data[7] = (((BMS.imono_max_voltage)>>0)&0xFF);
    communicate_T123_data[8] = (((BMS.imono_max_voltage)>>8)&0xFF);
    communicate_T123_data[9] = (((BMS.imono_min_voltage)>>0)&0xFF);
    communicate_T123_data[10] = (((BMS.imono_min_voltage)>>8)&0xFF);
...
void Send0x24_3 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((BMS.iaverage_voltage)>>0)&0xFF);
    communicate_T123_data[4] = (((BMS.iaverage_voltage)>>8)&0xFF);
...
void Send0x25_2 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((BMS.rated_capacity)>>0)&0xFF);
    communicate_T123_data[4] = (((BMS.rated_capacity)>>8)&0xFF);
    communicate_T123_data[5] = (((vol)>>0)&0xFF);
    communicate_T123_data[6] = (((vol)>>8)&0xFF);
    communicate_T123_data[7] = (((BMS.battery_series_num)>>0)&0xFF);
    communicate_T123_data[8] = (((BMS.battery_series_num)>>8)&0xFF);
...
void Send0x26_2 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((BMS.imono_max_voltage)>>0)&0xFF);
    communicate_T123_data[4] = (((BMS.imono_max_voltage)>>8)&0xFF);
    communicate_T123_data[5] = (((BMS.imono_min_voltage)>>0)&0xFF);
    communicate_T123_data[6] = (((BMS.imono_min_voltage)>>8)&0xFF);
...
void Send0x22_1 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((vol1)>>0)&0xFF);
    communicate_T123_data[4] = (((vol1)>>8)&0xFF);
    communicate_T123_data[5] = (((cur)>>0)&0xFF);
    communicate_T123_data[6] = (((cur)>>8)&0xFF);
    communicate_T123_data[7] = (((vol2)>>0)&0xFF);
    communicate_T123_data[8] = (((vol2)>>8)&0xFF);
...
void Send0x22_3 (u8 initpw)
{
    ...
    communicate_T123_data[3] = (((InsulationMonitorRes_Positive)>>0)&0xFF);
    communicate_T123_data[4] = (((InsulationMonitorRes_Positive)>>8)&0xFF);
    communicate_T123_data[5] = (((InsulationMonitorRes_Negative)>>0)&0xFF);
    communicate_T123_data[6] = (((InsulationMonitorRes_Negative)>>8)&0xFF);
...
static u32 display_surface6(u8 key,u8 initpw)
{
    static u8 flag = 0;
    static u8 fan = 0;
    u8 changescreenflag = 0;
...
void Send0x21_1 (u8 initpw)
{
    ...
    communicate_T123_data[7] = (((MOTOR.itorque)>>0)&0xFF);
    communicate_T123_data[8] = (((MOTOR.itorque)>>8)&0xFF);

    cur = MOTOR.icurrent * 0.1;
    communicate_T123_data[9] = (((cur)>>0)&0xFF);
    communicate_T123_data[10] = (((cur)>>8)&0xFF);
...
# 1106 "../source/display.c"
void AddWanDaMenu(void)
{
# 1122 "../source/display.c"
