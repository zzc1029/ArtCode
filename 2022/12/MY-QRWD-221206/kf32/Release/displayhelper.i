...
# 1 "D:/zzc/project/pro_2022/pro_12/MY-QRWD-221206/kf32/driver/keyfifo.h" 1
# 12 "D:/zzc/project/pro_2022/pro_12/MY-QRWD-221206/kf32/driver/keyfifo.h"
...
void module_information(uint8_t module)
{
 ...
 u16 temp;
   ...
   temp = bcm_senor1_f*0.1*Air_Coef;
            communicate_T123_data[3] = temp;
            communicate_T123_data[4] = temp >> 8;

   temp = bcm_senor2_f*0.1*Air2_Coef;
...
void meter_information(void)
{
    ...
    if((meterx&0x03)==0x01)
    {
        ...
        communicate_T123_data[2] = 0x01;
        b2_add.bit.b7 = port_b.bit.b0;
        b2_add.bit.b6 = port_a.bit.b6;
        b2_add.bit.b5 = port_a.bit.b5;
        b2_add.bit.b4 = port_a.bit.b4;
        ...
        b2_add.bit.b7 = port_b.bit.b8;
        b2_add.bit.b6 = port_b.bit.b7;
        b2_add.bit.b5 = port_b.bit.b6;
        b2_add.bit.b4 = port_b.bit.b5;
        b2_add.bit.b3 = port_b.bit.b4;
        b2_add.bit.b2 = port_b.bit.b3;
        b2_add.bit.b1 = port_b.bit.b2;
        b2_add.bit.b0 = port_b.bit.b1;
        communicate_T123_data[4] = b2_add.byte;

        b2_add.bit.b7 = port_c.bit.b8;
        b2_add.bit.b6 = port_c.bit.b0;
        b2_add.bit.b5 = port_c.bit.b1;
        b2_add.bit.b4 = port_c.bit.b2;
        b2_add.bit.b3 = port_c.bit.b3;
        b2_add.bit.b2 = port_b.bit.b11;
        b2_add.bit.b1 = port_b.bit.b10;
        b2_add.bit.b0 = port_b.bit.b9;
        communicate_T123_data[5] = b2_add.byte;

        b2_add.bit.b7 = port_d.bit.b3;
        b2_add.bit.b6 = port_d.bit.b2;
        b2_add.bit.b5 = port_d.bit.b1;
        b2_add.bit.b4 = port_d.bit.b0;
        b2_add.bit.b3 = port_c.bit.b12;
        b2_add.bit.b2 = port_c.bit.b11;
        b2_add.bit.b1 = port_c.bit.b10;
        b2_add.bit.b0 = port_c.bit.b9;
        communicate_T123_data[6] = b2_add.byte;

        b2_add.bit.b7 = port_d.bit.b11;
        b2_add.bit.b6 = port_d.bit.b10;
        b2_add.bit.b5 = port_d.bit.b9;
        b2_add.bit.b4 = port_d.bit.b8;
        b2_add.bit.b3 = port_d.bit.b7;
        b2_add.bit.b2 = port_d.bit.b6;
        b2_add.bit.b1 = port_d.bit.b5;
        b2_add.bit.b0 = port_d.bit.b4;
...
void Meter_Add_Menu(u8 initpw)
{
 ...
 outpower_state.byte = 0;
    ...
    outpower_state.bit.b3 = port_c.bit.b4;
    outpower_state.bit.b2 = port_d.bit.b15;
    outpower_state.bit.b1 = port_d.bit.b14;
    outpower_state.bit.b0 = port_d.bit.b13;
...
void Send0x2E01(u8 initpw)
{
 ...
 vol = BMS.ivoltage*0.1;
 cur = BMS.icadc/10;

 communicate_T123_data[1] = PAGE_0x2E;
 communicate_T123_data[2] = 0x01;
 communicate_T123_data[3] = Bat_Soc;
 communicate_T123_data[4] = (((vol)>>0)&0xFF);
 communicate_T123_data[5] = (((vol)>>8)&0xFF);
 communicate_T123_data[6] = (((cur)>>0)&0xFF);
 communicate_T123_data[7] = (((cur)>>8)&0xFF);
 communicate_T123_data[8] = BMS.imono_max_temp_2;
 communicate_T123_data[9] = (((BMS.imono_max_voltage)>>0)&0xFF);
 communicate_T123_data[10] = (((BMS.imono_max_voltage)>>8)&0xFF);

    do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}
void Send0x2E02(u8 initpw)
{
 u16 vol;
    u16 cur;
 ...
 communicate_T123_data[3] = (((BMS.imono_min_voltage)>>0)&0xFF);
 communicate_T123_data[4] = (((BMS.imono_min_voltage)>>8)&0xFF);
 communicate_T123_data[5] = BMS.imono_min_temp;
 communicate_T123_data[6] = (((BMS.itotal_anode_riso)>>0)&0xFF);
 communicate_T123_data[7] = (((BMS.itotal_anode_riso)>>8)&0xFF);
 communicate_T123_data[8] = (((BMS.itotal_cathode_riso)>>0)&0xFF);
 communicate_T123_data[9] = (((BMS.itotal_cathode_riso)>>8)&0xFF);
 communicate_T123_data[10] = DisplaySymbol[1].bit.b5|(DisplaySymbol[1].bit.b4 << 1);

    do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}

void Send0x2E03(u8 initpw)
{
    u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;

 communicate_T123_data[1] = PAGE_0x2E;
 communicate_T123_data[2] = 0x03;
 communicate_T123_data[3] = BMS.ChargeOutletTemp1;
    communicate_T123_data[4] = BMS.ChargeOutletTemp2;
    communicate_T123_data[5] = BMS.ChargeOutletTemp3;
    communicate_T123_data[6] = BMS.ChargeOutletTemp4;

 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
}

static u32 ChargeMesg(u8 key,u8 initpw)
{
    static u8 loop = 0;
    if(initpw)
    {
        ChangeToPage(PAGE_0x2E);
  Send0x2E01(1);
  Send0x2E02(1);
    }
 ...
 if(port_c.bit.b4 || (!port_a.bit.b3))
  return DIS_NOP_MENU;
 else
  return DIS_CHARGE_MENU;
}
...
u16 GetWenziWarnCode(u16 alarm_count)
{
    ...
    if((alarm_count>= 0xB9) && (alarm_count <= 0XC2))
    {
        return (BAT_FIRE.status[alarm_count - 0XB9] >> 4);
    }
 else if((alarm_count>= 0xC3) && (alarm_count <= 0XC7))
  return (TIRE.alarm_num[alarm_count - 0xC3] + 1);
...
void InitDisplayHelper(void)
{
 ...
 AddMenu(ChargeMesg, DIS_CHARGE_MENU);
...
void display_time_bar_soc(u8 initpw)
{
    ...
    communicate_T123_data[10] = Bat_Soc;
...
void SendPAGE_MAIN04(u8 initpw)
{
 ...
 u8 i; static u8 data1save[11]={0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF}; for(i = 1; i < 12; i++) communicate_T123_data[i] = 0;;
    ...
    communicate_T123_data[7] = MOTOR.itemp;
    communicate_T123_data[8] = CONTROL.itemp;
    communicate_T123_data[9] = (((BMS.imono_max_voltage)>>0)&0xFF);
    communicate_T123_data[10] = (((BMS.imono_max_voltage)>>8)&0xFF);
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
...
void SendPAGE_MAIN05(u8 initpw)
{
 ...
 communicate_T123_data[1] = PAGE_MAIN;
    ...
    communicate_T123_data[3] = (((BMS.imono_min_voltage)>>0)&0xFF);
    communicate_T123_data[4] = (((BMS.imono_min_voltage)>>8)&0xFF);
    communicate_T123_data[5] = BMS.imono_max_temp_2;
    communicate_T123_data[6] = (((SystemCode)>>0)&0xFF);
    communicate_T123_data[7] = (((SystemCode)>>8)&0xFF);
    communicate_T123_data[8] = BMS.imono_min_temp;
    communicate_T123_data[9] = baigongli[0];
    communicate_T123_data[10] = baigongli[1];
 do{ u8 change = 0; for(i=3; i<11; i++) { if(data1save[i] != communicate_T123_data[i]) { data1save[i] = communicate_T123_data[i]; change ++; } } if((change>0) ||(initpw)) { fifo_in(&SendBuff); } }while(0);
...
void SendPAGE_MAIN06(u8 initpw)
{
 ...
 communicate_T123_data[1] = PAGE_MAIN;
    ...
    communicate_T123_data[3] = (((shunshigonglv)>>0)&0xFF);
    communicate_T123_data[4] = (((shunshigonglv)>>8)&0xFF);
    communicate_T123_data[5] = DrivingRange;
    communicate_T123_data[6] = shengyugonglv;
    communicate_T123_data[7] = shengyugonglv>>8;
 communicate_T123_data[8] = (shuileng2[7] & 0x3f);
