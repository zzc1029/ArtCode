...
void InitSwitch(void)
{
    ...
    port_mask.tb[0].bit.b0 = 0;


    port_mask.tb[0].bit.b1 = 0;


    port_mask.tb[0].bit.b2 = 0;


    port_mask.tb[0].bit.b3 = 0;


    port_mask.tb[0].bit.b4 = 0;


    port_mask.tb[0].bit.b5 = 0;


    port_mask.tb[0].bit.b6 = 0;


    port_mask.tb[0].bit.b7 = 0;
# 256 "../source/MeterConfig.c"
}
...
{
    fmode_mask.U32 = 0;
# 309 "../source/MeterConfig.c"
    fmode_mask.bit.b17 = 1;



    fmode_mask.bit.b15 = 0;
# 324 "../source/MeterConfig.c"
}
...
{
    rmode_mask.U32 = 0;
# 374 "../source/MeterConfig.c"
    rmode_mask.bit.b17 = 1;



    rmode_mask.bit.b15 = 0;
# 389 "../source/MeterConfig.c"
}
...
{
    tmode_mask.U32 = 0;
# 428 "../source/MeterConfig.c"
    tmode_mask.bit.b21 = 1;
# 440 "../source/MeterConfig.c"
    tmode_mask.bit.b17 = 1;



    tmode_mask.bit.b15 = 0;
# 455 "../source/MeterConfig.c"
}

void initPWM_F(void)
{
    F_Set_PWM.word = 0x0000;
# 479 "../source/MeterConfig.c"
    F_Set_PWM.bit.b6 = 1;
...
# 521 "../source/MeterConfig.c"
    R_Set_PWM.bit.b3 = 1;
# 545 "../source/MeterConfig.c"
    R_Set_PWM.bit.b11 = 1;
# 557 "../source/MeterConfig.c"
}
...
void RainConfig(void)
{
    ctrl_cmd[6].bit.b0 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b5;
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b6;
    ctrl_cmd[6].bit.b2 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b8;
    ctrl_cmd[6].bit.b3 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b7;
    ...
    ctrl_cmd[6].bit.b5 = port_a.bit.b0;
}
