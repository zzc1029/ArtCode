...
# 12 "../driver/ZD24C0x.c" 2
 ...
 void ZD_iic_init(void)
 {
   GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
   GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800));;

   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000), SET);
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800), SET);
 }
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800), SET);
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000),GPIO_MODE_IN,GPIO_NOPULL,GPIO_POD_OD);
 delay_(1);
 while((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000)) > 0) && (i < 255))
   i++;
  GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800), RESET);
 delay_(1);
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
 ...
 for(i = 0;i < 8; i++)
 {
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800), SET);
   delay_(1);
   k = (k<<1)|GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000));
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0800), RESET);
   delay_(1);
 }
 GPIOInit_PullOd_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x1000),GPIO_MODE_OUT,GPIO_NOPULL,GPIO_POD_OD);
