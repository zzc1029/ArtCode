...
# 40 "../driver/Pcan.c"
 ...
 switch(PCandomsg.sended)
 {
   case SENDED:
    ...
    CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001180)),PCandomsg.ID,PCandomsg.data,PCandomsg.len,((uint32_t)0),PCandomsg.type);
     }
     break;
   case DELAYING:
     if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)((uint32_t)1<<((18))))))
     {
    PCandomsg.sended = SENDED;
