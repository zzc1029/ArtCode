...
void LedPortInit(void)
{
 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0001));
 ...
 GPIOInit_Output_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0001));
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0001), RESET);
}
...
void led_out(void)
{
 uint8_t i,j, k;
    uint8_t dump;
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0001), SET);
 for(j = 0; j < 3; j++)
 {
  dump = led[j].byte;
  for(i=0;i<8;i++)
   {
    GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0001), RESET);
   if(dump & 0x80)
    {

     GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0080), RESET);
   }
   else
   {
    GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0080), SET);
   }
   dump <<= 1;
   ...
   GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000040)),((uint16_t)0x0001), SET);
 ...
 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x0100), SET);
