...
void KeyIoInit(void)
{
 ...
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x2000));
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x4000));
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0040));
 GPIOInit_Input_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x8000));
}
...
static const KEY_EVENT KeyEvent[][3] =
{
 ...
 {IN_KEY5_SP, IN_KEY5_CP, IN_KEY5_RP },
 {IN_KEY6_SP, IN_KEY6_CP, IN_KEY6_RP }
};
# 42 "../driver/key.c"
...
uint8_t read_key_port(void)
{
 ...
 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x2000)) & 0x01) == 0)
 {
  key_dat |= 0x04;
 }
 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x4000)) & 0x01) == 0)
 {
  key_dat |= 0x08;
 }

 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000100)),((uint16_t)0x0040)) & 0x01) == 0)
 {
  key_dat |= 0x10;
 }
 if((GPIO_Read_Input_Data_Bit(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint16_t)0x8000)) & 0x01) == 0)
 {
  key_dat |= 0x20;
 }
