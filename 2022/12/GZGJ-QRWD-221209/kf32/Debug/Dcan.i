...
# 14 "../driver/Dcan.c" 2
 ...
 static void xGPIO_Dcan(void)
 {
  ...
  GPIO_InitStructure.m_Pin = ((uint16_t)0x0800)|((uint16_t)0x1000);
  ...
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint32_t)0xB),((uint8_t)0x09));
  GPIO_Pin_RMP_Config(((GPIO_SFRmap *) ((uint32_t)0x50000000)),((uint32_t)0xC),((uint8_t)0x09));
 }
# 41 "../driver/Dcan.c"
 ...
 void DcanInint(void)
 {
   ...
   xINT_DCAN(((CAN_SFRmap *) ((uint32_t)0x40001900)));
 }
 ...
 switch(DCandomsg.sended)
 {
   case SENDED:
    ...
    DcanDelay = 10;
    if(DCandomsg.type == ((uint32_t)0))
     CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001900)),DCandomsg.ID,DCandomsg.data,DCandomsg.len,((uint32_t)0),((uint32_t)0));
    else
     CAN_Transmit_DATA(((CAN_SFRmap *) ((uint32_t)0x40001900)),DCandomsg.ID,DCandomsg.data,DCandomsg.len,((uint32_t)0),((uint32_t)1));
     }
     break;
   case DELAYING:
     if((DcanDelay == 0) || (CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)((uint32_t)1<<((19)))))))
     {
    DCandomsg.sended = SENDED;
    DcanDelay = 0;
