 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<0)) != RESET)
 {
  ...
  else
  {
   Can2_Rx_Isr(CAN_MessageStructrue);
    ...
    if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<2)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)1<<2));
  if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001900)),((uint32_t)((uint32_t)1<<((23))))))
  {
     ...
     {
     CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001900)), FALSE);
     }
  }
 }
}
...
void __attribute__((interrupt))_CAN0_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<2)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001100)),((uint32_t)1<<2));
     ...
     {
              CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001100)), FALSE);
     }
  }
 }
...
void __attribute__((interrupt))_CAN3_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<2)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)1<<2));
  if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001980)),((uint32_t)((uint32_t)1<<((23))))))
  {
     ...
     {
     CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001980)), FALSE);
     }
  }
 }
...
void __attribute__((interrupt))_CAN1_exception (void)
{
 ...
 if(CAN_Get_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<2)) != RESET)
 {
  CAN_Clear_INT_Flag(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)1<<2));
  if(CAN_Get_Transmit_Status(((CAN_SFRmap *) ((uint32_t)0x40001180)),((uint32_t)((uint32_t)1<<((23))))))
  {
     ...
     {
     CAN_Reset_Mode_Enable(((CAN_SFRmap *) ((uint32_t)0x40001180)), FALSE);
     }
  }
 }
...
void __attribute__((interrupt))_USART2_exception (void)
{
 ...
 if(USART_Get_Receive_BUFR_Ready_Flag(((USART_SFRmap *) ((uint32_t)0x40000A80))))
 {
  data = USART_ReceiveData(((USART_SFRmap *) ((uint32_t)0x40000A80)));
...
{
  if(INT_Get_External_Flag(((uint32_t)2)) != RESET)
  {
   INT_External_Clear_Flag(((uint32_t)2));
   A5Count++;
