...
void BCMConfig(void)
{
 ...
 ctrl_cmd[3].bit.b4 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b0;
 ctrl_cmd[3].bit.b5 = (port_c.bit.b4||port_a.bit.b0) && port_d.bit.b1;

 if(port_c.bit.b4 && ((CanData[ID(0x0C0AA79D)][BYTE8] & 0x80) == 0x80))
  R_TimeCount = 600;
 ctrl_cmd[3].bit.b6 = (R_TimeCount > 0);
 if(R_TimeCount > 0)
  R_TimeCount--;
...
void LedHand(void)
{
 ...
 led[0].bit.b3 = (port_c.bit.b4||port_a.bit.b0);
    ...
    led[2].bit.b1 = port_c.bit.b4 && (((((bcm_fb_st_f.dword)>>(A12*2))&0x03) == 0) && ((bcm_out_st_f.word>>A12)&0x01));
 ...
 led[1].bit.b0 = (port_c.bit.b4||port_a.bit.b0) && (bcm_sw1_f.bit.b7 || ((DriverOperateStatus&0x0f)==0x0f));
