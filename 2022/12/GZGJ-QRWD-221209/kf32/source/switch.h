...
/*Define 74HC165 Pins	*/
#define HC165_PL(state)	  GPIO_Set_Output_Data_Bits(GPIOF_SFR,GPIO_PIN_MASK_3, state)	//asynchronous parallel load input (active LOW)
#define HC165_CP(state)	  GPIO_Set_Output_Data_Bits(GPIOG_SFR,GPIO_PIN_MASK_7, state)		

//…ËŒ™ ‰»Î
#define HC165_Q7		  GPIO_Read_Input_Data_Bit(GPIOC_SFR,GPIO_PIN_MASK_8)		//serial output from the last stage
...
/*	Port_A */	
#define PTA7		port_a.bit.b0
#define PTA8		port_a.bit.b1
#define PTA9		port_a.bit.b2
#define PTA10		port_a.bit.b3
#define PTA17		port_a.bit.b4
#define PTA18		port_a.bit.b5
#define PTA19		port_a.bit.b6

#define PTA6		port_a.bit.b7
#define PTA12		port_a.bit.b8
#define PTA15		port_a.bit.b9
#define PTA20		port_a.bit.b10
...
/*	Port_C */	
#define PTC10		port_c.bit.b3
#define PTC11		port_c.bit.b2
#define PTC12		port_c.bit.b1
#define PTC13		port_c.bit.b0
#define PTC14       port_c.bit.b8
#define PTC15       port_c.bit.b9
#define PTC16       port_c.bit.b10
#define PTC17       port_c.bit.b11
#define PTC18       port_c.bit.b12
