...
# 165 "../source/MeterConfig.c"
    port_mask.tb[1].bit.b2 = 0;


    port_mask.tb[1].bit.b3 = 0;
# 189 "../source/MeterConfig.c"
    port_mask.tb[2].bit.b2 = 0;
# 204 "../source/MeterConfig.c"
    port_mask.tb[2].bit.b7 = 0;
# 219 "../source/MeterConfig.c"
    port_mask.tb[3].bit.b4 = 0;
# 231 "../source/MeterConfig.c"
    port_mask.tb[4].bit.b0 = 0;


    port_mask.tb[4].bit.b1 = 0;


    port_mask.tb[4].bit.b2 = 0;
# 246 "../source/MeterConfig.c"
    port_mask.tb[4].bit.b5 = 0;


    port_mask.tb[4].bit.b6 = 0;
...
{
    fmode_mask.U32 = 0;
# 308 "../source/MeterConfig.c"
    fmode_mask.bit.b17 = 1;



    fmode_mask.bit.b15 = 0;
# 323 "../source/MeterConfig.c"
}
...
{
    rmode_mask.U32 = 0;
# 373 "../source/MeterConfig.c"
    rmode_mask.bit.b17 = 1;



    rmode_mask.bit.b15 = 0;
# 388 "../source/MeterConfig.c"
}
...
{
    tmode_mask.U32 = 0;
# 439 "../source/MeterConfig.c"
    tmode_mask.bit.b17 = 1;



    tmode_mask.bit.b15 = 0;
# 454 "../source/MeterConfig.c"
}

void initPWM_F(void)
{
    F_Set_PWM.word = 0x0000;
# 505 "../source/MeterConfig.c"
}

void initPWM_R(void)
{
    R_Set_PWM.word = 0x0000;
# 556 "../source/MeterConfig.c"
}
...
void RainConfig(void)
{
    ctrl_cmd[6].bit.b0 = (port_c.bit.b4||port_a.bit.b0) && 0;
    if(ctrl_cmd[6].bit.b0 == 1)
        ctrl_cmd[6].bit.b1 = 0;
    else
        ctrl_cmd[6].bit.b1 = (port_c.bit.b4||port_a.bit.b0) && 0;
    ctrl_cmd[6].bit.b2 = (port_c.bit.b4||port_a.bit.b0) && 0;
    ctrl_cmd[6].bit.b3 = (port_c.bit.b4||port_a.bit.b0) && 0;
