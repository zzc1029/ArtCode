...
volatile uint16_t timeout[(sizeof(CanIdTable)/sizeof(CanIdTable[0]))];
...
void ReceCan(uint32_t id,volatile uint8_t *data)
{
 ...
 switch(id)
 {
  ...
  case 0x18FECA00:
   ...
   break;
  case 0x18ECFF00:
   Tot_packets = get_faualt_bytes(data[BYTE4]);
   Tot_packets = Tot_packets*4;
   Const_0X20 = data[BYTE1];
