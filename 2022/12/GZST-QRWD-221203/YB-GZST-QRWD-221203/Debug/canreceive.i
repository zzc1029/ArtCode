...
volatile uint8_t CanData[(sizeof(CanIdTable)/sizeof(CanIdTable[0]))][8];
volatile uint8_t timeout[(sizeof(CanIdTable)/sizeof(CanIdTable[0]))];
...
{
 uint16_t i;
 for(i=0;i<((sizeof(CanIdTable)/sizeof(CanIdTable[0])));i++)
 {
  if(CanIdTable[i] == id)
   return i;
 }
 return ((sizeof(CanIdTable)/sizeof(CanIdTable[0])));
}
...
{
 if(index<((sizeof(CanIdTable)/sizeof(CanIdTable[0]))))
 {
